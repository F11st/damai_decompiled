...
public final class C8753a {
    ...
    public static final AbstractC8825p EMPTY_REQUEST;
    public static final AbstractC8829r EMPTY_RESPONSE;
    private static final Method d;
    private static final Pattern e;
    public static final String[] EMPTY_STRING_ARRAY = new String[0];
    public static final C8816l EMPTY_HEADERS = C8816l.g(new String[0]);
    private static final C8849i a = C8849i.d(ByteString.decodeHex("efbbbf"), ByteString.decodeHex("feff"), ByteString.decodeHex("fffe"), ByteString.decodeHex("0000ffff"), ByteString.decodeHex("ffff0000"));
    ...
    static {
        ...
        Method method = null;
        EMPTY_RESPONSE = AbstractC8829r.i(null, bArr);
        EMPTY_REQUEST = AbstractC8825p.d(null, bArr);
        try {
    ...
    public static boolean E(C8818m c8818m, C8818m c8818m2) {
        return c8818m.m().equals(c8818m2.m()) && c8818m.x() == c8818m2.x() && c8818m.C().equals(c8818m2.C());
    }
    ...
    public static ThreadFactory I(final String str, final boolean z) {
        return new ThreadFactory() { // from class: tb.uv2
            ...
            public final Thread newThread(Runnable runnable) {
                Thread B;
                B = C8753a.B(str, z, runnable);
                return B;
            }
        };
    }

    public static List<C8789a> J(C8816l c8816l) {
        ArrayList arrayList = new ArrayList();
        for (int i = 0; i < c8816l.h(); i++) {
            arrayList.add(new C8789a(c8816l.e(i), c8816l.j(i)));
        }
        return arrayList;
    }

    public static C8816l K(List<C8789a> list) {
        C8816l.C8817a c8817a = new C8816l.C8817a();
        for (C8789a c8789a : list) {
            w31.a.b(c8817a, c8789a.a.utf8(), c8789a.b.utf8());
        }
        return c8817a.e();
    }
    ...
    */
    private static java.net.InetAddress m(java.lang.String r11, int r12, int r13) {
        ...
        L90:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.C8753a.m(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    public static String s(C8818m c8818m, boolean z) {
        String m;
        if (c8818m.m().contains(":")) {
            m = jn1.ARRAY_START_STR + c8818m.m() + jn1.ARRAY_END_STR;
        } else {
            m = c8818m.m();
        }
        if (z || c8818m.x() != C8818m.e(c8818m.C())) {
            return m + ":" + c8818m.x();
        }
        return m;
    }
