...
public final class c {
    ...
    static {
        ...
        while (true) {
            ...
            strArr2[i2] = okhttp3.internal.a.q("%8s", Integer.toBinaryString(i2)).replace(' ', YKUpsConvert.CHAR_ZERO);
            i2++;
        }
        String[] strArr3 = c;
        strArr3[0] = "";
    ...
    public static String b(boolean z, int i, int i2, byte b2, byte b3) {
        String[] strArr = b;
        String q = b2 < strArr.length ? strArr[b2] : okhttp3.internal.a.q("0x%02x", Byte.valueOf(b2));
        String a2 = a(b2, b3);
