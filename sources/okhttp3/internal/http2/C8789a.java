...
public final class C8789a {
    ...
    public C8789a(String str, String str2) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof C8789a) {
            ...
            return this.a.equals(c8789a.a) && this.b.equals(c8789a.b);
        }
        return false;
    }
    ...
    public String toString() {
        return C8753a.q("%s: %s", this.a.utf8(), this.b.utf8());
    }

    public C8789a(ByteString byteString, String str) {
        this(byteString, ByteString.encodeUtf8(str));
    }

    public C8789a(ByteString byteString, ByteString byteString2) {
        this.a = byteString;
        this.b = byteString2;
