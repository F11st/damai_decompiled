...
public class a {
    ...
    /* loaded from: classes10.dex */
    public class TextureView$SurfaceTextureListenerC0253a implements TextureView.SurfaceTextureListener {
        final /* synthetic */ TextureView.SurfaceTextureListener a;
        final /* synthetic */ FlutterTextureView b;

        TextureView$SurfaceTextureListenerC0253a(TextureView.SurfaceTextureListener surfaceTextureListener, FlutterTextureView flutterTextureView) {
    ...
    public void c(FlutterTextureView flutterTextureView) {
        ...
        this.b = flutterTextureView;
        flutterTextureView.setSurfaceTextureListener(new TextureView$SurfaceTextureListenerC0253a(surfaceTextureListener, flutterTextureView));
    }
