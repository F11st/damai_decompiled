...
/* renamed from: com.real.android.nativehtml.common.layout.a */
/* loaded from: classes5.dex */
public class C6147a implements Layout {

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: com.real.android.nativehtml.common.layout.a$a */
    /* loaded from: classes5.dex */
    ...
    public float layout(ComponentElement componentElement, float f, float f2, float f3, boolean z) {
        ...
        while (i < componentElement.getChildren().getLength()) {
            ...
            if (!C6149b.g(componentElement, f, f2, f3, z, componentElement3)) {
                ...
                if (f10 != CssEnum.BLOCK && f10 != CssEnum.TABLE && f10 != CssEnum.LIST_ITEM) {
                    ...
                    float e = C6149b.e(componentElement2, directive, f3);
                    float c = C6149b.c(componentElement2, directive, f3);
                    float f11 = g + c + g2;
                    float a = C6149b.a(componentElement2, e, f3);
                    if (i2 > 0 && f6 + f11 > f3) {
                    ...
                    float e2 = C6149b.e(componentElement2, directive2, f3);
                    float c2 = C6149b.c(componentElement2, directive2, f3);
                    float a2 = C6149b.a(componentElement2, e2, f3);
                    if (!z) {
        ...
        for (int i = 0; i < children.getLength(); i++) {
            ...
            if (!C6149b.f(componentElement2)) {
                ...
                if (f4 != CssEnum.BLOCK && f4 != CssEnum.TABLE && f4 != CssEnum.LIST_ITEM && directive != Layout.Directive.MINIMUM) {
                    f2 += g + C6149b.c(componentElement2, Layout.Directive.FIT_CONTENT, f) + g2;
                } else {
                    if (f2 > 0.0f) {
                        f3 = Math.max(f2, f3);
                    }
                    f3 = Math.max(f3, g + C6149b.c(componentElement2, directive, f) + g2);
                }
            }
        }
