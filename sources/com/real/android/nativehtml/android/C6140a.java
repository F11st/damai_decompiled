...
/* renamed from: com.real.android.nativehtml.android.a */
/* loaded from: classes5.dex */
class C6140a {

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: com.real.android.nativehtml.android.a$a */
    /* loaded from: classes5.dex */
    ...
    public static int a(Layout.Directive directive) {
        int i = C6141a.b[directive.ordinal()];
        if (i != 1) {
            if (i != 2) {
                if (i == 3) {
                    return 0;
    ...
    public static int c(fq fqVar) {
        int i = C6141a.a[fqVar.f(CssProperty.TEXT_DECORATION).ordinal()];
        if (i != 1) {
            return i != 2 ? 0 : 16;
        }
        return 8;
