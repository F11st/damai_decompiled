    ...
    */
    public static int a(tb.u43 r10) {
        /*
            ...
            com.loc.v r3 = com.loc.C5887v.b(r3, r5)     // Catch: java.lang.Throwable -> L94
        ...
        Lad:
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.C5792b0.a(tb.u43):int");
    }

    private static void b(C5887v c5887v, List<String> list) {
        if (c5887v != null) {
            try {
                for (String str : list) {
                    c5887v.r(str);
    ...
    public static void c(String str, byte[] bArr, u43 u43Var) throws IOException, CertificateException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
        ...
        try {
            ...
            c5887v = C5887v.b(file, u43Var.b);
            try {
                c5887v.f(u43Var.d);
                byte[] b = u43Var.e.b(bArr);
                C5887v.C5891d l = c5887v.l(str);
                outputStream = l.b();
    ...
    private static byte[] e(C5887v c5887v, u43 u43Var, List<String> list) {
        String[] list2;
        try {
            File m = c5887v.m();
            if (m != null && m.exists()) {
