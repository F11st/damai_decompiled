...
public final class C5861o {
    ...
    private static volatile C5863b O = null;
    static String a = "";
    static String b = "";
    static volatile boolean c = true;
    static String d = "";
    private static String e = null;
    public static InterfaceC5862a f = null;
    ...
    public static class C5863b {
        ...
        /* loaded from: classes10.dex */
        public final class C5864a extends ConnectivityManager.NetworkCallback {
            C5864a(C5863b c5863b) {
            }
        ...
        public final void a(Context context) {
            ...
            } else if (C5861o.I(context, v1.v("AYW5kcm9pZC5wZXJtaXNzaW9uLkFDQ0VTU19ORVRXT1JLX1NUQVRF")) && context != null && b == null) {
                ConnectivityManager connectivityManager = (ConnectivityManager) context.getSystemService("connectivity");
                b = connectivityManager;
                if (connectivityManager != null) {
                    c = new NetworkRequest.Builder().addCapability(0).addCapability(1).build();
                    C5864a c5864a = new C5864a(this);
                    d = c5864a;
                    b.registerNetworkCallback(c, c5864a);
                }
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: com.loc.o$c */
    /* loaded from: classes10.dex */
    public static class ServiceConnectionC5865c implements ServiceConnection {
        private static String c;
        private Context a;
        private int b;

        ServiceConnectionC5865c(Context context, int i) {
            this.a = context;
            this.b = i;
        }
        ...
        */
        public final void onServiceConnected(android.content.ComponentName r6, android.os.IBinder r7) {
            ...
            L4c:
                ...
                com.loc.C5861o.E(r7)     // Catch: java.lang.Throwable -> L62
            L5b:
                r0.recycle()
                r6.recycle()
                return
            ...
            L75:
                ...
                throw r7
            */
            throw new UnsupportedOperationException("Method not decompiled: com.loc.C5861o.ServiceConnectionC5865c.onServiceConnected(android.content.ComponentName, android.os.IBinder):void");
        }
    ...
    public static String C() {
        try {
            if (TextUtils.isEmpty(d)) {
                InterfaceC5862a interfaceC5862a = f;
                return interfaceC5862a == null ? "" : interfaceC5862a.a();
            }
            return d;
        } catch (Throwable unused) {
            return "";
    ...
    public static InterfaceC5862a G() {
        return f;
    }
    ...
    public static String Q(final Context context) {
        ...
        if (TextUtils.isEmpty(h) && !j) {
            if (Looper.getMainLooper() == Looper.myLooper()) {
                C5866o0.f().d(new ck() { // from class: com.loc.o.2
                    @Override // com.loc.ck
                    public final void a() {
                        C5861o.g(context);
                        C5861o.U();
    ...
    private static synchronized C5863b u(Context context) {
        synchronized (C5861o.class) {
            if (O == null) {
                if (context == null) {
                    return null;
                }
                ...
                O = c5863b;
                c5863b.a(context.getApplicationContext());
            }
            return O;
        }
    }
    ...
    public static String w(final Context context) {
        if (TextUtils.isEmpty(b)) {
            ...
            if (TextUtils.isEmpty(q2)) {
                ...
                g = true;
                C5866o0.f().d(new ck() { // from class: com.loc.o.1
                    @Override // com.loc.ck
                    public final void a() {
                        try {
                            Map<String, String> b2 = C5861o.f.b();
                            String a2 = C5861o.f.a(C5861o.R(context), "", "", C5861o.k0(context));
                            if (TextUtils.isEmpty(a2)) {
                                return;
                            }
                            bg.b();
                            String a3 = C5861o.f.a(context, new String(bg.c(C5861o.f.a(a2.getBytes(), b2)).a));
    ...
    private static String x(Context context, int i2) {
        try {
            ...
            ServiceConnectionC5865c serviceConnectionC5865c = new ServiceConnectionC5865c(context, i2);
            if (context.bindService(intent, serviceConnectionC5865c, 1)) {
                int i3 = 0;
                while (i3 < 100 && TextUtils.isEmpty(h)) {
                    i3++;
                    Thread.sleep(15L);
                }
                context.unbindService(serviceConnectionC5865c);
            }
            return h;
        } catch (Throwable th) {
    ...
    public static void z(InterfaceC5862a interfaceC5862a) {
        if (f == null) {
            f = interfaceC5862a;
        }
    }
