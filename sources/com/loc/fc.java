...
public final class fc {
    ...
    private synchronized void l(boolean z, final int i2) {
        ...
        o0.f().d(new ck() { // from class: com.loc.fc.1
            @Override // com.loc.ck
            public final void a() {
                int i3;
                ...
                t73Var.L(sb2);
                t73Var.N(sb2);
                t73Var.d(bl.a.SINGLE);
                t73Var.f(bl.c.HTTP);
                try {
                    bg.b();
                    JSONObject jSONObject = new JSONObject(new String(bg.c(t73Var).a));
                    String[] n = fc.n(jSONObject.optJSONArray("ips"), fc.j);
                    if (n != null && n.length > 0 && !fc.m(n, fc.this.j(fc.j).d())) {
                        fc.this.j(fc.j).c(n);
                        fc.this.r(fc.j);
                    }
                    String[] n2 = fc.n(jSONObject.optJSONArray("ipsv6"), fc.k);
                    ...
                    l1.n(fc.this.f, "O018", jSONObject2);
                }
            }
        });
    }
