...
/* renamed from: com.loc.a0 */
/* loaded from: classes10.dex */
public final class C5790a0 extends SSLSocketFactory {
    private SSLSocketFactory a;
    private Context b;
    private SSLContext c;

    public C5790a0(Context context, SSLContext sSLContext) {
        if (context != null) {
            try {
    ...
    private static Socket a(Socket socket) {
        try {
            if (Build.VERSION.SDK_INT >= 21 && C5849m.C5857f.b && (socket instanceof SSLSocket)) {
    ...
    private static void d(Socket socket) {
        ...
        if (i >= 17 && C5849m.C5857f.c && C5849m.C5857f.e && (socket instanceof SSLSocket)) {
            int i2 = C5849m.C5857f.f;
            int i3 = C5849m.C5857f.d;
            if (i2 <= i3) {
                i3 = C5849m.C5857f.f;
            }
            if (i3 <= 17 || i <= i3) {
    ...
    public final void b() {
        int i = Build.VERSION.SDK_INT;
        if (i >= 17 && C5849m.C5857f.c && this.b != null && this.c != null) {
            int i2 = C5849m.C5857f.d;
            if (i2 <= 17 || i <= i2) {
