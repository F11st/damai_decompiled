...
public final class C5812d {
    ...
    private C5838i y = null;
    String z = null;
    private ServiceConnection A = new ServiceConnectionC5813a();
    AMapLocationQualityReport B = null;
    boolean C = false;
    private volatile boolean D = false;
    HandlerC5816d E = null;
    String F = null;
    boolean G = false;
    ...
    /* loaded from: classes10.dex */
    final class ServiceConnectionC5813a implements ServiceConnection {
        ServiceConnectionC5813a() {
        }

        @Override // android.content.ServiceConnection
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            try {
                C5812d.this.m = new Messenger(iBinder);
                C5812d.this.g = true;
                C5812d.this.v = true;
            } catch (Throwable th) {
    ...
    /* loaded from: classes10.dex */
    public static class HandlerThreadC5814b extends HandlerThread {
        C5812d a;

        public HandlerThreadC5814b(String str, C5812d c5812d) {
            super(str);
            this.a = null;
            this.a = c5812d;
        }
        ...
        protected final void onLooperPrepared() {
            try {
                ...
                z73.a(this.a.b);
                this.a.v0();
                C5812d c5812d = this.a;
                if (c5812d != null && c5812d.b != null) {
                    i1.j(this.a.b);
                    i1.a(this.a.b);
                }
    ...
    /* loaded from: classes10.dex */
    public static /* synthetic */ class C5815c {
    ...
    /* loaded from: classes10.dex */
    public class HandlerC5816d extends Handler {
        public HandlerC5816d(Looper looper) {
            super(looper);
        }
        ...
        public final void handleMessage(Message message) {
            ...
            try {
                ...
                int i = message.what;
                if (i == 11) {
                    C5812d.this.k(message.getData());
                } else if (i == 12) {
                    C5812d.this.I(message);
                } else if (i == 1011) {
                    C5812d.this.f(14, null);
                    C5812d.this.i0();
                } else {
                    try {
                        switch (i) {
                            case 1002:
                                C5812d.this.U((AMapLocationListener) message.obj);
                                return;
                            case 1003:
                                C5812d.this.o0();
                                C5812d.this.f(13, null);
                                return;
                            case 1004:
                                C5812d.this.r0();
                                C5812d.this.f(14, null);
                                return;
                            case 1005:
                                C5812d.this.Z((AMapLocationListener) message.obj);
                                return;
                            default:
                                switch (i) {
                                    case 1014:
                                        C5812d.this.l(message);
                                        return;
                                    case 1015:
                                        C5812d c5812d = C5812d.this;
                                        c5812d.e.k(c5812d.c);
                                        C5812d.this.g(1025, null, 300000L);
                                        return;
                                    case 1016:
                                        if (m1.f0(C5812d.this.b)) {
                                            C5812d.this.x0();
                                            return;
                                        } else if (C5812d.this.e.v()) {
                                            C5812d.this.g(1016, null, 1000L);
                                            return;
                                        } else {
                                            C5812d.this.t0();
                                            return;
                                    ...
                                    case 1017:
                                        ...
                                        return;
                                    case 1018:
                                        C5812d c5812d2 = C5812d.this;
                                        AMapLocationClientOption aMapLocationClientOption = (AMapLocationClientOption) message.obj;
                                        c5812d2.c = aMapLocationClientOption;
                                    ...
                                    default:
                                        switch (i) {
                                            case 1023:
                                                C5812d.this.S(message);
                                                return;
                                            case 1024:
                                                C5812d.this.X(message);
                                                return;
                                            case 1025:
                                                if (C5812d.this.e.F()) {
                                                    C5812d.this.e.c();
                                                    C5812d c5812d3 = C5812d.this;
                                                    c5812d3.e.k(c5812d3.c);
                                                }
                                                C5812d.this.g(1025, null, 300000L);
                                                return;
                                            case 1026:
                                                C5812d.this.f.i(C5812d.this.c);
                                                return;
                                            case 1027:
                                                C5812d.this.f.b();
                                                return;
                                            case 1028:
                                                C5812d.this.g0((AMapLocation) message.obj);
                                                return;
                                            default:
                                                return;
                                        }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.loc.d$e */
    /* loaded from: classes10.dex */
    public class HandlerC5817e extends Handler {
        public HandlerC5817e() {
        }

        public HandlerC5817e(Looper looper) {
            super(looper);
        }
        ...
        @Override // android.os.Handler
        public final void handleMessage(Message message) {
            HandlerC5817e handlerC5817e;
            HandlerC5817e handlerC5817e2;
            try {
                super.handleMessage(message);
                C5812d c5812d = C5812d.this;
                if (c5812d.r) {
                ...
                int i = message.what;
                if (i == 1) {
                    Message obtainMessage = c5812d.E.obtainMessage();
                    obtainMessage.what = 11;
                    obtainMessage.setData(message.getData());
                    C5812d.this.E.sendMessage(obtainMessage);
                    return;
                }
                if (i != 2) {
                    if (i == 13) {
                        ...
                        C5812d.this.n(aMapLocation);
                        return;
                    }
                    switch (i) {
                        case 5:
                            Bundle data = message.getData();
                            data.putBundle("optBundle", j1.a(C5812d.this.c));
                            C5812d.this.f(10, data);
                            return;
                        case 6:
                            Bundle data2 = message.getData();
                            h83 h83Var = C5812d.this.e;
                            if (h83Var != null) {
                                h83Var.h(data2);
                                return;
                            }
                            return;
                        case 7:
                            C5812d.this.p = message.getData().getBoolean("ngpsAble");
                            return;
                        case 8:
                            l1.p(null, 2141);
                            break;
                        case 9:
                            boolean unused = C5812d.J = message.getData().getBoolean("installMockApp");
                            return;
                        case 10:
                            c5812d.n((AMapLocation) message.obj);
                            return;
                        default:
                            switch (i) {
                                case 100:
                                ...
                                case 102:
                                    ...
                                    data3.putBundle("optBundle", j1.a(C5812d.this.c));
                                    C5812d.this.f(15, data3);
                                    return;
                                case 103:
                                    Bundle data4 = message.getData();
                                    if (C5812d.this.f != null) {
                                        C5812d.this.f.f(data4);
                                        return;
                                    }
                                    return;
                                default:
                            ...
                            C5812d.this.E.sendMessage(obtain);
                            if (C5812d.this.x == null || !C5812d.this.x.getCacheCallBack() || (handlerC5817e2 = C5812d.this.d) == null) {
                                return;
                            }
                            handlerC5817e2.removeMessages(13);
                            return;
                    }
                }
                ...
                C5812d.this.E.sendMessage(obtain2);
                if (C5812d.this.x == null || !C5812d.this.x.getCacheCallBack() || (handlerC5817e = C5812d.this.d) == null) {
                    return;
                }
                handlerC5817e.removeMessages(13);
            } catch (Throwable th) {
    ...
    public C5812d(Context context, Intent intent, Looper looper) {
        this.o = null;
        this.b = context;
        this.o = intent;
        H(looper);
    ...
    */
    private com.loc.eo E(com.loc.ej r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.loc.C5812d.E(com.loc.ej):com.loc.eo");
    }

    private void H(Looper looper) {
        try {
            if (looper == null) {
                this.d = Looper.myLooper() == null ? new HandlerC5817e(this.b.getMainLooper()) : new HandlerC5817e();
            } else {
                this.d = new HandlerC5817e(looper);
            }
        } catch (Throwable th) {
        ...
        try {
            ...
            HandlerThreadC5814b handlerThreadC5814b = new HandlerThreadC5814b("amapLocManagerThread", this);
            this.q = handlerThreadC5814b;
            handlerThreadC5814b.setPriority(5);
            this.q.start();
    ...
    private HandlerC5816d b(Looper looper) {
        HandlerC5816d handlerC5816d;
        synchronized (this.t) {
            handlerC5816d = new HandlerC5816d(looper);
            this.E = handlerC5816d;
        }
        return handlerC5816d;
    }
    ...
    public void d(int i) {
        synchronized (this.t) {
            HandlerC5816d handlerC5816d = this.E;
            if (handlerC5816d != null) {
                handlerC5816d.removeMessages(i);
            }
        }
    }
    ...
    public void f(int i, Bundle bundle) {
        ...
        bundle.putString(AbstractC5658c.a, this.z);
        Message obtain = Message.obtain();
        obtain.what = i;
    ...
    private static void h(final Context context) {
        if (K.compareAndSet(false, true)) {
            C5866o0.f().d(new ck() { // from class: com.loc.d.1
                @Override // com.loc.ck
                public final void a() {
                    C5861o.M();
                    C5861o.w(context);
    ...
    private void k0() {
        synchronized (this.t) {
            HandlerC5816d handlerC5816d = this.E;
            if (handlerC5816d != null) {
                handlerC5816d.removeCallbacksAndMessages(null);
            }
            this.E = null;
        }
    }
    ...
    public synchronized void o0() {
        ...
        this.h = true;
        int i2 = C5815c.a[this.c.getLocationMode().ordinal()];
        long j = 0;
        if (i2 == 1) {
            g(1027, null, 0L);
            g(1017, null, 0L);
    ...
    private Intent w0() {
        ...
        try {
            str = !TextUtils.isEmpty(AMapLocationClientOption.getAPIKEY()) ? AMapLocationClientOption.getAPIKEY() : C5846l.j(this.b);
        } catch (Throwable th) {
            j1.h(th, "ALManager", "startServiceImpl p2");
            str = "";
        }
        this.o.putExtra("a", str);
        this.o.putExtra("b", C5846l.g(this.b));
    ...
    public final void G() {
        HandlerC5817e handlerC5817e;
        try {
            if (this.x.getCacheCallBack() && (handlerC5817e = this.d) != null) {
                handlerC5817e.sendEmptyMessageDelayed(13, this.x.getCacheCallBackTime());
            }
        } catch (Throwable unused) {
        }
        try {
    ...
    final void i0() {
        ...
        this.A = null;
        k0();
        HandlerThreadC5814b handlerThreadC5814b = this.q;
        if (handlerThreadC5814b != null) {
            if (Build.VERSION.SDK_INT >= 18) {
                try {
                    k1.b(handlerThreadC5814b, HandlerThread.class, "quitSafely", new Object[0]);
                } catch (Throwable unused2) {
                    this.q.quit();
                }
            } else {
                handlerThreadC5814b.quit();
            }
        }
        this.q = null;
        HandlerC5817e handlerC5817e = this.d;
        if (handlerC5817e != null) {
            handlerC5817e.removeCallbacksAndMessages(null);
        }
        n1 n1Var = this.l;
        if (n1Var != null) {
            n1Var.e();
    ...
    public final void m(WebView webView) {
        if (this.y == null) {
            this.y = new C5838i(this.b, webView);
        }
        this.y.c();
    }
