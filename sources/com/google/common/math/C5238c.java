...
public final class C5238c {
    ...
    public static int a(int i, int i2) {
        long j = i + i2;
        int i3 = (int) j;
        C5246e.b(j == ((long) i3), "checkedAdd", i, i2);
        return i3;
    }
    ...
    */
    public static int b(int r5, int r6, java.math.RoundingMode r7) {
        ...
        Le:
            ...
            r2 = 1
            r5 = r5 | r2
            int[] r3 = com.google.common.math.C5238c.C5239a.a
            int r4 = r7.ordinal()
            r3 = r3[r4]
            r4 = 0
            switch(r3) {
        ...
        L53:
            r2 = 0
        L54:
            com.google.common.math.C5246e.d(r2)
        L57:
            r2 = 0
        L58:
            if (r2 == 0) goto L5b
        ...
        L5c:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.common.math.C5238c.b(int, int, java.math.RoundingMode):int");
    }
    ...
    public static int e(int i, RoundingMode roundingMode) {
        C5246e.c(Constants.Name.X, i);
        switch (C5239a.a[roundingMode.ordinal()]) {
            case 1:
                C5246e.d(c(i));
                break;
            case 2:
