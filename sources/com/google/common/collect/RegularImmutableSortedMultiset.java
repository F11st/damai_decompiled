...
public final class RegularImmutableSortedMultiset<E> extends ImmutableSortedMultiset<E> {
    ...
    Multiset.Entry<E> getEntry(int i) {
        return Multisets.g(this.elementSet.asList().get(i), getCount(i));
    }
    ...
    public ImmutableSortedMultiset<E> headMultiset(E e, BoundType boundType) {
        return getSubMultiset(0, this.elementSet.headIndex(e, du1.p(boundType) == BoundType.CLOSED));
    }

    @Override // com.google.common.collect.ImmutableSortedMultiset, com.google.common.collect.SortedMultiset
    public ImmutableSortedMultiset<E> tailMultiset(E e, BoundType boundType) {
        return getSubMultiset(this.elementSet.tailIndex(e, du1.p(boundType) == BoundType.CLOSED), this.length);
    }
