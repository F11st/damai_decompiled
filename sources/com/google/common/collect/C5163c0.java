...
public class C5163c0<K> {
    ...
    /* loaded from: classes10.dex */
    class C5164a extends Multisets.AbstractC5082b<K> {
        @NullableDecl
        final K a;
        int b;

        C5164a(int i) {
            this.a = (K) C5163c0.this.a[i];
            this.b = i;
        }

        void a() {
            int i = this.b;
            if (i == -1 || i >= C5163c0.this.C() || !nm1.a(this.a, C5163c0.this.a[this.b])) {
                this.b = C5163c0.this.m(this.a);
            }
        }
    ...
    public static <K> C5163c0<K> b() {
        return new C5163c0<>();
    }

    public static <K> C5163c0<K> c(int i) {
        return new C5163c0<>(i);
    }
    ...
    public int u(@NullableDecl K k, int i) {
        C5191k.d(i, AdUtConstants.XAD_UT_ARG_COUNT);
        long[] jArr = this.f;
        Object[] objArr = this.a;
        int[] iArr = this.b;
        int d = C5211z.d(k);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C5163c0(C5163c0<? extends K> c5163c0) {
        n(c5163c0.C(), 1.0f);
        int e = c5163c0.e();
        while (e != -1) {
            u(c5163c0.i(e), c5163c0.k(e));
            e = c5163c0.s(e);
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C5163c0(int i) {
        this(i, 1.0f);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C5163c0(int i, float f) {
        n(i, f);
    }
}
