...
public abstract class AbstractC5165d<E> extends AbstractCollection<E> implements Multiset<E> {
    ...
    /* loaded from: classes10.dex */
    public class C5166a extends Multisets.AbstractC5083c<E> {
        C5166a() {
        }

        @Override // com.google.common.collect.Multisets.AbstractC5083c
        Multiset<E> a() {
            return AbstractC5165d.this;
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
        public Iterator<E> iterator() {
            return AbstractC5165d.this.elementIterator();
        }
    }
    ...
    /* loaded from: classes10.dex */
    public class C5167b extends Multisets.AbstractC5084d<E> {
        /* JADX INFO: Access modifiers changed from: package-private */
        public C5167b() {
        }
        ...
        public Iterator<Multiset.Entry<E>> iterator() {
            return AbstractC5165d.this.entryIterator();
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.Set
        public int size() {
            return AbstractC5165d.this.distinctElements();
        }
    }
