...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(badgeText, this.badgeCenterX, this.badgeCenterY + (com.alibaba.wireless.security.aopsdk.replace.android.graphics.Rect.height(rect) / 2), this.textDrawableHelper.getTextPaint());
    }
