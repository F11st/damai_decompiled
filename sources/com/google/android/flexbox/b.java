...
public class b {
    ...
    public static class C0223b {
        List<com.google.android.flexbox.a> a;
        int b;
    ...
    private boolean M(int i, int i2, com.google.android.flexbox.a aVar) {
    ...
    private void S(int i, int i2, com.google.android.flexbox.a aVar, int i3, int i4, boolean z) {
        int i5;
        int i6;
        int i7;
        int i8 = aVar.e;
        ...
        while (i9 < aVar.h) {
            ...
            if (reorderedFlexItemAt == null || reorderedFlexItemAt.getVisibility() == 8) {
                ...
                if (flexDirection != 0 && flexDirection != 1) {
                    ...
                    aVar.e += measuredHeight + flexItem.getMarginTop() + flexItem.getMarginBottom();
                } else {
                    i5 = i8;
                    int i12 = i9;
                    ...
                    aVar.e += measuredWidth2 + flexItem.getMarginLeft() + flexItem.getMarginRight();
                    i7 = max;
                }
    ...
    private void a(List<com.google.android.flexbox.a> list, com.google.android.flexbox.a aVar, int i, int i2) {
        aVar.m = i2;
    ...
    */
    ...
    private List<com.google.android.flexbox.a> k(List<com.google.android.flexbox.a> list, int i, int i2) {
    ...
    private void v(int i, int i2, com.google.android.flexbox.a aVar, int i3, int i4, boolean z) {
        int i5;
        int i6;
        int i7;
        double d;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void P(View view, com.google.android.flexbox.a aVar, int i, int i2, int i3, int i4) {
        FlexItem flexItem = (FlexItem) view.getLayoutParams();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void Q(View view, com.google.android.flexbox.a aVar, boolean z, int i, int i2, int i3, int i4) {
        FlexItem flexItem = (FlexItem) view.getLayoutParams();
        int alignItems = this.a.getAlignItems();
        if (flexItem.getAlignSelf() != -1) {
            alignItems = flexItem.getAlignSelf();
    ...
    public void X(int i) {
        ...
        for (com.google.android.flexbox.a aVar2 : this.a.getFlexLinesInternal()) {
            for (Integer num : aVar2.n) {
                ...
                if (flexDirection == 0 || flexDirection == 1) {
                    V(reorderedFlexItemAt2, aVar2.g, num.intValue());
                } else if (flexDirection != 2 && flexDirection != 3) {
                    throw new IllegalArgumentException("Invalid flex direction: " + flexDirection);
                } else {
                    U(reorderedFlexItemAt2, aVar2.g, num.intValue());
                }
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void b(C0223b c0223b, int i, int i2, int i3, int i4, int i5, @Nullable List<com.google.android.flexbox.a> list) {
        int i6;
        C0223b c0223b2;
        int i7;
        int i8;
        ...
        while (true) {
            ...
            if (reorderedFlexItemAt == null) {
                ...
                list2 = arrayList;
                int i31 = i9;
                if (O(reorderedFlexItemAt, i8, i7, aVar2.e, B(flexItem, isMainAxisDirectionHorizontal) + L(reorderedFlexItemAt, isMainAxisDirectionHorizontal) + D(flexItem, isMainAxisDirectionHorizontal), flexItem, i30, i25, arrayList.size())) {
                    if (aVar3.c() > 0) {
                        if (i30 > 0) {
                            i17 = i30 - 1;
                            aVar = aVar3;
                ...
                this.a.onNewFlexItemAdded(view, i21, i12, aVar2);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void c(C0223b c0223b, int i, int i2) {
        b(c0223b, i, i2, Integer.MAX_VALUE, 0, -1, null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void d(C0223b c0223b, int i, int i2, int i3, int i4, @Nullable List<com.google.android.flexbox.a> list) {
        b(c0223b, i, i2, i3, i4, -1, list);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void e(C0223b c0223b, int i, int i2, int i3, int i4, List<com.google.android.flexbox.a> list) {
        b(c0223b, i, i2, i3, 0, i4, list);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void f(C0223b c0223b, int i, int i2) {
        b(c0223b, i2, i, Integer.MAX_VALUE, 0, -1, null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void g(C0223b c0223b, int i, int i2, int i3, int i4, @Nullable List<com.google.android.flexbox.a> list) {
        b(c0223b, i2, i, i3, i4, -1, list);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public void h(C0223b c0223b, int i, int i2, int i3, int i4, List<com.google.android.flexbox.a> list) {
        b(c0223b, i2, i, i3, 0, i4, list);
    }
    ...
    public void q(int i, int i2, int i3) {
        ...
        for (int i6 = i5; i6 < size2; i6++) {
            ...
            if (aVar.e < size) {
                v(i, i2, aVar, size, i4, false);
            } else {
                S(i, i2, aVar, size, i4, false);
            }
        }
    }
