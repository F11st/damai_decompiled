...
/* renamed from: com.uc.sandboxExport.i */
/* loaded from: classes11.dex */
public final class BinderC7174i extends IChildProcessSetup.Stub {
    final /* synthetic */ SandboxedProcessService a;

    /* JADX INFO: Access modifiers changed from: package-private */
    public BinderC7174i(SandboxedProcessService sandboxedProcessService) {
    ...
    public final IBinder preSetupConnection(Bundle bundle) {
        ...
        if (intent.getExtras() == null) {
            str4 = this.a.c;
            C7169c.a(4, str4, "preSetupConnection, mLastIntent has not extras", null);
            intent2 = this.a.l;
        ...
        str = this.a.c;
        C7169c.a(str, "preSetupConnection, dex fd: %s", parcelFileDescriptor);
        ...
        try {
            ...
            str3 = this.a.c;
            C7169c.a(4, str3, "preSetupConnection done.", null);
            iBinder = this.a.j;
            return iBinder;
        } catch (Throwable th) {
            str2 = this.a.c;
            C7169c.a(str2, "preSetupConnection.init exception", th);
            throw th;
        }
    }
}
