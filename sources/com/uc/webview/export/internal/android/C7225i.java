...
/* renamed from: com.uc.webview.export.internal.android.i */
/* loaded from: classes11.dex */
final class C7225i extends WebChromeClientCompatibility implements IOpenFileChooser {

    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.android.i$a */
    /* loaded from: classes11.dex */
    class C7226a implements WebChromeClient.CustomViewCallback {
        private WebChromeClient.CustomViewCallback b;

        public C7226a(WebChromeClient.CustomViewCallback customViewCallback) {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.android.i$b */
    /* loaded from: classes11.dex */
    class C7227b implements GeolocationPermissions.Callback {
        private GeolocationPermissions.Callback b;

        public C7227b(GeolocationPermissions.Callback callback) {
            this.b = callback;
        }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.android.i$c */
    /* loaded from: classes11.dex */
    static class C7228c extends PermissionRequest {
        private android.webkit.PermissionRequest a;

        public C7228c(android.webkit.PermissionRequest permissionRequest) {
    ...
    public C7225i(WebView webView, com.uc.webview.export.WebChromeClient webChromeClient) {
        this.a = webView;
        this.b = webChromeClient;
    }

    private void a(ValueCallback<Uri> valueCallback, String str, String str2) {
        if (this.b.onShowFileChooser(this.a, new C7230k(this, valueCallback), new C7231l(this, str, str2))) {
            return;
        }
    ...
    public final boolean onCreateWindow(android.webkit.WebView webView, boolean z, boolean z2, Message message) {
        ...
        Message obtain = Message.obtain(new HandlerC7229j(this, Looper.getMainLooper()));
    ...
    public final void onGeolocationPermissionsShowPrompt(String str, GeolocationPermissions.Callback callback) {
        this.b.onGeolocationPermissionsShowPrompt(str, new C7227b(callback));
    }
    ...
    public final boolean onJsPrompt(android.webkit.WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        return this.b.onJsPrompt(this.a, str, str2, str3, new C7219d(jsPromptResult));
    }

    @Override // android.webkit.WebChromeClient
    public final void onPermissionRequest(android.webkit.PermissionRequest permissionRequest) {
        this.b.onPermissionRequest(new C7228c(permissionRequest));
    }

    @Override // android.webkit.WebChromeClient
    public final void onPermissionRequestCanceled(android.webkit.PermissionRequest permissionRequest) {
        this.b.onPermissionRequestCanceled(new C7228c(permissionRequest));
    }
    ...
    public final void onShowCustomView(View view, WebChromeClient.CustomViewCallback customViewCallback) {
        this.b.onShowCustomView(view, new C7226a(customViewCallback));
    }
