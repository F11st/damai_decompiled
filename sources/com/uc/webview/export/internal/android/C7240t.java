...
/* renamed from: com.uc.webview.export.internal.android.t */
/* loaded from: classes11.dex */
public final class C7240t extends WebViewClient {
    private WebView a;
    private com.uc.webview.export.WebViewClient b;

    /* compiled from: Taobao */
    @TargetApi(23)
    /* renamed from: com.uc.webview.export.internal.android.t$a */
    /* loaded from: classes11.dex */
    static class C7241a extends WebResourceError {
        private final android.webkit.WebResourceError a;

        public C7241a(android.webkit.WebResourceError webResourceError) {
    ...
    public C7240t(WebView webView, com.uc.webview.export.WebViewClient webViewClient) {
        this.a = webView;
    ...
    public final void onReceivedHttpAuthRequest(android.webkit.WebView webView, HttpAuthHandler httpAuthHandler, String str, String str2) {
        ...
        if (webViewClient != null) {
            webViewClient.onReceivedHttpAuthRequest(this.a, new HandlerC7218c(httpAuthHandler), str, str2);
        } else {
    ...
    public final void onReceivedSslError(android.webkit.WebView webView, SslErrorHandler sslErrorHandler, SslError sslError) {
        this.b.onReceivedSslError(this.a, new HandlerC7222g(sslErrorHandler), sslError);
    }

    @Override // android.webkit.WebViewClient
    @TargetApi(26)
    public final boolean onRenderProcessGone(android.webkit.WebView webView, RenderProcessGoneDetail renderProcessGoneDetail) {
        boolean onRenderProcessGone = this.b.onRenderProcessGone(this.a, new C7242u(this, renderProcessGoneDetail));
    ...
    public final void onReceivedError(android.webkit.WebView webView, WebResourceRequest webResourceRequest, android.webkit.WebResourceError webResourceError) {
        ...
        this.b.onReceivedError(this.a, new com.uc.webview.export.WebResourceRequest(webResourceRequest.getMethod(), webResourceRequest.getRequestHeaders(), webResourceRequest.getUrl(), webResourceRequest.hasGesture(), webResourceRequest.isForMainFrame()), new C7241a(webResourceError));
    }
