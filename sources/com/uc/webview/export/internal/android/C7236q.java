...
/* renamed from: com.uc.webview.export.internal.android.q */
/* loaded from: classes11.dex */
public final class C7236q implements IWebStorage {
    private WebStorage a = WebStorage.getInstance();

    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.android.q$a */
    /* loaded from: classes11.dex */
    class C7237a implements ValueCallback<Map> {
        private ValueCallback<Map> b;

        public C7237a(ValueCallback<Map> valueCallback) {
    ...
    public final void getOrigins(ValueCallback<Map> valueCallback) {
        this.a.getOrigins(new C7237a(valueCallback));
    }
