...
/* renamed from: com.uc.webview.export.internal.cd.a */
...
public final class C7247a {
    ...
    public static void a(String str) {
        ...
        if (!C7349p.a(str) && str.startsWith("JSON_CMD")) {
            C7248a.a(str);
        }
        if (str != null && !str.startsWith("JSON_CD") && (indexOf = str.indexOf("JSON_CD")) != -1) {
            str = str.substring(indexOf);
        }
        if (!C7349p.a(str) && str.startsWith("JSON_CD")) {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.cd.a$a */
    /* loaded from: classes11.dex */
    static class C7248a {
