...
/* renamed from: com.uc.webview.export.internal.update.a */
...
public final class C7311a {
    ...
    public static void a(Context context) {
        if (!C7336i.a().b(UCCore.OPTION_USE_UC_PLAYER) || b || !SDKFactory.b() || 2 == SDKFactory.e()) {
            return;
        }
        File b2 = b(context);
