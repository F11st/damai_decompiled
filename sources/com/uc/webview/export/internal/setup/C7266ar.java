...
/* renamed from: com.uc.webview.export.internal.setup.ar */
/* loaded from: classes11.dex */
public class C7266ar extends bh {
    private static String c = C7266ar.class.getSimpleName();
    ...
    public void run() {
        ...
        try {
            ...
            if (!"0".equals((String) UCCore.getGlobalOption(UCCore.PROCESS_PRIVATE_DATA_DIR_SUFFIX_OPTION))) {
                ...
                ((AbstractC7282l) ((AbstractC7282l) ((AbstractC7282l) onEvent("success", (ValueCallback) new av(this))).onEvent("exception", (ValueCallback) new au(this))).onEvent(UCCore.LEGACY_EVENT_SETUP, (ValueCallback) new at(this))).onEvent("switch", (ValueCallback) new as(this));
                String e2 = C7337j.e(getContext().getApplicationContext());
                String str2 = c;
