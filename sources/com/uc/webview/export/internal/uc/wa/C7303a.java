...
import com.uc.webview.export.internal.utility.C7331f;
...
/* renamed from: com.uc.webview.export.internal.uc.wa.a */
...
public class C7303a {
    ...
    private static C7303a j;
    public List<C7305b> d;
    private Context k;
    private Map<String, C7304a> m;
    private C7331f l = null;
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.uc.wa.a$b */
    /* loaded from: classes11.dex */
    public class C7305b {
        String a;
        Map<String, String> b;

        public C7305b(String str, Map<String, String> map) {
            this.a = str;
            this.b = map;
        }
    ...
    public static boolean c() {
        return C7247a.c(UCCore.EVENT_STAT).booleanValue();
    }
                                ...
                                if (indexOf >= 0 && indexOf2 >= 0) {
                                    ...
                                    if (trim.startsWith(str4)) {
                                        ...
                                        if (split2.length == 2 && split2[c2].length() == 8 && split2[1].length() <= 2) {
                                            C7304a c7304a = (C7304a) hashMap.get(substring);
                                            if (c7304a == null) {
                                                if (hashMap.size() == 8) {
                                                    ...
                                                    c7304a = new C7304a(this, (byte) 0);
                                                    hashMap.put(substring, c7304a);
                                                }
                                            }
                                            ...
                                            while (i3 < length) {
                                                ...
                                                if (split3.length != 2 || split3[1].length() <= 2) {
                                                    ...
                                                    if (split3[1].startsWith("#0")) {
                                                        i = length;
                                                        Integer num = c7304a.a.get(split3[0]);
                                                        if (num == null) {
                                                            c7304a.a.put(split3[0], Integer.valueOf(Integer.parseInt(substring2)));
                                                        } else {
                                                            c7304a.a.put(split3[0], Integer.valueOf(Integer.parseInt(substring2) + num.intValue()));
                                                        }
                                                    } else {
                                                        i = length;
                                                        if (split3[1].startsWith("#1")) {
                                                            c7304a.b.put(split3[0], substring2);
                                                        }
                                                    }
                                                }
                                                i3++;
                                        ...
                                        if (arrayList.size() != 10) {
                                            ...
                                            arrayList.add(new C7305b(substring, hashMap2));
                                        }
                                    }
                                    str4 = str;
                                    str5 = str2;
    ...
    private List<String[]> k() {
        ...
        strArr[1] = C7326c.a(model) ? "unknown" : model.trim().replaceAll("[`|=]", "");
        arrayList.add(strArr);
        String[] strArr2 = new String[2];
        strArr2[0] = "sdk_f";
        StringBuilder sb = new StringBuilder();
        sb.append((SDKFactory.c(Long.valueOf((long) PlaybackStateCompat.ACTION_SET_SHUFFLE_MODE_ENABLED)).booleanValue() || C7311a.b(this.k) == null) ? "0" : "1");
        sb.append(SDKFactory.c((Long) 1L).booleanValue() ? "1" : "0");
        sb.append(C7336i.a().b(UCCore.OPTION_MULTI_CORE_TYPE) ? "1" : "0");
        ...
        strArr3[1] = C7326c.a(brand) ? "unknown" : brand.trim().replaceAll("[`|=]", "");
        ...
        arrayList.add(new String[]{"sdk_cos", C7349p.e()});
        ...
        if (!C7326c.a(com.uc.webview.export.Build.CORE_VERSION)) {
            arrayList.add(new String[]{"sdk_sdk_cv", com.uc.webview.export.Build.CORE_VERSION.trim()});
        }
        if (!C7326c.a(com.uc.webview.export.Build.UCM_VERSION)) {
        ...
        String a2 = C7349p.C7351b.a(this.k);
        if (!C7326c.a(a2)) {
        ...
        arrayList.add(new String[]{"thrct", Integer.toString(C7345n.b())});
        ...
        sb2.append(C7349p.f() ? "thick" : "thin");
        String str3 = (String) C7336i.a().a(UCCore.OPTION_BUSINESS_INIT_TYPE);
        if (!C7349p.a(str3)) {
            sb2.append('_');
            sb2.append(str3);
        }
        Boolean bool = (Boolean) C7336i.a().a("gk_dec_exist");
        if (bool != null) {
            sb2.append('_');
            sb2.append(bool.booleanValue() ? "dec_exist" : "dec_not");
        }
        Boolean bool2 = (Boolean) C7336i.a().a("gk_upd_exist");
        if (bool2 != null) {
            sb2.append('_');
            sb2.append(bool2.booleanValue() ? "upd_exist" : "upd_not");
        }
        Boolean bool3 = (Boolean) C7336i.a().a("gk_quick_path");
        if (bool3 != null) {
            sb2.append('_');
            sb2.append(bool3.booleanValue() ? "qpath" : "qpath_not");
        }
        Boolean bool4 = (Boolean) C7336i.a().a("gk_quick_init");
        if (bool4 != null) {
            sb2.append('_');
        ...
        ?? b2 = C7336i.a().b("gk_init_pre");
        int i = b2;
        if (C7336i.a().b("gk_preload_io")) {
            i = b2 + 2;
        }
        int i2 = i;
        if (C7336i.a().b("gk_preload_so")) {
            i2 = i + 4;
        }
        int i3 = i2;
        if (C7336i.a().b("gk_preload_cl")) {
            i3 = i2 + 8;
        }
        if (b) {
    ...
    public String l() {
        ...
        try {
            ...
            for (Map.Entry entry2 : map.entrySet()) {
                ...
                for (Map.Entry<String, Integer> entry3 : ((C7304a) entry2.getValue()).a.entrySet()) {
                    jSONObject2.put(entry3.getKey(), String.valueOf(entry3.getValue()));
                }
                for (Map.Entry<String, String> entry4 : ((C7304a) entry2.getValue()).b.entrySet()) {
                    jSONObject2.put(entry4.getKey(), entry4.getValue());
                }
                jSONArray.put(jSONObject2);
            }
            for (C7305b c7305b : list) {
                JSONObject jSONObject3 = new JSONObject();
                for (Map.Entry<String, String> entry5 : c7305b.b.entrySet()) {
    ...
    public final C7331f b() {
        if (this.l == null) {
            this.l = new C7331f("U4SDKWaStat");
        }
        return this.l;
    }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.uc.wa.a$a */
    /* loaded from: classes11.dex */
    public class C7304a {
        ...
        /* synthetic */ C7304a(C7303a c7303a, byte b) {
            this();
        }
    }

    public static C7303a a() {
        Context context;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void c(C7303a c7303a) {
        if (c()) {
            c7303a.b().a(new RunnableC7309e(c7303a));
        }
    }

    private static String b(Map<String, C7304a> map, List<C7305b> list) {
        String[] strArr = {HiAnalyticsConstant.KeyAndValue.NUMBER_01, "10", "20"};
        String str = null;
        for (int i = 0; i < 3; i++) {
            String str2 = strArr[i];
            for (Map.Entry<String, C7304a> entry : map.entrySet()) {
    ...
    public static boolean b(String str, byte[] bArr) {
        ...
        try {
            ...
            httpURLConnection.setConnectTimeout(C7349p.c());
            httpURLConnection.setReadTimeout(C7349p.d());
    ...
    public final void a(String str, int i, int i2, int i3, String str2) {
        ...
        synchronized (this.i) {
            ...
            C7304a c7304a = this.m.get(str3);
            if (c7304a == null) {
                c7304a = new C7304a(this, (byte) 0);
                a(c7304a.b);
                this.m.put(str3, c7304a);
            }
            c7304a.b.put(U4WPKAdapter.KEY_TM, this.h.format(date));
            if (i == 0) {
                Integer num2 = c7304a.a.get(str);
                if (num2 == null) {
                    c7304a.a.put(str, Integer.valueOf(i3));
                } else {
                    c7304a.a.put(str, Integer.valueOf(i3 + num2.intValue()));
                }
            } else if (i != 1) {
                if (i == 2 && ((num = c7304a.a.get(str)) == null || Integer.MAX_VALUE - num.intValue() >= i3)) {
                    if (num == null) {
                        c7304a.a.put(str, Integer.valueOf(i3));
                        c7304a.a.put(str + "_sc", 1);
                    } else {
                        c7304a.a.put(str, Integer.valueOf(i3 + num.intValue()));
                        Map<String, Integer> map = c7304a.a;
                        c7304a.a.put(str + "_sc", Integer.valueOf(map.get(str + "_sc").intValue() + 1));
                    }
                }
            } else if (i2 == 1) {
                c7304a.b.put(str, str2);
            } else {
                String str4 = c7304a.b.get(str);
                if (C7326c.a(str4)) {
                    c7304a.b.put(str, str2);
                } else {
                    c7304a.b.put(str, str4 + "|" + str2);
                }
            }
        }
    }
    ...
    public final void a(boolean z) {
        if (!c() || C7326c.a((String) UCCore.getGlobalOption(UCCore.PROCESS_PRIVATE_DATA_DIR_SUFFIX_OPTION))) {
            return;
        }
        try {
            b().a(new RunnableC7306b(this));
            if (z) {
                Thread.sleep(20L);
            }
        } catch (Exception e2) {
    ...
    */
    private boolean b(android.content.Context r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.webview.export.internal.uc.wa.C7303a.b(android.content.Context):boolean");
    }

    /* JADX WARN: Code restructure failed: missing block: B:38:0x00ba, code lost:
        if (com.uc.webview.export.internal.uc.wa.C7303a.b == false) goto L51;
     */
    /* JADX WARN: Code restructure failed: missing block: B:39:0x00bc, code lost:
        com.uc.webview.export.internal.utility.Log.d("SDKWaStat", "write merge data, size(" + r14 + ") more then " + com.uc.webview.export.internal.uc.wa.C7303a.e);
     */
    /* JADX WARN: Code restructure failed: missing block: B:58:0x0162, code lost:
        com.uc.webview.export.internal.utility.Log.d("SDKWaStat", "write un merge data, size(" + r0 + ") more then " + com.uc.webview.export.internal.uc.wa.C7303a.e);
     */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void a(java.util.Map<java.lang.String, com.uc.webview.export.internal.uc.wa.C7303a.C7304a> r18, java.util.List<com.uc.webview.export.internal.uc.wa.C7303a.C7305b> r19) {
        /*
            Method dump skipped, instructions count: 505
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.webview.export.internal.uc.wa.C7303a.a(java.util.Map, java.util.List):void");
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ byte[] a(C7303a c7303a, String[] strArr) {
        Object[] j2 = c7303a.j();
        if (j2 == null) {
            return null;
        }
        ...
        while (true) {
            ...
            if (sb.length() >= e) {
                ...
                for (Map.Entry<String, Integer> entry2 : ((C7304a) entry.getValue()).a.entrySet()) {
                    a(sb, entry2.getKey(), String.valueOf(entry2.getValue()));
                }
                for (Map.Entry<String, String> entry3 : ((C7304a) entry.getValue()).b.entrySet()) {
    ...
    public static /* synthetic */ String a(String str, boolean z) {
        boolean b2 = C7336i.a().b(UCCore.OPTION_SDK_INTERNATIONAL_ENV);
        String str2 = b2 ? "4ee01a39f0c1" : "27120f2b4115";
        String valueOf = String.valueOf(System.currentTimeMillis());
        String a2 = C7310f.a(str2 + str + valueOf + "AppChk#2014");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ void a(C7303a c7303a, long j2, String str) {
        SharedPreferences.Editor edit = c7303a.k.getSharedPreferences("UC_WA_STAT", 4).edit();
        edit.putLong(i(), j2);
        if (str != null) {
