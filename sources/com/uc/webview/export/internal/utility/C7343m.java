...
/* renamed from: com.uc.webview.export.internal.utility.m */
...
public class C7343m {
    ...
    static EnumC7344a o = EnumC7344a.NUndefined;
    static Object p = new Object();

    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.utility.m$a */
    /* loaded from: classes11.dex */
    ...
    private static boolean c() {
        ...
        if (i2 >= 21) {
            try {
                Object invoke = ClassLoader.class.getDeclaredMethod("findLibrary", String.class).invoke(C7343m.class.getClassLoader(), "art");
                if (invoke != null) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:95:0x01be, code lost:
        a(com.uc.webview.export.internal.utility.C7343m.EnumC7344a.k);
     */
    ...
    */
    private static boolean c(android.content.Context r19, java.util.concurrent.ConcurrentHashMap<java.lang.String, java.lang.Object> r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.webview.export.internal.utility.C7343m.c(android.content.Context, java.util.concurrent.ConcurrentHashMap):boolean");
    }
    ...
    public static boolean b(Context context, ConcurrentHashMap<String, Object> concurrentHashMap) {
        if (!af.b()) {
            EnumC7344a enumC7344a = EnumC7344a.NDisable;
            a(enumC7344a);
            if (i) {
                String str = j;
                Log.d(str, "willReuseOldCore false. rz=" + enumC7344a);
            }
            return false;
        } else if (!C7277h.a(context)) {
            if (i) {
                Log.d(j, "willReuseOldCore false. no lastwebview flag");
            }
            a(EnumC7344a.NNoLastWebViewFlag);
            return false;
        } else {
            EnumC7344a enumC7344a2 = o;
            EnumC7344a enumC7344a3 = EnumC7344a.YLastOK;
            if (enumC7344a2.equals(enumC7344a3)) {
                if (i) {
                    Log.d(j, "willReuseOldCore true. rz=okincache");
                    return true;
                }
                return true;
            } else if (!o.equals(enumC7344a3) && !o.equals(EnumC7344a.NUndefined)) {
                if (i) {
                    String str2 = j;
                ...
                C7336i.a().a("gk_quick_path", Boolean.valueOf(c2));
                return c2;
            }
        }
    }
    ...
    private static JSONObject a(String str) {
        if (!new File(str).exists()) {
            a(EnumC7344a.NNoFile);
            return null;
        }
        try {
            String a2 = a(str, l);
            if (a2 == null) {
                a(EnumC7344a.NEmptyFile);
                return null;
            }
            C7302b.a(InputDeviceCompat.SOURCE_DPAD);
            JSONObject b2 = b(a2);
            C7302b.a(514);
            return b2;
        } catch (Exception e2) {
    ...
    private static bt a(Context context, JSONObject jSONObject) {
        ...
        try {
            ...
            C7302b.a(VerifyCookieResult.COOKIE_VERIFY_ERROR);
    ...
    public static boolean a(Context context, ConcurrentHashMap<String, Object> concurrentHashMap) {
        ...
        if (af.b()) {
            if (o.equals(EnumC7344a.YLastOK) || o.equals(EnumC7344a.NUndefined)) {
                if (n == null) {
    ...
    private static void a(EnumC7344a enumC7344a) {
        o = enumC7344a;
        if (i) {
            String str = j;
            Log.d(str, "statQuickPathStatus st=" + enumC7344a);
        }
        StringBuilder sb = new StringBuilder();
        sb.append(enumC7344a.ordinal());
        C7302b.a(501, sb.toString());
    }
}
