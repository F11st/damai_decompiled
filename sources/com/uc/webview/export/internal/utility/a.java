...
public final class a {
    ...
    public static class C0352a extends Exception {
        ...
        public C0352a(String str, Throwable th) {
            super(str, th);
        }
    }
    ...
    public static boolean a(String str) throws IOException {
        ...
        } catch (C0352a unused2) {
        } catch (Throwable th2) {
            th = th2;
        }
    }

    public static X509Certificate[][] b(String str) throws C0352a, SecurityException, IOException {
    ...
    private static ByteBuffer e(ByteBuffer byteBuffer) throws C0352a {
        f(byteBuffer);
            ...
            if (a.remaining() >= 8) {
                ...
                if (j >= 4 && j <= 2147483647L) {
                    ...
                    if (i2 <= a.remaining()) {
                        ...
                        throw new C0352a("APK Signing Block entry #" + i + " size out of range: " + i2 + ", available: " + a.remaining());
                    }
                } else {
                    throw new C0352a("APK Signing Block entry #" + i + " size out of range: " + j);
                }
            } else {
                throw new C0352a("Insufficient data to read size of APK Signing Block entry #" + i);
            }
        }
        throw new C0352a("No APK Signature Scheme v2 block in APK Signing Block");
    }
    ...
    private static int c(ByteBuffer byteBuffer, int i) throws C0352a {
        f(byteBuffer);
        if (i >= 32) {
            if (byteBuffer.getLong(i - 16) == 2334950737559900225L && byteBuffer.getLong(i - 8) == 3617552046287187010L) {
                ...
                if (j < 24 || j > 2147483639) {
                    throw new C0352a("APK Signing Block size out of range: " + j);
                }
                int i2 = (int) j;
                int i3 = i - (i2 + 8);
                if (i3 >= 0) {
                    ...
                    throw new C0352a("APK Signing Block sizes in header and footer do not match: " + j2 + " vs " + i2);
                }
                throw new C0352a("APK Signing Block offset out of range: " + i3);
            }
            throw new C0352a("No APK Signing Block before ZIP Central Directory");
        }
        throw new C0352a("APK too small for APK Signing Block. ZIP Central Directory offset: " + i);
    }

    private static int b(ByteBuffer byteBuffer) throws C0352a {
        int i;
        x.a(byteBuffer);
        ...
        throw new C0352a("Not an APK file: ZIP End of Central Directory record not found");
    }

    private static X509Certificate[][] a(RandomAccessFile randomAccessFile) throws C0352a, SecurityException, IOException {
        ...
        if (length <= 2147483647L) {
            try {
                ...
                if (e.getCause() instanceof OutOfMemoryError) {
                    throw new C0352a("Failed to memory-map APK", e);
                }
                throw new IOException("Failed to memory-map APK", e);
            }
        }
    ...
    public static X509Certificate[][] a(ByteBuffer byteBuffer) throws C0352a, SecurityException {
        ByteBuffer slice = byteBuffer.slice();
    ...
    */
    ...
    private static long a(ByteBuffer byteBuffer, int i) throws C0352a {
        x.a(byteBuffer);
        int i2 = i - 20;
        if (!(i2 >= 0 && byteBuffer.getInt(i2) == 117853008)) {
            ...
            if (a2 < j) {
                ...
                throw new C0352a("ZIP Central Directory is not immediately followed by End of Central Directory");
            }
            throw new C0352a("ZIP Central Directory offset out of range: " + a2 + ". ZIP End of Central Directory offset: " + i);
        }
        throw new C0352a("ZIP64 APK not supported");
    }
}
