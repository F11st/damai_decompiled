...
/* renamed from: com.uc.webview.export.internal.utility.p */
/* loaded from: classes11.dex */
public class C7349p {
    public static final String[] a = {"armeabi-v7a", "arm64-v8a", "armeabi", DeviceUtils.ABI_X86};
    public static String b;
    private static EnumC7350a c;
    private static EnumC7350a d;
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.utility.p$a */
    /* loaded from: classes11.dex */
    public enum EnumC7350a {
        NOT_INITED,
        ENABLE,
        DISABLE
    }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.uc.webview.export.internal.utility.p$b */
    /* loaded from: classes11.dex */
    public static class C7351b {
    ...
    static {
        EnumC7350a enumC7350a = EnumC7350a.NOT_INITED;
        c = enumC7350a;
        d = enumC7350a;
        e = new C7352q();
        f = null;
    ...
    public static int c() {
        Integer num = (Integer) C7336i.a().a(UCCore.OPTION_CONNECTION_CONNECT_TIMEOUT);
        if (num != null) {
            return num.intValue();
        }
        return 5000;
    ...
    public static int d() {
        Integer num = (Integer) C7336i.a().a(UCCore.OPTION_CONNECTION_READ_TIMEOUT);
        if (num != null) {
            return num.intValue();
        }
        return 5000;
    ...
    public static boolean f() {
        EnumC7350a enumC7350a = c;
        EnumC7350a enumC7350a2 = EnumC7350a.NOT_INITED;
        if (enumC7350a == enumC7350a2) {
            synchronized (c) {
                if (c == enumC7350a2) {
                    try {
                        ...
                        c = EnumC7350a.DISABLE;
                    }
                }
            }
        }
        return c == EnumC7350a.ENABLE;
    }
    ...
    public static File g(String str) throws UCSetupException {
        ...
        if ((i2 == 34 || i2 == 43) && (listFiles = j(str).listFiles(new C7354s())) != null && listFiles.length > 0) {
            return listFiles[0];
        }
        return null;
    }
    ...
    public static String a() {
        try {
            File[] listFiles = new File("/sys/devices/system/cpu/").listFiles(new C7353r());
    ...
    */
    private static com.uc.webview.export.internal.setup.bt d(android.content.Context r13, java.lang.String r14, java.lang.String r15) throws com.uc.webview.export.internal.setup.UCSetupException {
        ...
        L40:
            ...
            if (r14 == 0) goto L71
            java.lang.String[] r1 = com.uc.webview.export.internal.utility.C7349p.a
            int r2 = r1.length
            r3 = 0
            r4 = 0
        L4c:
        ...
        L71:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.webview.export.internal.utility.C7349p.d(android.content.Context, java.lang.String, java.lang.String):com.uc.webview.export.internal.setup.bt");
    }
    ...
    public static synchronized List<bt> b(Context context, ConcurrentHashMap<String, Object> concurrentHashMap) {
        synchronized (C7349p.class) {
            ...
            if (arrayList != null && arrayList.size() > 1) {
                Collections.sort(arrayList, new C7356u());
            }
            C7302b.a(286);
            return arrayList;
        }
            ...
            synchronized (d) {
                if (d == enumC7350a2) {
                    try {
                        ...
                        d = EnumC7350a.DISABLE;
                    }
                }
            }
        }
        return d == EnumC7350a.ENABLE;
    }
    ...
    public static void b(Context context) {
        File[] listFiles = context.getCacheDir().listFiles(new C7357v());
    ...
    public static boolean a(UCMRunningInfo uCMRunningInfo) {
        if (uCMRunningInfo != null) {
            return uCMRunningInfo.coreType == 2 && C7336i.a().b(UCCore.OPTION_MULTI_CORE_TYPE);
        }
        return true;
    }
    ...
    */
    public static void a(android.content.Context r5, java.io.File r6, java.io.File r7) throws com.uc.webview.export.internal.setup.UCSetupException {
        ...
        L73:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.webview.export.internal.utility.C7349p.a(android.content.Context, java.io.File, java.io.File):void");
    }

    public static boolean a(ConcurrentHashMap<String, Object> concurrentHashMap) {
        Boolean bool;
        EnumC7350a enumC7350a;
        if (c == EnumC7350a.NOT_INITED && concurrentHashMap != null && (bool = (Boolean) concurrentHashMap.get(UCCore.OPTION_THICK_INTEGRATION)) != null) {
            boolean a2 = a(bool);
            synchronized (c) {
                enumC7350a = a2 ? EnumC7350a.ENABLE : EnumC7350a.DISABLE;
                c = enumC7350a;
            }
            return enumC7350a == EnumC7350a.ENABLE;
        }
        return f();
    }
    ...
    public static String a(Context context, String str, String str2) {
        File j2;
        String[] list;
        if (a(str2) || (list = (j2 = j(str2)).list(new C7355t())) == null || list.length == 0) {
            return null;
        }
        String e2 = e(str);
    ...
    private static List<bt> a(Context context, File file, List<bt> list) throws UCSetupException {
        ...
        if (file.exists() && file.isDirectory()) {
            ...
            C7336i.a().b(UCCore.OPTION_USE_SDK_SETUP);
            if (f()) {
                z = file5.isDirectory();
            } else {
                z = file4.exists() && (!C7336i.a().b(UCCore.OPTION_USE_SDK_SETUP) || file2.exists()) && file5.isDirectory();
            }
            if (z) {
                String[] strArr = a;
