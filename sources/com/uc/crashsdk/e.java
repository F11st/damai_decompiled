...
public class e implements Thread.UncaughtExceptionHandler {
    ...
    public static class c extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            ...
            if ("android.intent.action.BATTERY_CHANGED".equals(action)) {
                ...
                boolean unused9 = e.J = "android.intent.action.BATTERY_LOW".equals(action);
                e.K();
    ...
    public static void B() {
        ...
        com.uc.crashsdk.a.f.a(1, new com.uc.crashsdk.a.e(RpcException.ErrorCode.API_UNAUTHORIZED), 1000L);
    }
    ...
    */
    ...
    private static String R() {
        return (!com.uc.crashsdk.b.F() || d) ? "java" : "ucebujava";
    }
    ...
    */
    private static void c(java.io.OutputStream r7) {
        ...
        Lc:
            ...
            a(r1, r7)
        L10:
            boolean r1 = com.uc.crashsdk.e.ae
            r2 = 0
            if (r1 == 0) goto L2d
            com.uc.crashsdk.e.h = r2
    ...
    */
    private static void f(java.io.OutputStream r11) {
        ...
        L5f:
            ...
            boolean r5 = com.uc.crashsdk.e.ae     // Catch: java.lang.Throwable -> Lbd
            r8 = 2
            if (r5 == 0) goto L9b
    ...
    public static String k() {
        ...
        if (com.uc.crashsdk.a.g.a(str)) {
            synchronized (x) {
                str = com.uc.crashsdk.a.g.a(com.uc.crashsdk.b.i(), g.P() ? "https://up4-intl.ucweb.com/upload" : "https://up4.ucweb.com/upload", true);
                w = str;
            }
        }
        return str;
    ...
    public static void r() {
        ...
        if (!com.uc.crashsdk.b.B()) {
            com.uc.crashsdk.a.f.a(3, new com.uc.crashsdk.a.e(TypedValues.Cycle.TYPE_PATH_ROTATE), 11000L);
        }
        if (U()) {
            return;
        }
    ...
    */
    ...
    public static boolean e(String str) {
        try {
            if (com.uc.crashsdk.a.g.b(str) && str.startsWith(SolidMonitor.CHECK_TYPE_LIB) && str.endsWith(".so")) {
    ...
    */
    ...
    public static void b(String str) {
        synchronized (x) {
            w = str;
            com.uc.crashsdk.a.b.a(com.uc.crashsdk.b.i(), str + StringUtils.LF);
        }
    }
    ...
    public static String a(String str) {
        ...
        if (g.x() && (lastIndexOf = str.lastIndexOf(47)) > 0 && (indexOf = str.indexOf(95, lastIndexOf)) > lastIndexOf && (indexOf2 = str.indexOf(95, (i2 = indexOf + 1))) > indexOf) {
            String d2 = com.uc.crashsdk.a.g.d(CrashReporter._MAGIC + str.substring(lastIndexOf + 1, indexOf) + str.substring(i2, indexOf2));
