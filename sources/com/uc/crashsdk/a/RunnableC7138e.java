...
import com.uc.crashsdk.C7151f;
import com.youku.alixplayer.util.PlaybackParamKey;

/* compiled from: Taobao */
/* renamed from: com.uc.crashsdk.a.e */
/* loaded from: classes11.dex */
public class RunnableC7138e implements Runnable {
    static final /* synthetic */ boolean a = true;
    private final int b;
    private final Object[] c;

    public RunnableC7138e(int i) {
        this.b = i;
        this.c = null;
    }
            ...
            switch (i) {
                ...
                default:
                    switch (i) {
                        ...
                        case 755:
                        case 756:
                            return C7151f.a(i, this.c);
                        default:
                            C7134a.d("crashsdk", "Unknown sync runnable: " + toString());
                            if (a) {
                                return false;
                            }
                                ...
                                default:
                                    switch (i) {
                                        ...
                                        case TypedValues.Cycle.TYPE_PATH_ROTATE /* 416 */:
                                            break;
                                        default:
                                            C7134a.d("crashsdk", "Unknown async runnable: " + toString());
                                            if (!a) {
                                                throw new AssertionError();
                                            }
                                            return;
    ...
    public RunnableC7138e(int i, Object[] objArr) {
        this.b = i;
        this.c = objArr;
    }
}
