...
public class C7133a {
    ...
    private static Runnable F = new RunnableC7138e(201);
    ...
    public static void n() {
        ...
        H = true;
        C7139f.a(0, new RunnableC7138e(202));
    }

    private static boolean o() {
        try {
            PackageInfo packageInfo = C7140g.a().getPackageManager().getPackageInfo(a, 0);
    ...
    private static void p() {
        if (!I && C7146e.a()) {
            if (C7143b.d || !C7143b.g) {
                String format = String.format(Locale.US, "%s/%s/%s", C7152g.R(), C7152g.S(), C7152g.T());
                C7134a.b("crashsdk", "UUID: " + C7146e.q());
                C7134a.b("crashsdk", "Version: " + format);
                C7134a.b("crashsdk", "Process Name: " + C7146e.h());
                I = true;
            }
        }
    }
    ...
    public static int b(String str, String str2) {
        ...
        synchronized (hashMap) {
            ...
            if (C7143b.d && JNIBridge.nativeAddCachedInfo(str, str2)) {
    ...
    public static int a(String str, String str2, boolean z2, boolean z3, int i2, boolean z4) {
        ...
        if (str.length() > 256) {
            C7134a.a("crashsdk", "addDumpFile: description is too long!", null);
            return 0;
        }
    ...
    */
    public static void b(java.io.OutputStream r11, java.lang.String r12, java.lang.String r13, java.util.ArrayList<java.lang.String> r14) {
        /*
            java.util.HashMap<java.lang.String, java.lang.Object[]> r0 = com.uc.crashsdk.C7133a.A
            monitor-enter(r0)
            java.util.List<java.lang.String> r1 = com.uc.crashsdk.C7133a.B     // Catch: java.lang.Throwable -> Ld1
        ...
        L9:
            ...
            java.util.HashMap<java.lang.String, java.lang.Object[]> r3 = com.uc.crashsdk.C7133a.A     // Catch: java.lang.Throwable -> Ld1
        ...
        L68:
            r2 = move-exception
            com.uc.crashsdk.C7146e.a(r2, r11)     // Catch: java.lang.Throwable -> Ld1
        L6c:
        ...
        La9:
            if (r14 == 0) goto Lcf
            boolean r12 = com.uc.crashsdk.C7146e.F()     // Catch: java.lang.Throwable -> Ld1
            if (r12 == 0) goto Lcf
        ...
        Lb5:
            ...
            java.util.List<java.lang.String> r14 = com.uc.crashsdk.C7133a.B     // Catch: java.lang.Throwable -> Ld1
            boolean r14 = a(r14, r13)     // Catch: java.lang.Throwable -> Ld1
            if (r14 != 0) goto Lb5
            java.lang.String r14 = "CUSTOMCACHEDINFO"
            com.uc.crashsdk.C7146e.a(r11, r14, r13)     // Catch: java.lang.Throwable -> Ld1
            goto Lb5
        Lcf:
        ...
        Ld1:
            ...
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.crashsdk.C7133a.b(java.io.OutputStream, java.lang.String, java.lang.String, java.util.ArrayList):void");
    }
    ...
    */
    public static void a(java.io.OutputStream r18, java.lang.String r19, java.util.ArrayList<java.lang.String> r20) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.crashsdk.C7133a.a(java.io.OutputStream, java.lang.String, java.util.ArrayList):void");
    }
    ...
    */
    public static int a(java.lang.String r16, int r17, java.util.concurrent.Callable<java.lang.String> r18, long r19, int r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.crashsdk.C7133a.a(java.lang.String, int, java.util.concurrent.Callable, long, int):int");
    }
    ...
    */
    public static void a(java.io.OutputStream r10, java.lang.String r11, java.lang.String r12, java.util.ArrayList<java.lang.String> r13) {
        /*
            java.util.HashMap<java.lang.String, java.lang.Object[]> r0 = com.uc.crashsdk.C7133a.q
            monitor-enter(r0)
            java.util.List<java.lang.String> r1 = com.uc.crashsdk.C7133a.r     // Catch: java.lang.Throwable -> Ld1
            java.util.Iterator r1 = r1.iterator()     // Catch: java.lang.Throwable -> Ld1
        L9:
            boolean r2 = r1.hasNext()     // Catch: java.lang.Throwable -> Ld1
            if (r2 == 0) goto La9
            java.lang.Object r2 = r1.next()     // Catch: java.lang.Throwable -> Ld1
            java.lang.String r2 = (java.lang.String) r2     // Catch: java.lang.Throwable -> Ld1
            java.util.HashMap<java.lang.String, java.lang.Object[]> r3 = com.uc.crashsdk.C7133a.q     // Catch: java.lang.Throwable -> L8d
        ...
        L8d:
            r2 = move-exception
            com.uc.crashsdk.C7146e.a(r2, r10)     // Catch: java.lang.Throwable -> Ld1
        L91:
            java.lang.String r2 = "\n"
        ...
        La9:
            if (r13 == 0) goto Lcf
            boolean r11 = com.uc.crashsdk.C7146e.F()     // Catch: java.lang.Throwable -> Ld1
            if (r11 == 0) goto Lcf
        ...
        Lb5:
            ...
            java.util.List<java.lang.String> r13 = com.uc.crashsdk.C7133a.r     // Catch: java.lang.Throwable -> Ld1
            boolean r13 = a(r13, r12)     // Catch: java.lang.Throwable -> Ld1
            if (r13 != 0) goto Lb5
            java.lang.String r13 = "CUSTOMCALLBACKINFO"
            com.uc.crashsdk.C7146e.a(r10, r13, r12)     // Catch: java.lang.Throwable -> Ld1
            goto Lb5
        Lcf:
            monitor-exit(r0)     // Catch: java.lang.Throwable -> Ld1
            return
        Ld1:
            ...
            throw r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.crashsdk.C7133a.a(java.io.OutputStream, java.lang.String, java.lang.String, java.util.ArrayList):void");
    }
    ...
    */
    public static void a(java.io.OutputStream r13, java.lang.String r14, java.lang.String r15) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.uc.crashsdk.C7133a.a(java.io.OutputStream, java.lang.String, java.lang.String):void");
    }
    ...
    public static int a(String str, int i2, int i3) {
        ...
        if (i2 > 1500) {
            C7134a.a("crashsdk", "createCachedInfo: capacity is too large!", null);
            return 0;
        }
        HashMap<String, Object[]> hashMap = A;
        synchronized (hashMap) {
    ...
    public static int a(int i2, String str) {
        ...
        if (LogType.isForNative(i2) || LogType.isForANR(i2)) {
            if (C7143b.d) {
                ...
                C7134a.a("crashsdk", "crashsdk so has not loaded!", null);
            }
        }
    ...
    public static boolean a(boolean z2) {
        int E2;
        if (!C7143b.c) {
            C7134a.a("crashsdk", "Unexp log not enabled, skip update unexp info!");
            return false;
        } else if (C7146e.F() || C7143b.L()) {
            return false;
        } else {
            if (z2) {
                C7139f.a(F);
                ...
                C7134a.a("crashsdk", "Stop update unexp info in background!");
                return false;
            } else if (C7152g.E() <= 0) {
                return false;
            } else {
    ...
    public static void a(int i2) {
        if (i2 == 201) {
            C7134a.a("crashsdk", "Begin update info ...");
            long currentTimeMillis = System.currentTimeMillis();
            if (C7143b.d && c) {
                JNIBridge.nativeCmd(11, C7152g.E(), String.valueOf(C7152g.F()), null);
            }
            C7134a.a("crashsdk", "Update info took " + (System.currentTimeMillis() - currentTimeMillis) + " ms");
            a(false);
        } else if (i2 != 202) {
            if (!d) {
                throw new AssertionError();
            ...
            p();
            Locale locale = Locale.US;
            String format = String.format(locale, "%s/%s/%s", C7152g.R(), C7152g.S(), C7152g.T());
            g = m();
            if (C7143b.d) {
                JNIBridge.set(128, g);
            }
            ...
            if (z2) {
                C7135b.a(C7143b.m(), format);
            }
            if (z2 && C7152g.u()) {
                C7134a.a("crashsdk", String.format(locale, "Is new version ('%s' -> '%s'), deleting old stats data!", g, format));
                C7143b.v();
            }
        }
    }
