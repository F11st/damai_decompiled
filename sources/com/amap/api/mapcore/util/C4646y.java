...
public class C4646y {
    ...
    private C4505de.C4512g t;
    private FloatBuffer u;
    private FloatBuffer v;
    private InterfaceC4647a w;
    ...
    public C4646y(IAMapDelegate iAMapDelegate) {
        this.h = null;
        this.j = false;
    ...
    private void e() {
        ...
        if (iAMapDelegate != null) {
            this.t = (C4505de.C4512g) iAMapDelegate.getGLShader(0);
        }
    }
        ...
        this.h.execute(new Runnable() { // from class: com.amap.api.mapcore.util.y.2
            ...
            public void run() {
                try {
                    ...
                    C4646y.this.k = 0;
                    int i = 0;
                    while (!C4646y.this.j && C4646y.this.k < 5 && i < 50) {
                        i++;
                        try {
                            Thread.sleep(16L);
                        ...
                        if (!C4646y.this.i) {
                            if (C4646y.this.x != null) {
                                C4646y.this.x.onGenerateComplete(null, -1);
                            }
                            if (!C4646y.this.n) {
                                C4646y.this.n = true;
                                if (C4646y.this.x != null) {
                            ...
                            if (C4646y.this.r != EGL14.EGL_NO_CONTEXT) {
                                EGL14.eglDestroyContext(C4646y.this.q, C4646y.this.r);
                                EGL14.eglDestroySurface(C4646y.this.q, C4646y.this.s);
                                C4646y.this.r = null;
                            }
                            if (C4646y.this.q != EGL14.EGL_NO_DISPLAY) {
                                EGL14.eglTerminate(C4646y.this.q);
                                C4646y.this.q = null;
                            }
                            C4646y.this.r = EGL14.EGL_NO_CONTEXT;
                            C4646y.this.q = EGL14.EGL_NO_DISPLAY;
                            return;
                        }
                        GLES20.glViewport(0, 0, C4646y.this.e, C4646y.this.f);
    ...
    public void a(InterfaceC4647a interfaceC4647a) {
        this.w = interfaceC4647a;
    }
}
