...
import com.amap.api.mapcore.util.C4607l;
...
public class C4600k extends Thread {
    WeakReference<IAMapDelegate> a;
    private Context b;

    public C4600k(Context context, IAMapDelegate iAMapDelegate) {
        this.a = null;
        this.b = context;
    ...
    public void run() {
        ...
        try {
            if (MapsInitializer.getNetWorkEnable()) {
                ...
                gd.C4555a a = gd.a(this.b, eq.e(), sb.toString(), (Map<String, String>) null);
                boolean z = true;
                    ...
                    ep.a().a(new Runnable() { // from class: com.amap.api.mapcore.util.k.1
                        ...
                        public void run() {
                            if (!TextUtils.isEmpty(optString4) && !TextUtils.isEmpty(optString3)) {
                                ...
                                if (z2) {
                                    C4607l.C4611d c4611d = new C4607l.C4611d(str3, str4, str5, str2);
                                    c4611d.a("amap_web_logo", "md5_day");
                                    new C4607l(C4600k.this.b, c4611d, eq.e()).a();
                                }
                                WeakReference<IAMapDelegate> weakReference6 = C4600k.this.a;
                                if (weakReference6 != null && weakReference6.get() != null) {
                                    C4600k.this.a.get().changeLogoIconStyle(str2, z2, 0);
                                }
                            }
                            ...
                            if (z3) {
                                C4607l.C4611d c4611d2 = new C4607l.C4611d(str7, str8, str9, str6);
                                c4611d2.a("amap_web_logo", "md5_night");
                                new C4607l(C4600k.this.b, c4611d2, eq.e()).a();
                            }
                            WeakReference<IAMapDelegate> weakReference7 = C4600k.this.a;
                            if (weakReference7 == null || weakReference7.get() == null) {
                                return;
                            }
                            C4600k.this.a.get().changeLogoIconStyle(str6, z3, 1);
                        }
                    });
                }
                if (a != null) {
    ...
    private void a(Context context, gm gmVar, gd.C4555a c4555a) {
        JSONObject jSONObject;
    ...
    private void a(gd.C4555a c4555a) {
        try {
            gd.C4555a.C4556a c4556a = c4555a.x;
            if (c4556a != null) {
                en.a(this.b, "maploc", "ue", Boolean.valueOf(c4556a.a));
                JSONObject jSONObject = c4556a.c;
