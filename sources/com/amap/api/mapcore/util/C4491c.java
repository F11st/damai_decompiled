...
import com.amap.api.mapcore.util.C4480b;
...
public class C4491c implements C4480b.InterfaceC4481a, di.InterfaceC4516a, IAMapDelegate, IAMapListener {
    ...
    private final C4643v aL;
    private int aM;
    private int aN;
    private List<C4645x> aO;
    private dg aP;
    private di aQ;
    private C4553g aR;
    ...
    private boolean ay;
    private boolean az;
    protected final C4641u b;
    private Runnable bA;
    private AbstractRunnableC4492a bB;
    private AbstractRunnableC4492a bC;
    private jp bD;
    private String bE;
    private String bF;
    ...
    private C4480b bo;
    private long bp;
    private AbstractRunnableC4492a bq;
    private AbstractRunnableC4492a br;
    private AbstractRunnableC4492a bs;
    private AbstractRunnableC4492a bt;
    private AbstractRunnableC4492a bu;
    private AbstractRunnableC4492a bv;
    private AbstractRunnableC4492a bw;
    private AbstractRunnableC4492a bx;
    private AbstractRunnableC4492a by;
    private AbstractRunnableC4492a bz;
    ...
    /* loaded from: classes10.dex */
    public static abstract class AbstractRunnableC4492a implements Runnable {
        boolean b;
        boolean c;
        int d;
        int e;
        ...
        private AbstractRunnableC4492a() {
            this.b = false;
            this.c = false;
            this.h = 0;
            this.i = 0;
    ...
    class C4493b {
        ...
        public void a(aq aqVar) {
            ...
            int[] iArr;
            String[] strArr;
            MapConfig mapConfig = C4491c.this.c;
            if (mapConfig == null || !mapConfig.isIndoorEnable()) {
                return;
            }
            final fb e = C4491c.this.ae.e();
            if (aqVar == null) {
                try {
                    if (C4491c.this.S != null && C4491c.this.S.size() > 0) {
                        for (int i = 0; i < C4491c.this.S.size(); i++) {
                            ((AMap.OnIndoorBuildingActiveListener) C4491c.this.S.get(i)).OnIndoorBuilding(aqVar);
                        }
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
                aq aqVar4 = C4491c.this.d;
                if (aqVar4 != null) {
                    aqVar4.g = null;
                }
                if (e.d()) {
                    C4491c.this.j.post(new Runnable() { // from class: com.amap.api.mapcore.util.c.b.1
                        @Override // java.lang.Runnable
                        public void run() {
                            e.a(false);
                        }
                ...
                MapConfig mapConfig2 = C4491c.this.c;
                mapConfig2.maxZoomLevel = mapConfig2.isSetLimitZoomLevel() ? C4491c.this.c.getMaxZoomLevel() : 20.0f;
                try {
                    if (!C4491c.this.ab.isZoomControlsEnabled() || C4491c.this.am == null || C4491c.this.am.size() <= 0) {
                        return;
                    }
                    for (int i2 = 0; i2 < C4491c.this.am.size(); i2++) {
                        ((AMapWidgetListener) C4491c.this.am.get(i2)).invalidateZoomController(C4491c.this.c.getSZ());
                    }
                    return;
                } catch (Throwable th2) {
                    th2.printStackTrace();
            ...
            if (aqVar == null || (aqVar3 = C4491c.this.d) == null || aqVar3.activeFloorIndex == aqVar.activeFloorIndex || !e.d()) {
                if (aqVar != null && ((aqVar2 = C4491c.this.d) == null || !aqVar2.poiid.equals(aqVar.poiid) || C4491c.this.d.g == null)) {
                    ...
                    if (c4491c.c != null) {
                        ...
                        DPoint mapGeoCenter = C4491c.this.c.getMapGeoCenter();
                        if (mapGeoCenter != null) {
                            Point point = C4491c.this.d.g;
                ...
                try {
                    if (C4491c.this.S != null && C4491c.this.S.size() > 0) {
                        for (int i4 = 0; i4 < C4491c.this.S.size(); i4++) {
                            ((AMap.OnIndoorBuildingActiveListener) C4491c.this.S.get(i4)).OnIndoorBuilding(aqVar);
                        }
                    }
                    MapConfig mapConfig3 = C4491c.this.c;
                    mapConfig3.maxZoomLevel = mapConfig3.isSetLimitZoomLevel() ? C4491c.this.c.getMaxZoomLevel() : 20.0f;
                    if (C4491c.this.ab.isZoomControlsEnabled() && C4491c.this.am != null && C4491c.this.am.size() > 0) {
                        for (int i5 = 0; i5 < C4491c.this.am.size(); i5++) {
                            ((AMapWidgetListener) C4491c.this.am.get(i5)).invalidateZoomController(C4491c.this.c.getSZ());
                        }
                    }
                    if (!C4491c.this.ab.isIndoorSwitchEnabled()) {
                        if (C4491c.this.ab.isIndoorSwitchEnabled() || !e.d()) {
                            return;
                        }
                        C4491c.this.ab.setIndoorSwitchEnabled(false);
                        return;
                    }
                    if (!e.d()) {
                        C4491c.this.ab.setIndoorSwitchEnabled(true);
                    }
                    C4491c.this.j.post(new Runnable() { // from class: com.amap.api.mapcore.util.c.b.2
                        @Override // java.lang.Runnable
                        public void run() {
                            try {
                                e.a(C4491c.this.d.floor_names);
                                e.a(C4491c.this.d.activeFloorName);
                                if (e.d()) {
                                    return;
                                }
                                e.a(true);
    ...
    /* loaded from: classes10.dex */
    private class C4494c implements fb.InterfaceC4540a {
        private C4494c() {
        }

        @Override // com.amap.api.mapcore.util.fb.InterfaceC4540a
        public void a(int i) {
            C4491c c4491c = C4491c.this;
            aq aqVar = c4491c.d;
            if (aqVar != null) {
                ...
                try {
                    c4491c.setIndoorBuildingInfo(aqVar);
    ...
    /* loaded from: classes10.dex */
    public class RunnableC4495d implements Runnable {
        private Context b;
        private AMap.OnCacheRemoveListener c;

        public RunnableC4495d(Context context, AMap.OnCacheRemoveListener onCacheRemoveListener) {
            this.b = context;
            this.c = onCacheRemoveListener;
        }

        public boolean equals(Object obj) {
            return obj instanceof RunnableC4495d;
        }
        ...
        */
        public void run() {
            ...
            L41:
                r1 = 0
            L42:
                com.amap.api.mapcore.util.c r2 = com.amap.api.mapcore.util.C4491c.this     // Catch: java.lang.Throwable -> L61
                com.amap.api.mapcore.util.ab r2 = com.amap.api.mapcore.util.C4491c.i(r2)     // Catch: java.lang.Throwable -> L61
                if (r2 == 0) goto L53
                com.amap.api.mapcore.util.c r2 = com.amap.api.mapcore.util.C4491c.this     // Catch: java.lang.Throwable -> L61
                com.amap.api.mapcore.util.ab r2 = com.amap.api.mapcore.util.C4491c.i(r2)     // Catch: java.lang.Throwable -> L61
                r2.i()     // Catch: java.lang.Throwable -> L61
            L53:
                com.amap.api.mapcore.util.c r0 = com.amap.api.mapcore.util.C4491c.this     // Catch: java.lang.Throwable -> L7a
            ...
            L62:
                ...
                com.amap.api.mapcore.util.c r1 = com.amap.api.mapcore.util.C4491c.this     // Catch: java.lang.Throwable -> L7a
            ...
            L7f:
                r0 = move-exception
                com.amap.api.mapcore.util.c r2 = com.amap.api.mapcore.util.C4491c.this     // Catch: java.lang.Throwable -> L8e
            ...
            L92:
                throw r0
            */
            throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4491c.RunnableC4495d.run():void");
        }
    }

    public C4491c(IGLSurfaceView iGLSurfaceView, Context context, AttributeSet attributeSet) {
    ...
    public Arc addArc(ArcOptions arcOptions) throws RemoteException {
        try {
            resetRenderTime();
            IArcDelegate a = this.ah.a(arcOptions);
            if (a != null) {
                return new Arc(a);
            }
            return null;
    ...
    public Circle addCircle(CircleOptions circleOptions) throws RemoteException {
        try {
            resetRenderTime();
            ICircleDelegate a = this.ah.a(circleOptions);
            if (a != null) {
                return new Circle(a);
            }
            return null;
    ...
    public GroundOverlay addGroundOverlay(GroundOverlayOptions groundOverlayOptions) throws RemoteException {
        try {
            resetRenderTime();
            IGroundOverlayDelegate a = this.ah.a(groundOverlayOptions);
            if (a != null) {
    ...
    public HeatMapLayer addHeatMapLayer(HeatMapLayerOptions heatMapLayerOptions) throws RemoteException {
        try {
            resetRenderTime();
            IHeatMapLayer a = this.ah.a(heatMapLayerOptions);
            if (a != null) {
                return new HeatMapLayer(a);
            }
            return null;
        } catch (Throwable th) {
            eq.a(th);
    ...
    public MultiPointOverlay addMultiPointOverlay(MultiPointOverlayOptions multiPointOverlayOptions) throws RemoteException {
        try {
            resetRenderTime();
            IMultiPointOverlay a = this.bn.a(multiPointOverlayOptions);
            if (a != null) {
    ...
    public NavigateArrow addNavigateArrow(NavigateArrowOptions navigateArrowOptions) throws RemoteException {
        try {
            resetRenderTime();
            INavigateArrowDelegate a = this.ah.a(navigateArrowOptions);
            if (a != null) {
    ...
    public ParticleOverlay addParticleOverlay(ParticleOverlayOptions particleOverlayOptions) {
        try {
            IParticleLatyer a = this.ah.a(particleOverlayOptions);
            if (a != null) {
                eo.c(this.f);
                return new ParticleOverlay(a);
            }
            return null;
        } catch (RemoteException e) {
            eq.a(e);
    ...
    public Polygon addPolygon(PolygonOptions polygonOptions) throws RemoteException {
        try {
            resetRenderTime();
            IPolygonDelegate a = this.ah.a(polygonOptions);
            if (a != null) {
    ...
    public Polyline addPolyline(PolylineOptions polylineOptions) throws RemoteException {
        try {
            resetRenderTime();
            IPolylineDelegate a = this.ah.a(polylineOptions);
            if (a != null) {
    ...
    @Override // com.autonavi.base.amap.api.mapcore.IAMapDelegate
    public void addTextureItem(C4645x c4645x) {
        if (c4645x == null || c4645x.k() == 0) {
            return;
        }
    ...
    public TileOverlay addTileOverlay(TileOverlayOptions tileOverlayOptions) throws RemoteException {
        try {
            synchronized (this.ag) {
                if (this.af == null) {
                    this.af = new C4469ab(this.f, this);
                }
            }
            if (this.af != null) {
    ...
    public void afterDrawLabel(int i, GLMapState gLMapState) {
        ...
        C4629o c4629o = this.al;
        if (c4629o != null) {
            c4629o.a();
        }
        C4641u c4641u = this.b;
        if (c4641u != null) {
            c4641u.a(false);
        }
        da daVar = this.Y;
    ...
    public Pair<Float, LatLng> calculateZoomToSpanLevel(int i, int i2, int i3, int i4, LatLng latLng, LatLng latLng2) {
        ...
        if (latLng != null && latLng2 != null && this.bc && !this.ak) {
            ...
            Pair<Float, IPoint> a = eq.a(mapConfig, i, i2, i3, i4, builder.build(), getMapWidth(), getMapHeight());
            gLMapState.recycle();
            if (a != null) {
                ...
                Pair<Float, LatLng> pair = new Pair<>(a.first, new LatLng(obtain.y, obtain.x));
                obtain.recycle();
                return pair;
            }
            return null;
    ...
    public void changeSurface(int i, GL10 gl10, int i2, int i3) {
        ...
        C4630p c4630p = this.aT;
        if (c4630p != null && this.f != null && ((this.h != c4630p.b() || this.i != this.aT.c()) && (windowManager = (WindowManager) this.f.getSystemService(C9796v.ATTACH_MODE_WINDOW)) != null)) {
        ...
        C4553g c4553g = this.aR;
        if (c4553g != null) {
            c4553g.a(new C4644w(AliMediaPlayer.UPLAYER_PROPERTY_TYPE_PATTAYA_FIXED_GEAR_INDEX));
        }
        synchronized (this) {
            this.bd = true;
        }
        ...
        this.a = true;
        AbstractRunnableC4492a abstractRunnableC4492a = this.by;
        if (abstractRunnableC4492a.b) {
            abstractRunnableC4492a.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a2 = this.bs;
        if (abstractRunnableC4492a2.b) {
            abstractRunnableC4492a2.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a3 = this.bt;
        if (abstractRunnableC4492a3.b) {
            abstractRunnableC4492a3.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a4 = this.bq;
        if (abstractRunnableC4492a4.b) {
            abstractRunnableC4492a4.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a5 = this.bu;
        if (abstractRunnableC4492a5.b) {
            abstractRunnableC4492a5.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a6 = this.bB;
        if (abstractRunnableC4492a6.b) {
            abstractRunnableC4492a6.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a7 = this.bv;
        if (abstractRunnableC4492a7.b) {
            abstractRunnableC4492a7.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a8 = this.bw;
        if (abstractRunnableC4492a8.b) {
            abstractRunnableC4492a8.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a9 = this.bx;
        if (abstractRunnableC4492a9.b) {
            abstractRunnableC4492a9.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a10 = this.bz;
        if (abstractRunnableC4492a10.b) {
            abstractRunnableC4492a10.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a11 = this.br;
        if (abstractRunnableC4492a11.b) {
            abstractRunnableC4492a11.run();
        }
        AbstractRunnableC4492a abstractRunnableC4492a12 = this.bC;
        if (abstractRunnableC4492a12.b) {
            abstractRunnableC4492a12.run();
        }
        ...
        try {
            if (limitLatLngBounds != null) {
                ...
                if (this.c.isSetLimitZoomLevel()) {
                    ...
                    float max = Math.max(b, Math.min(mapZoomer, maxZoomLevel));
                    if (b <= maxZoomLevel) {
                        maxZoomLevel = max;
                    }
                    b = maxZoomLevel < minZoomLevel ? minZoomLevel : maxZoomLevel;
                } else if (b <= 0.0f || mapZoomer >= b) {
                    b = mapZoomer;
                }
                iGLMapState.setMapZoomer(b);
                ...
                int[] a = eq.a(com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.getx(limitIPoints[0]), com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.gety(limitIPoints[0]), com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.getx(limitIPoints[1]), com.alibaba.wireless.security.aopsdk.replace.android.graphics.Point.gety(limitIPoints[1]), this.c, iGLMapState, xVar, yVar);
    ...
    public void destroy() {
        ...
        try {
            ...
            C4639s c4639s = this.bm;
            if (c4639s != null) {
                c4639s.e();
            }
            C4630p c4630p = this.aT;
            if (c4630p != null) {
                c4630p.a((AMapGestureListener) null);
                this.aT.d();
                this.aT = null;
            }
            C4637r c4637r = this.ah;
            ...
            di diVar = this.aQ;
            if (diVar != null) {
                diVar.a((di.InterfaceC4516a) null);
                this.aQ.a();
                this.aQ = null;
            }
            ea.b();
            ...
            if (gLMapEngine != null) {
                ...
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.33
                    ...
                    public void run() {
                        try {
                            C4491c c4491c = C4491c.this;
                            c4491c.destroySurface(c4491c.aj);
                        } catch (Throwable th) {
                            th.printStackTrace();
                            eq.a(th);
                        }
        ...
        if (eh.a()) {
            try {
                if (this.ad instanceof C4539f) {
                    ...
                    if (this.e.a(((C4539f) this.ad).getBitmap())) {
                        if (eh.b()) {
                            removecache();
                        }
                        if (eh.c()) {
    ...
    public String getCurrentWorldVectorMapStyle() {
        try {
            jp jpVar = this.bD;
            if (jpVar != null) {
                Object a = jpVar.a("getCurMapStyleKey");
    ...
    @Override // com.autonavi.base.amap.api.mapcore.IAMapDelegate
    public C4505de getGLShaderManager() {
        return this.bl;
    }
    ...
    public String getMapContentApprovalNumber() {
        ...
        eo.d(this.f);
        String a = eg.a(this.f, "approval_number", "mc", "");
        return !TextUtils.isEmpty(a) ? a : "GS（2017）3426号 | GS（2017）2550号";
    }
    ...
    public String getSatelliteImageApprovalNumber() {
        eo.e(this.f);
        String a = eg.a(this.f, "approval_number", "si", "");
    ...
    @Override // com.autonavi.base.amap.api.mapcore.IAMapDelegate
    public C4645x getTextureItem(BitmapDescriptor bitmapDescriptor) {
    ...
    public float getZoomToSpanLevel(LatLng latLng, LatLng latLng2) {
        try {
            ...
            if (latLng != null && latLng2 != null && this.bc && !this.ak) {
                ...
                builder.include(latLng2);
                GLMapState gLMapState = new GLMapState(1, this.g.getNativeInstance());
                Pair<Float, IPoint> a = eq.a(mapConfig, 0, 0, 0, 0, builder.build(), getMapWidth(), getMapHeight());
                gLMapState.recycle();
                if (a != null) {
    ...
    public void onIndoorBuildingActivity(int i, byte[] bArr) {
        ...
        if (bArr != null) {
            try {
                aqVar = new aq();
                byte b = bArr[0];
                aqVar.a = new String(bArr, 1, b, "utf-8");
                int i2 = 1 + b;
                int i3 = i2 + 1;
                byte b2 = bArr[i2];
                aqVar.b = new String(bArr, i3, b2, "utf-8");
                int i4 = i3 + b2;
                int i5 = i4 + 1;
                byte b3 = bArr[i4];
                aqVar.activeFloorName = new String(bArr, i5, b3, "utf-8");
                int i6 = i5 + b3;
                aqVar.activeFloorIndex = GLConvertUtil.getInt(bArr, i6);
                int i7 = i6 + 4;
                int i8 = i7 + 1;
                byte b4 = bArr[i7];
                aqVar.poiid = new String(bArr, i8, b4, "utf-8");
                int i9 = i8 + b4;
                int i10 = i9 + 1;
                byte b5 = bArr[i9];
                aqVar.h = new String(bArr, i10, b5, "utf-8");
                int i11 = i10 + b5;
                ...
                for (int i14 = 0; i14 < aqVar.c; i14++) {
                    ...
                    byte b6 = bArr[i15];
                    if (b6 > 0) {
                        aqVar.floor_names[i14] = new String(bArr, i16, b6, "utf-8");
                        i16 += b6;
                    }
                    i13 = i16 + 1;
                    byte b7 = bArr[i16];
                    if (b7 > 0) {
                        aqVar.d[i14] = new String(bArr, i13, b7, "utf-8");
                        i13 += b7;
                    }
                }
        ...
        post(new Runnable() { // from class: com.amap.api.mapcore.util.c.31
            @Override // java.lang.Runnable
            public void run() {
                if (C4491c.this.bk != null) {
                    C4491c.this.bk.a(C4491c.this.bI);
                }
            }
        });
    }
    ...
    public void onLongPress(int i, MotionEvent motionEvent) {
        ...
        try {
            this.av = false;
            b(i);
            BaseOverlayImp a = this.b.a(motionEvent);
            this.au = a;
    ...
    public boolean removeMarker(String str) {
        try {
            IOverlayImageDelegate a = this.b.a(str);
            if (a != null) {
                resetRenderTime();
                return this.b.a(a);
            }
        ...
        if (this.bd && this.bc) {
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.28
                ...
                public void run() {
                    try {
                        C4491c c4491c = C4491c.this;
                        c4491c.c.setAnchorX(Math.max(0, Math.min(c4491c.bi, C4491c.this.h)));
                        C4491c c4491c2 = C4491c.this;
                        c4491c2.c.setAnchorY(Math.max(0, Math.min(c4491c2.bj, C4491c.this.i)));
                        C4491c c4491c3 = C4491c.this;
                        c4491c3.g.setProjectionCenter(1, c4491c3.c.getAnchorX(), C4491c.this.c.getAnchorY());
                        C4491c.this.aI = true;
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
    ...
    public void setIndoorBuildingInfo(IndoorBuildingInfo indoorBuildingInfo) throws RemoteException {
        ...
        queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.29
            ...
            public void run() {
                C4491c c4491c = C4491c.this;
                GLMapEngine gLMapEngine = c4491c.g;
                if (gLMapEngine != null) {
                    aq aqVar = c4491c.d;
    ...
    public void setIndoorEnabled(final boolean z) throws RemoteException {
        ...
        try {
            if (this.bc && !this.ak) {
                ...
                if (this.ab.isIndoorSwitchEnabled()) {
                    this.j.post(new Runnable() { // from class: com.amap.api.mapcore.util.c.22
                        ...
                        public void run() {
                            if (!z) {
                                if (C4491c.this.ae != null) {
                                    C4491c.this.ae.i(Boolean.FALSE);
                                    return;
                                }
                                return;
                            }
                            C4491c.this.showIndoorSwitchControlsEnabled(true);
                        }
                    });
                    return;
                }
            ...
            AbstractRunnableC4492a abstractRunnableC4492a = this.bz;
            abstractRunnableC4492a.c = z;
            abstractRunnableC4492a.b = true;
            abstractRunnableC4492a.g = 1;
        } catch (Throwable th) {
            eq.a(th);
        }
    }
    ...
    public void setInfoWindowAdapter(AMap.InfoWindowAdapter infoWindowAdapter) throws RemoteException {
        C4479ar c4479ar;
        if (this.ak || (c4479ar = this.X) == null) {
            return;
        }
        c4479ar.a(infoWindowAdapter);
    }
    ...
    public void setLoadOfflineData(final boolean z) throws RemoteException {
        queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.23
            @Override // java.lang.Runnable
            public void run() {
                GLMapEngine gLMapEngine = C4491c.this.g;
                if (gLMapEngine != null) {
    ...
    public void setMapCustomEnable(boolean z, boolean z2) {
        ...
        AbstractRunnableC4492a abstractRunnableC4492a = this.bt;
        abstractRunnableC4492a.b = true;
        abstractRunnableC4492a.c = z;
    }
    ...
    public void setMapLanguage(String str) {
        ...
        try {
            ...
            C4469ab c4469ab = this.af;
            if (c4469ab != null) {
                c4469ab.a(this.c.getMapLanguage());
            }
        } catch (Throwable th2) {
            eq.a(th2);
            th2.printStackTrace();
        ...
        try {
            if (this.bc && this.bd) {
                ...
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.24
                    ...
                    public void run() {
                        try {
                            C4491c.this.g.setLabelEnable(1, z);
                        } catch (Throwable th) {
                            th.printStackTrace();
                        }
                    }
                ...
                AbstractRunnableC4492a abstractRunnableC4492a = this.bv;
                abstractRunnableC4492a.c = z;
                abstractRunnableC4492a.b = true;
                abstractRunnableC4492a.g = 1;
            }
    ...
    public void setMapType(int i) throws RemoteException {
        ...
        if (i != this.aC || ((mapConfig = this.c) != null && mapConfig.isCustomStyleEnable())) {
            C4553g c4553g = this.aR;
            if (c4553g != null) {
                c4553g.a(new C4644w(1, Integer.valueOf(i)));
            }
            this.aC = i;
        }
    }
                ...
                if (i5 == -1) {
                    ...
                    gLAlphaAnimation.setAnimationListener(new Animation.AnimationListener() { // from class: com.amap.api.mapcore.util.c.30
                        ...
                        public void onAnimationEnd() {
                            C4491c.this.j.post(new Runnable() { // from class: com.amap.api.mapcore.util.c.30.1
                                @Override // java.lang.Runnable
                                public void run() {
                                    AnonymousClass30 anonymousClass30 = AnonymousClass30.this;
                                    C4491c.this.aM = i5;
                                    if (C4491c.this.ae != null) {
                                        C4491c.this.ae.j(Boolean.TRUE);
                                    }
                                }
                            });
                        }
            ...
            if (this.bc && this.bd && myTrafficStyle != null) {
                ...
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.27
                    ...
                    public void run() {
                        try {
                            C4491c c4491c = C4491c.this;
                            c4491c.g.setTrafficStyle(1, c4491c.aD.getSmoothColor(), C4491c.this.aD.getSlowColor(), C4491c.this.aD.getCongestedColor(), C4491c.this.aD.getSeriousCongestedColor());
                        } catch (Throwable th) {
                            th.printStackTrace();
                        }
                    }
                ...
                AbstractRunnableC4492a abstractRunnableC4492a = this.bC;
                abstractRunnableC4492a.c = false;
                abstractRunnableC4492a.b = true;
                abstractRunnableC4492a.g = 1;
            }
        } catch (Throwable th) {
        ...
        try {
            if (this.bc && this.bd) {
                ...
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.26
                    ...
                    public void run() {
                        try {
                            C4491c.this.g.setNaviLabelEnable(1, z, i, i2);
                        } catch (Throwable th) {
                            th.printStackTrace();
                        }
                    }
                ...
                AbstractRunnableC4492a abstractRunnableC4492a = this.bx;
                abstractRunnableC4492a.c = z;
                abstractRunnableC4492a.h = i;
                abstractRunnableC4492a.i = i2;
                abstractRunnableC4492a.b = true;
                abstractRunnableC4492a.g = 1;
            }
        } catch (Throwable th) {
        ...
        try {
            if (this.bc && this.bd) {
                ...
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.25
                    ...
                    public void run() {
                        try {
                            C4491c.this.g.setRoadArrowEnable(1, z);
                        } catch (Throwable th) {
                            th.printStackTrace();
                        }
                    }
                ...
                AbstractRunnableC4492a abstractRunnableC4492a = this.bw;
                abstractRunnableC4492a.c = z;
                abstractRunnableC4492a.b = true;
                abstractRunnableC4492a.g = 1;
            }
        ...
        try {
            if (this.bc && !this.ak) {
                queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.20
                    ...
                    public void run() {
                        try {
                            if (C4491c.this.c.isTrafficEnabled() != z) {
                                C4491c.this.c.setTrafficEnabled(z);
                                C4491c.this.aS.setTrafficMode(z);
                                C4491c.this.g.setTrafficEnable(1, z);
                                C4491c.this.resetRenderTime();
                            }
                        } catch (Throwable th) {
                            th.printStackTrace();
                            eq.a(th);
                ...
                AbstractRunnableC4492a abstractRunnableC4492a = this.bq;
                abstractRunnableC4492a.c = z;
                abstractRunnableC4492a.b = true;
                abstractRunnableC4492a.g = 1;
            }
    ...
    public void showInfoWindow(BaseOverlayImp baseOverlayImp) throws RemoteException {
        C4479ar c4479ar;
        if (baseOverlayImp == null || (c4479ar = this.X) == null) {
            return;
        }
        try {
            c4479ar.a(baseOverlayImp);
        } catch (RemoteException e) {
            e.printStackTrace();
        }
    }
    ...
    public C4491c(IGLSurfaceView iGLSurfaceView, Context context, AttributeSet attributeSet, boolean z) {
        this.u = null;
        this.v = null;
        this.w = null;
        this.x = null;
        ...
        this.j = new Handler(Looper.getMainLooper()) { // from class: com.amap.api.mapcore.util.c.1
            ...
            public void handleMessage(Message message) {
                if (message == null || C4491c.this.ak) {
                    return;
                }
                try {
                    int i = message.what;
                    if (i != 2) {
                        ...
                        switch (i) {
                            case 10:
                                ...
                                if (cameraPosition != null && C4491c.this.M != null && C4491c.this.M.size() > 0) {
                                    for (AMap.OnCameraChangeListener onCameraChangeListener : C4491c.this.M) {
                                        onCameraChangeListener.onCameraChange(cameraPosition);
                                    }
                                }
                                C4491c.this.c.addChangedCounter();
                                return;
                            case 11:
                                CameraPosition cameraPosition2 = C4491c.this.getCameraPosition();
                                if (cameraPosition2 != null && C4491c.this.ae != null) {
                                    C4491c.this.ae.a(cameraPosition2);
                                }
                                C4491c.this.a(cameraPosition2);
                                if (C4491c.this.ba) {
                                    C4491c.this.ba = false;
                                    if (C4491c.this.af != null) {
                                        C4491c.this.af.b(false);
                                    }
                                    C4491c.this.a(true);
                                }
                                if (C4491c.this.ay) {
                                    C4491c.this.redrawInfoWindow();
                                    C4491c.this.ay = false;
                                }
                                C4491c.this.a(true, cameraPosition2);
                                return;
                            case 12:
                                if (C4491c.this.ae != null) {
                                    C4491c.this.ae.a(Float.valueOf(C4491c.this.getZoomLevel()));
                                    return;
                                }
                                return;
                            case 13:
                                ...
                                return;
                            case 14:
                                if (C4491c.this.O == null || C4491c.this.O.size() <= 0) {
                                    return;
                                }
                                for (AMap.OnMapTouchListener onMapTouchListener : C4491c.this.O) {
                            ...
                            case 15:
                                ...
                                int i3 = message.arg1;
                                try {
                                    if (bitmap == null || C4491c.this.ae == null) {
                                        if (C4491c.this.U != null && C4491c.this.U.size() > 0) {
                                            for (int i4 = 0; i4 < C4491c.this.U.size(); i4++) {
                                                ((AMap.onMapPrintScreenListener) C4491c.this.U.get(i4)).onMapPrint(null);
                                            }
                                        }
                                        if (C4491c.this.V != null && C4491c.this.V.size() > 0) {
                                            while (i2 < C4491c.this.V.size()) {
                                                ((AMap.OnMapScreenShotListener) C4491c.this.V.get(i2)).onMapScreenShot(null);
                                                ((AMap.OnMapScreenShotListener) C4491c.this.V.get(i2)).onMapScreenShot(null, i3);
                                                i2++;
                                            }
                                        }
                                    } else {
                                        Canvas canvas = new Canvas(bitmap);
                                        fg g = C4491c.this.ae.g();
                                        if (g != null) {
                                            g.onDraw(canvas);
                                        }
                                        C4491c.this.ae.a(canvas);
                                        if (C4491c.this.U != null && C4491c.this.U.size() > 0) {
                                            for (int i5 = 0; i5 < C4491c.this.U.size(); i5++) {
                                                ((AMap.onMapPrintScreenListener) C4491c.this.U.get(i5)).onMapPrint(new BitmapDrawable(C4491c.this.f.getResources(), bitmap));
                                            }
                                        }
                                        if (C4491c.this.V != null && C4491c.this.V.size() > 0) {
                                            while (i2 < C4491c.this.V.size()) {
                                                ((AMap.OnMapScreenShotListener) C4491c.this.V.get(i2)).onMapScreenShot(bitmap);
                                                ((AMap.OnMapScreenShotListener) C4491c.this.V.get(i2)).onMapScreenShot(bitmap, i3);
                                                i2++;
                                            }
                                        }
                                    }
                                ...
                                return;
                            case 16:
                                if (C4491c.this.L != null) {
                                    while (i2 < C4491c.this.L.size()) {
                                        ((AMap.OnMapLoadedListener) C4491c.this.L.get(i2)).onMapLoaded();
                                        i2++;
                                    }
                                }
                                if (C4491c.this.ae != null) {
                                ...
                                return;
                            case 17:
                                if (C4491c.this.g.isInMapAnimation(1) && C4491c.this.af != null) {
                                    C4491c.this.af.b(false);
                                }
                                if (C4491c.this.af != null) {
                                    C4469ab c4469ab = C4491c.this.af;
                                    if (message.arg1 == 0) {
                                        z2 = false;
                                    }
                                    c4469ab.a(z2);
                                ...
                                return;
                            case 18:
                                if (C4491c.this.X == null || !C4491c.this.ap) {
                                    return;
                                }
                                C4491c.this.X.c();
                                return;
                            case 19:
                                if (C4491c.this.N != null) {
                                    DPoint obtain = DPoint.obtain();
                                    C4491c.this.getPixel2LatLng(message.arg1, message.arg2, obtain);
                                    for (AMap.OnMapClickListener onMapClickListener : C4491c.this.N) {
                                ...
                                return;
                            case 20:
                                if (C4491c.this.P == null || C4491c.this.P.size() <= 0) {
                                    return;
                                }
                                while (i2 < C4491c.this.P.size()) {
                                    ((AMap.OnPOIClickListener) C4491c.this.P.get(i2)).onPOIClick((Poi) message.obj);
                                    i2++;
                                }
                                return;
                            default:
        ...
        this.bq = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.11
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c.this.setTrafficEnabled(this.c);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        };
        this.br = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.21
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c c4491c = C4491c.this;
                    c4491c.setCenterToPixel(c4491c.bi, C4491c.this.bj);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        };
        this.bs = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.32
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                C4491c.this.b(this.g, this.d, this.e, this.f);
            }
        };
        this.bt = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.34
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                C4491c.this.setMapCustomEnable(this.c);
            }
        };
        this.bu = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.35
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                C4491c.this.a(this.g, this.c);
            }
        };
        this.bv = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.36
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c.this.setMapTextEnable(this.c);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        };
        this.bw = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.37
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c.this.setRoadArrowEnable(this.c);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        };
        this.bx = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.38
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c.this.setNaviLabelEnable(this.c, this.h, this.i);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        };
        this.by = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.2
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                C4491c.this.b(this.g, this.c);
            }
        };
        this.bz = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.3
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c.this.setIndoorEnabled(this.c);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        ...
        this.bA = new Runnable() { // from class: com.amap.api.mapcore.util.c.4
            ...
            public void run() {
                fg g;
                if (C4491c.this.ae == null || (g = C4491c.this.ae.g()) == null) {
                    return;
                }
                g.d();
            }
        };
        this.bB = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.5
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                C4491c.this.c(this.g, this.c);
            }
        };
        this.bC = new AbstractRunnableC4492a() { // from class: com.amap.api.mapcore.util.c.6
            @Override // com.amap.api.mapcore.util.C4491c.AbstractRunnableC4492a, java.lang.Runnable
            public void run() {
                super.run();
                try {
                    C4491c c4491c = C4491c.this;
                    c4491c.setMyTrafficStyle(c4491c.aD);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
        ...
        this.aR = new C4553g(context, this, iGLSurfaceView);
        hd.a(this.f);
        ea.a().a(this.f);
        C4614m.b = C4554gc.c(context);
        dr.a(this.f);
        this.aT = new C4630p(this);
        ...
        fdVar.a(new C4494c());
        this.bk = new C4493b();
        this.ah = new C4637r(this);
        this.b = new C4641u(this.f, this);
        this.al = new C4629o(this.f, this);
        iGLSurfaceView.setRenderMode(0);
        this.aS.setRenderFps(15.0f);
        this.g.setMapListener(this);
        this.aa = new C4648z(this);
        this.G = new C4572h(this);
        this.Y = new da(this, context);
        C4479ar c4479ar = new C4479ar(this.f);
        this.X = c4479ar;
        c4479ar.a(this.ae);
        this.X.b(this.Y);
        this.aL = new C4643v();
        this.aE = new C4600k(this.f, this);
        ...
        b(z);
        MapConfig mapConfig = this.c;
        C4480b c4480b = new C4480b(this, this.f, mapConfig != null ? mapConfig.isAbroadEnable() : false);
        this.bo = c4480b;
        c4480b.a(this);
    }
    ...
    private boolean d(MotionEvent motionEvent) {
        try {
            ...
            if (list != null && list.size() > 0) {
                ...
                obtain.recycle();
                IOverlayDelegate a = this.ah.a(latLng);
                if (a != null) {
                    for (AMap.OnPolylineClickListener onPolylineClickListener : this.J) {
                        onPolylineClickListener.onPolylineClick(new Polyline((IPolylineDelegate) a));
                    }
                }
            }
        } catch (Throwable unused) {
    ...
    private void h(final int i) {
        if (this.bc) {
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.7
                ...
                public void run() {
                    try {
                        C4491c.this.g.clearAllMessages(i);
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
                }
    ...
    private void k() {
        ...
        try {
            if (this.aF == null) {
                this.aF = new C4584i(this.f, this);
            }
    ...
    @Override // com.autonavi.base.amap.api.mapcore.IAMapDelegate
    public C4645x getTextureItem(BitmapDescriptor bitmapDescriptor, boolean z) {
        if (bitmapDescriptor == null || bitmapDescriptor.getBitmap() == null || bitmapDescriptor.getBitmap().isRecycled()) {
            return null;
        }
        synchronized (this.aO) {
            for (int i = 0; i < this.aO.size(); i++) {
                C4645x c4645x = this.aO.get(i);
                if ((!z || c4645x.k() != getBaseOverlayTextureID()) && c4645x.j().equals(bitmapDescriptor)) {
                    return c4645x;
                }
            }
            return null;
    ...
    public void removecache(AMap.OnCacheRemoveListener onCacheRemoveListener) throws RemoteException {
        ...
        try {
            RunnableC4495d runnableC4495d = new RunnableC4495d(this.f, onCacheRemoveListener);
            this.j.removeCallbacks(runnableC4495d);
            this.j.post(runnableC4495d);
        } catch (Throwable th) {
    ...
    public void c(final MotionEvent motionEvent) {
        this.j.post(new Runnable() { // from class: com.amap.api.mapcore.util.c.10
            ...
            public void run() {
                ...
                C4491c.this.j.sendMessage(obtain);
            }
        });
    }
    ...
    public void setInfoWindowAdapter(AMap.CommonInfoWindowAdapter commonInfoWindowAdapter) throws RemoteException {
        ...
        c4479ar.a(commonInfoWindowAdapter);
    }
    ...
    */
    public void clear(boolean r4) throws android.os.RemoteException {
        ...
        L5a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4491c.clear(boolean):void");
    }
    ...
    private boolean g(MotionEvent motionEvent) throws RemoteException {
        try {
            C4479ar c4479ar = this.X;
            if (c4479ar != null && c4479ar.a(motionEvent)) {
                List<AMap.OnInfoWindowClickListener> list = this.R;
                if (list != null && list.size() > 0) {
                    BaseOverlayImp d = this.b.d();
                    if (!d.isVisible() && d.isInfoWindowEnable()) {
                        return true;
                    }
                    Marker marker = new Marker((cu) d);
    ...
    public void c(final int i, final boolean z) {
        if (this.bc && this.bd) {
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.18
                ...
                public void run() {
                    try {
                        if (z) {
                            C4491c.this.g.setBuildingTextureEnable(i, true);
                        } else {
                            C4491c.this.g.setBuildingTextureEnable(i, false);
                        }
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
        ...
        AbstractRunnableC4492a abstractRunnableC4492a = this.bB;
        abstractRunnableC4492a.c = z;
        abstractRunnableC4492a.b = true;
        abstractRunnableC4492a.g = i;
    }

    private void b(boolean z) {
        jp jpVar = this.bD;
        if (jpVar != null) {
            Object a = jpVar.a("getAbroadEnable");
            if (a != null && (a instanceof Boolean)) {
                MapConfig mapConfig = this.c;
                if (mapConfig != null) {
                    mapConfig.setAbroadEnable(z && ((Boolean) a).booleanValue());
                }
                if (z && ((Boolean) a).booleanValue()) {
                    MapsInitializer.setSupportRecycleView(false);
                }
            }
            Object a2 = this.bD.a("getLogoEnable");
            if (a2 != null && (a2 instanceof Boolean)) {
                this.ae.a(((Boolean) a2).booleanValue());
            }
            Object a3 = this.bD.a("getMapZindex");
            if (a2 == null || !(a2 instanceof Integer)) {
                return;
            }
            this.aJ = ((Integer) a3).intValue();
        }
    }
    ...
    public void f(final int i) {
        queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.15
            ...
            public void run() {
                try {
                    C4491c.this.g.clearAllMessages(i);
                    C4491c.this.g.clearAnimations(i, true);
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
    ...
    private boolean e(MotionEvent motionEvent) throws RemoteException {
        ...
        if (this.b.b(motionEvent)) {
            ...
            try {
                ...
                showInfoWindow((cu) d);
                if (!d.isViewMode() && (realPosition = d.getRealPosition()) != null) {
                    IPoint obtain = IPoint.obtain();
    ...
    */
    public void g(int r15) {
        ...
        L88:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4491c.g(int):void");
    }
            ...
            public void run() {
                try {
                    ...
                    if (mapConfig != null && mapConfig.isTouchPoiEnable()) {
                        poi = C4491c.this.b((int) motionEvent.getX(), (int) motionEvent.getY(), 25);
                    }
                    if (C4491c.this.P == null || C4491c.this.P.size() <= 0 || poi == null) {
                        C4491c.this.c(motionEvent);
                        return;
                    }
                    obtain.what = 20;
                    obtain.obj = poi;
    ...
    public void b(final int i) {
        queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.13
            ...
            public void run() {
                GLMapEngine gLMapEngine;
                if (!C4491c.this.bc || (gLMapEngine = C4491c.this.g) == null) {
                    return;
                }
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.17
                ...
                public void run() {
                    ...
                    if (gLMapEngine != null) {
                        ...
                        C4491c.this.g.setSimple3DEnable(i, false);
                    }
                }
            });
            return;
    ...
    */
    public void a() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4491c.a():void");
    }
    ...
    public synchronized void a(final int i, final int i2, final int i3, final int i4, final boolean z, final boolean z2, final StyleItem[] styleItemArr) {
        if (this.bd && this.bc && this.a) {
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.14
                ...
                public void run() {
                    try {
                        C4491c.this.g.setMapModeAndStyle(i, i2, i3, i4, z, z2, styleItemArr);
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
                }
            ...
            AbstractRunnableC4492a abstractRunnableC4492a = this.bs;
            abstractRunnableC4492a.g = i;
            abstractRunnableC4492a.d = i2;
            abstractRunnableC4492a.e = i3;
            abstractRunnableC4492a.f = i4;
            abstractRunnableC4492a.b = true;
        }
    }
    ...
    public void a(final int i, final boolean z) {
        if (this.bc && this.bd) {
            ...
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.c.16
                ...
                public void run() {
                    try {
                        C4491c.this.g.setBuildingEnable(i, z);
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
                }
        ...
        AbstractRunnableC4492a abstractRunnableC4492a = this.bu;
        abstractRunnableC4492a.c = z;
        abstractRunnableC4492a.b = true;
        abstractRunnableC4492a.g = i;
    }
    ...
    @Override // com.amap.api.mapcore.util.C4480b.InterfaceC4481a
    ...
    @Override // com.amap.api.mapcore.util.di.InterfaceC4516a
