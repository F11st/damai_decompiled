...
public class C4480b implements dg.InterfaceC4514a {
    ...
    public C4480b(IAMapDelegate iAMapDelegate, Context context, boolean z) {
        this.n = false;
        this.o = false;
        this.x = false;
    ...
    private void b(byte[] bArr) {
        ...
        try {
            ...
            this.y.setSmoothColor(a2);
            this.y.setSlowColor(a3);
            this.y.setCongestedColor(a4);
            this.y.setSeriousCongestedColor(a5);
    ...
    @Override // com.amap.api.mapcore.util.dg.InterfaceC4514a
                ...
                if (iAMapDelegate != null && (mapConfig = iAMapDelegate.getMapConfig()) != null && mapConfig.isProFunctionAuthEnable()) {
                    ...
                    if (i == 1) {
                        ...
                        if (uncompressToByteWithKeys != null) {
                            ...
                            if (bArr3 != null && (interfaceC4481a = this.z) != null) {
                                interfaceC4481a.a(bArr3);
                            }
                        }
                    }
                }
    ...
    public void a(InterfaceC4481a interfaceC4481a) {
        this.z = interfaceC4481a;
    }
}
