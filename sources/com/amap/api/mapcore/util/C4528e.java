...
public class C4528e extends GLSurfaceView implements IGLSurfaceView {
    protected boolean a;
    private IAMapDelegate b;
    private GLMapRender c;

    public C4528e(Context context, boolean z) {
        this(context, null, z);
    }
    ...
    public void onPause() {
        if (!this.c.mSurfacedestoryed) {
            queueEvent(new Runnable() { // from class: com.amap.api.mapcore.util.e.1
                ...
                public void run() {
                    if (C4528e.this.c != null) {
                        try {
                            C4528e.this.c.onSurfaceDestory();
                        } catch (Throwable th) {
                            th.printStackTrace();
                            eq.a(th);
                        }
    ...
    public C4528e(Context context, AttributeSet attributeSet, boolean z) {
        super(context, attributeSet);
        this.b = null;
        this.c = null;
        this.a = false;
        dy.a(this, 5, 6, 5, 0, 16, 8);
        this.b = new C4491c(this, context, attributeSet, z);
    }
