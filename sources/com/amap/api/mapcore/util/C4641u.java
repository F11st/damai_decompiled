...
public final class C4641u {
    IAMapDelegate a;
    public C4505de.C4509d c;
    private IPoint k;
    ...
    private List<C4645x> g = new ArrayList();
    private List<IOverlayImageDelegate> h = new ArrayList();
    private C4642a i = new C4642a();
    ...
    /* loaded from: classes10.dex */
    public static class C4642a implements Serializable, Comparator<Object> {
        C4642a() {
        }
    ...
    public C4641u(Context context, IAMapDelegate iAMapDelegate) {
    ...
    private void k() {
        ...
        this.c = (C4505de.C4509d) iAMapDelegate.getGLShader(1);
    }
    ...
    public void h() {
        synchronized (this.g) {
            ...
            for (int i = 0; i < this.g.size(); i++) {
                C4645x c4645x = this.g.get(i);
                if (c4645x != null) {
                    c4645x.n();
                    if (c4645x.o() <= 0) {
                        if (c4645x.k() == baseOverlayTextureID) {
                            this.n.a(c4645x.p());
                        } else {
                            this.s[0] = c4645x.k();
            ...
            if (arrayList.size() == 1 && (markerOptions = arrayList.get(0)) != null) {
                ...
                if (z && arrayList2.size() > 0) {
                    this.a.getMainHandler().postDelayed(new Runnable() { // from class: com.amap.api.mapcore.util.u.1
                        ...
                        public void run() {
                            try {
                                C4641u.this.a.moveCamera(ah.a(builder.build(), 50));
    ...
    public boolean b(MotionEvent motionEvent) throws RemoteException {
        ...
        synchronized (this.f) {
            ...
            while (true) {
                ...
                if ((iOverlayImageDelegate instanceof cu) && iOverlayImageDelegate.isVisible() && ((cu) iOverlayImageDelegate).isClickable() && (a = eq.a((rect = iOverlayImageDelegate.getRect()), (int) motionEvent.getX(), (int) motionEvent.getY()))) {
    ...
    */
    public void b(java.lang.String r7) {
        ...
        L72:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4641u.b(java.lang.String):void");
    }
    ...
    public Text a(TextOptions textOptions) throws RemoteException {
        ...
        synchronized (this.f) {
            C4502db c4502db = new C4502db(textOptions, this);
            d(c4502db);
            text = new Text(c4502db);
        }
        return text;
    }
    ...
    private void a(int i, int i2, int i3, FloatBuffer floatBuffer, MapConfig mapConfig) {
        ...
        C4505de.C4509d c4509d = this.c;
        if (c4509d == null || c4509d.c()) {
            k();
        }
        C4505de.C4509d c4509d2 = this.c;
        if (c4509d2 == null || this.d == 0 || c4509d2.c < 0 || this.e == 0) {
            return;
        }
        c4509d2.a();
    ...
    public synchronized boolean a(Bitmap bitmap, C4645x c4645x) {
        ew.C4537c a = this.n.a(bitmap.getWidth() + 1, bitmap.getHeight() + 1, c4645x.p());
        if (a != null) {
            c4645x.f(a.a / this.n.a());
            c4645x.e(a.b / this.n.b());
            c4645x.g(((a.a + a.c) - 1) / this.n.a());
            c4645x.h(((a.b + a.d) - 1) / this.n.b());
            c4645x.c((a.a + 0.5f) / this.n.a());
            c4645x.d((a.b + 0.5f) / this.n.b());
            c4645x.a((((a.a + a.c) - 1) - 0.5f) / this.n.a());
            c4645x.b((((a.b + a.d) - 1) - 0.5f) / this.n.b());
            c4645x.a(true);
            return true;
        }
        return false;
