...
public class C4637r implements IGlOverlayLayer {
    IAMapDelegate a;
    private C4505de c;
    private int d = 0;
    private List<IOverlayDelegate> e = new Vector(500);
    private List<C4645x> f = new ArrayList();
    ...
    private Runnable j = new Runnable() { // from class: com.amap.api.mapcore.util.r.1
        ...
        public synchronized void run() {
            try {
                synchronized (C4637r.this) {
                    if (C4637r.this.e != null && C4637r.this.e.size() > 0) {
                        Collections.sort(C4637r.this.e, C4637r.this.b);
                    }
                }
            } finally {
            }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.amap.api.mapcore.util.r$a */
    /* loaded from: classes10.dex */
    static class C4638a implements Serializable, Comparator<Object> {
        C4638a() {
        }
    ...
    public C4637r(IAMapDelegate iAMapDelegate) {
    ...
    public C4645x a(BitmapDescriptor bitmapDescriptor) {
        IAMapDelegate iAMapDelegate = this.a;
        if (iAMapDelegate != null) {
