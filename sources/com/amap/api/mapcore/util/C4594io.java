...
/* renamed from: com.amap.api.mapcore.util.io */
/* loaded from: classes10.dex */
public class C4594io {
    public static void a(String str, byte[] bArr, C4593in c4593in) throws IOException, CertificateException, NoSuchAlgorithmException, IllegalBlockSizeException, BadPaddingException, NoSuchPaddingException, InvalidKeyException, InvalidKeySpecException {
        hy hyVar;
        ...
        try {
            ...
            File file = new File(c4593in.a);
            if (!file.exists()) {
                file.mkdirs();
            }
            hyVar = hy.a(file, 1, 1, c4593in.b * c4593in.d);
            try {
                hyVar.a(c4593in.d);
                byte[] b = c4593in.e.b(bArr);
                hy.C4580a b2 = hyVar.b(str);
                outputStream = b2.a(0);
    ...
    */
    public static void a(com.amap.api.mapcore.util.C4593in r9) {
        /*
        ...
        La1:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.amap.api.mapcore.util.C4594io.a(com.amap.api.mapcore.util.in):void");
    }

    private static byte[] a(hy hyVar, C4593in c4593in, List<String> list) {
        String[] list2;
        try {
            File c = hyVar.c();
            if (c != null && c.exists()) {
