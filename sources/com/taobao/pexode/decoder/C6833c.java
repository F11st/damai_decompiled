...
/* renamed from: com.taobao.pexode.decoder.c */
/* loaded from: classes11.dex */
public class C6833c implements Decoder {
    ...
    public boolean isSupported(MimeType mimeType) {
        return a && mimeType != null && mimeType.g(C6838a.GIF);
    }
    ...
    public void prepare(Context context) {
        ...
        String a2 = a();
        boolean z = C6829a.b(a2, 2) && GifImage.nativeLoadedVersionTest() == 2;
        a = z;
