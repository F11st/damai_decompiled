...
public class d implements Decoder {
    ...
    private static void a(RewindableStream rewindableStream, PexodeOptions pexodeOptions) throws PexodeException {
        ...
        if (rewindableStream.getInputType() == 3) {
            ...
            if (!com.taobao.pexode.mimetype.a.WEBP.g(pexodeOptions.outMimeType) || c) {
                return;
            }
    ...
    private static BitmapFactory.Options c(PexodeOptions pexodeOptions) {
        ...
        d(options, (com.taobao.pexode.a.f().b || !pexodeOptions.enableAshmem) ? false : false);
    ...
    public boolean acceptInputType(int i, MimeType mimeType, boolean z) {
        if (Pexode.g && Build.VERSION.SDK_INT == 28 && (com.taobao.pexode.mimetype.a.WEBP_A.g(mimeType) || com.taobao.pexode.mimetype.a.WEBP.g(mimeType))) {
            return i == 1;
            ...
            if (i == 3) {
                ...
                if (com.taobao.pexode.mimetype.a.WEBP.g(mimeType) && !c) {
                    return false;
                }
            }
            return true;
    ...
    */
    public tb.or1 decode(com.taobao.pexode.entity.RewindableStream r13, com.taobao.pexode.PexodeOptions r14, com.taobao.pexode.common.DegradeEventListener r15) throws com.taobao.pexode.exception.PexodeException, java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.pexode.decoder.d.decode(com.taobao.pexode.entity.RewindableStream, com.taobao.pexode.PexodeOptions, com.taobao.pexode.common.DegradeEventListener):tb.or1");
    }
    ...
    public MimeType detectMimeType(byte[] bArr) {
        ...
        MimeType mimeType2 = com.taobao.pexode.mimetype.a.JPEG;
        if (mimeType2.f(bArr)) {
            return mimeType2;
        }
        MimeType mimeType3 = com.taobao.pexode.mimetype.a.PNG;
        if (mimeType3.f(bArr)) {
            return mimeType3;
        }
        MimeType mimeType4 = com.taobao.pexode.mimetype.a.PNG_A;
        if (mimeType4.f(bArr)) {
            return mimeType4;
        }
        if (c) {
            MimeType mimeType5 = com.taobao.pexode.mimetype.a.WEBP_A;
            if (mimeType5.f(bArr)) {
                return mimeType5;
            }
        }
        MimeType mimeType6 = com.taobao.pexode.mimetype.a.BMP;
        if (mimeType6.f(bArr)) {
            return mimeType6;
        }
        if (Pexode.f && Build.VERSION.SDK_INT == 28) {
            MimeType mimeType7 = com.taobao.pexode.mimetype.a.HEIF;
            if (mimeType7.f(bArr)) {
                return mimeType7;
            }
            return null;
    ...
    public boolean isSupported(MimeType mimeType) {
        return mimeType != null && ((b && mimeType.g(com.taobao.pexode.mimetype.a.WEBP)) || mimeType.g(com.taobao.pexode.mimetype.a.JPEG) || mimeType.g(com.taobao.pexode.mimetype.a.PNG) || mimeType.g(com.taobao.pexode.mimetype.a.PNG_A) || ((c && mimeType.g(com.taobao.pexode.mimetype.a.WEBP_A)) || mimeType.g(com.taobao.pexode.mimetype.a.BMP) || (Pexode.f && Build.VERSION.SDK_INT == 28 && mimeType.g(com.taobao.pexode.mimetype.a.HEIF))));
    }
