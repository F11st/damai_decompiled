...
/* renamed from: com.taobao.pexode.decoder.a */
/* loaded from: classes11.dex */
public class C6831a implements Decoder {
    private static boolean a;

    static {
        C6838a.ALL_EXTENSION_TYPES.add(C9025d0.APNG);
        String a2 = a();
        try {
    ...
    public or1 decode(RewindableStream rewindableStream, PexodeOptions pexodeOptions, DegradeEventListener degradeEventListener) throws PexodeException, IOException {
        ...
        if (pexodeOptions.justDecodeBounds) {
            ...
            List<Decoder> g = Pexode.g(C6838a.PNG);
    ...
    public MimeType detectMimeType(byte[] bArr) {
        if (a) {
            MimeType mimeType = C9025d0.APNG;
            if (mimeType.f(bArr)) {
                return mimeType;
            }
            return null;
    ...
    public boolean isSupported(MimeType mimeType) {
        return a && C9025d0.APNG.g(mimeType);
    }
    ...
    public void prepare(Context context) {
        ...
        String a2 = a();
        boolean z = C6829a.b(a2, 1) && APngImage.nativeLoadedVersionTest() == 1;
        a = z;
