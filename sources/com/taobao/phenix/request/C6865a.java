...
/* renamed from: com.taobao.phenix.request.a */
/* loaded from: classes11.dex */
public class C6865a extends a22 {
    private int A;
    private int B;
    private boolean C;
    ...
    public C6865a(String str, ye yeVar, boolean z) {
        super(z);
        this.A = 17;
        this.B = 17;
        this.E = 0;
        C6866b c6866b = new C6866b(str, yeVar);
        this.m = c6866b;
        this.o = new ImageStatistics(c6866b);
        this.k = new ds1(this);
    ...
    public synchronized void i0(String str) {
        ...
        if (!str.equals(this.m.k())) {
            this.m = new C6866b(str, this.m.d());
            this.s = null;
        }
    ...
    public void q0(String str) {
        this.r = new C6866b(str, this.m.d());
    }

    @Override // tb.a22
    public void r(a22 a22Var) {
        C6865a c6865a = (C6865a) a22Var;
        ImageStatistics U = c6865a.U();
        this.o.a(true);
        this.o.b(U.k());
        this.o.v(U.j());
        this.o.A(U.o());
        Map<String, Long> Q = Q();
        for (Map.Entry<String, Long> entry : c6865a.Q().entrySet()) {
