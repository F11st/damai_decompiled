...
public class a extends BaseChainProducer<z40, oe0, com.taobao.phenix.request.a> implements RequestCancelListener<com.taobao.phenix.request.a> {
    public a() {
        super(0, 1);
    }

    private void I(Consumer<z40, com.taobao.phenix.request.a> consumer, boolean z, oe0 oe0Var, DecodeException decodeException) {
        if (z) {
    ...
    */
    public void consumeNewResult(com.taobao.rxm.consume.Consumer<tb.z40, com.taobao.phenix.request.a> r20, boolean r21, tb.oe0 r22) {
        /*
            Method dump skipped, instructions count: 853
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.phenix.decode.a.consumeNewResult(com.taobao.rxm.consume.Consumer, boolean, tb.oe0):void");
    }

    @Override // com.taobao.rxm.request.RequestCancelListener
    /* renamed from: K */
    public void onCancel(com.taobao.phenix.request.a aVar) {
        xt2.n("Phenix", "Decode Cancel.", aVar);
        PexodeOptions O = aVar.O();
        if (O != null) {
            aVar.p0(null);
            xt2.k("Decoder", aVar, "cancelled image decoding, result=%b", Boolean.valueOf(O.requestCancel()));
        }
    }
