...
/* renamed from: com.taobao.phenix.loader.file.b */
/* loaded from: classes11.dex */
public class C6861b extends BaseChainProducer<oe0, oe0, C6865a> {
    private final FileLoader j;

    public C6861b(FileLoader fileLoader) {
        super(1, 0);
        this.j = fileLoader;
    }

    private ne0 H(Consumer<oe0, C6865a> consumer, boolean z, h62 h62Var, String str) throws Exception {
    ...
    @Override // tb.jh
    protected boolean a(Consumer<oe0, C6865a> consumer) {
        String str;
        boolean z;
        C6865a context = consumer.getContext();
        C6866b G = context.G();
