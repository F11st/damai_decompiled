...
/* renamed from: com.taobao.android.dinamicx.n */
/* loaded from: classes11.dex */
public class C6387n extends C6365b {
    DinamicXEngine d;
    DTemplateManager e;

    /* compiled from: Taobao */
    /* renamed from: com.taobao.android.dinamicx.n$a */
    /* loaded from: classes11.dex */
    class C6388a implements DinamicTemplateDownloaderCallback {
        C6388a() {
        }
        ...
        public void onDownloadFinish(rc0 rc0Var) {
            ...
            C6387n c6387n = C6387n.this;
            c6387n.d.l.e(c6387n.r(rc0Var.a), C6387n.this.r(rc0Var.b));
        }
    }

    public C6387n(@NonNull DXEngineConfig dXEngineConfig) {
    ...
    private C6368e o(String str, DXTemplateItem dXTemplateItem, int i, String str2, Map<String, String> map) {
        C6368e c6368e = new C6368e(this.b);
        c6368e.b = dXTemplateItem;
        C6368e.C6369a c6369a = new C6368e.C6369a("Router", str, i);
        c6369a.e = str2;
        c6369a.f = map;
        c6368e.c.add(c6369a);
    ...
    public t00<DXRootView> c(Context context, ViewGroup viewGroup, @NonNull DXTemplateItem dXTemplateItem) {
        try {
            if (!i(dXTemplateItem)) {
                return new t00<>(o("Router_Create_view", dXTemplateItem, C6368e.DXERROR_ROUTER_CREATE_VIEW_EXCEPTION_TEMPLATE_NULL, "template is null ", null));
            }
            if (h(dXTemplateItem)) {
            ...
            if (j == null) {
                t00Var.d(o("Router_Create_view", dXTemplateItem, C6368e.DXERROR_ROUTER_CREATE_VIEW_EXCEPTION_V2_FAIL, "2.0 createView 失败 viewResult == null", null));
                t00Var.f(null);
                return t00Var;
            }
            if (!j.f()) {
                t00Var.d(o("Router_Create_view", dXTemplateItem, C6368e.DXERROR_ROUTER_CREATE_VIEW_EXCEPTION_V2_FAIL, "2.0 createView 失败", j.b().c()));
                if (j.d() == null) {
                    t00Var.f(null);
                    return t00Var;
                }
    ...
    public void d(List<DXTemplateItem> list) {
        try {
            ...
            if (this.e != null && arrayList2.size() > 0) {
                this.e.c(arrayList2, new C6388a());
            }
    ...
    public t00<DXRootView> n(Context context, JSONObject jSONObject, DXRootView dXRootView, int i, int i2, Object obj) {
        ...
        try {
            ...
            try {
                ...
                th = th;
                ry.b(th);
                return new t00<>(o("Router_Render", dXTemplateItem, C6368e.DXERROR_ROUTER_RENDER_VIEW_EXCEPTION_CATCH, ry.a(th), null));
            }
        } catch (Throwable th2) {
            th = th2;
            dXTemplateItem = null;
    ...
    public DinamicTemplate p(DXTemplateItem dXTemplateItem) {
        ...
        try {
            ...
            o("Router_Transform_Template", null, C6368e.DXERROR_ROUTER_TRASFORM_TEMPLATE_TOV2_EXCEPTION, "transformTemplateToV3 error:" + ry.a(th), null);
            return null;
        }
    }
    ...
    public DXTemplateItem q(DinamicTemplate dinamicTemplate) {
        ...
        try {
            ...
            o("Router_Transform_Template", null, C6368e.DXERROR_ROUTER_TRASFORM_TEMPLATE_TOV3_EXCEPTION, "transformTemplateToV3 error:" + ry.a(th), hashMap);
            return null;
        }
    }
