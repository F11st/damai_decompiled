...
/* renamed from: com.taobao.android.dinamicx.eventchain.a */
/* loaded from: classes12.dex */
public class C6371a {
    private WeakReference<View> a;
    private WeakReference<DXRuntimeContext> b;
    private WeakReference<C9586q> c;
    private WeakReference<C6372b> d;
    private my e;
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public C9192h d() {
        WeakReference<C6372b> weakReference = this.d;
    ...
    public C9586q e() {
        WeakReference<C9586q> weakReference = this.c;
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void w(C9586q c9586q) {
        this.c = new WeakReference<>(c9586q);
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public void z(C6372b c6372b) {
        this.d = new WeakReference<>(c6372b);
    }
}
