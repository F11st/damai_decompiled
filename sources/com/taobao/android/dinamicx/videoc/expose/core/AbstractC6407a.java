...
/* renamed from: com.taobao.android.dinamicx.videoc.expose.core.a */
/* loaded from: classes11.dex */
public abstract class AbstractC6407a<ExposeKey, ExposeData> implements IExposureEngine<ExposeKey, ExposeData> {
    protected final IExposureZoneRunner<ExposeKey, ExposeData> a;

    /* compiled from: Taobao */
    /* renamed from: com.taobao.android.dinamicx.videoc.expose.core.a$a */
    /* loaded from: classes12.dex */
    public static abstract class AbstractC6408a<ExposeKey, ExposeData, CacheDataType> {
        ...
        public AbstractC6408a(@NonNull IExposureZone.Builder<ExposeKey, ExposeData> builder, @Nullable IExposureCenter<ExposeKey, ExposeData, CacheDataType> iExposureCenter) {
            this.a = builder;
        ...
        public AbstractC6408a<ExposeKey, ExposeData, CacheDataType> c(@NonNull IExposure<ExposeKey, ExposeData> iExposure, @Nullable String str) {
            this.b.add(new Pair<>(iExposure, str));
            return this;
        }

        public AbstractC6408a<ExposeKey, ExposeData, CacheDataType> d(@NonNull ExposureLifecycle<ExposeKey, ExposeData> exposureLifecycle, long j, @Nullable String str) {
    ...
    public AbstractC6407a(IExposureZoneRunner<ExposeKey, ExposeData> iExposureZoneRunner) {
