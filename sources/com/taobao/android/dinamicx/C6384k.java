...
/* renamed from: com.taobao.android.dinamicx.k */
/* loaded from: classes11.dex */
public class C6384k extends DXRenderPipelineBase {
    private final boolean f;

    public C6384k(@NonNull C6367d c6367d, int i, String str) {
        this(c6367d, i, str, false);
    }
    ...
    public View g(DXWidgetNode dXWidgetNode, DXWidgetNode dXWidgetNode2, View view, DXRuntimeContext dXRuntimeContext, int i, int i2, int i3, int i4, int i5) {
        return h(dXWidgetNode, dXWidgetNode2, view, dXRuntimeContext, new DXRenderOptions.C6359b().l(i).s(i2).u(i3).m(i4).k());
    }
    ...
    public C6384k(@NonNull C6367d c6367d, int i, String str, boolean z) {
        super(c6367d, i, str);
        d(new C6383j());
        this.f = z;
    }
