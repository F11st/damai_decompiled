...
public class a extends b {
    ...
    public a(@NonNull d dVar) {
        ...
        this.d = -1;
        try {
            this.k = new HandlerC0287a(this, y00.c().getLooper());
        } catch (Throwable th) {
            this.k = new HandlerC0287a(this, Looper.getMainLooper());
    ...
    public void h(@NonNull List<DXRuntimeContext> list, @NonNull DXRenderOptions dXRenderOptions, @NonNull DXTemplateManager dXTemplateManager, @NonNull h hVar, @NonNull bu buVar, @Nullable DXBatchAsyncRenderCallback dXBatchAsyncRenderCallback, boolean z) {
        DXBatchRenderWorkTask dXBatchPreRenderWorkTask;
        if (dXRenderOptions.e() == 1) {
            dXBatchPreRenderWorkTask = new DXBatchPrefetchWorkTask(dXTemplateManager, hVar, buVar, dXRenderOptions, list, dXBatchAsyncRenderCallback, z);
        } else {
            dXBatchPreRenderWorkTask = dXRenderOptions.e() == 2 ? new DXBatchPreRenderWorkTask(dXTemplateManager, hVar, buVar, dXRenderOptions, list, dXBatchAsyncRenderCallback, z) : null;
        }
    ...
    public void s(DXRuntimeContext dXRuntimeContext, DXRenderOptions dXRenderOptions, DXTemplateManager dXTemplateManager, h hVar, bu buVar) {
        y00.h(new DXPriorityRunnable(0, new DXPreRenderWorkTask(dXRuntimeContext, dXRenderOptions, dXTemplateManager, hVar, this.c, buVar)));
    }

    public void u(DXRuntimeContext dXRuntimeContext, DXRenderOptions dXRenderOptions, DXTemplateManager dXTemplateManager, h hVar, bu buVar) {
        if (this.h == null) {
        ...
        DXPrefetchTask dXPrefetchTask = new DXPrefetchTask(dXRuntimeContext, dXRenderOptions, dXTemplateManager, hVar, this.c, buVar);
        y00.i(new DXPriorityRunnable(2, dXPrefetchTask));
