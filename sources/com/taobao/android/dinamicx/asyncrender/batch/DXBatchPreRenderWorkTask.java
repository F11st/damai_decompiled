...
public class DXBatchPreRenderWorkTask extends DXBatchRenderWorkTask<t00<DXRootView>> {
    public DXBatchPreRenderWorkTask(DXTemplateManager dXTemplateManager, C6380h c6380h, bu buVar, @Nullable DXRenderOptions dXRenderOptions, @NonNull List<DXRuntimeContext> list, @Nullable DXBatchAsyncRenderCallback dXBatchAsyncRenderCallback, boolean z) {
