...
/* renamed from: com.taobao.android.dinamicx.template.download.b */
    ...
    */
    private static byte[] e(java.lang.String r7) throws java.io.IOException {
        ...
        L5f:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.dinamicx.template.download.C6399b.e(java.lang.String):byte[]");
    }
    ...
    public static boolean g(DXTemplateItem dXTemplateItem, byte[] bArr, String str, IDXUnzipCallback iDXUnzipCallback, @NonNull C6368e c6368e) {
        boolean z;
        if (dXTemplateItem != null && bArr != null && iDXUnzipCallback != null && !TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                loop0: while (true) {
                    ...
                    C6368e.C6369a c6369a = new C6368e.C6369a("Downloader", "Downloader_download", 60001);
                    c6369a.e = ry.a(th);
                    c6368e.c.add(c6369a);
                }
                ...
                hashMap.clear();
                C6368e.C6369a c6369a2 = new C6368e.C6369a("Downloader", "Downloader_download", 60001);
                c6369a2.e = ry.a(th3);
                c6368e.c.add(c6369a2);
                z = false;
            }
            if (z) {
                ...
                if (dXTemplatePackageInfo2 != null && !TextUtils.isEmpty(dXTemplatePackageInfo2.mainFilePath)) {
                    ...
                    C6368e.C6369a c6369a3 = new C6368e.C6369a("Downloader", "Downloader_download", 60001);
                    c6369a3.e = "模板zip中缺少main.dx";
                    c6368e.c.add(c6369a3);
                    return false;
                }
            }
            return z;
        }
        c6368e.c.add(new C6368e.C6369a("Downloader", "Downloader_download", 60002));
        return false;
    }
    ...
    */
    public static boolean h(java.lang.String r5, byte[] r6) {
        ...
        L6a:
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.dinamicx.template.download.C6399b.h(java.lang.String, byte[]):boolean");
    }
}
