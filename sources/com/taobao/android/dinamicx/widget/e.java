...
public class e extends d {
    ...
    */
    private void k(boolean r10, int r11, int r12, int r13, int r14) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.taobao.android.dinamicx.widget.e.k(boolean, int, int, int, int):void");
    }
    ...
    public void measureChildWithMargins(DXWidgetNode dXWidgetNode, int i, int i2, int i3, int i4) {
        dXWidgetNode.measure(f.getChildMeasureSpec(i, dXWidgetNode.marginLeft + dXWidgetNode.marginRight + i2, dXWidgetNode.layoutWidth), f.getChildMeasureSpec(i3, dXWidgetNode.marginTop + dXWidgetNode.marginBottom + i4, dXWidgetNode.layoutHeight));
    }
