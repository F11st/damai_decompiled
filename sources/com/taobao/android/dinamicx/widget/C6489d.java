...
/* renamed from: com.taobao.android.dinamicx.widget.d */
/* loaded from: classes11.dex */
public class C6489d extends C6493f {
    private final ArrayList<DXWidgetNode> a = new ArrayList<>(1);
    boolean b = false;

    /* compiled from: Taobao */
    /* renamed from: com.taobao.android.dinamicx.widget.d$a */
    /* loaded from: classes11.dex */
    public static class C6490a implements IDXBuilderWidgetNode {
        ...
        for (int i7 = 0; i7 < virtualChildCount; i7++) {
            ...
            if (childAt.getVisibility() != 2) {
                ...
                switch (absoluteGravity) {
                    ...
                    case 4:
                    case 7:
                        i6 = (((((a - d) - measuredHeight) / 2) + d) + childAt.marginTop) - childAt.marginBottom;
                        break;
                    case 2:
                    case 5:
                    case 8:
                        i6 = (a - measuredHeight) - childAt.marginBottom;
                        break;
                    default:
                        i5 = childAt.marginTop;
                        i6 = i5 + d;
        ...
        if (size > 1) {
            for (int i8 = 0; i8 < size; i8++) {
                ...
                if (i9 == -1) {
                    ...
                    childMeasureSpec = C6493f.getChildMeasureSpec(i, this.paddingLeft + this.paddingRight + dXWidgetNode.marginLeft + dXWidgetNode.marginRight, i9);
                }
                ...
                if (i10 == -1) {
                    ...
                    childMeasureSpec2 = C6493f.getChildMeasureSpec(i2, this.paddingTop + this.paddingBottom + dXWidgetNode.marginTop + dXWidgetNode.marginBottom, i10);
                }
