...
/* renamed from: com.taobao.android.dinamicx.widget.b */
/* loaded from: classes11.dex */
public class C6478b extends DXWidgetNode {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.taobao.android.dinamicx.widget.b$a */
    /* loaded from: classes11.dex */
    public class C6479a implements DXNativeCountDownTimerView.OnFinishListener {
        C6479a() {
        }

        @Override // com.taobao.android.dinamicx.view.DXNativeCountDownTimerView.OnFinishListener
        public void onFinish() {
            C6478b.this.postEvent(new hy(-6786364507638278416L));
        }
    }

    /* compiled from: Taobao */
    /* renamed from: com.taobao.android.dinamicx.widget.b$b */
    /* loaded from: classes11.dex */
    public static class C6480b implements IDXBuilderWidgetNode {
    ...
    private void b(DXNativeCountDownTimerView dXNativeCountDownTimerView, int i, int i2, int i3, int i4, double d, int i5, String str) {
        ...
        if (i6 != -1) {
            Typeface a = a(i6);
            colonFirst.setTypeface(a);
            colonSecond.setTypeface(a);
            colonThird.setTypeface(a);
        }
    }
    ...
    private void c(DXNativeCountDownTimerView dXNativeCountDownTimerView, long j, long j2) {
        ...
        if (dXNativeCountDownTimerView.getLastTime() > 0) {
            ...
            dXNativeCountDownTimerView.setOnFinishListener(new C6479a());
            return;
        }
    ...
    private void g(DXNativeCountDownTimerView dXNativeCountDownTimerView, int i, int i2, int i3, int i4, int i5, int i6, double d, int i7, int i8, int i9) {
        ...
        if (i10 != -1) {
            ...
            hour.setTypeface(a);
            milli.setTypeface(a);
            minute.setTypeface(a);
            second.setTypeface(a);
        }
    }
    ...
    public void onClone(DXWidgetNode dXWidgetNode, boolean z) {
        ...
        if (dXWidgetNode instanceof C6478b) {
            C6478b c6478b = (C6478b) dXWidgetNode;
            this.w = c6478b.w;
            this.x = c6478b.x;
            this.b = c6478b.b;
            this.a = c6478b.a;
    ...
    public void onRenderView(Context context, View view) {
        ...
        if (getDXRuntimeContext() != null && getDXRuntimeContext().getEngineContext() != null) {
            long a = getDXRuntimeContext().getEngineContext().a();
            if (this.E && a > 0) {
                this.w = a;
            }
        }
