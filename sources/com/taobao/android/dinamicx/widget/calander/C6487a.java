...
/* renamed from: com.taobao.android.dinamicx.widget.calander.a */
...
public final class C6487a {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Calendar e(int i, C6488b c6488b) {
        Calendar calendar = new Calendar();
        boolean z = true;
        calendar.setYear((((c6488b.v() + i) - 1) / 12) + c6488b.t());
        calendar.setMonth((((i + c6488b.v()) - 1) % 12) + 1);
        if (c6488b.m() != 0) {
            int g = g(calendar.getYear(), calendar.getMonth());
            Calendar calendar2 = c6488b.M;
        ...
        if (!q(calendar, c6488b)) {
            if (t(calendar, c6488b)) {
                calendar = c6488b.s();
            } else {
                calendar = c6488b.o();
            }
        }
        calendar.setCurrentMonth((calendar.getYear() == c6488b.g().getYear() && calendar.getMonth() == c6488b.g().getMonth()) ? false : false);
        calendar.setCurrentDay(calendar.equals(c6488b.g()));
        return calendar;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Calendar m(Calendar calendar, C6488b c6488b) {
        if (q(c6488b.g(), c6488b) && c6488b.m() != 2) {
            return c6488b.a();
        }
        if (q(calendar, c6488b)) {
            return calendar;
        }
        if (c6488b.s().isSameMonth(calendar)) {
            return c6488b.s();
        }
        return c6488b.o();
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static List<Calendar> n(int i, int i2, C6488b c6488b) {
        int g;
        int i3;
        int i4;
        int i5;
        ...
        c6488b.L(i, i2, calendarArr[0], calendarArr[1]);
        return arrayList;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean q(Calendar calendar, C6488b c6488b) {
        return p(calendar, c6488b.t(), c6488b.v(), c6488b.u(), c6488b.p(), c6488b.r(), c6488b.q()) && !o(calendar, c6488b.n());
    }
    ...
    private static boolean t(Calendar calendar, C6488b c6488b) {
        java.util.Calendar calendar2 = java.util.Calendar.getInstance();
        calendar2.set(c6488b.t(), c6488b.v() - 1, c6488b.u(), 12, 0);
        long timeInMillis = calendar2.getTimeInMillis();
        calendar2.set(calendar.getYear(), calendar.getMonth() - 1, calendar.getDay(), 12, 0);
        return calendar2.getTimeInMillis() < timeInMillis;
    }

    static void u(Calendar calendar, C6488b c6488b) {
        HashMap<String, Calendar> c;
        Calendar calendar2;
        if (!q(calendar, c6488b) || (c = c6488b.c()) == null) {
            return;
        }
