...
/* renamed from: com.taobao.android.dinamicx.widget.calander.b */
...
public final class C6488b {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C6488b(Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.o = obtainStyledAttributes.getDimensionPixelSize(R$styleable.CalendarView_week_text_size, C6487a.c(context, 12.0f));
        this.y = (int) obtainStyledAttributes.getDimension(R$styleable.CalendarView_week_bar_height, C6487a.c(context, 40.0f));
        this.n = (int) obtainStyledAttributes.getDimension(R$styleable.CalendarView_week_line_margin, C6487a.c(context, 0.0f));
        ...
        this.v = obtainStyledAttributes.getDimensionPixelSize(R$styleable.CalendarView_day_text_size, C6487a.c(context, 16.0f));
        this.x = (int) obtainStyledAttributes.getDimension(R$styleable.CalendarView_calendar_height, C6487a.c(context, 56.0f));
        if (this.p <= 1900) {
            this.p = 1900;
        }
        if (this.q >= 2099) {
    ...
    private void H() {
        this.z = new Calendar();
        Date date = new Date();
        this.z.setYear(C6487a.d("yyyy", date));
        this.z.setMonth(C6487a.d("MM", date));
        this.z.setDay(C6487a.d("dd", date));
