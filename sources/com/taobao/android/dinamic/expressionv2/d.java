...
public class d extends DinamicASTNode {
    ...
    public Object c() {
        ...
        String str = this.d;
        DinamicDataParser b = str != null ? com.taobao.android.dinamic.expression.parser.a.b(str) : null;
    ...
    public void f(View view) {
        ...
        String str = this.d;
        DinamicEventHandler b = str != null ? com.taobao.android.dinamic.b.b(str) : null;
        if (b != null) {
            try {
