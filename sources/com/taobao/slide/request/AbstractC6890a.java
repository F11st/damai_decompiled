...
/* renamed from: com.taobao.slide.request.a */
/* loaded from: classes11.dex */
public abstract class AbstractC6890a<T> extends AbstractC6891b<T> {
    ...
    public AbstractC6890a(Context context, SlideConfig slideConfig, String str, String str2, String str3) {
    ...
    protected String a() throws Throwable {
        ...
        try {
            ...
            if (responseCode >= 200 && responseCode <= 299) {
                Map<String, List<String>> headFields = c6893d.getHeadFields();
