...
/* renamed from: com.taobao.rxm.schedule.c */
/* loaded from: classes11.dex */
public class C6878c implements ExecutorStateInspector, ScheduledActionListener, ThrottlingScheduler {
    private final Scheduler a;
    private final CentralSchedulerQueue b;
    private int c;
    private int d;

    public C6878c(Scheduler scheduler, int i, int i2, int i3) {
        this.a = scheduler;
        this.c = i;
