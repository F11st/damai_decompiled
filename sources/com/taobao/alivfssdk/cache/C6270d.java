...
/* renamed from: com.taobao.alivfssdk.cache.d */
/* loaded from: classes8.dex */
public class C6270d implements IAVFSCache {
    private final LSDB a;

    private C6270d(LSDB lsdb) {
        this.a = lsdb;
    }
    ...
    public static C6270d e(String str, int i, long j) {
        LSDBConfig lSDBConfig = new LSDBConfig();
        lSDBConfig.setWalSize(i);
        lSDBConfig.setTimeToLive(j);
        return new C6270d(LSDB.open(str, lSDBConfig));
    }
