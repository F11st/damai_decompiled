...
import com.taobao.applink.f.a.InterfaceC6683a;
import java.net.URLDecoder;
import tb.e33;
import tb.uj2;

/* compiled from: Taobao */
/* renamed from: com.taobao.applink.i.a */
/* loaded from: classes12.dex */
public class C6688a extends WebViewClient {
    private WebViewClient a;
    private InterfaceC6683a b = null;

    public C6688a(WebViewClient webViewClient) {
        this.a = webViewClient;
    }

    public InterfaceC6683a a() {
        return this.b;
    }

    public void a(InterfaceC6683a interfaceC6683a) {
        if (interfaceC6683a == null) {
            return;
        }
        this.b = interfaceC6683a;
    }
    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        e33.d(webView);
        e33.b(webView);
        InterfaceC6683a interfaceC6683a = this.b;
        if (interfaceC6683a != null) {
            interfaceC6683a.a(webView);
        }
    }
