...
public class DynamicPagerIndicator extends RelativeLayout implements ViewPager.OnPageChangeListener {
    public static final C5783a Companion = new C5783a(null);
    ...
    /* compiled from: Taobao */
    /* renamed from: com.kcrason.dynamicpagerindicatorlibrary.DynamicPagerIndicator$a */
    /* loaded from: classes10.dex */
    public static final class C5783a {
        private C5783a() {
        }

        public /* synthetic */ C5783a(k50 k50Var) {
            this();
        }
    }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.kcrason.dynamicpagerindicatorlibrary.DynamicPagerIndicator$b */
    /* loaded from: classes10.dex */
    public static final class View$OnClickListenerC5784b implements View.OnClickListener {
        final /* synthetic */ int b;

        View$OnClickListenerC5784b(int i) {
            this.b = i;
        }
    ...
    private final void setTabViewLayoutParams(BasePagerTabView basePagerTabView, int i) {
        ...
        basePagerTabView.setOnClickListener(new View$OnClickListenerC5784b(i));
