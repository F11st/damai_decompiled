...
class C2928r {
    static JsonReader.C2911a a = JsonReader.C2911a.a("k");

    /* JADX INFO: Access modifiers changed from: package-private */
    public static <T> List<u71<T>> a(JsonReader jsonReader, C2821a c2821a, float f, ValueParser<T> valueParser, boolean z) throws IOException {
        ...
        while (jsonReader.j()) {
            if (jsonReader.s(a) != 0) {
                ...
                if (jsonReader.q() == JsonReader.Token.NUMBER) {
                    arrayList.add(C2927q.c(jsonReader, c2821a, f, valueParser, false, z));
                } else {
                    while (jsonReader.j()) {
                        arrayList.add(C2927q.c(jsonReader, c2821a, f, valueParser, true, z));
                    }
                }
                jsonReader.f();
            } else {
