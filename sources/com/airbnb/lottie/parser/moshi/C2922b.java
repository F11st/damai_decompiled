...
public final class C2922b extends JsonReader {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public C2922b(BufferedSource bufferedSource) {
    ...
    */
    private int B(boolean r7) throws java.io.IOException {
        ...
        L88:
            ...
            throw r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.moshi.C2922b.B(boolean):int");
    }
    ...
    */
    private int F() throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.moshi.C2922b.F():int");
    }
    ...
    private int z(String str, JsonReader.C2911a c2911a) {
        int length = c2911a.a.length;
        for (int i = 0; i < length; i++) {
            if (str.equals(c2911a.a[i])) {
                this.j = 0;
                this.c[this.a - 1] = str;
                return i;
            }
    ...
    @Override // com.airbnb.lottie.parser.moshi.JsonReader
    public int s(JsonReader.C2911a c2911a) throws IOException {
        int i = this.j;
        if (i == 0) {
            i = y();
        }
        ...
        if (i == 15) {
            return z(this.m, c2911a);
        }
        int select = this.h.select(c2911a.b);
        if (select != -1) {
            this.j = 0;
            this.c[this.a - 1] = c2911a.a[select];
            return select;
        }
