...
public class C2903h implements ValueParser<DocumentData> {
    public static final C2903h INSTANCE = new C2903h();
    private static final JsonReader.C2911a a = JsonReader.C2911a.a("t", "f", "s", "j", "tr", "lh", "ls", "fc", IRequestConst.SC, "sw", "of");
        ...
        while (jsonReader.j()) {
            switch (jsonReader.s(a)) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    i2 = C2925p.d(jsonReader);
                    break;
                case 8:
                    i3 = C2925p.d(jsonReader);
                    break;
                case 9:
