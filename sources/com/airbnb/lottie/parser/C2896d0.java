...
public class C2896d0 implements ValueParser<jb2> {
    public static final C2896d0 INSTANCE = new C2896d0();
    private static final JsonReader.C2911a a = JsonReader.C2911a.a(AbstractC5658c.a, "v", "i", "o");
    ...
    public jb2 parse(JsonReader jsonReader, float f) throws IOException {
        ...
        while (jsonReader.j()) {
            ...
            if (s == 0) {
                ...
                list = C2925p.f(jsonReader, f);
            } else if (s == 2) {
                list2 = C2925p.f(jsonReader, f);
            } else if (s != 3) {
                jsonReader.t();
                jsonReader.u();
            } else {
                list3 = C2925p.f(jsonReader, f);
            }
        }
        jsonReader.g();
