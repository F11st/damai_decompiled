...
public class g extends com.airbnb.lottie.model.layer.a {
    ...
    private final Map<cp0, List<com.airbnb.lottie.animation.content.c>> E;
    ...
    public g(LottieDrawable lottieDrawable, Layer layer) {
        ...
        this.I = layer.a();
        l createAnimation = layer.q().createAnimation();
    ...
    private void H(cp0 cp0Var, Matrix matrix, float f, DocumentData documentData, Canvas canvas) {
        List<com.airbnb.lottie.animation.content.c> O = O(cp0Var);
    ...
    private void L(String str, DocumentData documentData, Matrix matrix, xo0 xo0Var, Canvas canvas, float f, float f2) {
        ...
        for (int i = 0; i < str.length(); i++) {
            ...
            if (cp0Var != null) {
                ...
                float b2 = ((float) cp0Var.b()) * f2 * aw2.e() * f;
    ...
    */
    private void N(com.airbnb.lottie.model.DocumentData r7, tb.xo0 r8, android.graphics.Matrix r9, android.graphics.Canvas r10) {
        ...
        Ldb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.g.N(com.airbnb.lottie.model.DocumentData, tb.xo0, android.graphics.Matrix, android.graphics.Canvas):void");
    }

    private List<com.airbnb.lottie.animation.content.c> O(cp0 cp0Var) {
        if (this.E.containsKey(cp0Var)) {
            return this.E.get(cp0Var);
        }
        List<lb2> a2 = cp0Var.a();
        int size = a2.size();
