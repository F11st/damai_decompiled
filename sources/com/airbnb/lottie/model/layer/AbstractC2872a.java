...
public abstract class AbstractC2872a implements DrawingContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    private C2848b q;
    @Nullable
    private AbstractC2872a r;
    @Nullable
    private AbstractC2872a s;
    private List<AbstractC2872a> t;
    ...
    /* loaded from: classes9.dex */
    public class C2873a implements BaseKeyframeAnimation.AnimationListener {
        C2873a() {
        }

        @Override // com.airbnb.lottie.animation.keyframe.BaseKeyframeAnimation.AnimationListener
        public void onValueChanged() {
            AbstractC2872a abstractC2872a = AbstractC2872a.this;
            abstractC2872a.C(abstractC2872a.q.p() == 1.0f);
        }
    }
    ...
    public static /* synthetic */ class C2874b {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public AbstractC2872a(LottieDrawable lottieDrawable, Layer layer) {
    ...
    private void D() {
        if (!this.o.c().isEmpty()) {
            C2848b c2848b = new C2848b(this.o.c());
            this.q = c2848b;
            c2848b.l();
            this.q.a(new C2873a());
    ...
    private void i(Canvas canvas, Matrix matrix) {
        ...
        for (int i = 0; i < this.p.b().size(); i++) {
            ...
            int i2 = C2874b.b[mask.a().ordinal()];
            if (i2 != 1) {
                if (i2 == 2) {
                    if (i == 0) {
    ...
    private void l() {
        ...
        for (AbstractC2872a abstractC2872a = this.s; abstractC2872a != null; abstractC2872a = abstractC2872a.s) {
            this.t.add(abstractC2872a);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Nullable
    public static AbstractC2872a o(Layer layer, LottieDrawable lottieDrawable, C2821a c2821a) {
        switch (C2874b.a[layer.d().ordinal()]) {
            case 1:
                return new C2879e(lottieDrawable, layer);
            case 2:
                return new C2875b(lottieDrawable, layer, c2821a.n(layer.k()), c2821a);
            case 3:
                return new C2880f(lottieDrawable, layer);
            case 4:
                return new C2877c(lottieDrawable, layer);
            case 5:
                return new C2878d(lottieDrawable, layer);
            case 6:
                return new C2881g(lottieDrawable, layer);
            default:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void A(@Nullable AbstractC2872a abstractC2872a) {
        this.s = abstractC2872a;
    }
    ...
    public void B(@FloatRange(from = 0.0d, to = 1.0d) float f) {
        ...
        C2848b c2848b = this.q;
        if (c2848b != null) {
            c2848b.m(f / this.o.t());
        }
        AbstractC2872a abstractC2872a = this.r;
        if (abstractC2872a != null) {
            this.r.B(abstractC2872a.o.t() * f);
        }
    ...
    public void getBounds(RectF rectF, Matrix matrix, boolean z) {
        ...
        this.m.set(matrix);
        if (z) {
            List<AbstractC2872a> list = this.t;
            if (list != null) {
                for (int size = list.size() - 1; size >= 0; size--) {
                    this.m.preConcat(this.t.get(size).v.f());
                }
            } else {
                AbstractC2872a abstractC2872a = this.s;
                if (abstractC2872a != null) {
                    this.m.preConcat(abstractC2872a.v.f());
                }
            }
        }
    ...
    public void resolveKeyPath(s71 s71Var, int i, List<s71> list, s71 s71Var2) {
        AbstractC2872a abstractC2872a = this.r;
        if (abstractC2872a != null) {
            s71 a = s71Var2.a(abstractC2872a.getName());
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public void y(@Nullable AbstractC2872a abstractC2872a) {
        this.r = abstractC2872a;
    }
