...
public class C2839k implements DrawingContent, GreedyContent, KeyPathElementContent, PathContent, BaseKeyframeAnimation.AnimationListener {
    private final Matrix a = new Matrix();
    private final Path b = new Path();
    private final LottieDrawable c;
    private final AbstractC2872a d;
    private final String e;
    private final boolean f;
    private final BaseKeyframeAnimation<Float, Float> g;
    private final BaseKeyframeAnimation<Float, Float> h;
    private final C2859m i;
    private C2829c j;

    public C2839k(LottieDrawable lottieDrawable, AbstractC2872a abstractC2872a, t12 t12Var) {
        this.c = lottieDrawable;
        this.d = abstractC2872a;
        this.e = t12Var.b();
        this.f = t12Var.e();
    ...
    public void absorbContent(ListIterator<Content> listIterator) {
        ...
        this.j = new C2829c(this.c, this.d, "Repeater", this.f, arrayList, null);
    }
