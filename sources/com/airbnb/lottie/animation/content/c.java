...
public class c implements DrawingContent, PathContent, BaseKeyframeAnimation.AnimationListener, KeyPathElement {
    ...
    public c(LottieDrawable lottieDrawable, com.airbnb.lottie.model.layer.a aVar, lb2 lb2Var) {
        this(lottieDrawable, aVar, lb2Var.b(), lb2Var.c(), a(lottieDrawable, aVar, lb2Var.a()), b(lb2Var.a()));
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public c(LottieDrawable lottieDrawable, com.airbnb.lottie.model.layer.a aVar, String str, boolean z, List<Content> list, @Nullable u5 u5Var) {
        this.a = new g81();
        this.b = new RectF();
        this.c = new Matrix();
        this.d = new Path();
        ...
        this.h = list;
        if (u5Var != null) {
            com.airbnb.lottie.animation.keyframe.m a = u5Var.a();
            this.k = a;
            a.a(aVar);
            this.k.b(this);
        }
