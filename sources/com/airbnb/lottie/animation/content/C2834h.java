...
public class C2834h implements GreedyContent, PathContent {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.airbnb.lottie.animation.content.h$a */
    /* loaded from: classes17.dex */
    static /* synthetic */ class C2835a {
    ...
    public C2834h(MergePaths mergePaths) {
    ...
    private void b(Path.Op op) {
        ...
        for (int size = this.e.size() - 1; size >= 1; size--) {
            ...
            if (pathContent instanceof C2829c) {
                C2829c c2829c = (C2829c) pathContent;
                List<PathContent> c = c2829c.c();
                for (int size2 = c.size() - 1; size2 >= 0; size2--) {
                    Path path = c.get(size2).getPath();
                    path.transform(c2829c.d());
                    this.b.addPath(path);
                }
            } else {
        ...
        if (pathContent2 instanceof C2829c) {
            C2829c c2829c2 = (C2829c) pathContent2;
            List<PathContent> c2 = c2829c2.c();
            for (int i = 0; i < c2.size(); i++) {
                Path path2 = c2.get(i).getPath();
                path2.transform(c2829c2.d());
    ...
    public Path getPath() {
        ...
        int i = C2835a.a[this.f.a().ordinal()];
        if (i == 1) {
            a();
        } else if (i == 2) {
            b(Path.Op.UNION);
