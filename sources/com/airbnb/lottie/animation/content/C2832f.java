...
public class C2832f implements DrawingContent, KeyPathElementContent, BaseKeyframeAnimation.AnimationListener {
    @NonNull
    ...
    public C2832f(LottieDrawable lottieDrawable, AbstractC2872a abstractC2872a, tu0 tu0Var) {
        Path path = new Path();
        this.f = path;
        this.g = new g81(1);
        this.h = new RectF();
