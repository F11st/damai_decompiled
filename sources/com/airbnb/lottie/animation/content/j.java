...
public class j implements KeyPathElementContent, PathContent, BaseKeyframeAnimation.AnimationListener {
    ...
    public j(LottieDrawable lottieDrawable, com.airbnb.lottie.model.layer.a aVar, oz1 oz1Var) {
        this.c = oz1Var.b();
        this.d = oz1Var.e();
    ...
    public Path getPath() {
        ...
        float p = baseKeyframeAnimation == null ? 0.0f : ((com.airbnb.lottie.animation.keyframe.b) baseKeyframeAnimation).p();
