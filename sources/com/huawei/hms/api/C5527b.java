...
final class C5527b extends HuaweiApiAvailability {
    private static final C5527b b = new C5527b();

    /* compiled from: Taobao */
    /* renamed from: com.huawei.hms.api.b$a */
    /* loaded from: classes10.dex */
    class C5528a implements BusResponseCallback {
        final /* synthetic */ TaskCompletionSource[] a;

        C5528a(C5527b c5527b, TaskCompletionSource[] taskCompletionSourceArr) {
    ...
    public static C5527b getInstance() {
        return b;
    }
    ...
    public PendingIntent b(Context context, int i) {
        ...
        if (a != null) {
            return PendingIntent.getActivity(context, 0, a, ConfigReporter.BIT_GETTER_IMP);
        }
        return null;
    }
    ...
    public Task<Void> getHuaweiServicesReady(Activity activity) {
        ...
        if (resolveErrorIntent != null) {
            ForegroundIntentBuilder.registerResponseCallback(ResolutionDelegate.CALLBACK_METHOD, new C5528a(this, taskCompletionSourceArr));
    ...
    public PendingIntent getErrPendingIntent(Context context, int i, int i2) {
        ...
        Intent a = a(context, i);
        if (a != null) {
            return PendingIntent.getActivity(context, i2, a, ConfigReporter.BIT_GETTER_IMP);
        }
        return null;
    }
