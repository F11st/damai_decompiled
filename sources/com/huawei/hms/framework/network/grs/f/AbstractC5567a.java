...
import com.huawei.hms.framework.network.grs.local.model.C5602c;
import com.huawei.hms.framework.network.grs.local.model.C5603d;
...
public abstract class AbstractC5567a {
    ...
    private Map<String, String> a(List<C5601b> list, GrsBaseInfo grsBaseInfo, String str) {
        ConcurrentHashMap concurrentHashMap = new ConcurrentHashMap(16);
        concurrentHashMap.put("no_route_country", "no-country");
        for (C5601b c5601b : list) {
            if (c5601b.a().contains(grsBaseInfo.getIssueCountry())) {
                concurrentHashMap.put(grsBaseInfo.getIssueCountry(), c5601b.b());
            }
            if (c5601b.a().contains(grsBaseInfo.getRegCountry())) {
                concurrentHashMap.put(grsBaseInfo.getRegCountry(), c5601b.b());
            }
            if (c5601b.a().contains(grsBaseInfo.getSerCountry())) {
                concurrentHashMap.put(grsBaseInfo.getSerCountry(), c5601b.b());
            }
            if (c5601b.a().contains(str)) {
                Logger.v("AbstractLocalManager", "get countryGroupID from geoIp");
                concurrentHashMap.put(str, c5601b.b());
            }
        }
    ...
    public String a(Context context, C5564a c5564a, GrsBaseInfo grsBaseInfo, String str, String str2, boolean z) {
        Map<String, String> a = a(context, c5564a, grsBaseInfo, str, z);
        if (a == null) {
    ...
    */
    public java.util.List<com.huawei.hms.framework.network.grs.local.model.C5601b> a(org.json.JSONArray r13) {
        /*
            r12 = this;
        ...
        Laa:
            ...
            return r13
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.framework.network.grs.f.AbstractC5567a.a(org.json.JSONArray):java.util.List");
    }

    public Map<String, String> a(Context context, C5564a c5564a, GrsBaseInfo grsBaseInfo, String str, boolean z) {
        C5600a c5600a = this.a;
        if (c5600a == null) {
            Logger.w("AbstractLocalManager", "application data is null.");
            return null;
        }
        C5602c a = c5600a.a(str);
        if (a == null) {
            Logger.w("AbstractLocalManager", "service not found in local config{%s}", str);
            return null;
        }
        String b = C5571e.b(context, c5564a, a.b(), grsBaseInfo, z);
        if (b == null) {
            Logger.w("AbstractLocalManager", "country not found by routeby in local config{%s}", a.b());
            return null;
        }
        List<C5601b> a2 = a.a();
        C5603d a3 = a.a(((a2 == null || a2.size() == 0) ? this.c : a(a2, grsBaseInfo, b)).get(b));
        if (a3 == null) {
            return null;
        }
        return a3.a();
    ...
    public void a(Context context, List<String> list) {
        ...
        for (String str : list) {
            if (Pattern.matches("^grs_sdk_global_route_config_[a-zA-Z]+\\.json$", str)) {
                if (g(C5594c.a(GrsApp.getInstance().getBrand("/") + str, context)) == 0) {
    ...
    public void a(GrsBaseInfo grsBaseInfo) {
        ...
        List<C5601b> list = this.b;
        if (list == null || list.isEmpty()) {
            return;
        }
        for (C5601b c5601b : this.b) {
            if (c5601b.a().contains(grsBaseInfo.getIssueCountry())) {
                this.c.put(grsBaseInfo.getIssueCountry(), c5601b.b());
            }
            if (c5601b.a().contains(grsBaseInfo.getRegCountry())) {
                this.c.put(grsBaseInfo.getRegCountry(), c5601b.b());
            }
            if (c5601b.a().contains(grsBaseInfo.getSerCountry())) {
                this.c.put(grsBaseInfo.getSerCountry(), c5601b.b());
            }
        }
        this.b = null;
    }
    ...
    */
    public void b(org.json.JSONArray r15) {
        ...
        Lf6:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.huawei.hms.framework.network.grs.f.AbstractC5567a.b(org.json.JSONArray):void");
    }
