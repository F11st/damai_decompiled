...
public class C5537c {
    ...
    public C5537c(int i, String str, int i2, String str2) {
        this.b = null;
        this.c = "HMS";
        this.d = 0;
        this.j = 0;
    ...
    public <T> C5537c a(T t) {
        this.a.append(t);
        return this;
    }

    public C5537c a(Throwable th) {
        a((C5537c) '\n').a((C5537c) Log.getStackTraceString(th));
        return this;
    }
