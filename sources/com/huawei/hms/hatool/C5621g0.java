...
public class C5621g0 {
    public static long a(Context context, String str, String str2, long j) {
        if (context == null || TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            C5653y.f("hmsSdk", "context is null or spName empty or spkey is empty");
            return j;
        }
    ...
    public static void b(Context context, String str, String str2, String str3) {
        if (context == null || TextUtils.isEmpty(str) || TextUtils.isEmpty(str2)) {
            C5653y.e("hmsSdk", "context is null or spName empty or spkey is empty");
            return;
        }
        SharedPreferences b = b(context, str);
        if (b != null) {
    ...
    public static String c(Context context, String str) {
        ...
        String n = AbstractC5609c.n("_hms_config_tag", "oper");
