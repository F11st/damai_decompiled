...
public class C5750b {
    ...
    public static X509Certificate a(String str) {
        try {
            ...
            String str2 = a;
            C5755g.b(str2, "generateX509FromStr: CertificateException" + e.getMessage());
            return null;
        }
    }
    ...
    public static boolean b(X509Certificate[] x509CertificateArr) {
        ...
        for (X509Certificate x509Certificate : x509CertificateArr) {
            try {
                ...
                e = e;
                C5755g.b(a, "verifyCertificateDate: exception : " + e.getMessage());
                return false;
                ...
                C5755g.b(a, "verifyCertificateDate : exception : " + e3.getMessage());
                return false;
            }
        }
        return true;
            ...
            try {
                ...
                for (X509CRLEntry x509CRLEntry : revokedCertificates) {
                    if (arrayList.contains(x509CRLEntry.getSerialNumber())) {
                        C5755g.b(a, "verify: certificate revoked");
                        return false;
                    }
                }
                return true;
            } catch (Exception e) {
                C5755g.b(a, "verify: revoked verify exception : " + e.getMessage());
                return false;
            }
        }
        return true;
    ...
    public static boolean a(X509Certificate x509Certificate, String str) {
        ...
        C5755g.b(a, "verify: subject name is error");
        return false;
    }
    ...
    public static boolean a(X509Certificate x509Certificate, X509Certificate x509Certificate2) {
        try {
            ...
            C5755g.b(a, "verify: date not right");
            return false;
        } catch (InvalidKeyException e) {
            String str = a;
            C5755g.b(str, "verify: publickey InvalidKeyException " + e.getMessage());
            return false;
        } catch (NoSuchAlgorithmException e2) {
            String str2 = a;
            C5755g.b(str2, "verify: publickey NoSuchAlgorithmException " + e2.getMessage());
            return false;
        } catch (NoSuchProviderException e3) {
            String str3 = a;
            C5755g.b(str3, "verify: publickey NoSuchProviderException " + e3.getMessage());
            return false;
        } catch (SignatureException e4) {
            String str4 = a;
            C5755g.b(str4, "verify: publickey SignatureException " + e4.getMessage());
            return false;
        } catch (CertificateException e5) {
            String str5 = a;
            C5755g.b(str5, "verify: publickey CertificateException " + e5.getMessage());
            return false;
        } catch (Exception e6) {
            String str6 = a;
            C5755g.b(str6, "verify: Exception " + e6.getMessage());
            return false;
        }
    }
        ...
        while (i < x509CertificateArr.length) {
            ...
            if (principal != null) {
                if (issuerDN.equals(principal)) {
                    ...
                    C5755g.b(a, "verify: principalIssuer not match");
                    return false;
                }
            }
            i++;
