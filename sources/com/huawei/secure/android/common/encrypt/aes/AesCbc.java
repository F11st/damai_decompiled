...
public final class AesCbc {
    ...
    private static byte[] a(String str, byte[] bArr, byte[] bArr2) {
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                b.b("CBC", " cbc encrypt data error" + e2.getMessage());
                return new byte[0];
            }
        }
    }
    ...
    public static byte[] d(byte[] bArr) {
        ...
        try {
            ...
            b.b("CBC", "stripCryptHead: exception : " + e2.getMessage());
            str = "";
        }
        if (str.startsWith(a)) {
            if (bArr.length > 9) {
    ...
    private static String b(String str) {
        ...
        try {
            ...
            b.b("CBC", "getIv exception : " + e2.getMessage());
            return "";
        }
    }
    ...
    private static String a(String str, String str2) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
            try {
                ...
                b.b("CBC", "mix exception: " + e2.getMessage());
            }
        }
        return "";
    }
    ...
    private static String a(String str) {
        ...
        try {
            ...
            b.b("CBC", "get encryptword exception : " + e2.getMessage());
            return "";
        }
    }
    ...
    public static String decrypt(String str, byte[] bArr, byte[] bArr2) {
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                b.b("CBC", " cbc decrypt data error" + e2.getMessage());
                return "";
            }
        }
    }
