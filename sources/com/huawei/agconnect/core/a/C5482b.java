...
public class C5482b {
    ...
    /* loaded from: classes10.dex */
    public static class C5483a implements Serializable, Comparator<Map.Entry<String, Integer>> {
        private C5483a() {
        }
    ...
    private List<String> b() {
        ...
        Collections.sort(arrayList2, new C5483a());
    ...
    public List<Service> a() {
        ...
        ArrayList arrayList = new ArrayList();
        for (String str : b) {
            ServiceRegistrar a = a(str);
            if (a != null) {
                a.initialize(this.a);
                List<Service> services = a.getServices(this.a);
                if (services != null) {
