...
/* renamed from: com.youku.opengl.a.e */
/* loaded from: classes13.dex */
public class C8018e {
    public static int a(int i) {
        if (C8013a.b) {
            C8013a.a("YkGLUtils", "makeTextureId() - textureTarget:" + i);
        }
        int[] iArr = new int[1];
        ...
        int i2 = iArr[0];
        if (C8013a.b) {
            C8013a.a("YkGLUtils", "makeTextureId() - texture name:" + i2);
        }
    ...
    public static int a(String str, int i) {
        if (C8013a.b) {
            C8013a.a("YkGLUtils", "loadShader() - strSource:\n" + str + "\ntype:" + i);
        }
        int[] iArr = new int[1];
        ...
        if (iArr[0] == 0) {
            C8013a.b("YkGLUtils", "loadShader() - failed, error:" + GLES20.glGetShaderInfoLog(glCreateShader));
    ...
    public static void a(String str) {
        ...
        if (glGetError != 0) {
            C8013a.c("YkGLUtils", str + ": glGetError: 0x" + Integer.toHexString(glGetError));
            new Throwable().printStackTrace();
        }
        if (Build.VERSION.SDK_INT < 17 || (eglGetError = EGL14.eglGetError()) == 12288) {
            return;
        }
        C8013a.c("YkGLUtils", str + ": eglGetError: 0x" + Integer.toHexString(eglGetError));
        new Throwable().printStackTrace();
    }
