...
import com.youku.opengl.a.C8017d;
...
/* renamed from: com.youku.opengl.filter.f */
/* loaded from: classes3.dex */
public class C8024f extends C8020b {
    private static final float[] d = {-1.0f, -1.0f, 1.0f, -1.0f, -1.0f, 1.0f, 1.0f, 1.0f};
    private static final float[] e = C8016c.a;
    private int f = -1;
    private Bitmap g;
    private String h;
    private String i;
    ...
    private void a(float f, float f2, float f3, float f4) {
        if (C8013a.b) {
            String str = this.a;
            C8013a.a(str, "setRenderArea() - x:" + f + " y:" + f2 + " width:" + f3 + " height:" + f4);
        }
        this.k = C8018e.a(f, f2, f3, f4);
        if (C8013a.b) {
            String str2 = this.a;
            C8013a.a(str2, "setRenderArea() - new cube:" + C8018e.a("cube:", this.k, 2));
        }
    ...
    public void a(float f, float f2) {
        if (C8013a.b) {
            String str = this.a;
            C8013a.a(str, "setStartPoint() - x:" + f + " y:" + f2);
        }
        this.p = f;
        this.q = f2;
    }
    ...
    public void a(int i, FloatBuffer floatBuffer, FloatBuffer floatBuffer2) {
        ...
        C8013a.a(this.a, "onDraw() - begin");
        String m = m();
        if (TextUtils.isEmpty(m)) {
            C8013a.b(this.a, "onDraw() - no text");
            return;
        }
        if (TextUtils.isEmpty(this.i) || !this.i.equals(m)) {
            Bitmap a = C8017d.a(this.g, m, this.n, this.o);
            this.g = a;
            this.f = C8018e.a(a, this.f, false);
