...
public final class ColorStrategyTokenManager extends StrategyTokenManager<Integer> {
    ...
    @NotNull
    private static final Lazy<ColorStrategyTokenManager> instance$delegate;

    /* compiled from: Taobao */
    @Metadata(bv = {1, 0, 3}, d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\n\u0002\u0010\b\n\u0002\b\u0005\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u000b\u0010\fR\u001d\u0010\u0007\u001a\u00020\u00028F@\u0006X\u0086\u0084\u0002¢\u0006\f\n\u0004\b\u0003\u0010\u0004\u001a\u0004\b\u0005\u0010\u0006R\u0016\u0010\t\u001a\u00020\b8\u0002@\u0002X\u0082T¢\u0006\u0006\n\u0004\b\t\u0010\n¨\u0006\r"}, d2 = {"Lcom/youku/arch/v3/token/ColorStrategyTokenManager$Companion;", "", "Lcom/youku/arch/v3/token/ColorStrategyTokenManager;", "instance$delegate", "Lkotlin/Lazy;", "getInstance", "()Lcom/youku/arch/v3/token/ColorStrategyTokenManager;", "instance", "", "NOT_SUPPORT", "I", "<init>", "()V", "konearch_release"}, k = 1, mv = {1, 5, 1})
    /* loaded from: classes2.dex */
    public static final class Companion {
        ...
        public final ColorStrategyTokenManager getInstance() {
            ...
            return AndroidInstantRuntime.support(ipChange, "-266091619") ? (ColorStrategyTokenManager) ipChange.ipc$dispatch("-266091619", new Object[]{this}) : (ColorStrategyTokenManager) ColorStrategyTokenManager.instance$delegate.getValue();
        }
    }

    static {
        Lazy<ColorStrategyTokenManager> a;
        a = C8177b.a(LazyThreadSafetyMode.SYNCHRONIZED, new Function0<ColorStrategyTokenManager>() { // from class: com.youku.arch.v3.token.ColorStrategyTokenManager$Companion$instance$2
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public final ColorStrategyTokenManager invoke() {
                IpChange ipChange = $ipChange;
                return AndroidInstantRuntime.support(ipChange, "1579722879") ? (ColorStrategyTokenManager) ipChange.ipc$dispatch("1579722879", new Object[]{this}) : new ColorStrategyTokenManager();
            }
        });
        instance$delegate = a;
    }
    ...
    public Integer parseTokenRaw(@NotNull Context context, @NotNull StrategyTokenJavaBean strategyTokenJavaBean) {
        ...
        IpChange ipChange = $ipChange;
        int i = 0;
        if (AndroidInstantRuntime.support(ipChange, "-1464530577")) {
            return (Integer) ipChange.ipc$dispatch("-1464530577", new Object[]{this, context, strategyTokenJavaBean});
        }
