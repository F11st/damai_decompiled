...
public final class OpacityStrategyTokenManager extends StrategyTokenManager<Double> {
    ...
    public static final class Companion {
        ...
        public final OpacityStrategyTokenManager getInstance() {
            ...
            return AndroidInstantRuntime.support(ipChange, "1949233037") ? (OpacityStrategyTokenManager) ipChange.ipc$dispatch("1949233037", new Object[]{this}) : (OpacityStrategyTokenManager) OpacityStrategyTokenManager.instance$delegate.getValue();
        }
    }

    static {
        Lazy<OpacityStrategyTokenManager> a;
        a = C8177b.a(LazyThreadSafetyMode.SYNCHRONIZED, new Function0<OpacityStrategyTokenManager>() { // from class: com.youku.arch.v3.token.OpacityStrategyTokenManager$Companion$instance$2
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public final OpacityStrategyTokenManager invoke() {
                IpChange ipChange = $ipChange;
                return AndroidInstantRuntime.support(ipChange, "842060271") ? (OpacityStrategyTokenManager) ipChange.ipc$dispatch("842060271", new Object[]{this}) : new OpacityStrategyTokenManager();
            }
        });
        instance$delegate = a;
    }
