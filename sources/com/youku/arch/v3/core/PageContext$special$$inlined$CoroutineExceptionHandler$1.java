...
public final class PageContext$special$$inlined$CoroutineExceptionHandler$1 extends n1 implements CoroutineExceptionHandler {
    private static transient /* synthetic */ IpChange $ipChange;

    public PageContext$special$$inlined$CoroutineExceptionHandler$1(CoroutineContext.Key key) {
        super(key);
    }
    ...
    public void handleException(@NotNull CoroutineContext coroutineContext, @NotNull Throwable th) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1485021454")) {
            ipChange.ipc$dispatch("-1485021454", new Object[]{this, coroutineContext, th});
        } else {
