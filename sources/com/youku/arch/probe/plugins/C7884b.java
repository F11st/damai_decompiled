...
import com.youku.arch.probe.b.C7880b;
import com.youku.arch.probe.plugins.BasePlugin;
import com.youku.network.c.C7985a;
import java.io.File;
...
/* renamed from: com.youku.arch.probe.plugins.b */
/* loaded from: classes2.dex */
public class C7884b extends BasePlugin implements C7985a.InterfaceC7986a {
    ...
    int i;
    private List<C7880b> j;
    private volatile C7880b k;
    ...
    /* compiled from: Taobao */
    /* renamed from: com.youku.arch.probe.plugins.b$a */
    /* loaded from: classes2.dex */
    public class C7885a {
        public String a;
        public String b;
    ...
    private void a(C7880b c7880b, String str) {
        int i;
        String[] split;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "753542253")) {
            ipChange.ipc$dispatch("753542253", new Object[]{this, c7880b, str});
            ...
            if (split2.length > 0) {
                ...
                if (arrayList.size() > 0) {
                    c7880b.b = ((Long) arrayList.get(arrayList.size() / 2)).longValue();
                }
                if (arrayList2.size() > 0) {
                    c7880b.c = ((Long) arrayList2.get(arrayList2.size() / 2)).longValue();
                }
                if (arrayList3.size() > 0) {
                    i = 1;
                    c7880b.d = ((Long) arrayList3.get(arrayList3.size() - 1)).longValue();
                } else {
                    i = 1;
                }
                if (arrayList4.size() > 0) {
                    c7880b.e = ((Long) arrayList4.get(arrayList4.size() - i)).longValue();
                }
            }
        }
    }
    ...
    public C7809a a(C7809a c7809a) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1656040053")) {
            return (C7809a) ipChange.ipc$dispatch("-1656040053", new Object[]{this, c7809a});
        }
        if (c7809a == null) {
            return null;
        }
    ...
    public void a(BasePlugin.NotiType notiType) {
        ...
        if (this.F == 1) {
            ...
            if (this.o > 0) {
                ...
                c7880b.f = j;
                if (j >= C7875c.j && this.p.size() < 6) {
                    this.p.add(Integer.valueOf((int) c7880b.f));
                } else if (!this.p.isEmpty()) {
                    int i2 = 0;
                    for (Integer num2 : this.p) {
                        i2 += num2.intValue();
                    }
                    if (i2 * this.J > C7875c.i) {
        ...
        if (notiType == BasePlugin.NotiType.LOOP && this.I % h == 1) {
            a(c7880b, DnsEngine.getInstance().dumpTcpInfo());
            this.j.add(c7880b);
            this.k = c7880b;
    ...
    public void c() {
        ...
        for (int i6 = 0; i6 < this.j.size(); i6++) {
            if (this.j.get(i6).a > 0) {
                if (this.j.get(i6).a > C7875c.d) {
                    i3++;
                }
                i2++;
            }
            if (this.j.get(i6).b > 0) {
                if (this.j.get(i6).b > C7875c.e) {
                    i5++;
                }
                i4++;
            }
        ...
        if (this.q.size() > 0) {
            ...
            Collections.sort(arrayList);
            if (((Integer) arrayList.get(this.q.size() / 2)).intValue() < C7875c.f) {
                this.g = 1;
            }
        }
    }
    ...
    */
    public double[] d() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.youku.arch.probe.plugins.C7884b.d():double[]");
    }
    ...
    */
    public java.util.Map<java.lang.String, java.lang.Long> f() {
        /*
            r7 = this;
            com.android.alibaba.ip.runtime.IpChange r0 = com.youku.arch.probe.plugins.C7884b.$ipChange
        ...
        Lbe:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.youku.arch.probe.plugins.C7884b.f():java.util.Map");
    }
}
