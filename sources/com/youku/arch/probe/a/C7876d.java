...
/* renamed from: com.youku.arch.probe.a.d */
...
public class C7876d {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.youku.arch.probe.a.d$a */
    /* loaded from: classes2.dex */
    private static class C7877a {
        private static final C7876d a = new C7876d();
    }
    ...
    public static C7876d a() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-435835151") ? (C7876d) ipChange.ipc$dispatch("-435835151", new Object[0]) : C7877a.a;
    }
    ...
    public String a(String str) {
        ...
        if (this.b != null) {
            ...
            rawQuery.close();
            if (i2 > 0) {
                ArrayList<Double> a = a(str, i);
                Collections.sort(a);
                String a2 = C7884b.a(a, 10.0d);
                String a3 = C7884b.a(a, 50.0d);
                String a4 = C7884b.a(a, 90.0d);
                sb2.append(a2);
                sb2.append("/");
                sb2.append(a3);
                sb2.append("/");
    ...
    public boolean a(List<C7884b.C7885a> list) {
        IpChange ipChange = $ipChange;
        ...
        if (this.b != null) {
            SQLiteDatabase sQLiteDatabase = this.b;
            for (C7884b.C7885a c7885a : list) {
                sQLiteDatabase.execSQL("insert into speed_history_table values(?,?,?,?,?,?,?,?,?,?,?)", new Object[]{null, c7885a.a, Long.valueOf(c7885a.c), Long.valueOf(c7885a.d), c7885a.b, c7885a.e, c7885a.g, c7885a.h, c7885a.i, c7885a.f, Integer.valueOf(c7885a.j)});
            }
            return true;
        }
        return false;
    ...
    public Map<String, String> b(List<C7884b.C7885a> list) {
        IpChange ipChange = $ipChange;
        ...
        if (this.b != null) {
            for (C7884b.C7885a c7885a : list) {
                ArrayList<Double> a = a(c7885a.a, -1);
                Collections.sort(a);
                String a2 = C7884b.a(a, 10.0d);
                String a3 = C7884b.a(a, 50.0d);
                String a4 = C7884b.a(a, 90.0d);
                hashMap.put(c7885a.a, a2 + "/" + a3 + "/" + a4);
            }
        }
        return hashMap;
    }
    ...
    public boolean e() {
        ...
        if (this.b != null) {
            ...
            sQLiteDatabase.execSQL("delete from speed_history_table where id <((select max(id) from speed_history_table) - " + C7873a.s + jn1.BRACKET_END_STR);
