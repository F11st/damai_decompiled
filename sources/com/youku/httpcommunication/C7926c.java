...
/* renamed from: com.youku.httpcommunication.c */
...
public class C7926c {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.youku.httpcommunication.c$a */
    /* loaded from: classes2.dex */
    public static class C7927a implements Comparator<File> {
        C7927a() {
        }
            ...
            public void run() {
                ...
                OrangeConfig.getInstance().registerListener(new String[]{"arch_common_config"}, new OrangeConfigListenerV1() { // from class: com.youku.httpcommunication.Utils$1.1
                    ...
                    public void onConfigUpdate(String str, boolean z) {
                        ...
                        strArr = C7926c.c;
                        String[] unused2 = C7926c.d = orangeConfig.getConfig("arch_common_config", "accs_whitelist", TextUtils.join(",", strArr)).split(",");
                    }
                });
            }
        }.start();
    ...
    public static void a(File file, File file2) {
        ...
        if (i == 0) {
            ...
            C7924a.b("HttpCommunication.Utils", "cacheData after add file " + e);
        }
        ...
        try {
            Arrays.sort(listFiles, new C7927a());
        } catch (Exception e2) {
            C7924a.a("HttpCommunication.Utils", "NetworkUtils", e2);
        }
    ...
    public static boolean d() {
        ...
        try {
            connectivityManager = (ConnectivityManager) C7925b.a.getSystemService("connectivity");
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        if (connectivityManager == null) {
            C7924a.b("NetWorkState", "Unavailabel");
            return false;
        }
        ...
        if (allNetworkInfo != null) {
            for (NetworkInfo networkInfo : allNetworkInfo) {
                if (networkInfo.getState() == NetworkInfo.State.CONNECTED) {
                    C7924a.b("NetWorkState", "Availabel");
                    return true;
                }
            }
        }
