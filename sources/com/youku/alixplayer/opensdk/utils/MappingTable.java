    ...
    private static final Map<Integer, String> mErrorDetailMap = new HashMap<Integer, String>() { // from class: com.youku.alixplayer.opensdk.utils.MappingTable.1
        {
            ...
            put(Integer.valueOf((int) C6368e.DXError_EngineInitContextNUll), "切换清晰度过程中,发生30010");
            put(Integer.valueOf((int) C6368e.DXERROR_REGISTER_NOTIFICATION_CRASH), "播放前，框架层interface 1阶段超时");
            put(Integer.valueOf((int) C6368e.DXERROR_ENGINE_INIT_EXCEPTION_TIMER_ERROR), "播放前，框架层interface 2阶段超时");
            put(Integer.valueOf((int) C6368e.ENGINE_POST_MSG_CRASH), "播放前，框架层Engine阶段超时");
            put(Integer.valueOf((int) C6368e.DXERROR_ENGINERENDER_TEMPLATE_NULL), "播放前，框架层LoadSource阶段超时");
            put(Integer.valueOf((int) C6368e.DXERROR_ENGINERENDER_INVALID_PARAMS), "播放前，32框架层FFMPEG open阶段超时");
            put(Integer.valueOf((int) C6368e.DXERROR_UNREGISTER_NOTIFICATION_CRASH), "播放前，框架层FFMPEG find stream info阶段超时");
