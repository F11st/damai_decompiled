...
public class YKFollowButtonStyle2 extends FrameLayout {
    ...
    public void changeState() {
        if (this.animate) {
            if (this.clicked) {
                ...
                this.lottieAnimationView.setAnimation(Utils.getCancelFollow2Path(), LottieAnimationView.CacheStrategy.Strong);
                this.lottieAnimationView.playAnimation();
                this.clicked = false;
                return;
            }
            this.lottieAnimationView.setImageAssetsFolder("images");
            this.lottieAnimationView.setAnimation(Utils.getAddFollow2Path(), LottieAnimationView.CacheStrategy.Strong);
            this.lottieAnimationView.playAnimation();
            this.clicked = true;
        } else if (this.clicked) {
            this.lottieAnimationView.setImageResource(R.C8072drawable.yk_button_addfollow2);
            this.clicked = false;
        } else {
            this.lottieAnimationView.setImageResource(R.C8072drawable.yk_button_followed2);
            this.clicked = true;
        }
    }
    ...
    public YKFollowButtonStyle2(@NonNull Context context, @Nullable AttributeSet attributeSet) {
