...
public class Types {
    ...
    public static boolean equals(Type type, Type type2) {
        ...
        if (type instanceof Class) {
            ...
            if (type2 instanceof ParameterizedType) {
                ...
                return equals(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType instanceof ParameterizedTypeImpl ? ((ParameterizedTypeImpl) parameterizedType).typeArguments : parameterizedType.getActualTypeArguments(), parameterizedType2 instanceof ParameterizedTypeImpl ? ((ParameterizedTypeImpl) parameterizedType2).typeArguments : parameterizedType2.getActualTypeArguments());
            }
            return false;
        } else if (type instanceof GenericArrayType) {
            if (type2 instanceof Class) {
    ...
    */
    public static java.lang.reflect.Type resolve(java.lang.reflect.Type r8, java.lang.Class<?> r9, java.lang.reflect.Type r10) {
        ...
        L77:
            if (r0 == 0) goto L83
            com.youku.gaiax.js.support.Types$ParameterizedTypeImpl r8 = new com.youku.gaiax.js.support.Types$ParameterizedTypeImpl
        ...
        La4:
            ...
            if (r0 != r1) goto Lb6
            r0 = r3[r2]
            java.lang.reflect.Type r8 = resolve(r8, r9, r0)     // Catch: java.lang.Throwable -> Lb7
            r9 = r3[r2]
            if (r8 == r9) goto Lb6
        ...
        Lb7:
            ...
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.youku.gaiax.js.support.Types.resolve(java.lang.reflect.Type, java.lang.Class, java.lang.reflect.Type):java.lang.reflect.Type");
    }
