...
public class MotionCurveXDecelerateInterpolator implements Interpolator {
    private float x1;
    private float x2;
    private float y1;
    private float y2;

    public MotionCurveXDecelerateInterpolator() {
        this.x1 = 0.0f;
        this.y1 = 0.0f;
        this.x2 = 0.1f;
        this.y2 = 1.0f;
    ...
    public MotionCurveXDecelerateInterpolator(float f, float f2, float f3, float f4) {
        this.x1 = f;
        this.y1 = f2;
        this.x2 = f3;
        this.y2 = f4;
