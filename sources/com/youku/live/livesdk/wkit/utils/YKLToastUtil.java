...
public class YKLToastUtil {
    ...
    public static void cancelToast() {
        ...
        new Handler(mainLooper).post(new Runnable() { // from class: com.youku.live.livesdk.wkit.utils.YKLToastUtil.1
            private static transient /* synthetic */ IpChange $ipChange;

            @Override // java.lang.Runnable
            public void run() {
                IpChange ipChange2 = $ipChange;
                if (AndroidInstantRuntime.support(ipChange2, "-1495290672")) {
                    ipChange2.ipc$dispatch("-1495290672", new Object[]{this});
