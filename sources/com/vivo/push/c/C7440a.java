...
public final class C7440a implements InterfaceC7442c {
    private KeyStore a;
    private SecretKey b;
    ...
    private void a() {
        try {
            ...
            e.printStackTrace();
            C7523p.a("AesSecurity", "initKeyStore error" + e.getMessage());
        }
    }
    ...
    private SecretKey b() {
        try {
            ...
            e.printStackTrace();
            C7523p.a("AesSecurity", "getSecretKey error" + e.getMessage());
            return null;
        }
    }
    ...
    private boolean c() {
        try {
            ...
            e.printStackTrace();
            C7523p.a("AesSecurity", "hasAESKey error" + e.getMessage());
            return false;
        }
    }
    ...
    private SecretKey d() {
        try {
            ...
            e.printStackTrace();
            C7523p.a("AesSecurity", "getAESSecretKey error" + e.getMessage());
            return null;
        }
    }
}
