...
final class C7461h extends AbstractC7480z {
    /* JADX INFO: Access modifiers changed from: package-private */
    public C7461h(AbstractC7496o abstractC7496o) {
    ...
    protected final void a(AbstractC7496o abstractC7496o) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            if (arrayList.size() > 0) {
                C7481e.a().b(arrayList);
            }
            C7481e.a().a(c7432t.g(), arrayList3.size() > 0 ? 10000 : h);
            C7492m.b(new RunnableC7462i(this, h, arrayList, arrayList3, g));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            if (arrayList2.size() > 0) {
                C7481e.a().c(arrayList2);
            }
            C7481e.a().a(c7432t.g(), h);
            C7492m.b(new RunnableC7463j(this, h, arrayList2, arrayList4, g));
        }
    }
}
