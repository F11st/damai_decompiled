...
public final class AsyncTaskC7518k extends AsyncTask<String, Void, List<Bitmap>> {
    private Context a;
    private InsideNotificationItem b;
    private long c;
    private boolean d;
    private int e = 0;
    private C7471r.InterfaceC7472a f;

    public AsyncTaskC7518k(Context context, InsideNotificationItem insideNotificationItem, long j, boolean z, C7471r.InterfaceC7472a interfaceC7472a) {
        this.a = context;
        this.b = insideNotificationItem;
        this.c = j;
        this.d = z;
        this.f = interfaceC7472a;
    }
    ...
    protected final /* synthetic */ void onPostExecute(List<Bitmap> list) {
        ...
        C7523p.c("ImageDownTask", "onPostExecute");
        C7492m.c(new RunnableC7519l(this, list2));
    }
    ...
    */
    public java.util.List<android.graphics.Bitmap> doInBackground(java.lang.String... r10) {
        /*
            ...
            com.vivo.push.util.C7523p.d(r2, r10)
            return r1
        L15:
        ...
        L1c:
            ...
            com.vivo.push.util.C7523p.d(r2, r6)
            ...
            com.vivo.push.util.C7523p.c(r2, r7)     // Catch: java.lang.Throwable -> L80 java.io.IOException -> L82 java.net.MalformedURLException -> L8e
        ...
        L83:
            ...
            com.vivo.push.util.C7523p.a(r2, r6)     // Catch: java.lang.Throwable -> L9c
            if (r5 == 0) goto L97
        L8a:
        ...
        Lad:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vivo.push.util.AsyncTaskC7518k.doInBackground(java.lang.String[]):java.util.List");
    }
}
