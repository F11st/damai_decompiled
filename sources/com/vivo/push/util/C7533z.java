...
public final class C7533z {
    ...
    public static long a(Context context) {
        ...
        if (TextUtils.isEmpty(b2)) {
            C7523p.a("Utility", "systemPushPkgName is null");
            return -1L;
        }
        return a(context, b2);
    }
    ...
    public static PublicKey c(Context context) {
        Cursor query = context.getContentResolver().query(C7497p.a, null, null, null, null);
        if (query == null) {
            return null;
        }
        do {
        ...
        C7523p.d("Utility", "result key : ".concat(String.valueOf(string)));
        PublicKey a2 = C7528u.a(string);
        try {
            query.close();
    ...
    public static long a(Context context, String str) {
        ...
        if (a2 != null) {
            try {
                ...
                e2.printStackTrace();
                C7523p.a("Utility", "getSdkVersionCode error ", e2);
                return -1L;
            }
        }
        C7523p.a("Utility", "getSdkVersionCode sdk version is null");
        return -1L;
    }
    ...
    */
    public static void b(android.content.Context r23) throws com.vivo.push.util.VivoPushException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.vivo.push.util.C7533z.b(android.content.Context):void");
    }
                ...
                try {
                    ...
                    if (0 != 0) {
                        try {
                            ...
                            C7523p.a("Utility", "close", e2);
                        }
                    }
                    throw th;
                }
            } catch (Exception e3) {
                C7523p.a("Utility", "isSupport", e3);
                if (0 != 0) {
                    cursor.close();
                }
            }
        } catch (Exception e4) {
            C7523p.a("Utility", "close", e4);
        }
        if (context == null) {
            C7523p.a("Utility", "context is null");
            return false;
        }
        String packageName = context.getPackageName();
        Cursor query = context.getContentResolver().query(C7497p.b, null, "pushVersion = ? and appPkgName = ? and appCode = ? ", new String[]{"323", packageName, String.valueOf(context.getPackageManager().getPackageInfo(packageName, 0).versionCode)}, null);
        if (query == null) {
            C7523p.a("Utility", "cursor is null");
            if (query != null) {
                try {
                    query.close();
                } catch (Exception e5) {
                    C7523p.a("Utility", "close", e5);
                }
            }
            return false;
    ...
    public static Object a(Context context, String str, String str2) {
        ...
        try {
            ...
            try {
                ...
                r0 = obj;
                e = e3;
                C7523p.a("Utility", "getMetaValue::".concat(String.valueOf(e)));
                return r0;
            }
        } catch (Exception e4) {
            e = e4;
    ...
    private static void a(Context context, String str, String str2, boolean z) throws VivoPushException {
        ...
        try {
            ...
            C7523p.a("Utility", "error  " + e2.getMessage());
    ...
    public static boolean b(Context context, String str, String str2) {
        ...
        Cursor query = context.getContentResolver().query(C7497p.c, null, "appPkgName = ? and regId = ? sdkVersion = ? ", new String[]{str, str2, "323"}, null);
        if (query == null) {
            C7523p.a("Utility", "cursor is null");
            if (query != null) {
                try {
    ...
    public static void a(Context context, Intent intent) {
        ...
        if (TextUtils.isEmpty(b2)) {
            C7523p.a("Utility", "illegality abe adapter : push pkg is null");
        } else if (TextUtils.isEmpty(stringExtra)) {
            C7523p.a("Utility", "illegality abe adapter : src pkg is null");
        } else if (b2.equals(context.getPackageName())) {
            C7523p.a("Utility", "illegality abe adapter : abe is not pushservice");
        } else if (!b2.equals(stringExtra)) {
            C7523p.d("Utility", "proxy to core : intent pkg : " + intent.getPackage() + " ; src pkg : " + stringExtra + " ; push pkg : " + b2);
            intent.setPackage(b2);
            intent.setClassName(b2, "com.vivo.push.sdk.service.PushService");
            context.startService(intent);
        } else {
            C7523p.a("Utility", "illegality abe adapter : pushPkg = " + b2 + " ; srcPkg = " + stringExtra);
        }
    }
}
