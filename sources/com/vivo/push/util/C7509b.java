...
public class C7509b {
    ...
    private List<String> c(String str) {
        ...
        String[] split;
        if (this.a == null) {
            C7523p.c("BaseSharePreference", " parsLocalIv error mContext is null ");
            return null;
        }
        ArrayList arrayList = new ArrayList();
        try {
            Context context = this.a;
            a = C7533z.a(context, context.getPackageName(), str);
        } catch (Exception e) {
            C7523p.c("BaseSharePreference", " parsLocalIv error e =" + e.getMessage());
            e.printStackTrace();
        }
        if (a == null) {
            return null;
    ...
    public final void a(Context context, String str) {
        if (!TextUtils.isEmpty(str)) {
            ...
            C7523p.a("BaseSharePreference", " initSecureCode error list is null ");
            return;
        }
