...
public class LoginWebViewClient extends WVUCWebViewClient {
    ...
    public void onReceivedSslError(WebView webView, final SslErrorHandler sslErrorHandler, SslError sslError) {
        ...
        DialogInterface.OnClickListener onClickListener = new DialogInterface.OnClickListener() { // from class: com.ali.user.mobile.ability.webview.LoginWebViewClient.1
        ...
        DialogInterface.OnClickListener onClickListener2 = new DialogInterface.OnClickListener() { // from class: com.ali.user.mobile.ability.webview.LoginWebViewClient.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
    ...
    */
    public boolean shouldOverrideUrlLoading(com.uc.webview.export.WebView r4, java.lang.String r5) {
        ...
        L2b:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ali.user.mobile.ability.webview.LoginWebViewClient.shouldOverrideUrlLoading(com.uc.webview.export.WebView, java.lang.String):boolean");
    }
}
