...
public class C7053a {
    ...
    public static final void a(final Context context, final String str, final InterfaceC7115d interfaceC7115d) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            final Handler handler = new Handler(context.getMainLooper()) { // from class: com.tencent.connect.share.a.1
                ...
                public void handleMessage(Message message) {
                    int i = message.what;
                    if (i == 101) {
                        interfaceC7115d.a(0, (ArrayList) message.obj);
                    } else if (i != 102) {
                        super.handleMessage(message);
                    } else {
                        interfaceC7115d.a(message.arg1, (String) null);
                    }
                }
            };
            new Thread(new Runnable() { // from class: com.tencent.connect.share.a.2
                ...
                public void run() {
                    ...
                    String str3;
                    try {
                        Bitmap a = C7053a.a(str, 840);
                        if (a != null) {
                            File a2 = C7119g.a("Images");
                            String str4 = null;
                            if (a2 != null) {
                            ...
                            String str7 = "share2qq_temp" + C7126m.g(str) + ".jpg";
                            String str8 = str;
                            if (!C7053a.b(str8, 840, 840)) {
                                ...
                                String a3 = C7053a.a(a, str3, str7);
                                if (!TextUtils.isEmpty(a3)) {
                                    str8 = a3;
                                }
                            }
                            boolean m = C7126m.m(str8);
                            ...
                            if (m) {
                                ...
                                boolean a4 = C7126m.a(context, str8, str9);
                            ...
                            if (arrayList.size() >= 2 && (arrayList.get(0) != null || arrayList.get(1) != null)) {
                                SLog.i("openSDK_LOG.AsynScaleCompressImage", "scaleCompressImage() return success ! destFilePath=[" + ((String) arrayList.get(0)) + "," + ((String) arrayList.get(1)) + jn1.ARRAY_END_STR);
    ...
    */
    public static final android.graphics.Bitmap a(java.lang.String r6, int r7) {
        ...
        L69:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.connect.share.C7053a.a(java.lang.String, int):android.graphics.Bitmap");
    }
