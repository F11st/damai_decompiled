...
import com.tencent.open.utils.C7112b;
...
public class C7048c {
    ...
    public int a(Activity activity, IUiListener iUiListener, Map<String, Object> map) {
        ...
        return a(activity, (Fragment) null, C7126m.a(map, Constants.KEY_SCOPE, "all"), iUiListener, "", C7126m.a(map, Constants.KEY_QRCODE, false), map);
    }
    ...
    private int a(Activity activity, Fragment fragment, String str, IUiListener iUiListener, String str2, boolean z, Map<String, Object> map) {
        try {
            String a = C7123k.a(activity);
            if (a != null) {
                String a2 = C7112b.a(new File(a));
