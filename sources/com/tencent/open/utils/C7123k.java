...
public class C7123k {
    private static ConcurrentHashMap<String, C7034a> a = new ConcurrentHashMap<>();
    ...
    public static String b(Context context, String str) {
        ...
        try {
            ...
            String a2 = C7126m.a(messageDigest.digest());
            messageDigest.reset();
            SLog.v("openSDK_LOG.SystemUtils", "-->sign: " + a2);
            messageDigest.update(C7126m.j(packageName + JSMethod.NOT_SET + a2 + JSMethod.NOT_SET + str + ""));
            str2 = C7126m.a(messageDigest.digest());
            messageDigest.reset();
    ...
    private static PackageInfo e(Context context, String str) {
        ...
        synchronized (C7123k.class) {
            if (a.containsKey(str)) {
                C7034a c7034a = a.get(str);
                if (c7034a == null) {
                    SLog.e("openSDK_LOG.SystemUtils", "getTargetPackageInfo wrapper is null");
                    return null;
                }
                PackageInfo packageInfo = c7034a.b;
                if (packageInfo == null) {
    ...
    private static boolean g(Context context, String str) {
        return (C7120h.a(context, c(), str) == null && e(context, str) == null) ? false : true;
    }
    ...
    public static String a(Context context, String str) {
        String a2 = C7120h.a(context, c(), str);
    ...
    public static boolean a(Context context, String str, String str2) {
        ...
        try {
            for (Signature signature : context.getPackageManager().getPackageInfo(str, 64).signatures) {
                if (C7126m.g(signature.toCharsString()).equals(str2)) {
                    return true;
                }
            }
    ...
    public static boolean b(Context context, Intent intent) {
        ...
        if (context != null && C7126m.c(context)) {
    ...
    public static String a(Activity activity, String str) {
        ...
        try {
            ...
            return C7116e.a(activity.getPackageName(), C7116e.a(bArr2), bArr);
        } catch (Exception e) {
    ...
    */
    public static boolean a(java.lang.String r10, java.lang.String r11, int r12) {
        ...
        Lc8:
            throw r11
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.open.utils.C7123k.a(java.lang.String, java.lang.String, int):boolean");
    }
