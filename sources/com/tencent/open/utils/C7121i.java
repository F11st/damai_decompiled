...
public class C7121i {
    private static Map<String, C7121i> a = Collections.synchronizedMap(new HashMap());
    ...
    private C7121i(Context context, String str) {
        this.c = null;
        this.d = null;
    ...
    private void b() {
        ...
        hashMap.put("status_machine", C7117f.a().c(C7119g.a()));
        hashMap.put("status_version", Build.VERSION.SDK);
        hashMap.put("sdkv", Constants.SDK_VERSION);
        hashMap.put("sdkp", "a");
        C7124l.a(new Runnable() { // from class: com.tencent.open.utils.i.1
            @Override // java.lang.Runnable
            public void run() {
                try {
                    InterfaceC7075g a2 = C7074f.a().a("https://cgi.connect.qq.com/qqconnectopen/openapi/policy_conf", hashMap);
                    String a3 = a2.a();
                    SLog.i("openSDK_LOG.OpenConfig", "update: get config statusCode " + a2.d());
                    C7121i.this.a(C7126m.d(a3));
                } catch (Exception e) {
    ...
    public static C7121i a(Context context, String str) {
        C7121i c7121i;
        synchronized (a) {
