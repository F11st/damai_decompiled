...
public class C7069b implements InterfaceC7068a {
    private int a = 15000;
    private int b = 30000;
    private final String c;

    public C7069b(String str) {
        this.c = str;
    }
    ...
    private InterfaceC7075g a(String str, int i) throws IOException {
        ...
        try {
            ...
            try {
                ...
                if (httpURLConnection.getResponseCode() == 200) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (read != -1) {
                                ...
                                C7070c c7070c = new C7070c(httpURLConnection, byteArrayOutputStream.toString(), httpURLConnection.getContentLength(), i, httpURLConnection.getResponseCode(), "");
                    ...
                    C7070c c7070c2 = new C7070c(httpURLConnection, "", httpURLConnection.getContentLength(), i, httpURLConnection.getResponseCode(), responseMessage);
                    a((Closeable) null);
                    a((Closeable) null);
                    b(httpURLConnection);
                    return c7070c2;
    ...
    private InterfaceC7075g a(String str, int i, String str2) throws IOException {
        HttpURLConnection httpURLConnection;
        InputStream inputStream;
        ByteArrayOutputStream byteArrayOutputStream;
        ByteArrayOutputStream byteArrayOutputStream2 = null;
        try {
            ...
            try {
                ...
                if (httpURLConnection.getResponseCode() == 200) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            if (read != -1) {
                                ...
                                C7070c c7070c = new C7070c(httpURLConnection, byteArrayOutputStream.toString(), contentLength, i, httpURLConnection.getResponseCode(), "");
                                a(byteArrayOutputStream);
                                a(inputStream);
                                b(httpURLConnection);
                                return c7070c;
                    ...
                    C7070c c7070c2 = new C7070c(httpURLConnection, "", 0, i, httpURLConnection.getResponseCode(), responseMessage);
                    a((Closeable) null);
                    a((Closeable) null);
                    b(httpURLConnection);
                    return c7070c2;
    ...
    public InterfaceC7075g a(String str, Map<String, String> map, String str2, byte[] bArr) throws IOException {
        ByteArrayOutputStream byteArrayOutputStream;
        ...
        try {
            C7070c c7070c = new C7070c(httpURLConnection, str3, httpURLConnection.getContentLength(), i, httpURLConnection.getResponseCode(), "");
            a(dataOutputStream2);
            a(inputStream2);
            a(byteArrayOutputStream2);
            b(httpURLConnection);
