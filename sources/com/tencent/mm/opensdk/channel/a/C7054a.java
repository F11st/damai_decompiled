...
public class C7054a {
    ...
    public static boolean a(Context context, C7055a c7055a) {
        String str;
        if (context == null || c7055a == null) {
            str = "send fail, invalid argument";
        } else if (!C7065b.b(c7055a.b)) {
            String str2 = null;
            if (!C7065b.b(c7055a.a)) {
                str2 = c7055a.a + ".permission.MM_MESSAGE";
            }
            Intent intent = new Intent(c7055a.b);
            Bundle bundle = c7055a.e;
            if (bundle != null) {
            ...
            intent.putExtra(ConstantsAPI.CONTENT, c7055a.c);
            intent.putExtra(ConstantsAPI.APP_SUPORT_CONTENT_TYPE, c7055a.d);
            intent.putExtra(ConstantsAPI.CHECK_SUM, a(c7055a.c, (int) Build.SDK_INT, packageName));
    ...
    */
    public static byte[] a(java.lang.String r8, int r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.opensdk.channel.a.C7054a.a(java.lang.String, int):byte[]");
    }
