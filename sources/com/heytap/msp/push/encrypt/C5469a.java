...
public class C5469a extends AbstractC5470b {
    ...
    */
    public C5469a(int r5, byte[] r6, boolean r7) {
        /*
            r4 = this;
            r0 = 0
            if (r6 != 0) goto L5
        ...
        L6:
            ...
            r3 = 4
            r4.<init>(r2, r3, r5, r1)
            byte[] r1 = com.heytap.msp.push.encrypt.C5469a.r
            r4.u = r1
            r1 = 0
            if (r6 == 0) goto L48
            boolean r2 = r4.l(r6)
        ...
        L4c:
            ...
            r4.w = r5
            if (r7 == 0) goto L57
            byte[] r5 = com.heytap.msp.push.encrypt.C5469a.q
            goto L59
        L57:
            byte[] r5 = com.heytap.msp.push.encrypt.C5469a.p
        L59:
            r4.t = r5
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.heytap.msp.push.encrypt.C5469a.<init>(int, byte[], boolean):void");
    }

    public C5469a(boolean z) {
        this(76, a, z);
    }
    ...
    public static byte[] a(byte[] bArr, boolean z, boolean z2, int i) {
        ...
        C5469a c5469a = z ? new C5469a(z2) : new C5469a(0, a, z2);
        long m2 = c5469a.m(bArr);
        if (m2 <= i) {
            return c5469a.encode(bArr);
        }
    ...
    public static boolean b(byte[] bArr) {
        for (int i = 0; i < bArr.length; i++) {
            if (!a(bArr[i]) && !AbstractC5470b.c(bArr[i])) {
                return false;
            }
        }
        return true;
    ...
    @Override // com.heytap.msp.push.encrypt.AbstractC5470b
