...
public class a {
    ...
    public static String c() {
        ...
        if (Variables.n().M() && !com.alibaba.analytics.core.config.b.a()) {
    ...
    private static byte[] h(Map<String, String> map) throws Exception {
        ...
        if (map != null && map.size() > 0) {
            ...
            for (String str : map.keySet()) {
                try {
                    try {
                        byteArrayOutputStream.write(com.alibaba.analytics.utils.b.f(Integer.valueOf(str).intValue()));
                        String str2 = map.get(str);
                        if (str2 != null) {
                            for (String str3 : str2.split(e)) {
                                if (!TextUtils.isEmpty(str3) && (i = i(str3)) != null && 34 == i.length) {
                                    for (String str4 : i) {
                                        byteArrayOutputStream2.write(com.alibaba.analytics.utils.b.c(str4));
                                    }
    ...
    private static String j(byte[] bArr, int i) {
        ...
        if (i == 2 || !com.alibaba.analytics.core.config.f.a() || (c2 = ut2.b().c()) == null || c2.isEmpty()) {
            return null;
        }
