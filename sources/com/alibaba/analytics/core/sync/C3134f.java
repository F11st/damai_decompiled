...
/* renamed from: com.alibaba.analytics.core.sync.f */
/* loaded from: classes5.dex */
public class C3134f extends UploadLog {
    private static C3134f o;
    ...
    private Map<String, String> g(List<qa1> list) {
        ...
        if (list != null && list.size() != 0) {
            ...
            for (int i2 = 0; i2 < list.size(); i2++) {
                ...
                } else if (SystemConfigMgr.i().g() && SystemConfigMgr.i().e(C3121a.e(qa1Var.b()))) {
                    list2 = f(list2, qa1Var);
    ...
    private boolean o(List<qa1> list, boolean z) throws Exception {
        ...
        if (g != null && g.size() != 0) {
            if (!Variables.n().J()) {
                if (this.n && z && C3129c.b().d() == 2 && C3129c.b().c() == 0 && vo2.b().c() == 0 && vo2.b().a() > 0) {
