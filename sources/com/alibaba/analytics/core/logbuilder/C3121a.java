...
import com.alibaba.analytics.core.config.C3112e;
...
/* renamed from: com.alibaba.analytics.core.logbuilder.a */
...
public class C3121a {
    ...
    public static String a(Map<String, String> map) {
        ...
        if (map != null && map.size() > 0) {
            ...
            if (!map.containsKey(logField7.toString())) {
                map.put(logField7.toString(), C9225hn.a());
            }
            map.put(LogField.RESERVE5.toString(), C3122b.d(j));
            ...
            if (b2 != null) {
                ...
                GoogleAdvertisingIdClient.C3119b a2 = GoogleAdvertisingIdClient.a();
                if (a2 != null) {
                    if (a2.b()) {
                        if (sb.length() > 0) {
                            sb.append(",_glat=1");
    ...
    private static void l(Map<String, String> map) {
        try {
            List<String> c = C3112e.d().c(map.get(LogField.EVENTID.toString()));
            if (c != null) {
                for (String str : c) {
                    map.remove(str);
                }
