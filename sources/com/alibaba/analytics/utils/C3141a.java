...
/* renamed from: com.alibaba.analytics.utils.a */
...
public class C3141a {
        ...
        if (i < 0) {
            ...
            if ((i3 & 2) != 0) {
                ...
                try {
                    ...
                    try {
                        c3142a = new C3142a(byteArrayOutputStream, i3 | 1);
                ...
                try {
                    gZIPOutputStream = new GZIPOutputStream(c3142a);
                    try {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.analytics.utils.a$a */
    /* loaded from: classes5.dex */
    public static class C3142a extends FilterOutputStream {
        private boolean a;
        private int b;
        private byte[] c;
        private int d;
        ...
        public C3142a(OutputStream outputStream, int i) {
            super(outputStream);
            this.f = (i & 8) != 0;
            boolean z = (i & 1) != 0;
            this.a = z;
        ...
        public void a() throws IOException {
            ...
            if (i > 0) {
                if (this.a) {
                    ((FilterOutputStream) this).out.write(C3141a.h(this.g, this.c, i, this.i));
                    this.b = 0;
                    return;
                }
        ...
        public void write(int i) throws IOException {
            if (this.h) {
                ...
                int i4 = this.d;
                if (i3 >= i4) {
                    ((FilterOutputStream) this).out.write(C3141a.h(this.g, bArr, i4, this.i));
                    int i5 = this.e + 4;
                    this.e = i5;
                    if (this.f && i5 >= 76) {
                ...
                if (bArr2[i6] > -5) {
                    ...
                    bArr3[i7] = (byte) i;
                    if (i8 >= this.d) {
                        ((FilterOutputStream) this).out.write(this.g, 0, C3141a.f(bArr3, 0, this.g, 0, this.i));
                        this.b = 0;
                    }
                } else if (bArr2[i6] != -5) {
