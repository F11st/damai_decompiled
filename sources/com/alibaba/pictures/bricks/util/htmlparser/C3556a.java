...
/* renamed from: com.alibaba.pictures.bricks.util.htmlparser.a */
/* loaded from: classes7.dex */
public final class C3556a {
    private static transient /* synthetic */ IpChange $ipChange;
    @NotNull
    public static final C3557a Companion = new C3557a(null);
    private int a;
    @Nullable
    private Reader b;
    private int c;
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.pictures.bricks.util.htmlparser.a$a */
    /* loaded from: classes7.dex */
    public static final class C3557a {
        private C3557a() {
        }

        public /* synthetic */ C3557a(k50 k50Var) {
            this();
        }
    }
        ...
        if (AndroidInstantRuntime.support(ipChange, "-932134396")) {
            ...
            if (this.j != null) {
                ...
                if (this.f >= 5) {
                    ...
                    c9832b = w8Var.m(b, cArr, this.f);
                }
                vz0 vz0Var = new vz0(b, str, c9832b);
                l(vz0Var);
                ParserCallback parserCallback = this.j;
                b41.f(parserCallback);
    ...
    private final void l(vz0 vz0Var) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1643591483")) {
            ...
            if (!this.k.isEmpty() && this.k.peek() != null && this.k.peek().a() != null) {
                vz0.C9832b a = this.k.peek().a();
                b41.f(a);
                if (vz0Var.a() == null) {
                    vz0Var.e(a);
                } else {
                    vz0.C9832b a2 = vz0Var.a();
                    b41.f(a2);
                    if (a2.b() == 1) {
                        vz0.C9832b a3 = vz0Var.a();
                        b41.f(a3);
                        a3.m(a.b());
                    }
                    vz0.C9832b a4 = vz0Var.a();
                    b41.f(a4);
                    if (a4.i() == -1) {
                        vz0.C9832b a5 = vz0Var.a();
                        b41.f(a5);
                        a5.t(a.i());
                    }
                    vz0.C9832b a6 = vz0Var.a();
                    b41.f(a6);
                    if (a6.a() == -1) {
                        vz0.C9832b a7 = vz0Var.a();
                        b41.f(a7);
                        a7.l(a.a());
                    }
                    vz0.C9832b a8 = vz0Var.a();
                    b41.f(a8);
                    if (a8.j() == 0) {
                        vz0.C9832b a9 = vz0Var.a();
                        b41.f(a9);
                        a9.u(a.j());
                    }
                }
