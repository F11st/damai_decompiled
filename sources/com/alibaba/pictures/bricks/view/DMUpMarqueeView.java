...
public class DMUpMarqueeView extends ViewFlipper {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.pictures.bricks.view.DMUpMarqueeView$a */
    /* loaded from: classes7.dex */
    public class View$OnClickListenerC3577a implements View.OnClickListener {
        ...
        View$OnClickListenerC3577a(int i, List list) {
            this.a = i;
            this.b = list;
        }
    ...
    public void setItems(List<View> list) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-776815035")) {
            ...
            for (int i = 0; i < list.size(); i++) {
                list.get(i).setOnClickListener(new View$OnClickListenerC3577a(i, list));
