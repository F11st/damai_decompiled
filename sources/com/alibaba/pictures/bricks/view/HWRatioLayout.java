...
public class HWRatioLayout extends FrameLayout {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1700576298")) {
            ipChange.ipc$dispatch("-1700576298", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2)});
            return;
        }
    ...
    public void setHwRatio(float f) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1174821829")) {
            ipChange.ipc$dispatch("1174821829", new Object[]{this, Float.valueOf(f)});
