...
public final class ResponsiveFrameLayout extends FrameLayout {
    ...
    public final z22 getResponsiveSizeManager() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-1242919028") ? (z22) ipChange.ipc$dispatch("-1242919028", new Object[]{this}) : this.responsiveSizeManager;
    }
    ...
    public final void setResponsiveSizeManager(@NotNull z22 z22Var) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-465156804")) {
            ipChange.ipc$dispatch("-465156804", new Object[]{this, z22Var});
            return;
        }
        b41.i(z22Var, "<set-?>");
        this.responsiveSizeManager = z22Var;
    ...
    public /* synthetic */ ResponsiveFrameLayout(Context context, AttributeSet attributeSet, int i, k50 k50Var) {
