...
public final class a {
    ...
    public static final class C0154a {
        ...
        public /* synthetic */ C0154a(k50 k50Var) {
            this();
        }
    }
    ...
    private final HttpURLConnection d(String str) throws IOException {
        ...
        D = o.D(str, reqProtocolEnum.getProtocol(), true);
        if (D) {
            ...
            if (reqProtocolEnum2 == reqProtocolEnum3) {
                o.A(str, reqProtocolEnum.getProtocol(), reqProtocolEnum3.getProtocol(), true);
            }
        } else {
            ReqProtocolEnum reqProtocolEnum4 = ReqProtocolEnum.HTTP;
            D2 = o.D(str, reqProtocolEnum4.getProtocol(), true);
            if (D2) {
                if (this.d == reqProtocolEnum) {
                    o.A(str, reqProtocolEnum4.getProtocol(), reqProtocolEnum.getProtocol(), true);
                }
            } else {
