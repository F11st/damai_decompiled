...
/* renamed from: com.alibaba.appmonitor.delegate.a */
...
public final class C3309a {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.appmonitor.delegate.a$a */
    /* loaded from: classes15.dex */
    public static class C3310a {
        @Deprecated
        public static boolean a(String str, String str2) {
            return C3317a.h().e(str, str2, Boolean.TRUE, null);
        }
        ...
        public static void c(String str, String str2, String str3, String str4, String str5) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    ...
                    if (C3309a.c && Variables.L()) {
                        EventType eventType = EventType.ALARM;
                        if (eventType.isOpen() && (C3309a.e() || C3317a.h().e(str, str2, Boolean.FALSE, hashMap))) {
                            Logger.f("commitFail ", "module", str, "monitorPoint", str2, "errorCode:", str4, "errorMsg:", str5);
                            if (C3317a.h().k(eventType, str, str2)) {
        ...
        public static void e(String str, String str2, String str3) {
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    if (C3309a.c && Variables.L()) {
                        EventType eventType = EventType.ALARM;
                        if (eventType.isOpen() && (C3309a.e() || C3317a.h().e(str, str2, Boolean.TRUE, null))) {
        ...
        public static void f(int i) {
            C3317a.h().o(EventType.ALARM, i);
        }

        public static void g(int i) {
            EventType eventType = EventType.ALARM;
            eventType.setStatisticsInterval(i);
            C3309a.o(eventType, i);
        }
    }

    /* compiled from: Taobao */
    /* renamed from: com.alibaba.appmonitor.delegate.a$b */
    /* loaded from: classes15.dex */
    public static class C3311b {
        @Deprecated
        public static boolean a(String str, String str2) {
            return C3317a.h().f(EventType.COUNTER, str, str2);
        }
            ...
            try {
                if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2)) {
                    if (C3309a.c && Variables.L()) {
                        ...
                        if (eventType.isOpen() && (C3309a.e() || C3317a.h().f(eventType, str, str2))) {
        ...
        public static void d(int i) {
            C3317a.h().o(EventType.COUNTER, i);
        }
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.appmonitor.delegate.a$c */
    /* loaded from: classes15.dex */
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.appmonitor.delegate.a$d */
    /* loaded from: classes15.dex */
    public static class C3313d {
        ...
        public static boolean b(String str, String str2) {
            return C3317a.h().f(EventType.STAT, str, str2);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:15:0x002d, code lost:
            if (com.alibaba.appmonitor.sample.C3317a.h().g(r0, r8, r9, r10 != null ? r10.getMap() : null) != false) goto L16;
         */
        /*
        ...
        */
        public static void d(java.lang.String r8, java.lang.String r9, com.alibaba.mtl.appmonitor.model.DimensionValueSet r10, double r11) {
            /*
                boolean r0 = com.alibaba.appmonitor.delegate.C3309a.c     // Catch: java.lang.Throwable -> L8e
                r1 = 3
                r2 = 2
                r3 = 4
                r4 = 1
                ...
                if (r6 == 0) goto L7a
                boolean r6 = com.alibaba.appmonitor.delegate.C3309a.e()     // Catch: java.lang.Throwable -> L8e
                if (r6 != 0) goto L2f
                com.alibaba.appmonitor.sample.a r6 = com.alibaba.appmonitor.sample.C3317a.h()     // Catch: java.lang.Throwable -> L8e
                if (r10 == 0) goto L28
            ...
            L2f:
                ...
                com.alibaba.appmonitor.pool.a r1 = com.alibaba.appmonitor.pool.C3316a.a()     // Catch: java.lang.Throwable -> L8e
            ...
            L94:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.appmonitor.delegate.C3309a.C3313d.d(java.lang.String, java.lang.String, com.alibaba.mtl.appmonitor.model.DimensionValueSet, double):void");
        }

        /* JADX WARN: Code restructure failed: missing block: B:16:0x0031, code lost:
            if (com.alibaba.appmonitor.sample.C3317a.h().g(r0, r11, r12, r13 != null ? r13.getMap() : null) != false) goto L17;
         */
        /*
            Code decompiled incorrectly, please refer to instructions dump.
            To view partially-correct code enable 'Show inconsistent code' option in preferences
        */
        public static void e(java.lang.String r11, java.lang.String r12, com.alibaba.mtl.appmonitor.model.DimensionValueSet r13, com.alibaba.mtl.appmonitor.model.MeasureValueSet r14) {
            /*
                boolean r0 = com.alibaba.appmonitor.delegate.C3309a.c     // Catch: java.lang.Throwable -> L90
                r1 = 3
                ...
                if (r8 == 0) goto L80
                boolean r8 = com.alibaba.appmonitor.delegate.C3309a.e()     // Catch: java.lang.Throwable -> L90
                if (r8 != 0) goto L33
                com.alibaba.appmonitor.sample.a r8 = com.alibaba.appmonitor.sample.C3317a.h()     // Catch: java.lang.Throwable -> L90
                if (r13 == 0) goto L2c
            ...
            L33:
                ...
                com.alibaba.appmonitor.sample.a r1 = com.alibaba.appmonitor.sample.C3317a.h()     // Catch: java.lang.Throwable -> L90
            ...
            L96:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.alibaba.appmonitor.delegate.C3309a.C3313d.e(java.lang.String, java.lang.String, com.alibaba.mtl.appmonitor.model.DimensionValueSet, com.alibaba.mtl.appmonitor.model.MeasureValueSet):void");
        }
