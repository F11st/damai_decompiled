...
/* renamed from: com.alibaba.aliweex.adapter.adapter.c */
/* loaded from: classes5.dex */
public class C3020c implements IWebSocketAdapter {
    private IWebSocket a;
    private IWebSocketAdapter.EventListener b;

    /* compiled from: Taobao */
    /* renamed from: com.alibaba.aliweex.adapter.adapter.c$a */
    /* loaded from: classes15.dex */
    class C3021a implements WebSocketListener {
        C3021a(C3020c c3020c) {
        }
    }
    ...
    public void connect(String str, @Nullable String str2, IWebSocketAdapter.EventListener eventListener) {
        if (eventListener == null) {
            ...
            try {
                ...
                this.a = WebSocketCenter.getInstance().newWebSocket(WXEnvironment.getApplication(), c22Var, new C3021a(this));
            } catch (Throwable th) {
