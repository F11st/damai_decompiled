...
/* renamed from: com.alibaba.aliweex.adapter.module.blur.b */
...
class C3056b {
    ...
    private C3056b(@NonNull BlurAlgorithm blurAlgorithm) {
        this.a = 8.0f;
    ...
    public static C3056b b(@NonNull BlurAlgorithm blurAlgorithm) {
        return new C3056b(blurAlgorithm);
    }
