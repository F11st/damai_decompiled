...
/* renamed from: com.alibaba.aliweex.adapter.module.a */
/* loaded from: classes5.dex */
public class C3050a implements IJsApiFailedCallBack, IJsApiSucceedCallBack {
    private String a;
    private String b;
    private boolean c;
    private boolean d;
    ...
    public C3050a(String str, String str2, boolean z, boolean z2) {
        this.c = true;
        this.a = str;
        this.b = str2;
        this.c = z;
