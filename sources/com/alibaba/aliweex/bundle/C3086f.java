...
/* renamed from: com.alibaba.aliweex.bundle.f */
/* loaded from: classes5.dex */
public class C3086f implements WXSDKInstance.NestedInstanceInterceptor {
    protected ArrayList<C3089b> a = new ArrayList<>();
    protected Handler b;

    /* compiled from: Taobao */
    /* renamed from: com.alibaba.aliweex.bundle.f$a */
    /* loaded from: classes5.dex */
    public static class C3087a extends WXEmbed.ClickToReloadListener {
        ...
        /* compiled from: Taobao */
        /* renamed from: com.alibaba.aliweex.bundle.f$a$a */
        /* loaded from: classes5.dex */
        class C3088a extends WVUCWebViewClient {
            C3088a(Context context) {
                super(context);
            }
        ...
        protected C3087a(Context context, Handler handler) {
            this.a = context;
            this.b = handler;
        }
        ...
        public void onException(NestedContainer nestedContainer, String str, String str2) {
            ...
            if (shouldDegrade) {
                ...
                wVUCWebView.setWebViewClient(new C3088a(this.a));
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.aliweex.bundle.f$b */
    /* loaded from: classes15.dex */
    public static class C3089b {
        public NestedContainer a;
        public C3087a b;

        public C3089b(C3087a c3087a, NestedContainer nestedContainer) {
            this.b = c3087a;
            this.a = nestedContainer;
        }
    }

    public C3086f(Context context, Handler handler) {
        this.b = handler;
    }

    public void a() {
        ArrayList<C3089b> arrayList = this.a;
        if (arrayList != null) {
            Iterator<C3089b> it = arrayList.iterator();
            while (it.hasNext()) {
                C3087a c3087a = it.next().b;
                if (c3087a != null) {
                    c3087a.b();
                }
            }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public ArrayList<C3089b> c() {
        return this.a;
    }

    @Override // com.taobao.weex.WXSDKInstance.NestedInstanceInterceptor
    public void onCreateNestInstance(WXSDKInstance wXSDKInstance, NestedContainer nestedContainer) {
        C3087a c3087a = new C3087a(wXSDKInstance.getContext(), this.b);
        c3087a.e(wXSDKInstance);
        nestedContainer.setOnNestEventListener(c3087a);
        this.a.add(new C3089b(c3087a, nestedContainer));
    }
}
