    ...
    */
    private void d(android.view.View r3) {
        ...
        L37:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.aliweex.bundle.g.d(android.view.View):void");
    }
    ...
    public void onException(WXSDKInstance wXSDKInstance, String str, String str2) {
        ...
        WeexPageFragment.b bVar = this.e;
        if (bVar != null) {
            bVar.c(wXSDKInstance, shouldDegrade, str, str2);
        }
    }
    ...
    public void onViewCreated(WXSDKInstance wXSDKInstance, View view) {
        ...
        if (this.a != null) {
            if (b()) {
                d(view);
                WeexPageFragment.b bVar = this.e;
                View b = bVar != null ? bVar.b(wXSDKInstance, view) : view;
