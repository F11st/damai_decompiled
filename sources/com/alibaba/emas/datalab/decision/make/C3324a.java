...
/* renamed from: com.alibaba.emas.datalab.decision.make.a */
...
public class C3324a {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.emas.datalab.decision.make.a$a */
    /* loaded from: classes15.dex */
    public static /* synthetic */ class C3325a {
    ...
    private void c(p30 p30Var) throws Exception {
        ...
        int i = C3325a.a[p30Var.b.ordinal()];
        if (i != 1) {
            if (i != 2) {
    ...
    public void b(DatalabBizType datalabBizType, j30 j30Var) {
        DatalabListener datalabListener = C3318a.b().a.get(datalabBizType);
