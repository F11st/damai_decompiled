...
/* renamed from: com.alibaba.android.ultron.vfw.web.c */
/* loaded from: classes6.dex */
public class C3269c extends j1 {
    ...
    public C3269c(ay2 ay2Var, String str) {
        super(ay2Var);
        this.e = str;
    }
    ...
    protected void d(@NonNull IDMComponent iDMComponent) {
        ...
        if (str == null || !str.equals(this.f)) {
            this.f = str;
            C3267a c3267a = new C3267a(this.a);
            this.d = c3267a;
            c3267a.a(iDMComponent);
            this.c.setVesselViewCallback(this.d);
            this.c.loadUrl(str);
            if (this.c.findViewWithTag(WebMaskView.TAG) == null) {
                this.c.setOnLoadListener(new C3268b(new WebMaskView(this.c, str), str, this.a.k()));
            }
        }
    }
    ...
    */
    protected android.view.View e(@androidx.annotation.Nullable android.view.ViewGroup r5) {
        ...
        L4b:
            ...
            if (r1 <= 0) goto L64
            float r1 = (float) r1
            java.lang.Float r3 = com.alibaba.android.ultron.vfw.web.C3269c.g
        ...
        L6c:
            float r0 = (float) r0
            java.lang.Float r1 = com.alibaba.android.ultron.vfw.web.C3269c.g
        ...
        L7e:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.android.ultron.vfw.web.C3269c.e(android.view.ViewGroup):android.view.View");
    }
