...
/* renamed from: com.alibaba.android.ultron.trade.presenter.a */
/* loaded from: classes6.dex */
public abstract class AbstractC3258a implements IPresenter {
    ...
    protected C3259b mViewManager;

    public AbstractC3258a(Activity activity) {
    ...
    public void init(BaseDataManager baseDataManager, C3259b c3259b) {
        this.mDataManager = baseDataManager;
        this.mViewManager = c3259b;
    ...
    public void onDestroy() {
        ...
        C3259b c3259b = this.mViewManager;
        if (c3259b != null) {
            c3259b.destroy();
        }
    }
    ...
    protected void registerDinamicXView() {
        ...
        this.mViewManager.v3RegisterDinamicXView(ek2.DX_WIDGET_ID, new ek2.C9102a());
        this.mViewManager.v3RegisterDinamicXView(gk2.DX_WIDGET_ID, new gk2.C9178a());
    }
