...
/* renamed from: com.alibaba.android.ultron.trade.presenter.b */
...
public class C3259b {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.android.ultron.trade.presenter.b$a */
    /* loaded from: classes6.dex */
    public class C3260a implements ComponentLifecycleCallback {
        C3260a() {
        }
        ...
        public void onBindData(RecyclerViewHolder recyclerViewHolder, IDMComponent iDMComponent, Map<String, Object> map) {
            ...
            List<IDMEvent> list;
            if (iDMComponent == null || (eventMap = iDMComponent.getEventMap()) == null || (list = eventMap.get(C3259b.KEY_EXPOSURE_ITEM)) == null) {
                return;
            }
            op2 tradeEventHandler = C3259b.this.mPresenter.getTradeEventHandler();
    ...
    public C3259b(IPresenter iPresenter) {
        if (iPresenter != null) {
    ...
    private void setDinamicContext() {
        this.mViewEngine.g(AbstractC3258a.DINAMIC_CONTEXT_KEY_PRESENTER, this.mPresenter);
    }
    ...
    public void showPopup(h30 h30Var, OpenPopupWindowEventModel openPopupWindowEventModel, PopupWindowManager.OnCancelListener onCancelListener) {
        ...
        PopupWindowManager.C3265e c3265e = new PopupWindowManager.C3265e();
        c3265e.j(-1);
        OpenPopupWindowEventModel.Css css = openPopupWindowEventModel.getCss();
        if (css != null) {
            try {
                c3265e.l(Float.parseFloat(css.getHeight()));
        ...
        if (options != null) {
            if ("true".equals(options.getNeedCloseButton())) {
                c3265e.h(this.mContext.getResources().getDrawable(R$drawable.popup_close_btn));
            }
        } else {
            c3265e.h(this.mContext.getResources().getDrawable(R$drawable.popup_close_btn));
        }
        ...
        List<String> c = themeManager.c(PopupWindowManager.C3265e.KEY_TOP_RADIUS);
        int i = 0;
        int a = (c == null || c.size() <= 0) ? 0 : pq2.a(c.get(0));
        List<String> c2 = themeManager.c(PopupWindowManager.C3265e.KEY_BOTTOM_RADIUS);
        if (c2 != null && c2.size() > 0) {
            i = pq2.a(c2.get(0));
        }
        c3265e.k(nd2.a(this.mContext, a), nd2.a(this.mContext, i));
        this.mPopupWindowManager.q(c3265e);
