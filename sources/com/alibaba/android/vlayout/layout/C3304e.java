...
/* renamed from: com.alibaba.android.vlayout.layout.e */
/* loaded from: classes6.dex */
public class C3304e extends r1 {
    private View[] e;
    ...
    private int g(VirtualLayoutManager.C3287d c3287d, m81 m81Var, LayoutManagerHelper layoutManagerHelper, boolean z, int i, int i2, int i3, int i4) {
        ...
        if (z) {
            ...
            a((max - getVerticalMargin()) - getVerticalPadding(), this.d, c3287d, layoutManagerHelper);
            AbstractC3291c abstractC3291c2 = abstractC3291c;
            int f8 = this.d.left + abstractC3291c2.f(view4);
            Rect rect = this.d;
            layoutChildWithMargin(view4, rect.left, rect.top, f8, rect.bottom, layoutManagerHelper);
            int f9 = f8 + abstractC3291c2.f(view5);
            int i15 = this.d.top;
            layoutChildWithMargin(view5, f8, i15, f9, i15 + abstractC3291c2.e(view5), layoutManagerHelper);
            int f10 = f9 + abstractC3291c2.f(view13);
            int i16 = this.d.top;
            layoutChildWithMargin(view13, f9, i16, f10, i16 + abstractC3291c2.e(view13), layoutManagerHelper);
            View view14 = view2;
            int f11 = f8 + abstractC3291c2.f(view14);
            layoutChildWithMargin(view14, f8, this.d.top + abstractC3291c2.e(view5), f11, this.d.bottom - abstractC3291c2.e(view11), layoutManagerHelper);
            layoutChildWithMargin(view12, f11, this.d.top + abstractC3291c2.e(view5), f11 + abstractC3291c2.f(view12), this.d.bottom - abstractC3291c2.e(view10), layoutManagerHelper);
            int f12 = f8 + abstractC3291c2.f(view11);
            layoutChildWithMargin(view11, f8, this.d.bottom - abstractC3291c2.e(view11), f12, this.d.bottom, layoutManagerHelper);
            layoutChildWithMargin(view10, f12, this.d.bottom - abstractC3291c2.e(view10), f12 + abstractC3291c2.f(view10), this.d.bottom, layoutManagerHelper);
            i5 = max;
        } else {
            i5 = 0;
        }
    ...
    private int h(VirtualLayoutManager.C3287d c3287d, m81 m81Var, LayoutManagerHelper layoutManagerHelper, boolean z, int i, int i2, int i3, int i4) {
        C3304e c3304e;
        int i5;
        View view;
        View view2;
        ...
        if (z) {
            ...
            c3304e = this;
            c3304e.a((max - getVerticalMargin()) - getVerticalPadding(), c3304e.d, c3287d, layoutManagerHelper);
            int f8 = c3304e.d.left + mainOrientationHelper.f(view3);
            Rect rect = c3304e.d;
            ...
            int i18 = c3304e.d.top;
            layoutChildWithMargin(view11, f8, i18, f9, i18 + mainOrientationHelper.e(view11), layoutManagerHelper);
            layoutChildWithMargin(view5, f8, c3304e.d.top + mainOrientationHelper.e(view5), f8 + mainOrientationHelper.f(view5), c3304e.d.bottom - mainOrientationHelper.e(view12), layoutManagerHelper);
            int f10 = c3304e.d.left + mainOrientationHelper.f(view12);
            Rect rect2 = c3304e.d;
            layoutChildWithMargin(view12, rect2.left, rect2.bottom - mainOrientationHelper.e(view12), f10, c3304e.d.bottom, layoutManagerHelper);
            int f11 = f10 + mainOrientationHelper.f(view10);
            layoutChildWithMargin(view10, f10, c3304e.d.bottom - mainOrientationHelper.e(view10), f11, c3304e.d.bottom, layoutManagerHelper);
            layoutChildWithMargin(view9, f11, c3304e.d.bottom - mainOrientationHelper.e(view9), f11 + mainOrientationHelper.f(view9), c3304e.d.bottom, layoutManagerHelper);
            i5 = max;
        } else {
            c3304e = this;
            i5 = 0;
        }
        c3304e.handleStateOnResult(m81Var, c3304e.e);
        return i5;
    }

    private int i(VirtualLayoutManager.C3287d c3287d, m81 m81Var, LayoutManagerHelper layoutManagerHelper, boolean z, int i, int i2, int i3, int i4) {
        C3304e c3304e;
        int i5;
        AbstractC3291c abstractC3291c;
        View view;
        ...
        if (z) {
            ...
            c3304e.a((max - getVerticalMargin()) - getVerticalPadding(), c3304e.d, c3287d, layoutManagerHelper);
            AbstractC3291c abstractC3291c2 = abstractC3291c;
            int f6 = c3304e.d.left + abstractC3291c2.f(view2);
            Rect rect = c3304e.d;
            layoutChildWithMargin(view2, rect.left, rect.top, f6, rect.bottom, layoutManagerHelper);
            int f7 = f6 + abstractC3291c2.f(view3);
            int i15 = c3304e.d.top;
            layoutChildWithMargin(view3, f6, i15, f7, i15 + abstractC3291c2.e(view3), layoutManagerHelper);
            int f8 = f7 + abstractC3291c2.f(view4);
            int i16 = c3304e.d.top;
            layoutChildWithMargin(view4, f7, i16, f8, i16 + abstractC3291c2.e(view4), layoutManagerHelper);
            int f9 = f6 + abstractC3291c2.f(view5);
            layoutChildWithMargin(view5, f6, c3304e.d.bottom - abstractC3291c2.e(view5), f9, c3304e.d.bottom, layoutManagerHelper);
            layoutChildWithMargin(view7, f9, c3304e.d.bottom - abstractC3291c2.e(view7), f9 + abstractC3291c2.f(view7), c3304e.d.bottom, layoutManagerHelper);
            i5 = max;
        } else {
            c3304e = this;
            i5 = 0;
    ...
    @Override // tb.r1, com.alibaba.android.vlayout.layout.AbstractC3303d, com.alibaba.android.vlayout.AbstractC3289a
    ...
    public void layoutViews(RecyclerView.Recycler recycler, RecyclerView.State state, VirtualLayoutManager.C3287d c3287d, m81 m81Var, LayoutManagerHelper layoutManagerHelper) {
        ...
        int e = e(this.e, recycler, c3287d, m81Var, layoutManagerHelper);
        if (e != getItemCount()) {
        ...
        if (e == 5) {
            i = i(c3287d, m81Var, layoutManagerHelper, z, contentWidth, contentHeight, paddingLeft, paddingTop);
        } else if (e == 6) {
            i = h(c3287d, m81Var, layoutManagerHelper, z, contentWidth, contentHeight, paddingLeft, paddingTop);
        } else if (e == 7) {
            i = g(c3287d, m81Var, layoutManagerHelper, z, contentWidth, contentHeight, paddingLeft, paddingTop);
        }
        m81Var.a = i;
