...
/* renamed from: com.alibaba.android.vlayout.layout.b */
/* loaded from: classes6.dex */
public class C3299b extends BaseLayoutHelper {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.android.vlayout.layout.b$a */
    /* loaded from: classes6.dex */
    static final class C3300a extends AbstractC3301b {
        @Override // com.alibaba.android.vlayout.layout.C3299b.AbstractC3301b
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.android.vlayout.layout.b$b */
    /* loaded from: classes15.dex */
    public static abstract class AbstractC3301b {
    ...
    public void checkAnchorInfo(RecyclerView.State state, VirtualLayoutManager.C3286c c3286c, LayoutManagerHelper layoutManagerHelper) {
        ...
        int a = this.e.a(c3286c.a, this.a);
        if (!c3286c.c) {
            while (a > 0) {
                int i = c3286c.a;
                if (i <= 0) {
                ...
                int i2 = i - 1;
                c3286c.a = i2;
                a = this.e.a(i2, this.a);
            }
        } else {
            while (a < this.a - 1 && c3286c.a < getRange().e().intValue()) {
                int i3 = c3286c.a + 1;
                c3286c.a = i3;
                a = this.e.a(i3, this.a);
            }
        }
        this.l = true;
    }
    ...
    */
    public void layoutViews(androidx.recyclerview.widget.RecyclerView.Recycler r30, androidx.recyclerview.widget.RecyclerView.State r31, com.alibaba.android.vlayout.VirtualLayoutManager.C3287d r32, tb.m81 r33, com.alibaba.android.vlayout.LayoutManagerHelper r34) {
        /*
            Method dump skipped, instructions count: 1638
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.android.vlayout.layout.C3299b.layoutViews(androidx.recyclerview.widget.RecyclerView$Recycler, androidx.recyclerview.widget.RecyclerView$State, com.alibaba.android.vlayout.VirtualLayoutManager$d, tb.m81, com.alibaba.android.vlayout.LayoutManagerHelper):void");
    }
    ...
    public C3299b(int i, int i2, int i3) {
        this(i, i2, i3, i3);
    }

    public C3299b(int i, int i2, int i3, int i4) {
        this.a = 4;
        this.b = 0;
        this.c = 0;
        this.d = true;
