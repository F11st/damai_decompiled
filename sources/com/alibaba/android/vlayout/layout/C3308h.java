...
/* renamed from: com.alibaba.android.vlayout.layout.h */
/* loaded from: classes6.dex */
public class C3308h extends vk {
    public C3308h() {
        setItemCount(1);
    }
    ...
    public void layoutViews(RecyclerView.Recycler recycler, RecyclerView.State state, VirtualLayoutManager.C3287d c3287d, m81 m81Var, LayoutManagerHelper layoutManagerHelper) {
        ...
        if (z2) {
            ...
            if (c3287d.f() == -1) {
                i5 = (c3287d.g() - this.mMarginBottom) - this.mPaddingBottom;
                g = i5 - m81Var.a;
            } else {
                g = this.mPaddingTop + c3287d.g() + this.mMarginTop;
                i5 = m81Var.a + g;
            }
            i = paddingLeft;
            i3 = i5;
            ...
            if (c3287d.f() == -1) {
                int g2 = (c3287d.g() - this.mMarginRight) - this.mPaddingRight;
                i2 = g2;
                i = g2 - m81Var.a;
            } else {
                int g3 = c3287d.g() + this.mMarginLeft + this.mPaddingLeft;
                i = g3;
                i2 = m81Var.a + g3;
            }
            i3 = contentHeight2;
