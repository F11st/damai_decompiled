...
/* renamed from: com.alibaba.android.bindingx.core.internal.a */
/* loaded from: classes5.dex */
public abstract class AbstractC3210a extends AbstractEventHandler {
    protected int n;
    protected int o;
    private boolean p;

    public AbstractC3210a(Context context, PlatformManager platformManager, Object... objArr) {
    ...
    protected void k(int i, int i2, int i3, int i4, int i5, int i6, String str) {
        ...
        if (this.p) {
            ...
            this.p = true;
            abstractC3210a = this;
            abstractC3210a.i("start", i, i2, i3, i4, i5, i6, new Object[0]);
        }
        try {
            JSMath.applyScrollValuesToScope(abstractC3210a.d, i, i2, i3, i4, i5, i6, abstractC3210a.h.e());
            if (abstractC3210a.d(abstractC3210a.j, abstractC3210a.d)) {
                return;
            }
            abstractC3210a.c(abstractC3210a.a, abstractC3210a.d, str);
        } catch (Exception e) {
