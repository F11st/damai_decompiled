...
/* renamed from: com.alibaba.android.bindingx.core.internal.e */
/* loaded from: classes5.dex */
public class C3215e extends AbstractEventHandler implements PhysicsAnimationDriver.OnAnimationEndListener, PhysicsAnimationDriver.OnAnimationUpdateListener {
    private C3224n n;

    public C3215e(Context context, PlatformManager platformManager, Object... objArr) {
    ...
    private Map<String, Object> j(Map<String, Object> map, double d, double d2) {
        ...
        Map<String, Object> f = C3227o.f(map, "eventConfig");
    ...
    protected void f(String str, @NonNull Map<String, Object> map) {
        C3224n c3224n = this.n;
        if (c3224n != null) {
            i("interceptor", c3224n.b(), this.n.c(), Collections.singletonMap("interceptor", str));
        }
    }
    ...
    public boolean onDisable(@NonNull String str, @NonNull String str2) {
        ...
        C3224n c3224n = this.n;
        if (c3224n != null) {
            i("end", c3224n.b(), this.n.c(), new Object[0]);
            this.n.g(null);
            this.n.h(null);
            this.n.a();
            return true;
