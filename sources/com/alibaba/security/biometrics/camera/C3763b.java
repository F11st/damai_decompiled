...
/* renamed from: com.alibaba.security.biometrics.camera.b */
/* loaded from: classes8.dex */
public final class C3763b extends AbstractC3759a {
    private Throwable A;
    private Throwable B;
    ...
    public C3763b(Context context, ALBiometricsParams aLBiometricsParams) {
    ...
    @Override // com.alibaba.security.biometrics.camera.AbstractC3759a
    protected final void c() {
        this.o = false;
    }

    @Override // com.alibaba.security.biometrics.camera.AbstractC3759a, com.alibaba.security.biometrics.camera.InterfaceC3764c
    ...
    public final String m() {
        ...
        hashMap.put("cameraInfo", C3811h.a(this.s));
        hashMap.put("previewSize", C3811h.a(this.e));
        hashMap.put("supportPreviewSize", C3811h.a(this.t));
        hashMap.put("supportPreviewFpsRange", C3811h.a(this.u));
        hashMap.put("currentPreviewFpsRange", C3811h.a(this.v));
        hashMap.put("cameraParameters", C3811h.a(this.w));
        hashMap.put("startCameraTime", Long.valueOf(System.currentTimeMillis()));
        hashMap.put("isCameraOpen", Boolean.valueOf(this.x));
        hashMap.put("openException", C3805b.a(this.y));
    ...
    public final String n() {
        ...
        hashMap.put("closeException", C3805b.a(this.A));
        hashMap.put("previewException", C3805b.a(this.B));
        return C3811h.a((Object) hashMap);
    }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        this.x = false;
                        d();
                        a(GlobalErrorCode.ERROR_DEVICE_CAMERA_INIT, "start preview fail: " + C3805b.a(th));
                    }
                } catch (Throwable th2) {
                    this.y = th2;
                    this.x = false;
        ...
        try {
            ...
            this.p.setPreviewCallback(new Camera.PreviewCallback() { // from class: com.alibaba.security.biometrics.camera.b.1
                ...
                public final void onPreviewFrame(byte[] bArr, Camera camera) {
                    ...
                    C3763b.this.a(bArr, i);
                    C3763b c3763b = C3763b.this;
                    if (!c3763b.o || (videoRecorderService = c3763b.n) == null) {
                        return;
                    }
    ...
    @Override // com.alibaba.security.biometrics.camera.InterfaceC3764c
    public final void a(InterfaceC3827b interfaceC3827b, boolean z) {
        if (!this.o) {
            if (interfaceC3827b != null) {
                interfaceC3827b.onFinish(null, this.j);
                return;
            }
            return;
        }
        ...
        if (videoRecorderService != null) {
            videoRecorderService.release(interfaceC3827b, z);
        }
        this.n = null;
    }
}
