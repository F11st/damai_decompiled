...
/* renamed from: com.alibaba.security.biometrics.c.a.a */
...
public final class C3746a implements InterfaceC3747b {
    ...
    private boolean b(boolean z) {
        ...
        if (!"armeabi-v7a".equalsIgnoreCase(cpu_abi) && !"armeabi".equalsIgnoreCase(cpu_abi) && !DeviceUtils.ABI_X86.equalsIgnoreCase(cpu_abi) && !"arm64-v8a".equalsIgnoreCase(cpu_abi)) {
            ...
            return false;
        } else if (GetCacheDataManager.getInstance().getUseHwMagicWindow() && C3807d.d(this.c)) {
    ...
    @Override // com.alibaba.security.biometrics.c.a.InterfaceC3747b
    public final int a() {
        return this.b;
    }
