...
/* renamed from: com.alibaba.security.biometrics.sensor.a.c */
/* loaded from: classes8.dex */
public final class View$OnTouchListenerC3793c extends AbstractC3791a<List<MotionEventData>> implements View.OnTouchListener {
    public volatile boolean c;
    public final List<MotionEventData> d;
    private View e;

    public View$OnTouchListenerC3793c(Activity activity) {
        super(activity);
        this.c = false;
    ...
    */
    public final boolean onTouch(android.view.View r6, android.view.MotionEvent r7) {
        ...
        L8b:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.security.biometrics.sensor.a.View$OnTouchListenerC3793c.onTouch(android.view.View, android.view.MotionEvent):boolean");
    }
