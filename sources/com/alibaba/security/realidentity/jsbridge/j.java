            ...
            public final ALBiometricsEventListener getEventListener() {
                return new ALBiometricsEventListener() { // from class: com.alibaba.security.realidentity.jsbridge.j.1.1
                    ...
                    public final void onError(int i6, Bundle bundle2) {
                        ...
                        com.alibaba.security.common.c.a.d(j.as, "onError.r: ".concat(String.valueOf(i6)));
                        if (i6 == 159) {
                            i6 = 100;
                        }
                    ...
                    public final void onSuccess(ALBiometricsResult aLBiometricsResult) {
                        ...
                        String a = com.alibaba.security.common.d.g.a(j.this.ao, k, aLBiometricsResult.getQi().getP());
                        Pair<String, String> putIdCardImage = RPWebViewMediaCacheManager.getInstance().putIdCardImage(j.this.ao, a);
                        JSONObject jSONObject2 = new JSONObject();
                        try {
                            jSONObject2.put("imageId", putIdCardImage.first);
                            jSONObject2.put("imageUrl", putIdCardImage.second);
                            if (i5 > 0 && a != null) {
                                jSONObject2.put("base64Image", com.alibaba.security.common.d.g.a(com.alibaba.security.common.d.g.b(a)));
                            }
                        ...
                        for (int i6 = 0; i6 < as2.size(); i6++) {
                            ...
                            String a2 = j.a(as2.get(i6).getAt());
                            List<ABImageResult> is = as2.get(i6).getIs();
                            for (int i7 = 0; i7 < is.size(); i7++) {
                                String putIdCardImage2 = RPWebViewMediaCacheManager.getInstance().putIdCardImage(j.this.ao, is.get(i7).getP(), k);
