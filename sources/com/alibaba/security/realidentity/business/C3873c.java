...
/* renamed from: com.alibaba.security.realidentity.business.c */
...
public class C3873c {
    ...
    public C3873c(BusinessHeadParams businessHeadParams) {
    ...
    private boolean b(BusinessType businessType) {
        ...
        if (this.k == null) {
            C3800a.d(h, "createParams classes is null");
            return false;
        }
    ...
    public final boolean a() {
        ...
        if (!b(businessType)) {
            String str = h;
            C3800a.d(str, "isCreateSuccessful params error businessType:" + businessType.name());
            return false;
        }
