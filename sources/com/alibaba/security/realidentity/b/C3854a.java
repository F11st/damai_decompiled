...
import com.alibaba.security.realidentity.utils.C3924b;
...
/* renamed from: com.alibaba.security.realidentity.b.a */
...
final class C3854a {
    ...
    private void b(Camera camera) {
        ...
        this.b = point;
        this.c = C3924b.a(parameters, point);
        ...
        this.e = C3924b.a(parameters, this.d);
    ...
    public final void a(Camera camera, boolean z) {
        ...
        Camera.Parameters parameters = camera.getParameters();
        if (parameters == null) {
            C3800a.e(g, "Device error: no camera parameters are available. Proceeding without configuration.");
            return;
        }
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(this.a);
        int i = 0;
        a(parameters, FrontLightMode.readPref(defaultSharedPreferences) == FrontLightMode.ON, z);
        C3924b.a(parameters, defaultSharedPreferences.getBoolean("preferences_auto_focus", true), defaultSharedPreferences.getBoolean("preferences_disable_continuous_focus", true), z);
        if (!z) {
        ...
        try {
            ...
            C3800a.e(g, "method error" + e.getLocalizedMessage());
        } catch (NoSuchMethodError e2) {
            parameters.setRotation(90);
            C3800a.e(g, "method error" + e2.getLocalizedMessage());
        }
    ...
    public final void a(Camera.Parameters parameters, boolean z, boolean z2) {
        C3924b.a(parameters, z);
        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(this.a);
        if (z2 || defaultSharedPreferences.getBoolean("preferences_disable_exposure", true)) {
            return;
        }
        C3924b.b(parameters, z);
    }
