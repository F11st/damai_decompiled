...
/* renamed from: com.alibaba.security.realidentity.b.b */
...
public final class C3855b {
    ...
    public C3855b(Context context) {
        this.g = context;
        this.h = new C3854a(context);
    }
    ...
    private synchronized Rect g() {
        if (this.j == null) {
            ...
            C3854a c3854a = this.h;
            Point point = c3854a.c;
            Point point2 = c3854a.b;
    ...
    */
    public final synchronized void a(android.view.SurfaceHolder r11) throws java.io.IOException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.security.realidentity.b.C3855b.a(android.view.SurfaceHolder):void");
    }
    ...
    public final synchronized void b() {
        ...
        if (camera != null && !this.l) {
            camera.startPreview();
            String str = b;
            C3800a.b(str, "SQY: startPreview.theCamera.startPreview Costs" + (System.currentTimeMillis() - currentTimeMillis));
            this.l = true;
            C3800a.b(str, "SQY: startPreview new AutoFocusManager Costs" + (System.currentTimeMillis() - currentTimeMillis));
        }
    }
    ...
    private synchronized void a(boolean z) {
        Camera camera;
        try {
            if (z != C3854a.a(this.a) && (camera = this.a) != null) {
                C3854a c3854a = this.h;
                Camera.Parameters parameters = camera.getParameters();
                c3854a.a(parameters, z, false);
