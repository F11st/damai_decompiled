...
/* renamed from: com.alibaba.security.realidentity.d.a */
...
public abstract class AbstractC3889a {
    ...
    public String d;
    public String e;
    protected InterfaceC3891a f;

    public AbstractC3889a(InterfaceC3891a interfaceC3891a) {
        this.f = interfaceC3891a;
    }
    ...
    private static void m() {
        C3800a.c("SecurityGuardManager", "看到该日志，说明接入的图片yw_1222_" + ((String) null) + "存在问题。图片错误码：");
    }
        ...
        try {
            ...
            initializer.registerInitFinishListener(new IInitializeComponent.IInitFinishListener() { // from class: com.alibaba.security.realidentity.d.a.1
                ...
                public final void onError() {
                    AbstractC3889a.this.c("security guard initialize error");
                }
    ...
    protected final void c(String str) {
        ...
        InterfaceC3891a interfaceC3891a = this.f;
        if (interfaceC3891a != null) {
            interfaceC3891a.b(createSdkExceptionLog);
        }
    }
    ...
    public final Pair<Boolean, String> a() {
        try {
            ...
            return new Pair<>(bool2, "SecurityGuard enter risk scene exception, error code is: " + C3805b.a(th));
        }
    }
    ...
    private void a(String str, Throwable th) {
        TrackLog createSdkExceptionLog = TrackLog.createSdkExceptionLog(str, C3805b.a(th), "");
        createSdkExceptionLog.setCode(-1);
        InterfaceC3891a interfaceC3891a = this.f;
        if (interfaceC3891a != null) {
            interfaceC3891a.b(createSdkExceptionLog);
