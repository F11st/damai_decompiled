...
public class d implements ISGPluginManager {
    ...
    public class RunnableC0183d implements Runnable {
        ...
        RunnableC0183d(String str, String str2) {
            this.a = str;
            this.b = str2;
        }
    ...
    private PackageInfo a(String str, l lVar, String str2) throws SecException {
        ...
        try {
            ...
            String str3 = "" + th;
            String d = d(lVar.a.getAbsolutePath() + "");
            File file = lVar.c;
        ...
        if (packageInfo == null) {
            ...
            String d2 = d(lVar.a.getAbsolutePath());
            File file2 = lVar.c;
    ...
    */
    ...
    private ClassLoader a(String str, String str2, boolean z) {
        ...
        return (Build.VERSION.SDK_INT < 21 || "6.0.1".equalsIgnoreCase(Build.VERSION.getRELEASE())) ? new DexClassLoader(str, str2, sb2, d.class.getClassLoader()) : new PathClassLoader(str, sb2, d.class.getClassLoader());
    }
            ...
            if (a2 != null) {
                ...
                for (int i2 = 0; i2 < split.length; i2++) {
                    ...
                    if (trim.length() != 0) {
                        ...
                        if (split2.length != 2) {
                            a(100041, 131, "nameVersionPair.length != 2", str + jn1.BRACKET_START_STR + str2 + jn1.BRACKET_END_STR, key + jn1.BRACKET_START_STR + value.getVersion() + jn1.BRACKET_END_STR, d(value.getPluginPath()), a2);
