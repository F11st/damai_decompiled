...
public class C4014c {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.wireless.security.framework.utils.c$a */
    /* loaded from: classes8.dex */
    ...
    private C4014c(Object obj) {
        this.a = obj;
    }

    public static C4014c a(Object obj) {
        return new C4014c(obj);
    }

    private static C4014c a(Method method, Object obj, Object... objArr) throws C4016d {
        try {
            a(method);
    ...
    private boolean a(Class<?>[] clsArr, Class<?>[] clsArr2) {
        if (clsArr.length == clsArr2.length) {
            for (int i = 0; i < clsArr2.length; i++) {
                if (clsArr2[i] != C4015a.class && !a(clsArr[i]).isAssignableFrom(a(clsArr2[i]))) {
                    return false;
                }
            }
            return true;
    ...
    private static Class<?>[] a(Object... objArr) {
        ...
        for (int i = 0; i < objArr.length; i++) {
            Object obj = objArr[i];
            clsArr[i] = obj == null ? C4015a.class : obj.getClass();
        }
        return clsArr;
    }
    ...
    public C4014c a(String str, Object... objArr) throws C4016d {
        Class<?>[] a = a(objArr);
        try {
            try {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof C4014c) {
            return this.a.equals(((C4014c) obj).a());
        }
        return false;
    }
