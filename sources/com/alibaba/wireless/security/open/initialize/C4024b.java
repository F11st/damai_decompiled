...
public class C4024b {
    ...
    /* compiled from: Taobao */
    /* renamed from: com.alibaba.wireless.security.open.initialize.b$a */
    /* loaded from: classes8.dex */
    class RunnableC4025a implements Runnable {
        final /* synthetic */ Context a;
        final /* synthetic */ String b;
        final /* synthetic */ boolean c;
        final /* synthetic */ boolean d;

        RunnableC4025a(Context context, String str, boolean z, boolean z2) {
            this.a = context;
            this.b = str;
            this.c = z;
            this.d = z2;
        ...
        public void run() {
            try {
                C4024b.this.b(this.a, this.b, this.c, this.d);
    ...
    public void a(Context context, String str, boolean z, boolean z2) throws SecException {
        ...
        new Thread(new RunnableC4025a(context, str, z, z2), "SGloadLibraryAsync").start();
    }
    ...
    public int b(Context context, String str, boolean z, boolean z2) throws SecException {
        synchronized (this.b) {
            if (!this.e) {
                ...
                c3999d.a(context, this.c, str, z, new Object[0]);
                SGApmMonitorManager.getInstance().setSGPluginManager(c3999d);
                ApmMonitorAdapter.jstageEnd(lu2.MAIN, "1");
                FLOG.printTimeCost(lu2.MAIN, "pluginMgr.init", "", j);
                c3999d.getPluginInfo(c3999d.getMainPluginName());
