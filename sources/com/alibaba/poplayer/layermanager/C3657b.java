...
/* renamed from: com.alibaba.poplayer.layermanager.b */
...
public class C3657b {
    ...
    private yv0<C3659d, PopRequest> b(ArrayList<PopRequest> arrayList) {
        yv0<C3659d, PopRequest> yv0Var = new yv0<>();
        Iterator<PopRequest> it = arrayList.iterator();
        while (it.hasNext()) {
            PopRequest next = it.next();
            yv0Var.c(this.b.findLayerInfoByLevel(((C3658c) next.h()).e), next);
        }
        return yv0Var;
    }
    ...
    private synchronized void g() {
        ...
        Iterator<C3659d> it = this.b.iterator();
        while (it.hasNext()) {
            C3659d next = it.next();
            if (next.g()) {
    ...
    public synchronized void a(ArrayList<PopRequest> arrayList) {
        yv0<C3659d, PopRequest> b = b(arrayList);
        for (C3659d c3659d : b.b().keySet()) {
            c3659d.a(b.a(c3659d));
        }
        g();
    }
    ...
    public void h(PopRequest popRequest) {
        C3659d findLayerInfoByLevel = this.b.findLayerInfoByLevel(((C3658c) popRequest.h()).e);
