...
/* renamed from: com.alibaba.poplayer.layermanager.view.app.c */
/* loaded from: classes8.dex */
public class Window$CallbackC3676c implements Window.Callback {
    public static final String TAG = Window$CallbackC3676c.class.getSimpleName();
    Window.Callback a;
    C3673a b;

    public Window$CallbackC3676c(C3673a c3673a, Window.Callback callback) {
        this.b = c3673a;
        this.a = callback;
    }
