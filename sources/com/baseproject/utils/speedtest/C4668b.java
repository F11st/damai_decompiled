...
/* renamed from: com.baseproject.utils.speedtest.b */
...
public class C4668b {
    ...
    public int a(String str, C4673j.C4674a c4674a) {
        q43 q43Var;
        String str2;
        String str3;
        if (TextUtils.isEmpty(str)) {
            if (c4674a.a.b == 1) {
                C7892a.a(c, "use pre-host cmd url");
                str = "https://106.11.46.130/speed/get?";
            } else {
                C7892a.a(c, "use official cmd url");
        ...
        try {
            ...
            C7892a.b(c, "orange_timeout_wrong_format");
        }
        String str4 = c;
        C7892a.a(str4, "requestCmdInfo time limit:" + this.a + "," + this.b);
        ...
        try {
            ...
            URL url = new URL(b);
            C7892a.a(str4, "com.baseproject.utils.speedtest cmd request:" + b);
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                try {
                    ...
                    C4666a c4666a = (C4666a) JSON.parseObject(stringBuffer.toString(), C4666a.class);
                    c4674a.b = c4666a;
                    if (c4666a.f >= 0) {
                        try {
                            inputStream.close();
