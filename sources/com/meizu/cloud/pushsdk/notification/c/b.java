    ...
    */
    private static synchronized void b(android.content.Context r6) {
        /*
            ...
            monitor-enter(r0)
            java.util.Map<java.lang.String, android.net.Uri> r1 = com.meizu.cloud.pushsdk.notification.c.b.f     // Catch: java.lang.Throwable -> L89
            if (r1 == 0) goto L9
            monitor-exit(r0)
            return
        L9:
        ...
        L20:
            ...
            com.meizu.cloud.pushsdk.notification.c.b.f = r2     // Catch: java.lang.Throwable -> L61 java.lang.Exception -> L63
        ...
        L2f:
            ...
            if (r4 != 0) goto L58
            if (r3 == 0) goto L58
            java.util.Map<java.lang.String, android.net.Uri> r4 = com.meizu.cloud.pushsdk.notification.c.b.f     // Catch: java.lang.Throwable -> L61 java.lang.Exception -> L63
