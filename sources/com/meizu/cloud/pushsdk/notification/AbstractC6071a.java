...
/* renamed from: com.meizu.cloud.pushsdk.notification.a */
/* loaded from: classes10.dex */
public abstract class AbstractC6071a implements InterfaceC6080c {
    ...
    public AbstractC6071a(Context context, PushNotificationBuilder pushNotificationBuilder) {
    ...
    private void b(Notification notification, MessageV3 messageV3) {
        C6082b.a(notification, true);
        C6082b.a(notification, g(messageV3));
    ...
    private void c(Notification.Builder builder, MessageV3 messageV3) {
        ...
        if (advanceSettingEx == null || TextUtils.isEmpty(advanceSettingEx.getSoundTitle())) {
            ...
            Uri b = C6082b.b(this.a, advanceSettingEx.getSoundTitle());
            if (b != null) {
    ...
    private void d(Notification.Builder builder, MessageV3 messageV3) {
        ...
        if (MinSdkChecker.isSupportNotificationChannel()) {
            ...
            Uri b = advanceSettingEx.getSoundTitle() != null ? C6082b.b(this.a, advanceSettingEx.getSoundTitle()) : null;
    ...
    @Override // com.meizu.cloud.pushsdk.notification.InterfaceC6080c
    @SuppressLint({"NewApi"})
    public void b(MessageV3 messageV3) {
        ...
        C6087a a2 = C6087a.a(messageV3);
        if (a2 != null && a2.a() != 0) {
            abs = a2.a();
            DebugLogger.e("AbstractPushNotification", "server notify id " + abs);
            if (!TextUtils.isEmpty(a2.b())) {
                int i = C6102b.i(this.a, messageV3.getUploadDataPackageName(), a2.b());
                ...
                C6102b.b(this.a, messageV3.getUploadDataPackageName(), a2.b(), abs);
            }
        }
        DebugLogger.e("AbstractPushNotification", "current notify id " + abs);
        if (messageV3.isDiscard()) {
            if (C6102b.c(this.a, messageV3.getPackageName()) == 0) {
                C6102b.a(this.a, messageV3.getPackageName(), abs);
            ...
            if (!TextUtils.isEmpty(messageV3.getTaskId())) {
                if (C6102b.d(this.a, messageV3.getPackageName()) == 0) {
                    C6102b.b(this.a, messageV3.getPackageName(), Integer.valueOf(messageV3.getTaskId()).intValue());
                } else if (Integer.valueOf(messageV3.getTaskId()).intValue() < C6102b.d(this.a, messageV3.getPackageName())) {
                    ...
                    C6102b.b(this.a, messageV3.getPackageName(), Integer.valueOf(messageV3.getTaskId()).intValue());
                    abs = C6102b.c(this.a, messageV3.getPackageName());
                }
            }
