...
/* renamed from: com.meizu.cloud.pushsdk.handler.a.d.b */
/* loaded from: classes10.dex */
public class C6052b extends AbstractC6034a<MessageV3> {
    private Context a;

    public C6052b(Context context, AbstractC6033a abstractC6033a) {
    ...
    private Intent b(Context context, MessageV3 messageV3) {
        ...
        if (intent != null) {
            intent.putExtra(PushConstants.MZ_PUSH_PLATFORM_EXTRA, C6043d.a().a(messageV3.getTaskId()).a().b());
        }
        return intent;
    }
    ...
    private void e(MessageV3 messageV3) {
        C6102b.a(d(), messageV3.getPackageName(), 0);
    ...
    public void b(MessageV3 messageV3) {
        C6104d.d(d(), messageV3.getUploadDataPackageName(), TextUtils.isEmpty(messageV3.getDeviceId()) ? d((Intent) null) : messageV3.getDeviceId(), messageV3.getTaskId(), messageV3.getSeqId(), messageV3.getPushTimestamp());
    }
