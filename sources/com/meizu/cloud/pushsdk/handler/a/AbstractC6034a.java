...
import com.meizu.cloud.pushsdk.handler.a.c.C6045e;
...
import com.meizu.cloud.pushsdk.util.C6103c;
import com.meizu.cloud.pushsdk.util.MinSdkChecker;
import com.meizu.cloud.pushsdk.util.MzSystemUtils;
import org.json.JSONObject;

/* compiled from: Taobao */
/* renamed from: com.meizu.cloud.pushsdk.handler.a.a */
/* loaded from: classes10.dex */
public abstract class AbstractC6034a<T> implements InterfaceC6069c {
    private AbstractC6033a a;
    private Context b;
    private SparseArray<String> c;

    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractC6034a(Context context, AbstractC6033a abstractC6033a) {
        if (context == null) {
            throw new IllegalArgumentException("Context must not be null.");
        }
        this.b = context.getApplicationContext();
        this.a = abstractC6033a;
    ...
    private boolean a(String str, MessageV3 messageV3, String str2) {
        ...
        } else if (C6102b.l(d(), messageV3.getPackageName())) {
            C6102b.c(d(), messageV3.getPackageName(), false);
            return true;
        } else {
    ...
    private boolean b(String str, MessageV3 messageV3, String str2) {
        ...
        String a = C6103c.a(str, str2);
        DebugLogger.i("AbstractMessageHandler", "decrypt sign: " + a);
        boolean a2 = C6045e.a(a, messageV3);
    ...
    protected InterfaceC6080c a(T t) {
        return null;
    }
    ...
    public void a(Context context, MessageV3 messageV3) {
        C6035a b;
        C6087a a;
        if (messageV3.getAdvertisementOption() == null || TextUtils.isEmpty(messageV3.getAdvertisementOption().getAdPackage()) || (b = C5915b.a(context).b()) == null || (a = C6087a.a(messageV3)) == null) {
            return;
        }
        b.a(a.a());
    }
        ...
        if (messageV3 == null || messageV3.getAdvertisementOption() == null || TextUtils.isEmpty(messageV3.getAdvertisementOption().getAdPackage())) {
            if (!MinSdkChecker.isSupportSetDrawableSmallIcon()) {
                ...
                if (MinSdkChecker.isSupportTransmitMessageValue(this.b, messageV3.getUploadDataPackageName())) {
                    intent.putExtra(PushConstants.MZ_MESSAGE_VALUE, C6070d.a(messageV3));
                } else {
    ...
    protected abstract void a(T t, InterfaceC6080c interfaceC6080c);
    ...
    public final boolean a(MessageV3 messageV3, String str) {
        ...
        if (a(k, messageV3, str)) {
            ...
            C6102b.k(d(), messageV3.getPackageName(), e);
            DebugLogger.i("AbstractMessageHandler", "security check passed");
            return true;
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public String b() {
        return new C6045e.C6046a((String) C5943a.a(PushConstants.GET_PUBLIC_KEY).a().a().a()).a();
    }
    ...
    public void b(MessageV3 messageV3) {
        ...
        C6087a a = C6087a.a(messageV3);
        if (a != null) {
            DebugLogger.e("AbstractMessageHandler", "delete notifyId " + a.a() + " notifyKey " + a.b());
            if (TextUtils.isEmpty(a.b())) {
                C6091b.a(d()).a(messageV3.getUploadDataPackageName(), a.a());
            } else {
                C6091b.a(d()).a(messageV3.getUploadDataPackageName(), a.b());
            }
        }
    }
    ...
    */
    public boolean b(android.content.Intent r7) {
        ...
        Lba:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meizu.cloud.pushsdk.handler.a.AbstractC6034a.b(android.content.Intent):boolean");
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public AbstractC6033a c() {
        return this.a;
    }
    ...
    public void c(MessageV3 messageV3) {
        ...
        if (a != null) {
            ...
            if (TextUtils.isEmpty(a.b())) {
                C6082b.c(d(), messageV3.getUploadDataPackageName(), a.a());
            } else {
                C6082b.a(d(), messageV3.getUploadDataPackageName(), a.b());
            }
        }
    }
