...
public class C5924c {
    ...
    private final C5922a b;
    private final String c;
    private Class<?>[] d;

    /* JADX INFO: Access modifiers changed from: private */
    /* compiled from: Taobao */
    /* renamed from: com.meizu.cloud.pushsdk.b.b.c$a */
    /* loaded from: classes10.dex */
    public class C5925a {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C5924c(C5922a c5922a, String str, Class<?>... clsArr) {
        this.b = c5922a;
        this.c = str;
        this.d = clsArr;
    }
    ...
    private boolean a(Class<?>[] clsArr, Class<?>[] clsArr2) {
        if (clsArr.length == clsArr2.length) {
            for (int i = 0; i < clsArr2.length; i++) {
                if (clsArr2[i] != C5925a.class && !a(clsArr[i]).isAssignableFrom(a(clsArr2[i]))) {
                    return false;
                }
            }
            return true;
    ...
    public <T> C5926d<T> a(Object obj, Object... objArr) {
        ...
        try {
            ...
            c5926d.b = (T) method.invoke(obj, objArr);
            c5926d.a = true;
        } catch (Exception e) {
