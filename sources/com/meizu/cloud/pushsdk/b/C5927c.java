...
/* renamed from: com.meizu.cloud.pushsdk.b.c */
...
public class C5927c {
    ...
    public static boolean a() {
        String a2 = C5941i.a("ro.target.product");
    ...
    public static String b(Context context) {
        String deviceId;
        try {
            C5926d a2 = C5922a.a("android.telephony.MzTelephonyManager").a("getDeviceId", new Class[0]).a(new Object[0]);
