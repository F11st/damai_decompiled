...
/* renamed from: com.meizu.cloud.pushsdk.platform.b.c */
/* loaded from: classes10.dex */
public abstract class AbstractC6095c<T extends BasicPushStatus> {
    protected final Context a;
    protected String b;
    protected String c;
    protected String d;
    protected final C6090a e;
    private ScheduledExecutorService h;
    protected boolean f = true;
    protected boolean g = true;
    private String i = null;

    public AbstractC6095c(Context context, String str, String str2, C6090a c6090a, ScheduledExecutorService scheduledExecutorService) {
    ...
    */
    public boolean n() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meizu.cloud.pushsdk.platform.b.AbstractC6095c.n():boolean");
    }
}
