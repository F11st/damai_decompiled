...
import com.meizu.cloud.pushsdk.b.c.ExecutorC5930b;
...
public abstract class MzPushMessageReceiver extends BroadcastReceiver {
    ...
    private AbstractC6033a getAbstractAppLogicListener() {
        return new AbstractC6033a() { // from class: com.meizu.cloud.pushsdk.MzPushMessageReceiver.2
    ...
    public void onHandleIntent(Context context, Intent intent) {
        C5915b.a(context).a(TAG, getAbstractAppLogicListener()).a(intent);
    }
    ...
    public void onReceive(Context context, final Intent intent) {
        ...
        ExecutorC5930b.a().execute(new Runnable() { // from class: com.meizu.cloud.pushsdk.MzPushMessageReceiver.1
    ...
    public void onUpdateNotificationBuilder(PushNotificationBuilder pushNotificationBuilder) {
        pushNotificationBuilder.setStatusBarIcon(R.C5906drawable.stat_sys_third_app_notify);
    }
}
