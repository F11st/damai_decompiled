...
public class o {
    public static void a(Context context, Intent intent, Uri uri) {
        ...
        if (ed.a(context.getApplicationContext()).m855a() == null) {
            ed.a(context.getApplicationContext()).a(b.m629a(context.getApplicationContext()).m630a(), context.getPackageName(), ba.a(context.getApplicationContext()).a(ho.AwakeInfoUploadWaySwitch.a(), 0), new c());
    ...
    public static void a(Context context, String str) {
        com.xiaomi.channel.commonutils.logger.b.m586a("aw_ping : send aw_ping cmd and content to push service from 3rd app");
