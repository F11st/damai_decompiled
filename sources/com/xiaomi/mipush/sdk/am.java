...
public class am {
    ...
    private PushMessageHandler.a a(Cif cif, boolean z, byte[] bArr, String str, int i, Intent intent) {
        ...
        try {
            ...
            if (a4 == null) {
                com.xiaomi.channel.commonutils.logger.b.d("receiving an un-recognized message. " + cif.f617a);
                eo.a(this.f45a).b(this.f45a.getPackageName(), en.m858a(i), str, "18");
                s.c(this.f45a, cif, z);
                return null;
            }
            hj a5 = cif.a();
            com.xiaomi.channel.commonutils.logger.b.m586a("processing a message, action=" + a5);
            switch (an.a[a5.ordinal()]) {
                case 1:
                    if (!cif.m1030b()) {
                        com.xiaomi.channel.commonutils.logger.b.d("receiving an un-encrypt message(SendMessage).");
                        return null;
                    } else if (b.m629a(this.f45a).m640e() && !z) {
                        com.xiaomi.channel.commonutils.logger.b.m586a("receive a message in pause state. drop it");
                        ...
                        if (z || !m609a(this.f45a, str3)) {
                            MiPushMessage generateMessage = PushMessageHelper.generateMessage(imVar, cif.m1022a(), z);
                            ...
                            com.xiaomi.channel.commonutils.logger.b.m586a("receive a message, msgid=" + a6.m980a() + ", jobkey=" + str3 + ", btn=" + intExtra);
                            ...
                            if (z && generateMessage.getExtra() != null && !TextUtils.isEmpty(a7)) {
                                ...
                                if (a9 != null) {
                                    ...
                                    s.a(this.f45a, cif);
                                    com.xiaomi.channel.commonutils.logger.b.m586a("start activity succ");
                            ...
                            com.xiaomi.channel.commonutils.logger.b.m586a("drop a duplicate message, key=" + str3);
                ...
                case 2:
                    ik ikVar = (ik) a4;
                    String str6 = b.m629a(this.f45a).f62a;
                    if (TextUtils.isEmpty(str6) || !TextUtils.equals(str6, ikVar.m1051a())) {
                        com.xiaomi.channel.commonutils.logger.b.m586a("bad Registration result:");
                    ...
                    if (m619a > 0 && SystemClock.elapsedRealtime() - m619a > 900000) {
                        com.xiaomi.channel.commonutils.logger.b.m586a("The received registration result has expired.");
                        eo.a(this.f45a).b(this.f45a.getPackageName(), en.m858a(i), str, "26");
                        return null;
                    }
                    b.m629a(this.f45a).f62a = null;
                    int i3 = (ikVar.f680a > 0L ? 1 : (ikVar.f680a == 0L ? 0 : -1));
                    Context context2 = this.f45a;
                    if (i3 == 0) {
                        b.m629a(context2).b(ikVar.f692e, ikVar.f693f, ikVar.f699l);
                ...
                case 6:
                    ...
                    if (ieVar.f605a == 0) {
                        if (TextUtils.equals(b, ey.COMMAND_SET_ACCEPT_TIME.f325a) && m1016a != null && m1016a.size() > 1) {
                            ...
                            if ("00:00".equals(m1016a.get(0)) && "00:00".equals(m1016a.get(1))) {
                                b.m629a(this.f45a).a(true);
                            } else {
                                b.m629a(this.f45a).a(false);
                            }
                    ...
                    com.xiaomi.channel.commonutils.logger.b.e("resp-cmd:" + b + AVFSCacheConstants.COMMA_SEP + ieVar.a());
                ...
                case 7:
                    ...
                    if (a4 instanceof ia) {
                        ia iaVar = (ia) a4;
                        String a11 = iaVar.a();
                        com.xiaomi.channel.commonutils.logger.b.e("resp-type:" + iaVar.b() + ", code:" + iaVar.f575a + AVFSCacheConstants.COMMA_SEP + a11);
                        ...
                        if ("registration id expired".equalsIgnoreCase(iiVar.f641d)) {
                            ...
                            com.xiaomi.channel.commonutils.logger.b.e("resp-type:" + iiVar.f641d + AVFSCacheConstants.COMMA_SEP + iiVar.m1037a());
                            ...
                            if (iiVar.m1038a() != null && iiVar.m1038a().containsKey("app_version")) {
                                b.m629a(this.f45a).m632a(iiVar.m1038a().get("app_version"));
                                break;
                            }
                            ...
                            if (cif.m1030b() && iiVar.m1038a() != null && iiVar.m1038a().containsKey("awake_info")) {
                                ...
                                o.a(context3, b.m629a(context3).m630a(), ba.a(this.f45a).a(ho.AwakeInfoUploadWaySwitch.a(), 0), iiVar.m1038a().get("awake_info"));
                                break;
                            }
                        } else {
                            try {
                                if (ht.NormalClientConfigUpdate.f497a.equalsIgnoreCase(iiVar.f641d)) {
                                    ...
                                    com.xiaomi.channel.commonutils.logger.b.m586a("receive force sync notification");
    ...
    private PushMessageHandler.a a(Cif cif, byte[] bArr) {
        ...
        if (a2 == null) {
            com.xiaomi.channel.commonutils.logger.b.d("message arrived: receiving an un-recognized message. " + cif.f617a);
            return null;
        }
        hj a3 = cif.a();
        com.xiaomi.channel.commonutils.logger.b.m586a("message arrived: processing an arrived message, action=" + a3);
        ...
        if (cif.m1030b()) {
            ...
            if (a4 != null) {
                ...
                MiPushMessage generateMessage = PushMessageHelper.generateMessage(imVar, cif.m1022a(), false);
                generateMessage.setArrivedMessage(true);
                com.xiaomi.channel.commonutils.logger.b.m586a("message arrived: receive a message, msgid=" + a4.m980a() + ", jobkey=" + str2);
    ...
    private void a(Cif cif) {
        com.xiaomi.channel.commonutils.logger.b.m586a("receive a message but decrypt failed. report now.");
    ...
    private void a(ii iiVar) {
        ...
        ao.a(this.f45a).a(iaVar, hj.Notification, false, true, null, false, this.f45a.getPackageName(), b.m629a(this.f45a).m630a(), false);
    }
    ...
    private void b(ia iaVar) {
        ...
        if (m1003a != null) {
            ...
            if (str.contains("brand:" + ag.FCM.name())) {
                com.xiaomi.channel.commonutils.logger.b.m586a("ASSEMBLE_PUSH : receive fcm token sync ack");
                context = this.f45a;
                eVar = e.ASSEMBLE_PUSH_FCM;
            } else {
                if (str.contains("brand:" + ag.HUAWEI.name())) {
                    com.xiaomi.channel.commonutils.logger.b.m586a("ASSEMBLE_PUSH : receive hw token sync ack");
                    context = this.f45a;
                    eVar = e.ASSEMBLE_PUSH_HUAWEI;
                } else {
                    if (str.contains("brand:" + ag.OPPO.name())) {
                        com.xiaomi.channel.commonutils.logger.b.m586a("ASSEMBLE_PUSH : receive COS token sync ack");
                        context = this.f45a;
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a("ASSEMBLE_PUSH : receive FTOS token sync ack");
                        context = this.f45a;
            ...
            if (!TextUtils.isEmpty(str2)) {
                try {
                    ...
                    if (com.xiaomi.push.w.a(runningAppProcesses)) {
                        com.xiaomi.channel.commonutils.logger.b.m586a("detect failed because params illegal");
                        return;
                    }
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m586a("detect failed " + th);
                    return;
                }
            }
    ...
    public PushMessageHandler.a a(Intent intent) {
        ...
        com.xiaomi.channel.commonutils.logger.b.m586a("receive an intent from server, action=" + action);
            ...
            try {
                ...
                if (cif.a() == hjVar && !cif.m1030b()) {
                    if (com.xiaomi.push.service.al.m1167a(cif)) {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a(String.format("drop an un-encrypted wake-up messages. %1$s, %2$s", objArr));
                        a3 = eo.a(this.f45a);
                        packageName2 = this.f45a.getPackageName();
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a(String.format("drop an un-encrypted messages. %1$s, %2$s", objArr2));
                        a3 = eo.a(this.f45a);
                        packageName2 = this.f45a.getPackageName();
                        format = String.format("14: %1$s", cif.b());
                    }
                    a3.a(packageName2, intent, format);
                    s.a(this.f45a, cif, booleanExtra);
                    return null;
                }
                if (cif.a() == hjVar && cif.m1030b() && com.xiaomi.push.service.al.m1167a(cif) && (!booleanExtra || m1022a == null || m1022a.m989a() == null || !m1022a.m989a().containsKey("notify_effect"))) {
                    ...
                    com.xiaomi.channel.commonutils.logger.b.m586a(String.format("drop a wake-up messages which not has 'notify_effect' attr. %1$s, %2$s", objArr3));
                    eo.a(this.f45a).a(this.f45a.getPackageName(), intent, String.format("25: %1$s", cif.b()));
                    s.b(this.f45a, cif, booleanExtra);
                    return null;
                }
                if (m629a.m638c() || cif.f617a == hj.Registration) {
                    ...
                    if (cif.f617a != hj.UnRegistration) {
                        s.e(this.f45a, cif, booleanExtra);
                    ...
                    com.xiaomi.channel.commonutils.logger.b.d("receive message without registration. need re-register!registered?" + m639d);
