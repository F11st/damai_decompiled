...
public class FCMPushHelper {
    ...
    private static void a(Context context, Cif cif) {
        try {
            MiPushMessage generateMessage = PushMessageHelper.generateMessage((im) ai.a(context, cif), cif.m1022a(), false);
    ...
    */
    private static void a(android.content.Context r7, byte[] r8) {
        /*
            ...
            if (r1 == 0) goto L69
            if (r4 == 0) goto L69
            com.xiaomi.mipush.sdk.b r0 = com.xiaomi.mipush.sdk.b.m629a(r7)
        ...
        L31:
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a(r0)
            r3 = 0
            goto L67
        L42:
    ...
    public static void clearToken(Context context) {
        i.m650a(context, e.ASSEMBLE_PUSH_FCM);
    }
    ...
    public static boolean isFCMSwitchOpen(Context context) {
        return i.m653a(context, e.ASSEMBLE_PUSH_FCM) && MiPushClient.getOpenFCMPush(context);
    }
    ...
    public static void uploadToken(Context context, String str) {
        i.m651a(context, e.ASSEMBLE_PUSH_FCM, str);
    }
}
