...
public class bm implements eh {
    ...
    public void a(Context context, HashMap<String, String> hashMap) {
        ...
        if (!(context instanceof XMPushService)) {
            com.xiaomi.channel.commonutils.logger.b.m586a("MoleInfo : context is not correct in pushLayer " + iiVar.m1037a());
            return;
        }
        com.xiaomi.channel.commonutils.logger.b.m586a("MoleInfo : send data directly in pushLayer " + iiVar.m1037a());
