...
public class C7781x {
    ...
    public static void a(Context context, int i, String str) {
        ...
        synchronized (map) {
            for (String str2 : map.keySet()) {
                AbstractC7535b.m586a("notify registration error. " + str2);
    ...
    public static void a(XMPushService xMPushService) {
        ...
        try {
            ...
            AbstractC7535b.d("meet error when process pending message. " + e);
        ...
        try {
            ...
            synchronized (map) {
                for (String str : map.keySet()) {
                    AbstractC7535b.m586a("processing pending registration request. " + str);
            ...
            AbstractC7535b.d("fail to deal with pending register request. " + e);
            xMPushService.a(10, e);
        }
    }
    ...
    public static void a(String str, byte[] bArr) {
        Map<String, byte[]> map = f1002a;
        synchronized (map) {
            AbstractC7535b.m586a("pending registration request. " + str);
            map.put(str, bArr);
        }
    }
