...
public class y {
    ...
    public static void a(Context context, Cif cif, byte[] bArr) {
        try {
            al.a(cif);
            cif.m1022a();
            al.c m1163a = al.m1163a(context, cif, bArr);
            if (m1163a.a > 0 && !TextUtils.isEmpty(m1163a.f887a)) {
                hb.a(context, m1163a.f887a, m1163a.a, true, false, System.currentTimeMillis());
            }
            if (!com.xiaomi.push.m.m1119a(context) || !ag.a(context, cif, m1163a.f888a)) {
                b(context, cif, bArr);
                return;
            }
            ag.m1158a(context, cif);
            com.xiaomi.channel.commonutils.logger.b.m586a("consume this broadcast by tts");
        } catch (Exception e) {
            com.xiaomi.channel.commonutils.logger.b.m586a("notify push msg error " + e);
            e.printStackTrace();
        }
    }
    ...
    */
    ...
    private static void a(XMPushService xMPushService, byte[] bArr, long j) {
        ...
        if (TextUtils.isEmpty(a.f624b)) {
            com.xiaomi.channel.commonutils.logger.b.m586a("receive a mipush message without package name");
            return;
        }
        ...
        if (m1022a != null && m1022a.m988a() != null) {
            com.xiaomi.channel.commonutils.logger.b.e(String.format("receive a message. appid=%1$s, msgid= %2$s, action=%3$s", a.m1023a(), bd.a(m1022a.m988a()), a.a()));
        }
        if (m1022a != null) {
        ...
        String str = "";
        if (hjVar == a.a() && v.a(xMPushService).m1242a(a.f624b) && !al.m1167a(a)) {
            if (m1022a != null) {
                str = m1022a.m988a();
                if (al.e(a)) {
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a("Drop a message for unregistered, msgid=" + str);
            a(xMPushService, a, a.f624b);
        } else if (hjVar == a.a() && v.a(xMPushService).m1244c(a.f624b) && !al.m1167a(a)) {
            if (m1022a != null) {
                str = m1022a.m988a();
                if (al.e(a)) {
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a("Drop a message for push closed, msgid=" + str);
            a(xMPushService, a, a.f624b);
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a("Receive a message with wrong package name, expect " + xMPushService.getPackageName() + ", received " + a.f624b);
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a("Receive the uninstalled dual app message");
            try {
                ah.a(xMPushService, ah.a(a3, a.m1023a()));
                com.xiaomi.channel.commonutils.logger.b.m586a("uninstall " + a3 + " msg sent");
            } catch (gh e) {
    ...
    public static boolean a(Context context, String str, byte[] bArr) {
        if (com.xiaomi.push.h.m943a(context, str)) {
            ...
            try {
                ...
                com.xiaomi.channel.commonutils.logger.b.m586a("broadcast message arrived.");
                context.sendBroadcast(intent, ah.a(str));
                return true;
            } catch (Exception e) {
                com.xiaomi.channel.commonutils.logger.b.m586a("meet error when broadcast message arrived. " + e);
                return false;
            }
        }
        return false;
    ...
    private static boolean a(XMPushService xMPushService, String str, Cif cif, hw hwVar) {
        ...
        if (hwVar != null && hwVar.m989a() != null && hwVar.m989a().containsKey("__check_alive") && hwVar.m989a().containsKey("__awake")) {
            ...
            boolean m943a = com.xiaomi.push.h.m943a(xMPushService.getApplicationContext(), str);
    ...
    public void a(Context context, bg.b bVar, boolean z, int i, String str) {
        t m1238a;
        if (z || (m1238a = u.m1238a(context)) == null || !"token-expired".equals(str)) {
            return;
        }
        u.a(context, m1238a.f, m1238a.d, m1238a.e);
    }

    public void a(XMPushService xMPushService, fl flVar, bg.b bVar) {
        try {
            a(xMPushService, flVar.m893a(bVar.h), flVar.c());
    ...
    public void a(XMPushService xMPushService, gn gnVar, bg.b bVar) {
        if (!(gnVar instanceof gm)) {
            com.xiaomi.channel.commonutils.logger.b.m586a("not a mipush message");
            return;
        }
        gm gmVar = (gm) gnVar;
        gk a = gmVar.a("s");
        if (a != null) {
            try {
                a(xMPushService, bp.a(bp.a(bVar.h, gmVar.j()), a.c()), hb.a(gnVar.mo926a()));
            } catch (IllegalArgumentException e) {
                com.xiaomi.channel.commonutils.logger.b.a(e);
            }
        }
