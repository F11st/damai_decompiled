...
public class o {
    ...
    private o(Context context) {
        this.f975a = context;
        this.f982c = com.xiaomi.push.m.m1119a(context);
    ...
    private void a(String str, String str2, Map<String, String> map) {
        ...
        if (a2 != null) {
            a2.a(hnVar, this.f975a.getPackageName());
        }
    }
    ...
    private void a(boolean z) {
        if (m1218c()) {
            ...
            if (incrementAndGet >= 5) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m586a(String.format("[HB] accumulate %s hb count(%s) and write to file. ", objArr2));
    ...
    private long b() {
        return this.f976a.getLong(a.j(), -1L);
    }
    ...
    */
    private void b(java.lang.String r10) {
        ...
        L90:
            ...
            com.xiaomi.channel.commonutils.logger.b.m586a(r10)
            return
        */
    ...
    private boolean m1218c() {
        return d() && ba.a(this.f975a).a(ho.IntelligentHeartbeatDataCollectSwitchBoolean.a(), true) && com.xiaomi.push.q.China.name().equals(com.xiaomi.push.service.a.a(this.f975a).a());
    }
    ...
    private boolean m1219e() {
        long j = this.f976a.getLong(a.c(), -1L);
        if (j == -1) {
            return false;
        }
        long currentTimeMillis = System.currentTimeMillis();
    ...
    private void f() {
        ...
        if (this.f976a.getLong(a.i(), -1L) == -1) {
    ...
    private void g() {
        ...
        if (m1218c()) {
            ...
            if (!TextUtils.isEmpty(string) && (split = string.split("###")) != null) {
                ...
                while (i2 < split.length) {
                    if (!TextUtils.isEmpty(split[i2]) && (split2 = split[i2].split(":::")) != null && split2.length >= 4) {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a("[HB] report hb changed events.");
                    }
                    i2++;
                    c = 1;
                    c2 = 0;
            ...
            if (this.f976a.getBoolean(a.a(), false) && !this.f976a.getBoolean(a.b(), false)) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m586a("[HB] report support wifi digest events.");
            ...
            if (m1219e()) {
                ...
                if (i3 > 0 || i4 > 0) {
                    ...
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a("[HB] report short/long hb count events.");
                    } catch (Throwable unused) {
                    }
                }
            ...
            if (m1220f()) {
                ...
                if (i5 > 0) {
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a("[HB] report ping timeout count events of mobile network.");
                ...
                if (i6 > 0) {
                    try {
                        ...
                        com.xiaomi.channel.commonutils.logger.b.m586a("[HB] report ping timeout count events of wifi network.");
    ...
    public long m1221a() {
        ...
        com.xiaomi.channel.commonutils.logger.b.m586a("[HB] ping interval:" + b);
        return b;
    }
    ...
    public void a(int i) {
        this.f976a.edit().putLong(a.j(), System.currentTimeMillis() + (i * 1000)).apply();
    }
    ...
    public void m1224b() {
        if (d()) {
            ...
            if (this.f979a && !TextUtils.isEmpty(this.f977a) && this.f977a.equals(this.b)) {
                ...
                com.xiaomi.channel.commonutils.logger.b.m586a("[HB] ping timeout count:" + this.f978a);
                if (m1216a()) {
                    com.xiaomi.channel.commonutils.logger.b.m586a("[HB] change hb interval for net:" + this.f977a);
                    c(this.f977a);
                    this.f979a = false;
