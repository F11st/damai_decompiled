...
public class C7752e {
    ...
    private static final SparseArray<ay.C7732a<String, String, String>> a = new C7753f(5);
    private static final SparseArray<Integer> b = new C7754g(5);
    ...
    public static void a(Context context, String str) {
        ...
        if (!C7688m.m1119a(context) || TextUtils.isEmpty(str) || (m1187a = ax.a(context, str).m1187a()) == null) {
            return;
        }
        synchronized (C7752e.class) {
    ...
    public static void a(Context context, String str, String str2, int i, String str3, boolean z, int i2) {
        if (!C7688m.m1119a(context) || TextUtils.isEmpty(str3) || TextUtils.isEmpty(str2) || TextUtils.isEmpty(str)) {
            if (C7688m.m1119a(context)) {
                AbstractC7535b.m586a("ChannelPC: can`t setup permission with permissionCode:" + String.valueOf(str3) + " channelId:" + String.valueOf(str2) + " targetPkg:" + str);
                return;
            }
            return;
        }
        int a2 = C7787w.a(str3, 0);
        boolean a3 = a(i, a2);
        if (z) {
            a(str, str2, a2, i2);
            if (a3) {
    ...
    private static void a(SharedPreferences sharedPreferences, String str) {
        a(sharedPreferences, new C7755h(str));
    }
    ...
    public static void a(String str, String str2, int i, int i2) {
        ...
        for (int i3 : f971a) {
            if ((b.get(i3).intValue() & i2) == 0) {
                ...
                AbstractC7535b.m586a("ChannelPermissions.grantPermission:" + str + ":" + str2 + ": <" + i3 + "> :stoped by userLock");
            }
        }
    }

    private static void a(String str, String str2, int i, boolean z) {
        boolean a2 = ay.a(C7786v.m1245a(), str, str2, a.get(i), z);
        AbstractC7535b.m586a("ChannelPermissions.grantPermission:" + str + ":" + str2 + ": <" + i + "=" + z + "> :" + a2);
    }
    ...
    private static boolean a(String str, String str2, int i) {
        boolean z = ay.a(C7786v.m1245a(), str, str2, a.get(i)) == 1;
        AbstractC7535b.m586a("ChannelPermissions.checkPermission:" + str + ":" + str2 + ": <" + i + "=" + z + jn1.G);
        return z;
    }
}
