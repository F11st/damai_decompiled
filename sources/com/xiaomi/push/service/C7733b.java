...
public class C7733b extends al.AbstractRunnableC7597a {
    private ii a;
    ...
    public C7733b(ii iiVar, WeakReference<XMPushService> weakReference, boolean z) {
        this.f911a = false;
        this.a = iiVar;
    ...
    public void run() {
        ...
        this.a.a(bd.a());
        this.a.a(false);
        AbstractC7535b.c("MoleInfo aw_ping : send aw_Ping msg " + this.a.m1037a());
        try {
            String c = this.a.c();
            xMPushService.a(c, it.a(ah.a(c, this.a.b(), this.a, hj.Notification)), this.f911a);
        } catch (Exception e) {
            AbstractC7535b.d("MoleInfo aw_ping : send help app ping error" + e.toString());
        }
    }
}
