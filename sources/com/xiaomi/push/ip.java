...
public class ip implements iu<ip, Object>, Serializable, Cloneable {
    ...
    public int compareTo(ip ipVar) {
        ...
        if (getClass().equals(ipVar.getClass())) {
            ...
            if (!m1076a() || (a13 = iv.a(this.f746a, ipVar.f746a)) == 0) {
    ...
    public boolean m1077a(ip ipVar) {
        ...
        boolean m1076a2 = ipVar.m1076a();
        if ((m1076a || m1076a2) && !(m1076a && m1076a2 && this.f746a.equals(ipVar.f746a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = ipVar.b();
        if ((b2 || b3) && !(b2 && b3 && this.f745a.m1000a(ipVar.f745a))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = ipVar.c();
