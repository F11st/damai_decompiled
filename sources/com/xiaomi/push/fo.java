...
public class fo {
    ...
    public int a(fl flVar) {
        int c = flVar.c();
        if (c > 32768) {
            com.xiaomi.channel.commonutils.logger.b.m586a("Blob size=" + c + " should be less than 32768 Drop blob chid=" + flVar.a() + " id=" + flVar.e());
            return 0;
        }
        this.f377a.clear();
        int i = c + 8 + 4;
        ...
        com.xiaomi.channel.commonutils.logger.b.c("[Slim] Wrote {cmd=" + flVar.m888a() + ";chid=" + flVar.a() + ";len=" + position2 + "}");
        return position2;
    }
    ...
    public void a() {
        ...
        eVar.a(model);
        eVar.b(v.m1246a());
        eVar.c(com.xiaomi.push.service.bv.m1206a());
        eVar.b(48);
        eVar.d(this.f375a.m912b());
        eVar.e(this.f375a.mo910a());
        eVar.f(Locale.getDefault().toString());
        int i = Build.VERSION.SDK_INT;
        eVar.c(i);
        byte[] mo918a = this.f375a.m909a().mo918a();
        if (mo918a != null) {
            eVar.a(dx.b.a(mo918a));
        }
        fl flVar = new fl();
        flVar.a(0);
        flVar.a("CONN", (String) null);
        flVar.a(0L, "xiaomi.com", null);
        flVar.a(eVar.m852a(), (String) null);
        a(flVar);
        com.xiaomi.channel.commonutils.logger.b.m586a("[slim] open conn: andver=" + i + " sdk=48 tz=" + this.a + ":" + this.b + " Model=" + model + " os=" + Build.VERSION.INCREMENTAL);
    }
