...
public class hn implements iu<hn, Object>, Serializable, Cloneable {
    ...
    public int compareTo(hn hnVar) {
        ...
        if (getClass().equals(hnVar.getClass())) {
            int compareTo = Boolean.valueOf(m960a()).compareTo(Boolean.valueOf(hnVar.m960a()));
            if (compareTo != 0) {
                return compareTo;
            }
            if (!m960a() || (a12 = iv.a(this.f469a, hnVar.f469a)) == 0) {
                int compareTo2 = Boolean.valueOf(m962b()).compareTo(Boolean.valueOf(hnVar.m962b()));
                if (compareTo2 != 0) {
                    return compareTo2;
                }
                if (!m962b() || (a11 = iv.a(this.f474b, hnVar.f474b)) == 0) {
                    int compareTo3 = Boolean.valueOf(m963c()).compareTo(Boolean.valueOf(hnVar.m963c()));
                    if (compareTo3 != 0) {
                        return compareTo3;
                    }
                    if (!m963c() || (a10 = iv.a(this.f475c, hnVar.f475c)) == 0) {
                        int compareTo4 = Boolean.valueOf(m964d()).compareTo(Boolean.valueOf(hnVar.m964d()));
                        if (compareTo4 != 0) {
                            return compareTo4;
                        }
                        if (!m964d() || (a9 = iv.a(this.f468a, hnVar.f468a)) == 0) {
                            int compareTo5 = Boolean.valueOf(m965e()).compareTo(Boolean.valueOf(hnVar.m965e()));
                            if (compareTo5 != 0) {
                                return compareTo5;
                            }
                            if (!m965e() || (a8 = iv.a(this.f473b, hnVar.f473b)) == 0) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m961a(hn hnVar) {
        if (hnVar == null) {
            return false;
        }
        boolean m960a = m960a();
        boolean m960a2 = hnVar.m960a();
        if ((m960a || m960a2) && !(m960a && m960a2 && this.f469a.equals(hnVar.f469a))) {
            return false;
        }
        boolean m962b = m962b();
        boolean m962b2 = hnVar.m962b();
        if ((m962b || m962b2) && !(m962b && m962b2 && this.f474b.equals(hnVar.f474b))) {
            return false;
        }
        boolean m963c = m963c();
        boolean m963c2 = hnVar.m963c();
        if ((m963c || m963c2) && !(m963c && m963c2 && this.f475c.equals(hnVar.f475c))) {
            return false;
        }
        boolean m964d = m964d();
        boolean m964d2 = hnVar.m964d();
        if ((m964d || m964d2) && !(m964d && m964d2 && this.f468a == hnVar.f468a)) {
            return false;
        }
        boolean m965e = m965e();
        boolean m965e2 = hnVar.m965e();
        if ((m965e || m965e2) && !(m965e && m965e2 && this.f473b == hnVar.f473b)) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = hnVar.f();
