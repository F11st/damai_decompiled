...
public class in implements iu<in, Object>, Serializable, Cloneable {
    ...
    public int compareTo(in inVar) {
        ...
        if (getClass().equals(inVar.getClass())) {
            int compareTo = Boolean.valueOf(m1069a()).compareTo(Boolean.valueOf(inVar.m1069a()));
            if (compareTo != 0) {
                return compareTo;
            }
            if (!m1069a() || (a9 = iv.a(this.f725a, inVar.f725a)) == 0) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m1070a(in inVar) {
        if (inVar == null) {
            return false;
        }
        boolean m1069a = m1069a();
        boolean m1069a2 = inVar.m1069a();
        if ((m1069a || m1069a2) && !(m1069a && m1069a2 && this.f725a.equals(inVar.f725a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = inVar.b();
        if ((b2 || b3) && !(b2 && b3 && this.f724a.m1000a(inVar.f724a))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = inVar.c();
