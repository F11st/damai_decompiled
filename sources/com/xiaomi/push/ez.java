...
public enum ez {
    ...
    GSLB_TCP_NOACCESS(SystemMessageConstants.H5_LOGIN_FAILURE),
    ...
    GSLB_ERR(10999),
    CONN_SUCCESS(20000),
    CONN_TCP_NOACCESS(ErrorConstants.REQUEST_ERROR_CODE_NO_RESPONSE),
    CONN_TCP_NETUNREACH(20102),
    CONN_TCP_CONNREFUSED(ErrorConstants.REQUEST_ERROR_CODE_SOCKET_TIMEOUT),
                        ...
                        switch (i) {
                            ...
                            default:
                                switch (i) {
                                    ...
                                    default:
                                        switch (i) {
                                            case ErrorConstants.REQUEST_ERROR_CODE_NO_RESPONSE /* 20101 */:
                                                return CONN_TCP_NOACCESS;
                                            case 20102:
                                                return CONN_TCP_NETUNREACH;
                                            case ErrorConstants.REQUEST_ERROR_CODE_SOCKET_TIMEOUT /* 20103 */:
