...
public class hv implements iu<hv, Object>, Serializable, Cloneable {
    ...
    public int compareTo(hv hvVar) {
        ...
        if (getClass().equals(hvVar.getClass())) {
            int compareTo = Boolean.valueOf(m982a()).compareTo(Boolean.valueOf(hvVar.m982a()));
            if (compareTo != 0) {
                return compareTo;
            }
            if (!m982a() || (a19 = iv.a(this.f510a, hvVar.f510a)) == 0) {
                int compareTo2 = Boolean.valueOf(m984b()).compareTo(Boolean.valueOf(hvVar.m984b()));
                if (compareTo2 != 0) {
                    return compareTo2;
                }
                if (!m984b() || (a18 = iv.a(this.f511a, hvVar.f511a)) == 0) {
                    int compareTo3 = Boolean.valueOf(m985c()).compareTo(Boolean.valueOf(hvVar.m985c()));
                    if (compareTo3 != 0) {
                        return compareTo3;
                    }
                    if (!m985c() || (a17 = iv.a(this.f515b, hvVar.f515b)) == 0) {
    ...
    /* renamed from: a  reason: collision with other method in class */
    public boolean m983a(hv hvVar) {
        if (hvVar == null) {
            return false;
        }
        boolean m982a = m982a();
        boolean m982a2 = hvVar.m982a();
        if ((m982a || m982a2) && !(m982a && m982a2 && this.f510a.m1000a(hvVar.f510a))) {
            return false;
        }
        boolean m984b = m984b();
        boolean m984b2 = hvVar.m984b();
        if ((m984b || m984b2) && !(m984b && m984b2 && this.f511a.equals(hvVar.f511a))) {
            return false;
        }
        boolean m985c = m985c();
        boolean m985c2 = hvVar.m985c();
        if ((m985c || m985c2) && !(m985c && m985c2 && this.f515b.equals(hvVar.f515b))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = hvVar.d();
        ...
        boolean l2 = l();
        boolean l3 = hvVar.l();
        if ((l2 || l3) && !(l2 && l3 && this.f509a.m992a(hvVar.f509a))) {
            return false;
        }
        boolean m2 = m();
        boolean m3 = hvVar.m();
