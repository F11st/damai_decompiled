...
public class C7627db {
            ...
            case 11:
                ...
                if (iuVar != null) {
                    try {
                        ...
                        AbstractC7535b.d("PERF_ERROR : parse Notification type error");
                        return a;
                    }
                }
                break;
            case 12:
                ...
                if (iuVar != null) {
                    try {
                        ...
                        AbstractC7535b.d("PERF_ERROR : parse Command type error");
                        break;
                    }
                }
                break;
    ...
    public static void a(String str, Context context, byte[] bArr) {
        ...
        try {
            ...
            AbstractC7535b.m586a("fail to convert bytes to container");
        }
    }
}
