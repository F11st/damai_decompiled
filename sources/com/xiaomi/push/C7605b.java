...
public final class C7605b {
    ...
    private C7605b(InputStream inputStream) {
    ...
    private C7605b(byte[] bArr, int i, int i2) {
        this.f = Integer.MAX_VALUE;
        this.h = 64;
        this.i = ConfigReporter.BIT_GETTER_IMP;
        this.f119a = bArr;
    ...
    public static C7605b a(InputStream inputStream) {
        return new C7605b(inputStream);
    }

    public static C7605b a(byte[] bArr, int i, int i2) {
        return new C7605b(bArr, i, i2);
    }
    ...
    public C7593a m675a() {
        ...
        int i2 = this.c;
        if (d > i - i2 || d <= 0) {
            return C7593a.a(m681a(d));
        }
        C7593a a = C7593a.a(this.f119a, i2, d);
        this.c += d;
        return a;
    }
    ...
    public void a(AbstractC7646e abstractC7646e) {
        int d = d();
        if (this.g >= this.h) {
            throw C7626d.g();
        }
