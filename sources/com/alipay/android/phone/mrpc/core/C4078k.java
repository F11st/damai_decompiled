...
public final class C4078k {
    ...
    public static class C4079a {
        ...
        public C4079a(int i, int i2, int i3) {
            this.a = i;
            this.b = i2;
            this.c = i3;
        }
    ...
    public static long a(String str) {
        ...
        time.set(c4079a.c, c4079a.b, c4079a.a, i2, i3, i4);
    ...
    public static C4079a e(String str) {
        int i;
        int i2;
        int i3;
        ...
        int i4 = i + 1 + 1 + 1 + 1;
        return new C4079a(charAt, ((str.charAt(i2) - '0') * 10) + (str.charAt(i3) - '0'), ((str.charAt(i4) - '0') * 10) + (str.charAt(i4 + 1) - '0'));
    }
}
