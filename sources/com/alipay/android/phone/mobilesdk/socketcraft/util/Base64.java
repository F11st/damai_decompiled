...
public class Base64 {
        ...
        public int read() {
            ...
            if (this.b < 0) {
                if (this.a) {
                    ...
                    Base64.f(bArr, 0, i, this.c, 0, this.h);
                    this.b = 0;
                    this.e = 4;
                } else {
    ...
    public static class OutputStream extends FilterOutputStream {
        ...
        public void flushBase64() {
            ...
            if (i > 0) {
                if (this.a) {
                    ((FilterOutputStream) this).out.write(Base64.g(this.g, this.c, i, this.i));
                    this.b = 0;
                    return;
                }
        ...
        public void write(int i) {
            if (this.h) {
                ...
                int i4 = this.d;
                if (i3 >= i4) {
                    ((FilterOutputStream) this).out.write(Base64.g(this.g, bArr, i4, this.i));
                    int i5 = this.e + 4;
                    this.e = i5;
                    if (this.f && i5 >= 76) {
    ...
    public static byte[] encodeBytesToBytes(byte[] bArr, int i, int i2, int i3) {
        ...
        if (i < 0) {
            ...
            if ((i3 & 2) != 0) {
                ...
                int i12 = i7;
                if (i12 < i2) {
                    f(bArr, i12 + i, i2 - i12, bArr2, i8, i3);
                    i8 += 4;
                }
                int i13 = i8;
                if (i13 <= i5 - 1) {
