...
import com.alipay.sdk.m.q.C4279b;
...
public final class C4245a {
    ...
    public List<C4247b> C = null;
    public int D = -1;

    /* compiled from: Taobao */
    /* renamed from: com.alipay.sdk.m.m.a$a */
    /* loaded from: classes12.dex */
    public class RunnableC4246a implements Runnable {
        public final /* synthetic */ C4293a a;
        public final /* synthetic */ Context b;
        public final /* synthetic */ boolean c;
        public final /* synthetic */ int d;

        public RunnableC4246a(C4293a c4293a, Context context, boolean z, int i) {
            this.a = c4293a;
            this.b = context;
            this.c = z;
            this.d = i;
        ...
        public void run() {
            try {
                C4268b a = new C4279b().a(this.a, this.b);
                if (a != null) {
                    C4245a.this.G(this.a, a.a());
                    C4245a.this.F(C4293a.h());
                    C4293a c4293a = this.a;
                    C4218a.a(c4293a, C4226b.l, "offcfg|" + this.c + "|" + this.d);
                }
            } catch (Throwable th) {
                C4302e.a(th);
            }
    ...
    private JSONObject E() throws JSONException {
        ...
        jSONObject.put(J0, u());
        jSONObject.put(D0, z());
        jSONObject.put(C4298a.b, a());
        return jSONObject;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void F(C4293a c4293a) {
        try {
            JSONObject E2 = E();
            C4314j.b(c4293a, C4295b.d().b(), g0, E2.toString());
        } catch (Exception e) {
            C4302e.a(e);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void G(C4293a c4293a, String str) {
        ...
        try {
            ...
            C4298a.a(c4293a, optJSONObject, C4298a.a(c4293a, jSONObject));
            if (optJSONObject != null) {
                I(optJSONObject);
            } else {
                C4302e.e(E, "empty config");
            }
        } catch (Throwable th) {
            C4302e.a(th);
        }
    ...
    private void I(JSONObject jSONObject) {
        ...
        this.C = C4247b.a(jSONObject.optJSONArray(l0));
        ...
        this.A = jSONObject.optJSONObject(C4298a.b);
    }
    ...
    public int k() {
        int i = this.a;
        if (i >= 1000 && i <= 20000) {
            C4302e.b(E, "time = " + this.a);
            return this.a;
        }
        C4302e.b(E, "time(def) = 10000");
        return 10000;
    }

    public List<C4247b> l() {
        return this.C;
    }
    ...
    public void t() {
        ...
        String a = C4314j.a(C4293a.h(), b, g0, null);
        try {
            this.D = Integer.parseInt(C4314j.a(C4293a.h(), b, z0, "-1"));
    ...
    /* loaded from: classes12.dex */
    public static final class C4247b {
        public final String a;
        public final int b;
        public final String c;

        public C4247b(String str, int i, String str2) {
            this.a = str;
            this.b = i;
            this.c = str2;
        }

        public static C4247b a(JSONObject jSONObject) {
            if (jSONObject == null) {
                return null;
            }
            return new C4247b(jSONObject.optString(IRequestConst.PN), jSONObject.optInt("v", 0), jSONObject.optString(PushConstants.URI_PACKAGE_NAME));
        }
        ...
        public static List<C4247b> a(JSONArray jSONArray) {
            if (jSONArray == null) {
                return null;
            }
            ...
            for (int i = 0; i < length; i++) {
                C4247b a = a(jSONArray.optJSONObject(i));
                if (a != null) {
                    arrayList.add(a);
                }
            }
        ...
        public static JSONObject a(C4247b c4247b) {
            if (c4247b == null) {
                return null;
            }
            try {
                return new JSONObject().put(IRequestConst.PN, c4247b.a).put("v", c4247b.b).put(PushConstants.URI_PACKAGE_NAME, c4247b.c);
        ...
        public static JSONArray a(List<C4247b> list) {
            if (list == null) {
                return null;
            }
            JSONArray jSONArray = new JSONArray();
            for (C4247b c4247b : list) {
                jSONArray.put(a(c4247b));
            }
            return jSONArray;
        }
    }
    ...
    public void a(C4293a c4293a, Context context, boolean z, int i) {
        C4218a.a(c4293a, C4226b.l, "oncfg|" + z + "|" + i);
        RunnableC4246a runnableC4246a = new RunnableC4246a(c4293a, context, z, i);
        if (z && !C4318n.h()) {
            int C = C();
            if (C4318n.a(C, runnableC4246a, "AlipayDCPBlok")) {
                return;
            }
            C4218a.b(c4293a, C4226b.l, C4226b.m0, "" + C);
            return;
        }
        Thread thread = new Thread(runnableC4246a);
    ...
    public boolean a(Context context, int i) {
        if (this.D == -1) {
            this.D = C4318n.a();
            C4314j.b(C4293a.h(), context, z0, String.valueOf(this.D));
        }
        return this.D < i;
    }
}
