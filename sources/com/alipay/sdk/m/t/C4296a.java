...
public class C4296a {
    ...
    public static synchronized C4296a a(Context context) {
        C4296a c4296a;
    ...
    */
    private void l() {
        /*
            ...
            r5 = 1
            java.lang.String r3 = com.alipay.sdk.m.t.C4296a.C4297a.a(r3, r4, r5)     // Catch: java.lang.Exception -> L52
        ...
        L55:
            r6 = r5
        L56:
            com.alipay.sdk.m.u.C4302e.a(r0)
        L59:
            r0 = r2
            r2 = r3
        L5b:
            ...
            com.alipay.sdk.m.u.C4302e.b(r3, r4)
        ...
        L7a:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.m.t.C4296a.l():void");
    }
    ...
    private void n() {
        try {
            ...
            C4297a.a(g, h, jSONObject.toString(), true);
        } catch (Exception e) {
            C4302e.a(e);
        }
    }
    ...
    /* loaded from: classes12.dex */
    public static class C4297a {
        public static boolean a(String str, String str2) {
            if (C4296a.n == null) {
                return false;
            }
            return C4296a.n.getSharedPreferences(str, 0).contains(str2);
        }
        ...
        public static void b(String str, String str2) {
            ...
            C4296a.n.getSharedPreferences(str, 0).edit().remove(str2).apply();
        }
        ...
        public static String a(String str, String str2, boolean z) {
            ...
            String string = C4296a.n.getSharedPreferences(str, 0).getString(str2, null);
            if (!TextUtils.isEmpty(string) && z) {
                string = C4254e.a(a(), string, string);
                if (TextUtils.isEmpty(string)) {
                    C4302e.b(C4230a.z, "tid_str: pref failed");
                }
            }
            C4302e.b(C4230a.z, "tid_str: from local");
            return string;
        }
        ...
        public static void a(String str, String str2, String str3, boolean z) {
            ...
            SharedPreferences sharedPreferences = C4296a.n.getSharedPreferences(str, 0);
            if (z) {
                String a = a();
                String b = C4254e.b(a, str3, str3);
        ...
        public static String a() {
            String str;
            try {
                str = C4296a.n.getApplicationContext().getPackageName();
            } catch (Throwable th) {
                C4302e.a(th);
                str = "";
            }
    ...
    public void a() {
        C4302e.b(C4230a.z, "tid_str: del");
        m();
    }

    public void a(String str, String str2) {
        C4302e.b(C4230a.z, "tid_str: save");
