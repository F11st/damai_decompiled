...
public final class d {
    ...
    public static boolean a(Context context) {
        ...
        int length;
        try {
            if (!Build.HARDWARE.contains("goldfish") && !com.alibaba.wireless.security.aopsdk.replace.android.os.Build.getPRODUCT().contains(a.C0166a.a) && !Build.FINGERPRINT.contains("generic")) {
