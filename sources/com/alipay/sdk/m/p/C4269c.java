...
import com.alipay.sdk.m.n.C4253d;
...
public final class C4269c {
    public boolean a;
    public String b = C4318n.a(24);

    public C4269c(boolean z) {
        this.a = z;
    }

    public static byte[] b(String str, byte[] bArr, String str2) {
        return C4254e.b(str, bArr, str2);
    }

    public C4270d a(C4268b c4268b, boolean z, String str) {
        byte[] a;
        if (c4268b == null) {
            return null;
        }
        byte[] bytes = c4268b.b().getBytes();
        byte[] bytes2 = c4268b.a().getBytes();
        if (z) {
            try {
                bytes2 = C4251b.a(bytes2);
            } catch (Exception unused) {
                z = false;
            }
        }
        if (this.a) {
            a = a(bytes, a(this.b, C4230a.e), b(this.b, bytes2, str));
        } else {
            a = a(bytes, bytes2);
        }
        return new C4270d(z, a);
    }
    ...
    */
    public com.alipay.sdk.m.p.C4268b a(com.alipay.sdk.m.p.C4270d r6, java.lang.String r7) {
        /*
            r5 = this;
            r0 = 0
        ...
        L42:
            ...
            if (r6 == 0) goto L4c
            byte[] r2 = com.alipay.sdk.m.n.C4251b.b(r2)     // Catch: java.lang.Exception -> L59 java.lang.Throwable -> L77
        L4c:
        ...
        L60:
            ...
            r4 = r1
        L63:
            com.alipay.sdk.m.u.C4302e.a(r6)     // Catch: java.lang.Throwable -> L77
            if (r1 == 0) goto L6b
        ...
        L7e:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.m.p.C4269c.a(com.alipay.sdk.m.p.d, java.lang.String):com.alipay.sdk.m.p.b");
    }

    public static byte[] a(String str, String str2) {
        return C4253d.a(str, str2);
    }

    public static byte[] a(String str, byte[] bArr, String str2) {
        return C4254e.a(str, bArr, str2);
    }
    ...
    */
    public static byte[] a(byte[]... r7) {
        ...
        L41:
            ...
            r2 = r1
        L44:
            com.alipay.sdk.m.u.C4302e.a(r7)     // Catch: java.lang.Throwable -> L54
            if (r1 == 0) goto L4e
        ...
        L63:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.sdk.m.p.C4269c.a(byte[][]):byte[]");
    }
