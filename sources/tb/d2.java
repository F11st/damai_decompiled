...
public abstract class d2 extends t40 implements ReceiverParameterDescriptor {
    private static final ni1 c = ni1.i("<this>");

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public d2(@NotNull Annotations annotations) {
        super(annotations, c);
        if (annotations == null) {
            a(0);
        }
    ...
    public ReceiverParameterDescriptor substitute(@NotNull TypeSubstitutor typeSubstitutor) {
        ...
        if (getContainingDeclaration() instanceof ClassDescriptor) {
            q = typeSubstitutor.q(getType(), Variance.OUT_VARIANCE);
        } else {
            q = typeSubstitutor.q(getType(), Variance.INVARIANT);
        }
        if (q == null) {
            return null;
        }
        return q == getType() ? this : new iz1(getContainingDeclaration(), new vp2(q), getAnnotations());
    }
}
