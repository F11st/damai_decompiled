...
public class zh1 implements IConverter<BaseResponse, BaseSection, GlobalConfig, List<Node>> {
    ...
    */
    public java.util.List<cn.damai.tetris.v2.common.Node> convert(cn.damai.tetris.core.mtop.BaseResponse r5, cn.damai.tetris.core.BaseSection r6, cn.damai.tetris.core.mtop.GlobalConfig r7, tb.C9039db r8) {
        /*
            r4 = this;
            com.android.alibaba.ip.runtime.IpChange r0 = tb.zh1.$ipChange
            java.lang.String r1 = "1792214578"
        ...
        L66:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.zh1.convert(cn.damai.tetris.core.mtop.BaseResponse, cn.damai.tetris.core.BaseSection, cn.damai.tetris.core.mtop.GlobalConfig, tb.db):java.util.List");
    }
}
