...
public class un2 extends cn.damai.common.user.b {
    ...
    public a.b A(String str, String str2, String str3, Map<String, String> map, Boolean bool) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-26861988") ? (a.b) ipChange.ipc$dispatch("-26861988", new Object[]{this, str, str2, str3, map, bool}) : e(str, str2, str3, map, bool);
    }

    public a.b B(String str, String str2, String str3, int i) {
        IpChange ipChange = $ipChange;
    ...
    public a.b D(String str, String str2, String str3, String str4) {
        IpChange ipChange = $ipChange;
    ...
    public a.b H(int i, Map<String, String> map) {
        IpChange ipChange = $ipChange;
    ...
    public a.b I() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "259670487") ? (a.b) ipChange.ipc$dispatch("259670487", new Object[]{this}) : e(TICKLET_LIST_PAGE, "list", "loginbutton", new HashMap(), Boolean.FALSE);
    }

    public a.b J(String str, int i) {
        IpChange ipChange = $ipChange;
    ...
    public a.b K(String str, String str2, int i, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b M(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b N(String str, String str2, String str3, String str4) {
        IpChange ipChange = $ipChange;
    ...
    public a.b Q(String str, String str2, String str3, String str4, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b R() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "287634522") ? (a.b) ipChange.ipc$dispatch("287634522", new Object[]{this}) : e(TICKLET_LIST_PAGE, "top", "transferother_msg", new HashMap(), Boolean.TRUE);
    }
    ...
    public void g(String str, String str2, String str3, String str4) {
        ...
        try {
            ...
            hashMap.put("usercode", z20.E());
            cn.damai.common.user.c.e().A(hashMap, "local_data", "ticket_local");
    ...
    public void h(String str, String str2, String str3) {
        ...
        hashMap.put("item_id", str2);
        hashMap.put("screening_id", str3);
        cn.damai.common.user.c.e().x(e(TICKLET_DETAIL_PAGE, "local", str, hashMap, Boolean.FALSE));
    }
    ...
    public a.b l(String str) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-733153414") ? (a.b) ipChange.ipc$dispatch("-733153414", new Object[]{this, str}) : new a.b().i(str);
    }
    ...
    public a.b o(String str, String str2, String str3, String str4, String str5, boolean z) {
        IpChange ipChange = $ipChange;
    ...
    public a.b p(String str, String str2, String str3) {
        IpChange ipChange = $ipChange;
    ...
    public a.b v(int i, String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public a.b x(int i, String str, String str2) {
        IpChange ipChange = $ipChange;
    ...
    public a.b y(String str, String str2, String str3, int i) {
        IpChange ipChange = $ipChange;
