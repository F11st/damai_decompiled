...
public final class p61 {
    ...
    @NotNull
    private static final List<hp0> d;
    @NotNull
    private static final hp0 e;
    @NotNull
    private static final hp0 f;
    @NotNull
    private static final List<hp0> g;
    @NotNull
    private static final hp0 h;
    @NotNull
    private static final hp0 i;
    @NotNull
    private static final hp0 j;
    @NotNull
    private static final hp0 k;
    @NotNull
    private static final List<hp0> l;
    @NotNull
    private static final List<hp0> m;
    ...
    static {
        ...
        List<hp0> j11;
        List<hp0> j12;
        hp0 hp0Var = new hp0("org.jspecify.nullness.Nullable");
        a = hp0Var;
        hp0 hp0Var2 = new hp0("org.jspecify.nullness.NullnessUnspecified");
        b = hp0Var2;
        ...
        h = hp0Var5;
        hp0 hp0Var6 = new hp0("org.checkerframework.checker.nullness.compatqual.NonNullDecl");
        i = hp0Var6;
        hp0 hp0Var7 = new hp0("androidx.annotation.RecentlyNullable");
        j = hp0Var7;
    ...
    @NotNull
    public static final List<hp0> j() {
        return m;
    }

    @NotNull
    public static final List<hp0> k() {
        return g;
    }

    @NotNull
    public static final List<hp0> l() {
        return d;
    }

    @NotNull
    public static final List<hp0> m() {
        return l;
    }
}
