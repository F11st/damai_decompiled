...
public class ce2 implements DMNav.NavPreprocessor {
    ...
    /* compiled from: Taobao */
    /* renamed from: tb.ce2$a */
    /* loaded from: classes7.dex */
    public class C9001a implements SoInstallListener {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ Context a;
        final /* synthetic */ Intent b;

        C9001a(ce2 ce2Var, Context context, Intent intent) {
            this.a = context;
            this.b = intent;
        }
    ...
    public boolean beforeNavTo(Intent intent, Context context) {
        ...
        C1768a.d().b(context, SoGroupEnum.VR, new C9001a(this, context, intent));
        C1768a.f("VrNavProcessor 启动了 VR DMNav 拦截");
        return true;
    }
}
