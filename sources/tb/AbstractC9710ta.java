...
public abstract class AbstractC9710ta {
    @Nullable
    ...
    /* loaded from: classes8.dex */
    public static final class C9711a implements PopupListener {
        final /* synthetic */ PopupListener b;

        C9711a(PopupListener popupListener) {
        ...
        public void onFail(@Nullable String str, @Nullable String str2) {
            PopupPriorityManager b = AbstractC9710ta.this.b();
            if (b != null) {
                b.j(null);
            }
    ...
    public static /* synthetic */ void f(AbstractC9710ta abstractC9710ta, String str, String str2, ArrayList arrayList, JSONObject jSONObject, PopupListener popupListener, int i, Object obj) {
        if (obj != null) {
        ...
        abstractC9710ta.e(str, (i & 2) != 0 ? null : str2, (i & 4) != 0 ? null : arrayList, (i & 8) != 0 ? null : jSONObject, (i & 16) == 0 ? popupListener : null);
    }
    ...
    public final void e(@NotNull String str, @Nullable String str2, @Nullable ArrayList<String> arrayList, @Nullable JSONObject jSONObject, @Nullable PopupListener popupListener) {
        ...
        if (a != null) {
            ...
            if (str2 == null) {
                str2 = a.getClass().getSimpleName();
            }
            String str3 = str2;
            b41.h(str3, "sceneType ?: it::class.java.simpleName");
            popupRequest.b(a, str, str3, arrayList, jSONObject, new C9711a(popupListener));
            wt2Var = wt2.INSTANCE;
        } else {
            wt2Var = null;
        }
