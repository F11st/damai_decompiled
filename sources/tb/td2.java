...
public class td2 extends cn.damai.common.user.b {
    ...
    public static final td2 i() {
        ...
        return AndroidInstantRuntime.support(ipChange, "1886578139") ? (td2) ipChange.ipc$dispatch("1886578139", new Object[0]) : a.a;
    }
    ...
    public a.b l(long j) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-420013931") ? (a.b) ipChange.ipc$dispatch("-420013931", new Object[]{this, Long.valueOf(j)}) : new a.b().d(String.valueOf(j)).i("screenings");
    }
    ...
    public void u(PerformBean performBean, String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1111657225")) {
            ...
            cn.damai.common.user.c.e().A(hashMap, "yhtc_screening_discountinfo", "screenings");
        }
    }
    ...
    public void v(View view, long j, int i) {
        ...
        cn.damai.common.user.c.e().G(view, "heat_index", "bottom", PROJECT_SCREENINGS_PRE_PAGE, hashMap);
    }
    ...
    public void w(View view, long j, String str) {
        ...
        hashMap.put("item_id", j + "");
        cn.damai.common.user.c.e().G(view, "seatmap", "center", "screenings", hashMap);
    }
    ...
    public void x(View view, long j) {
        ...
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", j + "");
        cn.damai.common.user.c.e().G(view, "alert", "center", "screenings", hashMap);
    }
