...
public abstract class AbstractC9433ma<OUT, NEXT_OUT extends Releasable> extends BaseChainProducer<OUT, NEXT_OUT, C6865a> {
    private final DiskCacheSupplier j;

    public AbstractC9433ma(int i, int i2, DiskCacheSupplier diskCacheSupplier) {
        super(i, i2);
    ...
    public ne0 J(@NonNull C6865a c6865a, String str, int i, int[] iArr) {
        p22 I = I(c6865a.E(), str, i, iArr);
        if (I != null) {
            try {
                return ne0.c(I, null);
            } catch (Exception e) {
                xt2.m("DiskCache", c6865a, "transform data from response[type:%d] error=%s", Integer.valueOf(I.a), e);
                return null;
            }
        }
        return null;
    ...
    */
    public int L(com.taobao.phenix.request.C6865a r17, tb.oe0 r18, boolean r19) {
        /*
            r16 = this;
            r0 = r17
            r1 = r18
        ...
        Lc2:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: tb.AbstractC9433ma.L(com.taobao.phenix.request.a, tb.oe0, boolean):int");
    }
}
