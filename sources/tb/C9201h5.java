...
public class C9201h5 {
    ...
    /* compiled from: Taobao */
    /* renamed from: tb.h5$a */
    /* loaded from: classes10.dex */
    public class DialogInterface$OnClickListenerC9202a implements DialogInterface.OnClickListener {
        final /* synthetic */ Context a;

        DialogInterface$OnClickListenerC9202a(Context context) {
            this.a = context;
        }
        ...
        public void onClick(DialogInterface dialogInterface, int i) {
            ...
            try {
                ...
                Log.e(C9201h5.a, "Google Play Services is not installed, unable to download VrCore.");
            }
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: tb.h5$b */
    /* loaded from: classes10.dex */
    public class DialogInterface$OnClickListenerC9203b implements DialogInterface.OnClickListener {
        final /* synthetic */ Context a;

        DialogInterface$OnClickListenerC9203b(Context context) {
            this.a = context;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    /* compiled from: Taobao */
    /* renamed from: tb.h5$c */
    /* loaded from: classes10.dex */
    public class DialogInterface$OnClickListenerC9204c implements DialogInterface.OnClickListener {
        DialogInterface$OnClickListenerC9204c() {
        }
    ...
    private static boolean c(Context context, int i) {
        if (i == -1) {
            k(context, R$string.dialog_vr_core_not_installed, R$string.go_to_playstore_button, new DialogInterface$OnClickListenerC9202a(context));
            return false;
        } else if (i == -2) {
            k(context, R$string.dialog_vr_core_not_enabled, R$string.go_to_vr_listeners_settings_button, new DialogInterface$OnClickListenerC9203b(context));
            return false;
        } else {
            return true;
        }
    ...
    private static void k(Context context, int i, int i2, DialogInterface.OnClickListener onClickListener) {
        ...
        builder.setMessage(i).setTitle(R$string.dialog_title_warning).setPositiveButton(i2, onClickListener).setNegativeButton(R$string.cancel_button, new DialogInterface$OnClickListenerC9204c());
        builder.create().show();
    }
}
