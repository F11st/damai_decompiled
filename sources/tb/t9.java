...
public class t9 {
        ...
        if (hu0.j() && !TextUtils.isEmpty(str)) {
            try {
                ...
                for (int i2 = 0; i2 < length; i2++) {
                    ...
                    anet.channel.strategy.d.b().c(string, ConnProtocol.valueOf(jSONObject.getString("protocol"), jSONObject.getString("rtt"), jSONObject.getString("publicKey")));
                    if (jSONObject.getBoolean("isKeepAlive")) {
                        anet.channel.c.k().C(xa2.a(string, true, false, null, null, null));
                    }
                }
    ...
    public static void f(Context context) {
        if (I.compareAndSet(false, true)) {
            ...
            Boolean j2 = anet.channel.util.c.j(context, STRATEGY_UPDATE_KEY);
            if (j2 != null) {
                N = j2.booleanValue();
            }
