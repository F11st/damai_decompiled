...
public class o62 extends cn.damai.common.user.b {
    ...
    public static o62 f() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-1610210391") ? (o62) ipChange.ipc$dispatch("-1610210391", new Object[0]) : a.a;
    }
    ...
    public void g() {
        ...
        cn.damai.common.user.c.e().A(hashMap, "screenfloatclick", "screenfloat");
    }
    ...
    public void h() {
        ...
        hashMap.put("havanaUserId", z20.i());
        cn.damai.common.user.c.e().A(hashMap, "feedback", vf1.FEED_BACK_LIST_PAGE);
    }
    ...
    public void j() {
        ...
        hashMap.put("permission", "after");
        hashMap.put("havanaUserId", z20.i());
        cn.damai.common.user.c.e().A(hashMap, "shotshare", "addscreenshare");
    }
}
