...
public final class iq2 {
    ...
    static {
        new iq2(TypeAliasExpansionReportStrategy.a.INSTANCE, false);
    }
    ...
    private final fd2 g(jq2 jq2Var, Annotations annotations, boolean z) {
        ...
        return KotlinTypeFactory.j(annotations, typeConstructor, jq2Var.a(), z, MemberScope.b.INSTANCE);
    }
    ...
    private final TypeProjection j(TypeProjection typeProjection, jq2 jq2Var, int i) {
        ...
        if (declarationDescriptor instanceof TypeAliasDescriptor) {
            ...
            fd2 k = k(jq2.Companion.a(jq2Var, typeAliasDescriptor, arrayList), a2.getAnnotations(), a2.d(), i + 1, false);
            fd2 m = m(a2, jq2Var, i);
            if (!md0.a(k)) {
                k = bf2.j(k, m);
            }
    ...
    private final fd2 k(jq2 jq2Var, Annotations annotations, boolean z, int i, boolean z2) {
        ...
        fd2 s = fr2.s(d(a2, annotations), z);
