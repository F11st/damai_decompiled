...
public abstract class ax1 extends u40 implements PropertyAccessorDescriptor {
    private boolean e;
    ...
    public ax1(@NotNull Modality modality, @NotNull f70 f70Var, @NotNull PropertyDescriptor propertyDescriptor, @NotNull Annotations annotations, @NotNull ni1 ni1Var, boolean z, boolean z2, boolean z3, CallableMemberDescriptor.Kind kind, @NotNull SourceElement sourceElement) {
        super(propertyDescriptor.getContainingDeclaration(), annotations, ni1Var, sourceElement);
        if (modality == null) {
            a(0);
        }
        if (f70Var == null) {
    ...
    @NotNull
    /* renamed from: d */
    public PropertyAccessorDescriptor copy(DeclarationDescriptor declarationDescriptor, Modality modality, f70 f70Var, CallableMemberDescriptor.Kind kind, boolean z) {
