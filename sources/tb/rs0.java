...
public final class rs0 {
    ...
    public final void a(@NotNull lz1<k80> lz1Var, @NotNull lz1<k80> lz1Var2) {
        ...
        if (!(lz1Var.c() instanceof k80.C9340d)) {
            lz1Var2.g(lz1Var.c());
        }
        if (!(lz1Var.b() instanceof k80.C9340d)) {
            lz1Var2.f(lz1Var.b());
        }
        if (!(lz1Var.d() instanceof k80.C9340d)) {
            lz1Var2.h(lz1Var.d());
        }
        if (lz1Var.a() instanceof k80.C9340d) {
            return;
        }
        lz1Var2.e(lz1Var.a());
    }
    ...
    public final void b(@NotNull ld2<k80> ld2Var, @NotNull ld2<k80> ld2Var2) {
        ...
        if (!(ld2Var.b() instanceof k80.C9340d)) {
            ld2Var2.d(ld2Var.b());
        }
        if (ld2Var.a() instanceof k80.C9340d) {
            return;
        }
        ld2Var2.c(ld2Var.a());
    }
