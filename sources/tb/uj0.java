...
public final class uj0 implements BitmapProcessor {
    ...
    public String getId() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-2018699525") ? (String) ipChange.ipc$dispatch("-2018699525", new Object[]{this}) : "com.alibaba.pictures.phenix.CenterCropProcessor";
    }
    ...
    public Bitmap process(@NotNull String str, @NotNull BitmapProcessor.BitmapSupplier bitmapSupplier, @NotNull Bitmap bitmap) {
        ...
        Bitmap h = sg1.INSTANCE.h(bitmapSupplier, bitmap, i, this.b);
