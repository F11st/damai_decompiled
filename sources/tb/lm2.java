...
public class lm2 extends pb {
    ...
    private void l(Map<String, String> map) {
        ...
        pb.h(pb.CNT_CONTENT_TYPE, "theme", map);
    ...
    public a.b A(int i, String str, boolean z) {
        ...
        return e(str2, str3, "item_" + i, hashMap, Boolean.valueOf(pb.i(2001)));
    }
    ...
    public a.b B() {
        ...
        pb.g(hashMap);
        l(hashMap);
        return e("theme", "center_item", "more", hashMap, Boolean.valueOf(pb.i(2001)));
    }

    public a.b C() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "71132345") ? (a.b) ipChange.ipc$dispatch("71132345", new Object[]{this}) : new a.b().j(new HashMap()).i("commodity");
    }
    ...
    public void D(int i) {
        ...
        pb.g(hashMap);
        l(hashMap);
        pb.j(e("theme", "rank", "item_" + i, hashMap, Boolean.valueOf(pb.i(2001))));
    }
    ...
    public a.b H() {
        ...
        pb.g(hashMap);
        l(hashMap);
        return e("theme", "top", "share", hashMap, Boolean.valueOf(pb.i(2101)));
    }
    ...
    public a.b I() {
        ...
        pb.g(hashMap);
        l(hashMap);
        pb.h("quandiid", this.b, hashMap);
        pb.h("source", this.d, hashMap);
        return e("theme", "bottom", "submitbtn", hashMap, Boolean.valueOf(pb.i(2001)));
    }
    ...
    public a.b K() {
        ...
        l(hashMap);
        if (!"圈子".equals(this.d)) {
            pb.h("theme_type", this.c ? "活动主题" : "普通主题", hashMap);
        }
        pb.h("type", this.d, hashMap);
    ...
    public a.b m(int i, String str) {
        ...
        pb.f(hashMap);
        pb.g(hashMap);
        pb.h("contentlabel", str, hashMap);
        l(hashMap);
        return e("theme", gh1.MODULE_BANNER, "item", hashMap, Boolean.valueOf(pb.i(2001)));
    }
    ...
    public a.b p(String str) {
        ...
        f.put("quanziid", str);
        return e("HotQuanzi", "top", "share", f, Boolean.valueOf(pb.i(2101)));
    }
    ...
    public a.b q() {
        ...
        pb.f(hashMap);
        pb.g(hashMap);
        pb.h("quanziid", this.b, hashMap);
        return e("HotQuanzi", "bottom", "submitbtn", hashMap, Boolean.valueOf(pb.i(2001)));
    }
    ...
    public void r(View view, int i, String str) {
        ...
        pb.h("contentlabel", str, hashMap);
        l(hashMap);
        cn.damai.common.user.c.e().G(view, gh1.MODULE_BANNER, "top", "theme", hashMap);
    }
    ...
    public void s(View view, String str, int i, int i2) {
        ...
        pb.f(hashMap);
        pb.h("id", str, hashMap);
        pb.h("type", String.valueOf(i2), hashMap);
        pb.g(hashMap);
        l(hashMap);
    ...
    public void w(View view, String str) {
        ...
        pb.h("id", str, hashMap);
        l(hashMap);
        cn.damai.common.user.c.e().G(view, "dvote", "center", "theme", hashMap);
    }
    ...
    public a.b y(HashMap<String, String> hashMap) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-462083621") ? (a.b) ipChange.ipc$dispatch("-462083621", new Object[]{this, hashMap}) : e("HotQuanzi", "top", "join", hashMap, Boolean.valueOf(pb.i(2001)));
    }
    ...
    public a.b z(int i, String str, int i2, String str2) {
        ...
        hashMap.put(pb.PUBLISHER_ID, str);
        hashMap.put("type", String.valueOf(i2));
        return e("theme", "content", "item_" + i, hashMap, Boolean.valueOf(pb.i(2001)));
    }
}
