...
public class C10007z {
    ...
    private Handler c = new HandlerC10008a(Looper.getMainLooper());

    /* compiled from: Taobao */
    /* renamed from: tb.z$a */
    /* loaded from: classes11.dex */
    class HandlerC10008a extends Handler {
        HandlerC10008a(Looper looper) {
            super(looper);
        }
    ...
    public void d(WVCallBackContext wVCallBackContext, String str) {
        ...
        new k60(this.b).asyncSend(c, null, null, new C10009b(this, null));
    }

    /* compiled from: Taobao */
    /* renamed from: tb.z$b */
    /* loaded from: classes11.dex */
    private class C10009b implements NetworkCallBack$FinishListener, NetworkCallBack$ProgressListener {
        ...
        public void onFinished(NetworkEvent$FinishEvent networkEvent$FinishEvent, Object obj) {
            Message obtainMessage = C10007z.this.c.obtainMessage();
            ...
            C10007z.this.c.sendMessage(obtainMessage);
        }

        /* synthetic */ C10009b(C10007z c10007z, HandlerC10008a handlerC10008a) {
            this();
        }
    }
}
