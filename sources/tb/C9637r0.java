...
public final class C9637r0 {
    @NotNull
    public static final C9638a Companion = new C9638a(null);
    ...
    /* compiled from: Taobao */
    /* renamed from: tb.r0$a */
    /* loaded from: classes9.dex */
    public static final class C9638a {
        private C9638a() {
        }

        public /* synthetic */ C9638a(k50 k50Var) {
            this();
        }
    }

    /* compiled from: Taobao */
    /* renamed from: tb.r0$b */
    /* loaded from: classes9.dex */
    public static final class C9639b implements IAbilityInvoker {
        C9639b() {
        }
        ...
        public jg0 invoke(@NotNull String str, @NotNull String str2, @NotNull IAbilityContext iAbilityContext, @NotNull Map<String, ? extends Object> map, @NotNull IOnCallbackListener iOnCallbackListener) {
            ...
            try {
                IAbility b = C9637r0.this.b(str);
                if (b != null) {
                    return b.execute(str2, iAbilityContext, map, new C9489o0(iOnCallbackListener));
                }
    ...
    public C9637r0(@NotNull IAbilityEnv iAbilityEnv) {
