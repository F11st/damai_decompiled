...
public class dl extends cn.damai.common.user.b {
    ...
    public static final dl I() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1415610469") ? (dl) ipChange.ipc$dispatch("1415610469", new Object[0]) : a.a;
    }
    ...
    public static void Q(int i, String str) {
        ...
        f.put("type", i + "");
        f.put("item_id", str);
        cn.damai.common.user.c.e().x(I().e(EVALUATE_LIST_PAGE, "want-tips", "favorite", f, Boolean.FALSE));
    }
    ...
    public static void f(String str, long j) {
        ...
        HashMap<String, String> f = d23.f();
        f.put("item_id", str);
        cn.damai.common.user.c.e().C("favorite", "want-tips", EVALUATE_LIST_PAGE, "1.0", j, f, 2201);
    }
    ...
    public a.b B(String str, String str2, String str3, String str4, int i, int i2, int i3) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1991285519")) {
            return (a.b) ipChange.ipc$dispatch("1991285519", new Object[]{this, str, str2, str3, str4, Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3)});
        }
    ...
    public a.b C(String str, String str2, String str3, String str4, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "754128530")) {
            return (a.b) ipChange.ipc$dispatch("754128530", new Object[]{this, str, str2, str3, str4, Integer.valueOf(i), Integer.valueOf(i2)});
        }
    ...
    public a.b D(String str, String str2, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "466920924")) {
            return (a.b) ipChange.ipc$dispatch("466920924", new Object[]{this, str, str2, Integer.valueOf(i)});
        }
        HashMap hashMap = new HashMap();
    ...
    public a.b E(String str, String str2, String str3, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-411410618")) {
            return (a.b) ipChange.ipc$dispatch("-411410618", new Object[]{this, str, str2, str3, Integer.valueOf(i), Integer.valueOf(i2)});
        }
        return e(EVALUATE_LIST_PAGE, "evaluate_tab_" + i, "likes_" + i2, A(z20.E(), str3, str, str2), Boolean.FALSE);
    }

    public a.b F(String str, String str2, String str3, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1101039888")) {
            return (a.b) ipChange.ipc$dispatch("1101039888", new Object[]{this, str, str2, str3, Integer.valueOf(i), Integer.valueOf(i2)});
        }
        return e(EVALUATE_LIST_PAGE, "evaluate_tab_" + i, "reply_" + i2, A(z20.E(), str3, str, str2), Boolean.TRUE);
    }

    public a.b G(String str, String str2, String str3, String str4, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "600120901")) {
            return (a.b) ipChange.ipc$dispatch("600120901", new Object[]{this, str, str2, str3, str4, Integer.valueOf(i), Integer.valueOf(i2)});
        }
        Map<String, String> A = A(z20.E(), str4, str, str2);
        A.put("scriptId", str3);
    ...
    public a.b H(String str, String str2, String str3, String str4, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "403516685")) {
            return (a.b) ipChange.ipc$dispatch("403516685", new Object[]{this, str, str2, str3, str4, Integer.valueOf(i), Integer.valueOf(i2)});
        }
        Map<String, String> A = A(z20.E(), str4, str, str2);
        A.put("scriptId", str3);
    ...
    public a.b J(String str, String str2, String str3, String str4, int i) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "929236791")) {
            return (a.b) ipChange.ipc$dispatch("929236791", new Object[]{this, str, str2, str3, str4, Integer.valueOf(i)});
        }
    ...
    public a.b K(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1007538133")) {
            return (a.b) ipChange.ipc$dispatch("1007538133", new Object[]{this, str, str2});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", z20.E());
    ...
    public a.b L(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "89863617")) {
            return (a.b) ipChange.ipc$dispatch("89863617", new Object[]{this, str});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", z20.E());
    ...
    public a.b M() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1030966942")) {
            return (a.b) ipChange.ipc$dispatch("1030966942", new Object[]{this});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", z20.E());
        return new a.b().j(hashMap).i(EVALUATE_SUCCESS_PAGE);
    }

    public a.b N(String str, int i, String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2132625947")) {
            return (a.b) ipChange.ipc$dispatch("-2132625947", new Object[]{this, str, Integer.valueOf(i), str2});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", z20.E());
        hashMap.put("style", str);
    ...
    public a.b O(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-640244441")) {
            return (a.b) ipChange.ipc$dispatch("-640244441", new Object[]{this, str, str2});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", z20.E());
        hashMap.put("style", str);
    ...
    public a.b P(String str, String str2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-816506998")) {
            return (a.b) ipChange.ipc$dispatch("-816506998", new Object[]{this, str, str2});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("type", str);
    ...
    public void g(View view, String str, String str2, int i) {
        ...
        try {
            ...
            cn.damai.common.user.c.e().G(view, "item", TextUtils.isEmpty(str) ? "scriptkill_store" : "scriptkill", i == 0 ? EVALUATE_LIST_PAGE : EVALUATE_DETAIL_PAGE, f);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public a.b h(String str, String str2) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1104893264")) {
            return (a.b) ipChange.ipc$dispatch("1104893264", new Object[]{this, str, str2});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("item_id", str);
        hashMap.put("usercode", str2);
        return new a.b().j(hashMap).i(EVALUATE_DETAIL_PAGE);
    }
    ...
    public a.b m(String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-924358688")) {
            return (a.b) ipChange.ipc$dispatch("-924358688", new Object[]{this, str, str2, str3, str4, str5, str6, str7});
        }
    ...
    public a.b n(String str, String str2, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1880074601")) {
            return (a.b) ipChange.ipc$dispatch("-1880074601", new Object[]{this, str, str2, Integer.valueOf(i)});
        }
        return e(EVALUATE_DETAIL_PAGE, "comment_" + i, "delete", k(z20.E(), str, str2), Boolean.FALSE);
    }

    public a.b o(String str, String str2, int i, String str3, String str4) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2076121732")) {
            return (a.b) ipChange.ipc$dispatch("2076121732", new Object[]{this, str, str2, Integer.valueOf(i), str3, str4});
        }
    ...
    public a.b p(String str, String str2) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1204712078") ? (a.b) ipChange.ipc$dispatch("-1204712078", new Object[]{this, str, str2}) : e(EVALUATE_DETAIL_PAGE, "bottom", "reply_btn", k(z20.E(), str, str2), Boolean.FALSE);
    }

    public a.b q(String str, String str2, String str3, String str4, String str5, String str6) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1957232429")) {
            return (a.b) ipChange.ipc$dispatch("-1957232429", new Object[]{this, str, str2, str3, str4, str5, str6});
        }
        if (TextUtils.isEmpty(str3)) {
            return null;
        }
    ...
    public a.b r(String str, String str2, String str3, String str4, String str5, String str6, String str7) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1159081343")) {
            return (a.b) ipChange.ipc$dispatch("1159081343", new Object[]{this, str, str2, str3, str4, str5, str6, str7});
        }
        if (TextUtils.isEmpty(str3)) {
            return null;
        }
    ...
    public a.b s(boolean z, String str, String str2, int i, String str3, String str4) {
        String str5;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-789770456")) {
            return (a.b) ipChange.ipc$dispatch("-789770456", new Object[]{this, Boolean.valueOf(z), str, str2, Integer.valueOf(i), str3, str4});
        }
        if (z) {
            str5 = "card";
        } else {
    ...
    public a.b t(boolean z, String str, String str2, int i) {
        String str3;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-748215216")) {
            return (a.b) ipChange.ipc$dispatch("-748215216", new Object[]{this, Boolean.valueOf(z), str, str2, Integer.valueOf(i)});
        }
        if (z) {
            str3 = "bottom";
        } else {
    ...
    public a.b u(String str, String str2, String str3, String str4, String str5) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "478346624")) {
            return (a.b) ipChange.ipc$dispatch("478346624", new Object[]{this, str, str2, str3, str4, str5});
        }
    ...
    public a.b v(String str, String str2, String str3, String str4) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2049214634")) {
            return (a.b) ipChange.ipc$dispatch("-2049214634", new Object[]{this, str, str2, str3, str4});
        }
        Map<String, String> l = l(z20.E(), str, str2, str4);
        if (!TextUtils.isEmpty(str3)) {
            l.put("item_id", str3);
    ...
    public a.b w(String str, String str2, String str3, int i) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2059219253")) {
            return (a.b) ipChange.ipc$dispatch("2059219253", new Object[]{this, str, str2, str3, Integer.valueOf(i)});
        }
        Map<String, String> k = k(z20.E(), str2, str3);
        return e(EVALUATE_DETAIL_PAGE, "comment_" + i, str, k, Boolean.FALSE);
    }

    public a.b x(String str, String str2, String str3, String str4, String str5, String str6) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1107449243")) {
            return (a.b) ipChange.ipc$dispatch("-1107449243", new Object[]{this, str, str2, str3, str4, str5, str6});
        }
    ...
    public a.b y(String str, String str2, String str3, String str4, String str5, String str6) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1975936610")) {
            return (a.b) ipChange.ipc$dispatch("1975936610", new Object[]{this, str, str2, str3, str4, str5, str6});
        }
        if (TextUtils.isEmpty(str2)) {
            return null;
        }
    ...
    public a.b z(String str) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1334966537")) {
            return (a.b) ipChange.ipc$dispatch("-1334966537", new Object[]{this, str});
        }
        HashMap hashMap = new HashMap();
        hashMap.put("usercode", str);
        return new a.b().j(hashMap).i(EVALUATE_LIST_PAGE);
    }
}
