    ...
    */
    ...
    public final String c(@NotNull String str, @NotNull ImageConfig imageConfig) {
        ...
        if (e() && !TextUtils.isEmpty(str)) {
            F = kotlin.text.o.F(str, "res://", false, 2, null);
            if (F) {
                return str;
            }
            F2 = kotlin.text.o.F(str, "file://", false, 2, null);
            if (F2) {
                return str;
            }
            F3 = kotlin.text.o.F(str, "asset://", false, 2, null);
            if (F3) {
                return str;
            }
