...
public interface Job extends CoroutineContext.Element {
    public static final C8614b Key = C8614b.a;
    ...
    public static final class C8613a {
        ...
        public static <R> R c(@NotNull Job job, R r, @NotNull Function2<? super R, ? super CoroutineContext.Element, ? extends R> function2) {
            return (R) CoroutineContext.Element.C8232a.a(job, r, function2);
        }

        @Nullable
        public static <E extends CoroutineContext.Element> E d(@NotNull Job job, @NotNull CoroutineContext.Key<E> key) {
            return (E) CoroutineContext.Element.C8232a.b(job, key);
        }
        ...
        public static CoroutineContext f(@NotNull Job job, @NotNull CoroutineContext.Key<?> key) {
            return CoroutineContext.Element.C8232a.c(job, key);
        }

        @NotNull
        public static CoroutineContext g(@NotNull Job job, @NotNull CoroutineContext coroutineContext) {
            return CoroutineContext.Element.C8232a.d(job, coroutineContext);
        }
    ...
    /* loaded from: classes8.dex */
    public static final class C8614b implements CoroutineContext.Key<Job> {
        static final /* synthetic */ C8614b a = new C8614b();

        static {
            CoroutineExceptionHandler.C8610a c8610a = CoroutineExceptionHandler.Key;
        }
