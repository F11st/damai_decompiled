...
public abstract class a<T> extends JobSupport implements Job, Continuation<T> {
    ...
    public /* synthetic */ a(CoroutineContext coroutineContext, boolean z, int i, k50 k50Var) {
    ...
    public final void resumeWith(@NotNull Object obj) {
        ...
        if (makeCompletingOnce$kotlinx_coroutines_core == s.COMPLETING_WAITING_CHILDREN) {
            return;
        }
