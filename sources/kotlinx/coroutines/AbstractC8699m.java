...
public abstract class AbstractC8699m extends CoroutineDispatcher {
    private boolean shared;
    private u7<DispatchedTask<?>> unconfinedQueue;
    private long useCount;

    public static /* synthetic */ void decrementUseCount$default(AbstractC8699m abstractC8699m, boolean z, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                z = false;
            }
            abstractC8699m.decrementUseCount(z);
            return;
        }
    ...
    public static /* synthetic */ void incrementUseCount$default(AbstractC8699m abstractC8699m, boolean z, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                z = false;
            }
            abstractC8699m.incrementUseCount(z);
            return;
        }
