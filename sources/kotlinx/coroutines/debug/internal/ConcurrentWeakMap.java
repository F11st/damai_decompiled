...
public final class ConcurrentWeakMap<K, V> extends z1<K, V> {
    ...
    public final class a {
        ...
        /* loaded from: classes9.dex */
        public final class C0433a<E> implements Iterator<E>, KMutableIterator {
            private int a = -1;
            private K b;
            private V c;
            ...
            public C0433a(@NotNull Function2<? super K, ? super V, ? extends E> function2) {
                this.d = function2;
                a();
            }
            ...
            private final void a() {
                ...
                while (true) {
                    ...
                    bw0 bw0Var = (bw0) a.this.c.get(this.a);
                    if (bw0Var != null && (k = (K) bw0Var.get()) != null) {
                        this.b = k;
                        V v = (V) a.this.d.get(this.a);
                        if (v instanceof kotlinx.coroutines.debug.internal.c) {
                            v = (V) ((kotlinx.coroutines.debug.internal.c) v).a;
                        }
                        if (v != null) {
                            this.c = v;
                            return;
        ...
        /* JADX WARN: Multi-variable type inference failed */
        public static /* synthetic */ Object g(a aVar, Object obj, Object obj2, bw0 bw0Var, int i, Object obj3) {
            if ((i & 4) != 0) {
                bw0Var = null;
            }
            return aVar.f(obj, obj2, bw0Var);
        }
        ...
        /* JADX WARN: Code restructure failed: missing block: B:26:0x005e, code lost:
            if ((r6 instanceof kotlinx.coroutines.debug.internal.c) == false) goto L20;
         */
        ...
        */
        public final java.lang.Object f(@org.jetbrains.annotations.NotNull K r6, @org.jetbrains.annotations.Nullable V r7, @org.jetbrains.annotations.Nullable tb.bw0<K> r8) {
            ...
            L19:
                ...
                int r3 = r5.b
                if (r1 < r3) goto L24
                tb.kj2 r6 = kotlinx.coroutines.debug.internal.a.a()
                return r6
            L24:
                int r3 = r1 + 1
            ...
            L77:
                ...
                goto L9
            */
            throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.debug.internal.ConcurrentWeakMap.a.f(java.lang.Object, java.lang.Object, tb.bw0):java.lang.Object");
        }
        ...
        public final ConcurrentWeakMap<K, V>.a h() {
            ...
            while (true) {
                ...
                ConcurrentWeakMap<K, V>.a aVar = (ConcurrentWeakMap<K, V>.a) new a(Integer.highestOneBit(a) * 4);
                int i = this.e;
                for (int i2 = 0; i2 < i; i2++) {
                    ...
                    if (obj2 != null && obj != null) {
                        Object f = aVar.f(obj2, obj, bw0Var);
                        kj2Var = kotlinx.coroutines.debug.internal.a.a;
                        if (f == kj2Var) {
                            break;
                        }
                    }
