...
final class ChannelsKt__Channels_commonKt$drop$1 extends SuspendLambda implements Function2<ProducerScope<Object>, Continuation<? super wt2>, Object> {
    ...
    public final Object invoke(ProducerScope<Object> producerScope, Continuation<? super wt2> continuation) {
        return ((ChannelsKt__Channels_commonKt$drop$1) create(producerScope, continuation)).invokeSuspend(wt2.INSTANCE);
    }
