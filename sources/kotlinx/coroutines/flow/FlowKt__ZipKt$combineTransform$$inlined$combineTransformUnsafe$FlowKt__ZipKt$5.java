...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$5", f = "Zip.kt", i = {0}, l = {GridBean.TYPE_VIDEO_UNDER_REVIEW}, m = "invokeSuspend", n = {"$this$flow"}, s = {"L$0"})
/* loaded from: classes11.dex */
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$5 extends SuspendLambda implements Function2<FlowCollector<Object>, Continuation<? super wt2>, Object> {
    ...
    public final Object invoke(FlowCollector<Object> flowCollector, Continuation<? super wt2> continuation) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$5) create(flowCollector, continuation)).invokeSuspend(wt2.INSTANCE);
    }
