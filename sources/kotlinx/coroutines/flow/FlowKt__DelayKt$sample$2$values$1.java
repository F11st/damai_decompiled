...
final class FlowKt__DelayKt$sample$2$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super wt2>, Object> {
    Object L$0;
    Object L$1;
    int label;
    ...
    /* compiled from: Taobao */
    /* renamed from: kotlinx.coroutines.flow.FlowKt__DelayKt$sample$2$values$1$a */
    /* loaded from: classes11.dex */
    public static final class C8663a implements FlowCollector<Object> {
        final /* synthetic */ ProducerScope a;

        public C8663a(ProducerScope producerScope) {
    ...
    public final Object invoke(ProducerScope<? super Object> producerScope, Continuation<? super wt2> continuation) {
        return ((FlowKt__DelayKt$sample$2$values$1) create(producerScope, continuation)).invokeSuspend(wt2.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            C8663a c8663a = new C8663a(producerScope);
            this.L$0 = producerScope;
            this.L$1 = flow;
            this.label = 1;
            if (flow.collect(c8663a, this) == d) {
                return d;
            }
        } else if (i != 1) {
