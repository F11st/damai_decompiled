...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__MergeKt$flatMapLatest$1", f = "Merge.kt", i = {0, 0, 1, 1, 1, 1}, l = {AliMediaPlayer.TYPE_SUBTITLE_LIB_PATH, 216}, m = "invokeSuspend", n = {"$this$transformLatest", AdvanceSetting.NETWORK_TYPE, "$this$transformLatest", AdvanceSetting.NETWORK_TYPE, "$this$emitAll$iv", "flow$iv"}, s = {"L$0", "L$1", "L$0", "L$1", "L$2", "L$3"})
/* loaded from: classes11.dex */
public final class FlowKt__MergeKt$flatMapLatest$1 extends SuspendLambda implements Function3<FlowCollector<Object>, Object, Continuation<? super wt2>, Object> {
    ...
    public final Object invoke(FlowCollector<Object> flowCollector, Object obj, Continuation<? super wt2> continuation) {
        return ((FlowKt__MergeKt$flatMapLatest$1) create(flowCollector, obj, continuation)).invokeSuspend(wt2.INSTANCE);
    }
