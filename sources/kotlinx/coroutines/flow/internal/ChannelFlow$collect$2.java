...
public final class ChannelFlow$collect$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super wt2>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super wt2> continuation) {
        return ((ChannelFlow$collect$2) create(coroutineScope, continuation)).invokeSuspend(wt2.INSTANCE);
    }
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        if (i == 0) {
            ...
            ReceiveChannel g = this.this$0.g(coroutineScope);
            this.L$0 = coroutineScope;
            this.label = 1;
            if (kotlinx.coroutines.flow.c.k(flowCollector, g, this) == d) {
                return d;
            }
        } else if (i != 1) {
