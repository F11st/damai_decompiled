...
final class FlowKt__ErrorsKt$onErrorCollect$2 extends SuspendLambda implements Function3<FlowCollector<Object>, Throwable, Continuation<? super wt2>, Object> {
    ...
    public final Object invoke(FlowCollector<Object> flowCollector, Throwable th, Continuation<? super wt2> continuation) {
        return ((FlowKt__ErrorsKt$onErrorCollect$2) create(flowCollector, th, continuation)).invokeSuspend(wt2.INSTANCE);
    }
