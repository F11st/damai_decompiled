...
public final /* synthetic */ class C8676f {
    @NotNull
    public static final <T> Flow<T> a(@NotNull Flow<? extends T> flow, int i, @NotNull BufferOverflow bufferOverflow) {
        ...
        if (i >= 0 || i == -2 || i == -1) {
            ...
            if (z) {
                ...
                return flow instanceof FusibleFlow ? FusibleFlow.C8681a.a((FusibleFlow) flow, null, i2, bufferOverflow2, 1, null) : new oh(flow, null, i2, bufferOverflow2, 2, null);
            }
    ...
    public static /* synthetic */ Flow b(Flow flow, int i, BufferOverflow bufferOverflow, int i2, Object obj) {
        ...
        return C8672c.b(flow, i, bufferOverflow);
    }
}
