...
public class a {
    private static volatile IFullTraceAnalysis a = new C0012a(null);
    ...
    /* loaded from: classes.dex */
    private static class C0012a implements IFullTraceAnalysis {
        private IFullTraceAnalysis a;

        C0012a(IFullTraceAnalysis iFullTraceAnalysis) {
    ...
    public static void g(IFullTraceAnalysis iFullTraceAnalysis) {
        a = new C0012a(iFullTraceAnalysis);
    }
