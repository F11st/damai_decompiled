...
public class C0241c {
    ...
    public static String d() {
        ...
        try {
            ...
            str2 = (String) cls.getDeclaredMethod(gn1.TYPE_OPEN_URL_METHOD_GET, String.class).invoke(cls, C4151a.b);
    ...
    */
    private static java.lang.String h(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: anet.channel.util.C0241c.h(int):java.lang.String");
    }
