...
class C0231a {
    ...
    static HostnameVerifier b = new C0232a();
    static Random c = new Random();

    /* compiled from: Taobao */
    /* renamed from: anet.channel.strategy.dispatch.a$a */
    /* loaded from: classes.dex */
    static class C0232a implements HostnameVerifier {
        C0232a() {
        }
    ...
    private static String a(String str, String str2, int i, Map<String, String> map, int i2) {
        ...
        if (str2 != null) {
            if (C9708t9.k() && Inet64Util.p() && lw2.c(str2)) {
                try {
    ...
    static List<IConnStrategy> d(String str) {
        ...
        if (!NetworkStatusHelper.o()) {
            list = C0213a.a().getConnStrategyListByHost(y90.a());
    ...
    */
    public static int f(java.lang.String r21, java.util.Map r22, int r23) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: anet.channel.strategy.dispatch.C0231a.f(java.lang.String, java.util.Map, int):int");
    }
    ...
    public static void g(Map map) {
        ...
        String schemeByHost = C0213a.a().getSchemeByHost(y90.a(), "http");
        ...
        for (int i = 0; i < 3; i++) {
            ...
            if (iConnStrategy != null) {
                ym ymVar = new ym();
                ymVar.a = f == 0;
                C0213a.a().notifyConnEvent(y90.a(), iConnStrategy, ymVar);
            }
            if (f == 0 || f == 2) {
                return;
            }
