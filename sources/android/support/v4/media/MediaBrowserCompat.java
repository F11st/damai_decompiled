...
public final class MediaBrowserCompat {
    ...
    private static class CustomActionResultReceiver extends ResultReceiver {
        ...
        protected void onReceiveResult(int i, Bundle bundle) {
            ...
            if (i == -1) {
                ...
                Log.w(MediaBrowserCompat.TAG, "Unknown result code: " + i + " (extras=" + this.mExtras + ", resultData=" + bundle + jn1.BRACKET_END_STR);
            } else {
    ...
    public static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
        ...
        public void connect() {
            int i = this.mState;
            if (i != 0 && i != 1) {
                throw new IllegalStateException("connect() called while neigther disconnecting nor disconnected (state=" + getStateLabel(this.mState) + jn1.BRACKET_END_STR);
            }
            this.mState = 2;
        ...
        public Bundle getExtras() {
            ...
            throw new IllegalStateException("getExtras() called while not connected (state=" + getStateLabel(this.mState) + jn1.BRACKET_END_STR);
        }
        ...
        public String getRoot() {
            ...
            throw new IllegalStateException("getRoot() called while not connected(state=" + getStateLabel(this.mState) + jn1.BRACKET_END_STR);
        }
        ...
        public ComponentName getServiceComponent() {
            ...
            throw new IllegalStateException("getServiceComponent() called while not connected (state=" + this.mState + jn1.BRACKET_END_STR);
        }
        ...
        public MediaSessionCompat.Token getSessionToken() {
            ...
            throw new IllegalStateException("getSessionToken() called while not connected(state=" + this.mState + jn1.BRACKET_END_STR);
        }
        ...
        public void search(@NonNull final String str, final Bundle bundle, @NonNull final SearchCallback searchCallback) {
            ...
            throw new IllegalStateException("search() called while not connected (state=" + getStateLabel(this.mState) + jn1.BRACKET_END_STR);
        }
