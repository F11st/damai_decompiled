...
public final class C8851k implements BufferedSink {
    public final Buffer a = new Buffer();
    public final Sink b;
    boolean c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C8851k(Sink sink) {
    ...
    /* loaded from: classes2.dex */
    class C8852a extends OutputStream {
        C8852a() {
        }
        ...
        public String toString() {
            return C8851k.this + ".outputStream()";
        }
        ...
        public void write(int i) throws IOException {
            C8851k c8851k = C8851k.this;
            if (!c8851k.c) {
                c8851k.a.writeByte((int) ((byte) i));
                C8851k.this.emitCompleteSegments();
                return;
            }
