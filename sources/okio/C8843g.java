...
public final class C8843g implements Source {
    private final BufferedSource a;
    private final Inflater b;
    private int c;
    private boolean d;

    public C8843g(Source source, Inflater inflater) {
        this(C8844h.d(source), inflater);
    }
    ...
    public final boolean a() throws IOException {
        if (this.b.needsInput()) {
            ...
            if (this.b.getRemaining() == 0) {
                ...
                C8855m c8855m = this.a.buffer().head;
                int i = c8855m.c;
                int i2 = c8855m.b;
                int i3 = i - i2;
                this.c = i3;
                this.b.setInput(c8855m.a, i2, i3);
                return false;
            }
    ...
    public C8843g(BufferedSource bufferedSource, Inflater inflater) {
