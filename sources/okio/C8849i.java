...
public final class C8849i extends AbstractList<ByteString> implements RandomAccess {
    final ByteString[] a;
    final int[] b;

    private C8849i(ByteString[] byteStringArr, int[] iArr) {
    ...
    */
    public static okio.C8849i d(okio.ByteString... r10) {
        /*
            Method dump skipped, instructions count: 264
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: okio.C8849i.d(okio.ByteString[]):okio.i");
    }
