...
public final class C8853l implements BufferedSource {
    public final Buffer a = new Buffer();
    public final Source b;
    boolean c;

    /* JADX INFO: Access modifiers changed from: package-private */
    public C8853l(Source source) {
    ...
    */
    public long readHexadecimalUnsignedLong() throws java.io.IOException {
        ...
        L4a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: okio.C8853l.readHexadecimalUnsignedLong():long");
    }
    ...
    @Override // okio.BufferedSource
    public int select(C8849i c8849i) throws IOException {
        if (!this.c) {
            do {
                int selectPrefix = this.a.selectPrefix(c8849i, true);
                if (selectPrefix == -1) {
                    return -1;
                }
                if (selectPrefix != -2) {
                    this.a.skip(c8849i.a[selectPrefix].size());
                    return selectPrefix;
                }
            } while (this.b.read(this.a, PlaybackStateCompat.ACTION_PLAY_FROM_URI) != -1);
            return -1;
    ...
    /* loaded from: classes2.dex */
    class C8854a extends InputStream {
        C8854a() {
        }

        @Override // java.io.InputStream
        public int available() throws IOException {
            C8853l c8853l = C8853l.this;
            if (!c8853l.c) {
                return (int) Math.min(c8853l.a.size, 2147483647L);
            }
        ...
        public int read() throws IOException {
            C8853l c8853l = C8853l.this;
            if (!c8853l.c) {
                Buffer buffer = c8853l.a;
                if (buffer.size == 0 && c8853l.b.read(buffer, PlaybackStateCompat.ACTION_PLAY_FROM_URI) == -1) {
                    return -1;
                }
                return C8853l.this.a.readByte() & 255;
            }
            throw new IOException(IRequestConst.CLOSED);
        }

        public String toString() {
            return C8853l.this + ".inputStream()";
        }
        ...
        public int read(byte[] bArr, int i, int i2) throws IOException {
            if (!C8853l.this.c) {
                ...
                return C8853l.this.a.read(bArr, i, i2);
            }
            throw new IOException(IRequestConst.CLOSED);
        }
    }
