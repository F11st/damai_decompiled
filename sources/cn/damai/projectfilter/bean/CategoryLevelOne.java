...
public class CategoryLevelOne implements Serializable {
    ...
    public static CategoryInitResult init(List<CategoryLevelOne> list, PresetBean presetBean) {
        ...
        if (cb2.g(list)) {
            ...
            if (presetBean != null && !TextUtils.isEmpty(presetBean.firstLevelSelection) && (categoryLevelOne = categoryInitResult.mOneMap.get(presetBean.firstLevelSelection)) != null && cb2.g(categoryLevelOne.lineItemList)) {
    ...
    public int hashCode() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1371554221") ? ((Integer) ipChange.ipc$dispatch("-1371554221", new Object[]{this})).intValue() : nm1.b(this.value, this.name);
    }

    public boolean isAll() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-521161508") ? ((Boolean) ipChange.ipc$dispatch("-521161508", new Object[]{this})).booleanValue() : TextUtils.isEmpty(this.value);
    }
    ...
    public void setChildrenPid() {
        ...
        } else if (!cb2.d(this.lineItemList)) {
    ...
    public void updateTag() {
        ...
        CategoryLevelTwo categoryLevelTwo = null;
        this.tag = null;
        if (TextUtils.isEmpty(this.value) || cb2.d(this.lineItemList)) {
            return;
        }
        for (CategoryLevelTwo categoryLevelTwo2 : this.lineItemList) {
            if (categoryLevelTwo2.select) {
