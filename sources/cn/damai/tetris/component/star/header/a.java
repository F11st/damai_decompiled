...
public class a {
    ...
    public class C0078a implements DMImageCreator.DMImageSuccListener {
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        /* loaded from: classes7.dex */
        public class C0079a implements DMRGBUtil.OnFetchColorListener {
            private static transient /* synthetic */ IpChange $ipChange;
            ...
            public void onFetchColor(int i) {
                ...
                if (AndroidInstantRuntime.support(ipChange, "1196099338")) {
                    ...
                    ((ImageView) C0078a.this.a.findViewById(R$id.user_star_b_headerbg_cover)).setImageDrawable(new GradientDrawable(GradientDrawable.Orientation.LEFT_RIGHT, new int[]{i, i, a.e(0.6f, i), a.e(0.4f, i)}));
                }
            }
        }

        C0078a(ViewGroup viewGroup, int i, String str) {
            this.a = viewGroup;
            this.b = i;
            this.c = str;
        }
        ...
        public void onSuccess(DMImageCreator.e eVar) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "1349474187")) {
                ...
                ((ImageView) this.a.findViewById(R$id.user_iv_header)).setImageDrawable(new vi(eVar.b));
                if (this.b != 2) {
                    ...
                    DMRGBUtil.g(1.0f, eVar.b, this.c, new C0079a());
                }
            }
        }
    }
    ...
    public static void d(Activity activity, ViewGroup viewGroup, StarHeaderData starHeaderData, int i, StarHeaderContract.Model model, BasePresenter basePresenter) {
        ...
        if (i == StarHeaderData.TYPE_COMMON) {
            ...
            cn.damai.common.image.a.b().c(str2).c(R$drawable.c_default_bg).i(i9).n(new C0078a(viewGroup, i, str2)).f();
            ...
            a = false;
            cn.damai.common.image.a.b().c(starHeaderData.backgroundPicGif).n(new DMImageCreator.DMImageSuccListener() { // from class: tb.uf2
                @Override // cn.damai.common.image.DMImageCreator.DMImageSuccListener
                public final void onSuccess(DMImageCreator.e eVar) {
                    cn.damai.tetris.component.star.header.a.g(imageView, eVar);
                }
            }).f();
            cn.damai.common.image.a.b().c(starHeaderData.backgroundPic).n(new DMImageCreator.DMImageSuccListener() { // from class: tb.tf2
                @Override // cn.damai.common.image.DMImageCreator.DMImageSuccListener
                public final void onSuccess(DMImageCreator.e eVar) {
                    cn.damai.tetris.component.star.header.a.h(imageView, eVar);
                }
            }).f();
        }
