...
public class ActionOpenWindow extends DMBridgeAction {
    ...
    public boolean doAction(String str, String str2, WVCallBackContext wVCallBackContext) {
        ...
        if (TextUtils.isEmpty(str3)) {
            ...
            DMNav.from(this.contextReference).withExtras(bundle).toUri(Uri.parse(str3.trim()));
    ...
    public String getAction() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-64736790") ? (String) ipChange.ipc$dispatch("-64736790", new Object[]{this}) : "openWindow";
    }
}
