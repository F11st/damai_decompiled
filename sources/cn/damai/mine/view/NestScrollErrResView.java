...
public class NestScrollErrResView extends NestedScrollView {
    ...
    public class C1473a implements ResponseErrorPage.ErrorRefreshListener {
        ...
        public void handleError(int i) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "843425041")) {
                ipChange.ipc$dispatch("843425041", new Object[]{this, Integer.valueOf(i)});
            } else if (r92.c()) {
            } else {
                this.a.onClick();
            }
    ...
    private void addResView(ResponseErrorPage responseErrorPage, OnErrClickListener onErrClickListener) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "247590556")) {
            ipChange.ipc$dispatch("247590556", new Object[]{this, responseErrorPage, onErrClickListener});
    ...
    public void hide() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1270209463")) {
            ipChange.ipc$dispatch("-1270209463", new Object[]{this});
            return;
        }
        this.state = 1;
        this.mPageContainer.removeAllViews();
    ...
    public boolean isShowLoginView() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1849125668") ? ((Boolean) ipChange.ipc$dispatch("-1849125668", new Object[]{this})).booleanValue() : this.state == 2;
    }

    public void showEmptyView(String str) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "183770868")) {
            ipChange.ipc$dispatch("183770868", new Object[]{this, str});
            return;
        }
        this.state = 3;
    ...
    public void showErrorView(String str, String str2, OnErrClickListener onErrClickListener) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2122575282")) {
            ipChange.ipc$dispatch("-2122575282", new Object[]{this, str, str2, onErrClickListener});
            return;
        }
        this.state = 4;
    ...
    public void showLoginView(OnErrClickListener onErrClickListener) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-2072362109")) {
            ipChange.ipc$dispatch("-2072362109", new Object[]{this, onErrClickListener});
            return;
        }
        this.state = 2;
