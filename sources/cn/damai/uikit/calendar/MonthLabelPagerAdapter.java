...
public class MonthLabelPagerAdapter extends CalendarPagerAdapter<MonthLabelView> {
    ...
    protected DateRangeIndex b(CalendarDay calendarDay, CalendarDay calendarDay2) {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1476387668") ? (DateRangeIndex) ipChange.ipc$dispatch("-1476387668", new Object[]{this, calendarDay, calendarDay2}) : new MonthPagerAdapter.a(calendarDay, calendarDay2);
    }
