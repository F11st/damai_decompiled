...
@TargetApi(9)
/* renamed from: cn.damai.uikit.pulltorefresh.library.b */
...
public final class C2536b {
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.uikit.pulltorefresh.library.b$a */
    /* loaded from: classes8.dex */
    public static /* synthetic */ class C2537a {
    ...
    public static void b(PullToRefreshBase<?> pullToRefreshBase, int i, int i2, int i3, int i4, int i5, int i6, float f, boolean z) {
        ...
        if (C2537a.a[pullToRefreshBase.getPullToRefreshScrollDirection().ordinal()] != 1) {
