...
public class a {
    ...
    /* loaded from: classes8.dex */
    public class ScaleGestureDetector$OnScaleGestureListenerC0091a implements ScaleGestureDetector.OnScaleGestureListener {
        private static transient /* synthetic */ IpChange $ipChange;

        ScaleGestureDetector$OnScaleGestureListenerC0091a() {
        }
    ...
    public a(Context context, OnGestureListener onGestureListener) {
        ...
        this.c = new ScaleGestureDetector(context, new ScaleGestureDetector$OnScaleGestureListenerC0091a());
    }
