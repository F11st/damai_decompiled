...
public class ContentDetailItem implements Serializable {
    ...
    public boolean isFeature() {
        ...
        return AndroidInstantRuntime.support(ipChange, "1970073916") ? ((Boolean) ipChange.ipc$dispatch("1970073916", new Object[]{this})).booleanValue() : TextUtils.equals("1", this.isFeature);
    }
}
