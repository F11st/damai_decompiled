...
import cn.damai.tetris.component.discover.bean.AttractiveLabel;
...
public class WaterFlowRecommendItem extends MarketTabBase {
    ...
    public cn.damai.tetris.component.discover.bean.ThemeBean themeCard;
    public String title;
    public VoteInfoBean voteCard;

    public String getCategoryNameCompat() {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "2044315160")) {
            return (String) ipChange.ipc$dispatch("2044315160", new Object[]{this});
        }
