...
public class LetterSortBar extends AppCompatTextView {
    ...
    private int dip2px(int i) {
        ...
        return AndroidInstantRuntime.support(ipChange, "-550635320") ? ((Integer) ipChange.ipc$dispatch("-550635320", new Object[]{this, Integer.valueOf(i)})).intValue() : (int) ((i * this.mDensity) + 0.5f);
    }

    private int getLettersSize() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-202196200") ? ((Integer) ipChange.ipc$dispatch("-202196200", new Object[]{this})).intValue() : getListSize(this.mLetters);
    }
    ...
    */
    protected void onDraw(android.graphics.Canvas r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.damai.commonbusiness.city.view.LetterSortBar.onDraw(android.graphics.Canvas):void");
    }
