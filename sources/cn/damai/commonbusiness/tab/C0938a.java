...
/* renamed from: cn.damai.commonbusiness.tab.a */
/* loaded from: classes.dex */
public class C0938a {
    private static transient /* synthetic */ IpChange $ipChange;

    /* compiled from: Taobao */
    /* renamed from: cn.damai.commonbusiness.tab.a$a */
    /* loaded from: classes.dex */
    public class C0939a implements Comparator<BottomSheetBean.Result> {
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    private static void a(List<TabItem> list, List<BottomSheetBean.Result> list2) {
        ...
        Collections.sort(list2, new C0939a(arrayList));
    }
