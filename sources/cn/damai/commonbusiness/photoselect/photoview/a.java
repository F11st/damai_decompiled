...
public class a {
    ...
    /* loaded from: classes4.dex */
    public class ScaleGestureDetector$OnScaleGestureListenerC0036a implements ScaleGestureDetector.OnScaleGestureListener {
        private static transient /* synthetic */ IpChange $ipChange;

        ScaleGestureDetector$OnScaleGestureListenerC0036a() {
        }
    ...
    public a(Context context, OnGestureListener onGestureListener) {
        ...
        this.c = new ScaleGestureDetector(context, new ScaleGestureDetector$OnScaleGestureListenerC0036a());
    }
    ...
    private boolean g(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            int b2 = b.b(motionEvent.getAction());
