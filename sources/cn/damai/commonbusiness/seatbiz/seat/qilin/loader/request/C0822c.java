...
/* renamed from: cn.damai.commonbusiness.seatbiz.seat.qilin.loader.request.c */
/* loaded from: classes.dex */
public class C0822c extends AbstractC0818a<SeatBox, i82> {
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.commonbusiness.seatbiz.seat.qilin.loader.request.c$a */
    /* loaded from: classes.dex */
    public class C0823a extends C6703a {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ RequestListener a;

        C0823a(RequestListener requestListener) {
        ...
        public void onDownloadFinish(String str, String str2) {
            ...
            try {
                ...
                i82 i82Var = (i82) C0822c.this.a.a();
                ...
                if (b != null && b.getResultCode() == 1) {
                    if (cr.g(b.getResult(), i82Var.b())) {
                        ...
                        this.a.onSuccess(C0822c.this.a, seatBox);
                    } else {
                        r92.f("VR PB 数据校验失败");
                ...
                e.printStackTrace();
                this.a.onFail(C0822c.this.a, OPRUtils.OPRPhoneLevel.OPR_PHONE_LEVEL_MEDIUM, e.getMessage());
            }
        }
        ...
        public void onNetworkLimit(int i, jq1 jq1Var, DownloadListener.NetworkLimitCallback networkLimitCallback) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-992623825")) {
                ...
                this.a.onFail(C0822c.this.a, "onNetLimit", "");
            }
        }
    }
    ...
    public void d(@NonNull RequestListener<SeatBox, i82> requestListener) {
        ...
        qc0Var.b.m = false;
        this.c = this.b.b(qc0Var, new C0823a(requestListener));
    }
}
