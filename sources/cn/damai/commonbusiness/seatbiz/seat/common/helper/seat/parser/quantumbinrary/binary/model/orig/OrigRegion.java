...
public class OrigRegion {
    ...
    public int chairCount() {
        ...
        return AndroidInstantRuntime.support(ipChange, "631048951") ? ((Integer) ipChange.ipc$dispatch("631048951", new Object[]{this})).intValue() : this.mChairList.size();
    }

    public List<OrigChair> chairs() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1347364423") ? (List) ipChange.ipc$dispatch("1347364423", new Object[]{this}) : this.mChairList;
    }
        ...
        if (this.mId.equals(origRegion.mId) && origRegion.chairs().size() == chairs().size()) {
            ...
            for (int i = 0; i < chairs().size(); i++) {
                ...
                if (!origChair.equals(origChair2)) {
                    jo.a("binary", "--------------------- verify: error chair -----------------------");
                    jo.a("binary", "[dest] this:" + origChair.toString());
                    jo.a("binary", "[ src] that:" + origChair2.toString());
                    return false;
                }
            }
            jo.a("binary", "region id:" + this.mId + "--------------------- verify: OK -----------------------");
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1699877062") ? ((Integer) ipChange.ipc$dispatch("1699877062", new Object[]{this})).intValue() : (this.mId.hashCode() * 31) + this.mChairList.hashCode();
    }

    public String id() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1521600109") ? (String) ipChange.ipc$dispatch("1521600109", new Object[]{this}) : this.mId;
    }
