...
public class DMSVG extends BaseSVG {
    ...
    private void buildHitLocationInfo(C4761f c4761f) {
        List<PointLocation> locationPoint;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "453753143")) {
            ipChange.ipc$dispatch("453753143", new Object[]{this, c4761f});
        } else if (c4761f != null) {
            ...
            List<C4761f.C4768g> l = c4761f.l();
            if (l == null || l.isEmpty()) {
                return;
            }
            for (int i = 0; i < l.size(); i++) {
                C4761f.C4768g c4768g = l.get(i);
                if (c4768g != null) {
                    String[] g = ju1.g(c4768g.b());
                    String str = g != null ? g[0] : "";
                    if (!TextUtils.isEmpty(str)) {
                        if (c4768g instanceof C4761f.C4765d) {
                            locationPoint = getLocationPoint((C4761f.C4765d) c4768g, str);
                        } else {
                            locationPoint = getLocationPoint(c4768g.a(), str);
                        }
                        this.regionLocationList.add(locationPoint);
                        if (c4768g instanceof C4761f.C4764c) {
                            this.mRegionBounds.add(new RegionBound(str, ((C4761f.C4764c) c4768g).e(), locationPoint));
                        } else {
    ...
    public void initSVGData(C4761f c4761f) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-841151337")) {
            ipChange.ipc$dispatch("-841151337", new Object[]{this, c4761f});
        } else if (c4761f == null) {
        } else {
            this.mSVG = c4761f;
            buildHitLocationInfo(c4761f);
            this.svgScale = this.mSVG.o();
            this.picture = c4761f.m();
    ...
    public Picture renderToPicture(C4748d c4748d) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "741971578")) {
            return (Picture) ipChange.ipc$dispatch("741971578", new Object[]{this, c4748d});
        }
        C4761f c4761f = this.mSVG;
        if (c4761f != null) {
            return c4761f.r(c4748d);
        }
        return null;
    }
    ...
    private List<PointLocation> getLocationPoint(C4761f.C4765d c4765d, String str) {
        float[] e;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-203352590")) {
            return (List) ipChange.ipc$dispatch("-203352590", new Object[]{this, c4765d, str});
        }
        ArrayList arrayList = null;
        if (c4765d == null || (e = c4765d.e()) == null) {
            return null;
        }
        RectF a = c4765d.a();
        if (e.length > 1) {
            ...
            if (!(c4765d instanceof C4761f.C4766e)) {
