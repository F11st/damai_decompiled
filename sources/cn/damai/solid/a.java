...
public class a {
    ...
    public class C0074a implements Solid.OnInitFinishCallback {
    ...
    private void h(Application application, long j) {
        ...
        Solid.getInstance().init(new SolidConfig.Builder(application).openLog(AppConfig.v()).useCompress(true).setLibPath(LibPathUtil.getDefaultLibPath(application)).setLaunchTimeMillions(j).setVersionName(AppConfig.q()).setDownloader(new XcdnDownloaderImpl("1")).setMonitor(new ih1()).build(), new C0074a());
