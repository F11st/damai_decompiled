...
public class b extends cn.damai.projectfiltercopy.floatview.a<SortBean> implements View.OnClickListener {
    ...
    public class a implements IPermissionListener {
        ...
        /* loaded from: classes6.dex */
        public class C0061a implements CityLocationUtil.LocaltionListener {
            private static transient /* synthetic */ IpChange $ipChange;
        ...
        public class DialogInterface$OnClickListenerC0062b implements DialogInterface.OnClickListener {
            ...
            DialogInterface$OnClickListenerC0062b() {
            }
        ...
        public void onPermissionGranted() {
            ...
            CityLocationUtil cityLocationUtil = new CityLocationUtil(AppInfoProviderProxy.getApplication(), new C0061a(this));
        ...
        public void onShowRationale(@NotNull String[] strArr) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "24950143")) {
                ...
                gm.INSTANCE.a().showPermissionDialog(b.this.a, "获取你所在城市的演出赛事信息，帮助你找到附近的演出赛事", Arrays.asList(strArr), false, new DialogInterface$OnClickListenerC0062b(), new c(this));
            }
        }
    }
    ...
    private void a(SortBean sortBean) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1076579983")) {
            ...
            new Permission(this.a, new PermissionModel(lr1.a, "位置权限使用说明", Integer.valueOf(R$drawable.permission_location_icon), "用于为你提供所在城市演出和场馆信息及帮助你找到附近的演出")).a(new a(sortBean)).b();
        }
    }
