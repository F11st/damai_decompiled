...
public class SortBean implements Serializable {
    ...
    public int hashCode() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-440157226") ? ((Integer) ipChange.ipc$dispatch("-440157226", new Object[]{this})).intValue() : nm1.b(this.value);
    }

    public boolean isLocationSort() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-830836539") ? ((Boolean) ipChange.ipc$dispatch("-830836539", new Object[]{this})).booleanValue() : TextUtils.equals("4", this.value);
    }
