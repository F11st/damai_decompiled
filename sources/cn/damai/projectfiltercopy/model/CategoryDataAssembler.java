...
public final class CategoryDataAssembler {
    ...
    public final String getBtnText() {
        ...
        if (this.mSelectUsed4RequestList.size() != 0) {
            try {
                str = qd.g(this.mCategoryList, this.mSelectUsed4RequestList);
            } catch (Exception e) {
                e.printStackTrace();
            }
            b41.h(str, "{\n            try {\n    …\"\n            }\n        }");
    ...
    public final OnCategoryUpdateListener getMListener() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "730855173") ? (OnCategoryUpdateListener) ipChange.ipc$dispatch("730855173", new Object[]{this}) : this.mListener;
    }

    @NotNull
    public final ArrayList<CategoryLevelOne> getSelect4Request() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "1477399092") ? (ArrayList) ipChange.ipc$dispatch("1477399092", new Object[]{this}) : this.mSelectUsed4RequestList;
    }
            ...
            for (CategoryLevelOne categoryLevelOne : list2) {
                ...
                if (categoryLevelOne.select && (list = categoryLevelOne.lineItemList) != null) {
                    ...
                    for (CategoryLevelTwo categoryLevelTwo : list) {
                        ...
                        b41.g(clone, "null cannot be cast to non-null type cn.damai.projectfiltercopy.bean.CategoryLevelTwo");
