...
public class CompatCoordinatorLayout extends CoordinatorLayout {
    ...
    private AppBarLayout findAppBar() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1673012957")) {
            return (AppBarLayout) ipChange.ipc$dispatch("-1673012957", new Object[]{this});
        }
    ...
    public void onNestedPreScroll(View view, int i, int i2, int[] iArr, int i3) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1314181149")) {
            ipChange.ipc$dispatch("1314181149", new Object[]{this, view, Integer.valueOf(i), Integer.valueOf(i2), iArr, Integer.valueOf(i3)});
            return;
        }
    ...
    public void onNestedScrollAccepted(View view, View view2, int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-236896916")) {
            ipChange.ipc$dispatch("-236896916", new Object[]{this, view, view2, Integer.valueOf(i), Integer.valueOf(i2)});
        } else {
