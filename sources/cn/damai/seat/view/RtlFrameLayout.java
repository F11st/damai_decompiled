...
public class RtlFrameLayout extends FrameLayout {
    ...
    private int getChildUsedHeight(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1107898090")) {
            return ((Integer) ipChange.ipc$dispatch("1107898090", new Object[]{this, view})).intValue();
        }
    ...
    private int getChildUsedWidth(View view) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1907500989")) {
            return ((Integer) ipChange.ipc$dispatch("-1907500989", new Object[]{this, view})).intValue();
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        IpChange ipChange = $ipChange;
        int i5 = 0;
        if (AndroidInstantRuntime.support(ipChange, "-81832936")) {
            ipChange.ipc$dispatch("-81832936", new Object[]{this, Boolean.valueOf(z), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)});
    ...
    protected void onMeasure(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-56056986")) {
            ipChange.ipc$dispatch("-56056986", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2)});
            return;
        }
    ...
    public RtlFrameLayout(Context context, @Nullable AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public RtlFrameLayout(Context context, @Nullable AttributeSet attributeSet, int i) {
