...
/* renamed from: cn.damai.seat.helper.b */
/* loaded from: classes7.dex */
public class C1667b extends jb {
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.seat.helper.b$a */
    /* loaded from: classes7.dex */
    public class C1668a implements OnNetBizListener<TicketCalcRes> {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ SeatComputeListener a;

        C1668a(SeatComputeListener seatComputeListener) {
        ...
        public void onNetSuccess(@NonNull TicketCalcRes ticketCalcRes) {
            ...
            if (ticketCalcRes.isBizSuccess()) {
                C1667b.this.n(ticketCalcRes.model, null, this.a);
            } else {
                C1667b.this.n(null, "价格计算失败", this.a);
            }
        }
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.seat.helper.b$b */
    /* loaded from: classes7.dex */
    public class C1669b implements SeatDataSubmitter.OnSubmitSeatDataListener {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ OnSubmitListener a;

        C1669b(OnSubmitListener onSubmitListener) {
        ...
        public void onSubmitFailed(String str, String str2, String str3) {
            ...
            t82.g(str, str2, str3, C1667b.this.f.itemId + "", C1667b.this.f.performId + "");
        ...
        public void onSubmitSuccess(OrderAfterChooseSeatInfo orderAfterChooseSeatInfo) {
            ...
            this.a.doNetWork(false, true);
            this.a.onSubmitSuccess(C1667b.this.f.orderId, orderAfterChooseSeatInfo);
        }
    }

    /* compiled from: Taobao */
    /* renamed from: cn.damai.seat.helper.b$c */
    /* loaded from: classes7.dex */
    public class C1670c implements OnNetBizListener<TicketCalcRes> {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ OnSubmitListener a;

        C1670c(OnSubmitListener onSubmitListener) {
            this.a = onSubmitListener;
        }
        ...
        public void onNetSuccess(@NonNull TicketCalcRes ticketCalcRes) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "147291715")) {
                ...
                C1667b.this.n(ticketCalcRes.model, null, this.a);
                C1667b.this.o(ticketCalcRes.model.ticketModuleDetailVOS, this.a);
            } else {
                this.a.doNetWork(false, false);
                C1667b.this.n(null, "价格计算失败", this.a);
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.seat.helper.b$d */
    /* loaded from: classes7.dex */
    public class C1671d implements SeatPreLocker.OnPreLockResultListener {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ OnSubmitListener a;
        final /* synthetic */ List b;

        C1671d(OnSubmitListener onSubmitListener, List list) {
            this.a = onSubmitListener;
            this.b = list;
        }
        ...
        public void onOpenNextPage(boolean z, String str, String str2) {
            ...
            this.a.doNetWork(false, false);
            this.a.onOpenPurchase(C1667b.this.m(this.b));
        }
    ...
    public C1667b(TbParams tbParams) {
        this.f = tbParams;
    ...
    public void o(@Nullable List<TicketCombineInfo> list, OnSubmitListener onSubmitListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-63750200")) {
            ...
            this.a.a(this.k.f(this.c, new C1671d(onSubmitListener, list)));
        }
    }
    ...
    public void C(OnSubmitListener onSubmitListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "236891821")) {
            ...
            if (this.f.firstPayChooseSeat) {
                ...
                new SeatDataSubmitter(this.f.orderId, this.c).b(new C1669b(onSubmitListener));
                return;
            }
            ...
            if ((!this.o || this.p) ? false : !e) {
                onSubmitListener.doNetWork(true, false);
                this.a.a(this.j.b(G, this.q, f92.f(this.e, z().getPid2PriceLineMap()), new C1670c(onSubmitListener)));
                return;
            }
    ...
    public int D() {
        ...
        this.k.c();
        if (!cb2.d(d) && !cb2.d(this.c)) {
            for (SeatNew seatNew : this.c) {
                if (d.contains(Long.valueOf(seatNew.sid))) {
                    seatNew.state = 8;
                }
            }
        }
    ...
    public void l(@NonNull SeatComputeListener seatComputeListener) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-800939223")) {
            ...
            this.a.a(this.j.b(G, this.q, list, new C1668a(seatComputeListener)));
        }
    }
