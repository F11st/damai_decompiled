package cn.damai.search.component;
...
public class RtlLayout extends FrameLayout {
    ...
    private int getChildUsedHeight(View view) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "1967270204")) {
            return ((Integer) ipChange.ipc$dispatch("1967270204", new Object[]{this, view})).intValue();
        }
    ...
    private int getChildUsedWidth(View view) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-909947983")) {
            return ((Integer) ipChange.ipc$dispatch("-909947983", new Object[]{this, view})).intValue();
        }
        ViewGroup.MarginLayoutParams marginLayoutParams = (ViewGroup.MarginLayoutParams) view.getLayoutParams();
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        IpChange ipChange = $ipChange;
        int i5 = 0;
        if (AndroidInstantRuntime.support(ipChange, "-825252758")) {
            ipChange.ipc$dispatch("-825252758", new Object[]{this, Boolean.valueOf(z), Integer.valueOf(i), Integer.valueOf(i2), Integer.valueOf(i3), Integer.valueOf(i4)});
    ...
    protected void onMeasure(int i, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "309649464")) {
            ipChange.ipc$dispatch("309649464", new Object[]{this, Integer.valueOf(i), Integer.valueOf(i2)});
            return;
        }
