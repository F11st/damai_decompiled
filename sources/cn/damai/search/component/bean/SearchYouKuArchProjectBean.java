...
public class SearchYouKuArchProjectBean implements Serializable {
    ...
    public static class RankingListArch implements Serializable {
        ...
        public int getType() {
            ...
            if (AndroidInstantRuntime.support(ipChange, "625883799")) {
                return ((Integer) ipChange.ipc$dispatch("625883799", new Object[]{this})).intValue();
            }
    ...
    public String getVideoSupport() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "2001535216") ? (String) ipChange.ipc$dispatch("2001535216", new Object[]{this}) : (TextUtils.isEmpty(this.isVideoSupport) || !this.isVideoSupport.equals("1")) ? "false" : "true";
    }
}
