...
/* renamed from: cn.damai.trade.newtradeorder.ui.projectdetail.projectdetailitem.ui.view.projectheader.b */
/* loaded from: classes8.dex */
public class View$OnClickListenerC2380b extends AbstractC2379a implements View.OnClickListener {
    ...
    private TextView p;
    private TextView q;
    private CountDownTimerC2383c r;
    private View s;
    private ImageView t;
    private TextView u;
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.trade.newtradeorder.ui.projectdetail.projectdetailitem.ui.view.projectheader.b$a */
    /* loaded from: classes8.dex */
    public class C2381a implements DMImageCreator.DMImageFailListener {
        private static transient /* synthetic */ IpChange $ipChange;
        ...
        public void onFail(DMImageCreator.C0501d c0501d) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "596802219")) {
                ipChange.ipc$dispatch("596802219", new Object[]{this, c0501d});
            } else {
                ProjectDetailXFlushUtil.n(c0501d != null ? String.valueOf(c0501d.a) : "", this.a, String.valueOf(View$OnClickListenerC2380b.this.b));
            }
        }
    }

    /* compiled from: Taobao */
    /* renamed from: cn.damai.trade.newtradeorder.ui.projectdetail.projectdetailitem.ui.view.projectheader.b$b */
    /* loaded from: classes8.dex */
    public class C2382b implements DMImageCreator.DMImageSuccListener {
        private static transient /* synthetic */ IpChange $ipChange;
        final /* synthetic */ String a;
        final /* synthetic */ boolean b;

        C2382b(String str, boolean z) {
            this.a = str;
            this.b = z;
        }
        ...
        public void onSuccess(DMImageCreator.C0502e c0502e) {
            ...
            if (AndroidInstantRuntime.support(ipChange, "-868450304")) {
                ipChange.ipc$dispatch("-868450304", new Object[]{this, c0502e});
            } else if (c0502e != null) {
                if (c0502e.a != null) {
                    View$OnClickListenerC2380b.this.e.setImageDrawable(c0502e.a);
                    View$OnClickListenerC2380b.this.e.setOnClickListener(View$OnClickListenerC2380b.this);
                }
                Bitmap bitmap = c0502e.b;
                if (bitmap != null) {
                    View$OnClickListenerC2380b.this.d.onLoadedPosterPic(this.a, bitmap, this.b);
                }
            }
        }
    }
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.trade.newtradeorder.ui.projectdetail.projectdetailitem.ui.view.projectheader.b$c */
    /* loaded from: classes16.dex */
    public class CountDownTimerC2383c extends CountDownTimer {
        private static transient /* synthetic */ IpChange $ipChange;

        public CountDownTimerC2383c(long j) {
            super(j, 1000L);
        }
        ...
        public void onFinish() {
            ...
            Activity activity = View$OnClickListenerC2380b.this.a;
            if (activity == null || activity.isDestroyed()) {
                return;
            }
            Activity activity2 = View$OnClickListenerC2380b.this.a;
            if ((activity2 instanceof ProjectDetailActivity) && ((ProjectDetailActivity) activity2).getCurrentFragment() != null && (((ProjectDetailActivity) View$OnClickListenerC2380b.this.a).getCurrentFragment() instanceof ProjectDetailItemMainFragment)) {
                ((ProjectDetailItemMainFragment) ((ProjectDetailActivity) View$OnClickListenerC2380b.this.a).getCurrentFragment()).onRefresh();
            }
        }
        ...
        public void onTick(long j) {
            ...
            View$OnClickListenerC2380b.this.i.setText(stringBuffer);
        }
    }

    public View$OnClickListenerC2380b(Activity activity, long j, View view, OnHeadClickListener onHeadClickListener) {
    ...
    private void j(String str, boolean z) {
        ...
        DMImageCreator k = C0504a.b().f(str, ScreenUtil.dip2px(mu0.a(), 93.0f), ScreenUtil.dip2px(mu0.a(), 131.0f)).k(new DMRoundedCornersBitmapProcessor(6, 0));
        int i = R$drawable.uikit_default_image_bg_trans_white;
        k.i(i).c(i).n(new C2382b(str, z)).e(new C2381a(str)).f();
    ...
    private void l(TextView textView, String str) {
        ...
        int a = t60.a(this.a, 10.0f);
        int a2 = t60.a(this.a, 11.0f);
        spannableString.setSpan(new AbsoluteSizeSpan(a), 0, length2, 18);
        spannableString.setSpan(new AbsoluteSizeSpan(a2), length2, length, 18);
    ...
    public void f(ProjectDetailDataBean projectDetailDataBean, boolean z) {
        ...
        if (AndroidInstantRuntime.support(ipChange, "-1649191225")) {
            ...
            String itemName = c == null ? "" : c.getItemName();
            n(k);
            String valueOf = c == null ? "" : String.valueOf(c.getItemId());
            ...
            if (c != null) {
                ...
                if (c.hasServiceFee) {
                    if (item != null && (item.hasEarlyBird || item.hasWedHalfPrice)) {
                        ...
                        l(this.p, c.sfptTip);
                        this.o.setText(c.sfptPrefix);
                        this.q.setText(c.sfptSuffix);
                    } else {
                        this.j.setVisibility(0);
                        this.m.setTextColor(this.a.getResources().getColor(j == 0 ? R$color.color_9C9CA5 : R$color.color_FF2869));
                        l(this.m, c.sfptTip);
                        this.l.setText(c.sfptPrefix);
                        this.n.setText(c.sfptSuffix);
                    }
                } else {
            ...
            if (item != null && (item.hasEarlyBird || item.hasWedHalfPrice)) {
                ...
                if (item.hasWedHalfPrice && (wedHalfPriceVO = item.wedHalfPriceVO) != null) {
                    ...
                    CountDownTimerC2383c countDownTimerC2383c = this.r;
                    if (countDownTimerC2383c != null) {
                        countDownTimerC2383c.cancel();
                    }
                } else if (item.hasEarlyBird && (earlyBirdVO = item.earlyBirdVO) != null) {
                    if (earlyBirdVO.showTips) {
                        this.i.setText(earlyBirdVO.tips);
                    } else {
                        CountDownTimerC2383c countDownTimerC2383c2 = this.r;
                        if (countDownTimerC2383c2 != null) {
                            countDownTimerC2383c2.cancel();
                        }
                        if (item.earlyBirdVO.countdown > 0) {
                            CountDownTimerC2383c countDownTimerC2383c3 = new CountDownTimerC2383c(item.earlyBirdVO.countdown);
                            this.r = countDownTimerC2383c3;
                            countDownTimerC2383c3.start();
                        }
                    }
                }
            } else {
