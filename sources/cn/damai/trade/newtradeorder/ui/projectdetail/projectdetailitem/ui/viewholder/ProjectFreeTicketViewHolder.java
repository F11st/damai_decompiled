...
public class ProjectFreeTicketViewHolder extends RecyclerView.ViewHolder {
    ...
    public void a(ProjectDataHolder projectDataHolder) {
        ...
        cn.damai.common.image.a.b().f(recommendFreeTicketItem.cover, m62.a(this.e, 90.0f), m62.a(this.e, 120.0f)).c(R$drawable.uikit_default_image_bg_gradient).g(this.a);
