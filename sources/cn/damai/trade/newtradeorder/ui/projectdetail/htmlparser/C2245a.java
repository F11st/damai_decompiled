...
/* renamed from: cn.damai.trade.newtradeorder.ui.projectdetail.htmlparser.a */
...
public class C2245a {
    ...
    public static C2247c.C2248a m(int i, char[] cArr, int i2) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1135597283")) {
            return (C2247c.C2248a) ipChange.ipc$dispatch("-1135597283", new Object[]{Integer.valueOf(i), cArr, Integer.valueOf(i2)});
        }
        C2247c.C2248a c2248a = new C2247c.C2248a();
        ...
        if (i == 1) {
            ...
            if (b != null && b.contains("&")) {
                c2248a.b = c2248a.b.replace("&amp;", "&");
            }
        } else if (i != 15) {
            switch (i) {
                case 53:
                case 55:
                    c2248a.g = a(false, str, 0);
                    break;
                case 54:
                    c2248a.c = i(str, 0);
                    c2248a.e = a(true, str, 0);
                    break;
                default:
                    switch (i) {
                        case 61:
            ...
            if (b2 != null && b2.contains("&")) {
                c2248a.a = c2248a.a.replace("&amp;", "&");
            }
            c2248a.g = a(false, str, 0);
            c2248a.h = g(str);
            c2248a.i = f(str);
            String str2 = c2248a.a;
            if (str2 != null) {
                boolean l = l(str2);
                if (l) {
                    try {
                        if (str.contains("style")) {
                            ...
                            c2248a.j = h(substring, "damai_width:");
                ...
                if (l) {
                    try {
                        if (str.contains("damai_width") && str.contains("damai_height")) {
                            c2248a.j = c(k(str.substring(str.indexOf("damai_width")), 0, "damai_width"));
                            c2248a.k = c(k(str.substring(str.indexOf("damai_height")), 0, "damai_height"));
                        }
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                Log.d("AttrParser", c2248a.j + jn1.MUL + c2248a.k);
            }
        }
        return c2248a;
    }
