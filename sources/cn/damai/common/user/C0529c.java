...
/* renamed from: cn.damai.common.user.c */
...
public class C0529c {
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.common.user.c$b */
    /* loaded from: classes13.dex */
    public static class C0531b {
        private static final C0529c a = new C0529c();
    }
    ...
    public static final C0529c e() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-36379293") ? (C0529c) ipChange.ipc$dispatch("-36379293", new Object[0]) : C0531b.a;
    }

    private Map<String, String> f(C0525a c0525a) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "4480989")) {
            return (Map) ipChange.ipc$dispatch("4480989", new Object[]{this, c0525a});
        }
        ...
        if (!TextUtils.isEmpty(c0525a.p())) {
            hashMap.put("item_id", c0525a.p());
        }
        if (!TextUtils.isEmpty(c0525a.m())) {
            hashMap.put("city", c0525a.m());
        }
        a(hashMap);
        if (!TextUtils.isEmpty(c0525a.q())) {
            hashMap.put("keyword", c0525a.q());
        }
        if (!TextUtils.isEmpty(c0525a.s())) {
            hashMap.put("orderid", c0525a.s());
        }
        if (!TextUtils.isEmpty(c0525a.v())) {
            hashMap.put("titlelabel", c0525a.v());
        }
        if (!TextUtils.isEmpty(c0525a.n())) {
            hashMap.put("contentlabel", c0525a.n());
        }
        hashMap.put("spm-cnt", "a2o4t." + c0525a.t() + ".0.0");
        return hashMap;
    }
    ...
    private void i(C0525a c0525a, boolean z) {
        String str;
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1394001846")) {
            ipChange.ipc$dispatch("1394001846", new Object[]{this, c0525a, Boolean.valueOf(z)});
            return;
        }
        HashMap hashMap = new HashMap();
        if (c0525a.u() != null) {
            hashMap.putAll(c0525a.u());
        }
        a(hashMap);
        hashMap.remove("PreABTrackInfo");
        hashMap.put("spm", "a2o4t." + c0525a.t() + "." + c0525a.r() + "." + c0525a.w());
        if (z) {
        ...
        UTHitBuilders.UTControlHitBuilder uTControlHitBuilder = new UTHitBuilders.UTControlHitBuilder("page_" + c0525a.t(), str);
    ...
    public void j(Activity activity, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1002920744")) {
            ipChange.ipc$dispatch("-1002920744", new Object[]{this, activity, c0527b});
        } else if (c0527b == null) {
        } else {
            try {
    ...
    public void k(Activity activity, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1790607733")) {
            ipChange.ipc$dispatch("-1790607733", new Object[]{this, activity, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
    ...
    public void l(Activity activity, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-183490391")) {
            ipChange.ipc$dispatch("-183490391", new Object[]{this, activity, c0527b});
        } else if (c0527b == null) {
        } else {
            try {
                UTAnalytics.getInstance().getDefaultTracker().updatePageProperties(activity, f(c0527b.m()));
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
    ...
    public void n(Activity activity, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-699722548")) {
            ipChange.ipc$dispatch("-699722548", new Object[]{this, activity, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
    ...
    public void o(Fragment fragment, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-737062618")) {
            ipChange.ipc$dispatch("-737062618", new Object[]{this, fragment, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
    ...
    public void p(Fragment fragment, C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "1417648731")) {
            ipChange.ipc$dispatch("1417648731", new Object[]{this, fragment, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
    ...
    public void x(C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-1404349866")) {
            ipChange.ipc$dispatch("-1404349866", new Object[]{this, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
    ...
    public void y(String str, String str2, Map<String, String> map) {
        ...
        try {
            ...
            Map<String, String> a = o23.c().a(map);
            o23.c();
            o23.e(a, uTControlHitBuilder);
            UTAnalytics.getInstance().getDefaultTracker().send(uTControlHitBuilder.build());
            rv2.e(a);
            UTAnalytics.getInstance().getDefaultTracker().updateNextPageProperties(rv2.d());
            UTAnalytics.getInstance().getDefaultTracker().updateNextPageUtparam(a.get("utparam"));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

    public void z(C0525a.C0527b c0527b) {
        IpChange ipChange = $ipChange;
        if (AndroidInstantRuntime.support(ipChange, "-147974387")) {
            ipChange.ipc$dispatch("-147974387", new Object[]{this, c0527b});
        } else if (c0527b == null) {
        } else {
            C0525a m = c0527b.m();
            try {
