...
/* renamed from: cn.damai.common.util.toastutil.c */
/* loaded from: classes13.dex */
public final class HandlerC0540c extends Handler {
    ...
    /* compiled from: Taobao */
    /* renamed from: cn.damai.common.util.toastutil.c$a */
    /* loaded from: classes13.dex */
    public class C0541a implements Application.ActivityLifecycleCallbacks {
        private static transient /* synthetic */ IpChange $ipChange;
    ...
    public HandlerC0540c(Toast toast, Application application) {
        super(Looper.getMainLooper());
        this.a = toast;
        this.b = application.getPackageName();
        mu0.a().registerActivityLifecycleCallbacks(new C0541a());
    }
    ...
    public void a() {
        ...
        if (this.c) {
            try {
                ((WindowManager) k3.b().c().getSystemService(C9796v.ATTACH_MODE_WINDOW)).removeView(this.a.getView());
    ...
    public void b() {
        ...
        if (AndroidInstantRuntime.support(ipChange, "2017934211")) {
            ...
            try {
                ((WindowManager) k3.b().c().getSystemService(C9796v.ATTACH_MODE_WINDOW)).addView(this.a.getView(), layoutParams);
                this.c = true;
