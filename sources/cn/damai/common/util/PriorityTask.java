...
public abstract class PriorityTask implements Runnable, Comparable<PriorityTask> {
    ...
    public Object getParam() {
        ...
        return AndroidInstantRuntime.support(ipChange, "-831263297") ? ipChange.ipc$dispatch("-831263297", new Object[]{this}) : this.param.get();
    }

    public int getPriority() {
        IpChange ipChange = $ipChange;
        return AndroidInstantRuntime.support(ipChange, "-1227865767") ? ((Integer) ipChange.ipc$dispatch("-1227865767", new Object[]{this})).intValue() : this.priority;
    }
