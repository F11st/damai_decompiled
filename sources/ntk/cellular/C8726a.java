...
public class C8726a {
    ...
    private int c = -100;
    protected final ConnectivityManager.NetworkCallback d = new C8727a();

    /* compiled from: Taobao */
    /* renamed from: ntk.cellular.a$a */
    /* loaded from: classes2.dex */
    class C8727a extends ConnectivityManager.NetworkCallback {
        C8727a() {
        }

        @Override // android.net.ConnectivityManager.NetworkCallback
        public void onAvailable(Network network) {
            C8726a c8726a = C8726a.this;
            c8726a.a = network;
            c8726a.k(0);
        }
