...
public abstract class c<T> implements MaybeSource<T> {
    ...
    @CheckReturnValue
    public static <T> c<T> amb(Iterable<? extends MaybeSource<? extends T>> iterable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> ambArray(MaybeSource<? extends T>... maybeSourceArr) {
    ...
    @CheckReturnValue
    public static <T> b<T> concat(Iterable<? extends MaybeSource<? extends T>> iterable) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatArray(MaybeSource<? extends T>... maybeSourceArr) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatArrayDelayError(MaybeSource<? extends T>... maybeSourceArr) {
        if (maybeSourceArr.length == 0) {
            return b.empty();
        }
        if (maybeSourceArr.length == 1) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatArrayEager(MaybeSource<? extends T>... maybeSourceArr) {
        return b.fromArray(maybeSourceArr).concatMapEager(MaybeToPublisher.instance());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatDelayError(Iterable<? extends MaybeSource<? extends T>> iterable) {
        ObjectHelper.requireNonNull(iterable, "sources is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatEager(Iterable<? extends MaybeSource<? extends T>> iterable) {
        return b.fromIterable(iterable).concatMapEager(MaybeToPublisher.instance());
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> create(MaybeOnSubscribe<T> maybeOnSubscribe) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> defer(Callable<? extends MaybeSource<? extends T>> callable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromAction(Action action) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromCallable(@NonNull Callable<? extends T> callable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromCompletable(CompletableSource completableSource) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromRunnable(Runnable runnable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromSingle(SingleSource<T> singleSource) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(Iterable<? extends MaybeSource<? extends T>> iterable) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeArray(MaybeSource<? extends T>... maybeSourceArr) {
        ObjectHelper.requireNonNull(maybeSourceArr, "sources is null");
        if (maybeSourceArr.length == 0) {
            return b.empty();
        }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeArrayDelayError(MaybeSource<? extends T>... maybeSourceArr) {
        if (maybeSourceArr.length == 0) {
            return b.empty();
        }
        return b.fromArray(maybeSourceArr).flatMap(MaybeToPublisher.instance(), true, maybeSourceArr.length);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeDelayError(Iterable<? extends MaybeSource<? extends T>> iterable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> e<Boolean> sequenceEqual(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> unsafeCreate(MaybeSource<T> maybeSource) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, D> c<T> using(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer) {
        return using(callable, function, consumer, true);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> wrap(MaybeSource<T> maybeSource) {
        if (maybeSource instanceof c) {
            return i42.m((c) maybeSource);
        }
        ObjectHelper.requireNonNull(maybeSource, "onSubscribe is null");
        return i42.m(new MaybeUnsafeCreate(maybeSource));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> c<R> zip(Iterable<? extends MaybeSource<? extends T>> iterable, Function<? super Object[], ? extends R> function) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, R> c<R> zipArray(Function<? super Object[], ? extends R> function, MaybeSource<? extends T>... maybeSourceArr) {
        ObjectHelper.requireNonNull(maybeSourceArr, "sources is null");
        if (maybeSourceArr.length == 0) {
            return empty();
        }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> ambWith(MaybeSource<? extends T> maybeSource) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> c<U> cast(Class<? extends U> cls) {
        ObjectHelper.requireNonNull(cls, "clazz is null");
        return (c<U>) map(Functions.castFunction(cls));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> compose(MaybeTransformer<? super T, ? extends R> maybeTransformer) {
        return wrap(((MaybeTransformer) ObjectHelper.requireNonNull(maybeTransformer, "transformer is null")).apply(this));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> concatMap(Function<? super T, ? extends MaybeSource<? extends R>> function) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final b<T> concatWith(MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
    ...
    @CheckReturnValue
    public final <U> c<T> delaySubscription(Publisher<U> publisher) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doAfterSuccess(Consumer<? super T> consumer) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doAfterTerminate(Action action) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doFinally(Action action) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnComplete(Action action) {
        Action action2 = Functions.EMPTY_ACTION;
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnDispose(Action action) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Consumer emptyConsumer3 = Functions.emptyConsumer();
        Action action2 = Functions.EMPTY_ACTION;
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnError(Consumer<? super Throwable> consumer) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnEvent(BiConsumer<? super T, ? super Throwable> biConsumer) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnSubscribe(Consumer<? super Disposable> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Consumer emptyConsumer2 = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> doOnSuccess(Consumer<? super T> consumer) {
        Consumer emptyConsumer = Functions.emptyConsumer();
        Action action = Functions.EMPTY_ACTION;
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> flatMap(Function<? super T, ? extends MaybeSource<? extends R>> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        return i42.m(new MaybeFlatten(this, function));
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> flatMapSingleElement(Function<? super T, ? extends SingleSource<? extends R>> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> lift(MaybeOperator<? extends R, ? super T> maybeOperator) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> map(Function<? super T, ? extends R> function) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final b<T> mergeWith(MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
    ...
    @CheckReturnValue
    public final c<T> observeOn(Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorComplete() {
        return onErrorComplete(Functions.alwaysTrue());
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorResumeNext(MaybeSource<? extends T> maybeSource) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorReturn(Function<? super Throwable, ? extends T> function) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorReturnItem(T t) {
        ObjectHelper.requireNonNull(t, "item is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onExceptionResumeNext(MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "next is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> retryUntil(BooleanSupplier booleanSupplier) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> retryWhen(Function<? super b<Throwable>, ? extends Publisher<?>> function) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> subscribeOn(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> switchIfEmpty(MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> c<T> takeUntil(MaybeSource<U> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> R to(Function<? super c<T>, R> function) {
        try {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> unsubscribeOn(Scheduler scheduler) {
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> c<R> zipWith(MaybeSource<? extends U> maybeSource, BiFunction<? super T, ? super U, ? extends R> biFunction) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatEager(Publisher<? extends MaybeSource<? extends T>> publisher) {
        return b.fromPublisher(publisher).concatMapEager(MaybeToPublisher.instance());
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> publisher) {
        return b.fromPublisher(publisher).flatMap(MaybeToPublisher.instance(), true);
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> e<Boolean> sequenceEqual(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, BiPredicate<? super T, ? super T> biPredicate) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public static c<Long> timer(long j, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T, D> c<T> using(Callable<? extends D> callable, Function<? super D, ? extends MaybeSource<? extends T>> function, Consumer<? super D> consumer, boolean z) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> delay(long j, TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorComplete(Predicate<? super Throwable> predicate) {
        ObjectHelper.requireNonNull(predicate, "predicate is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> retry(BiPredicate<? super Integer, ? super Throwable> biPredicate) {
    ...
    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final c<T> timeout(long j, TimeUnit timeUnit, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(maybeSource, "other is null");
        return timeout(j, timeUnit, io.reactivex.schedulers.a.a(), maybeSource);
    }

    @SchedulerSupport("none")
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concat(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concatDelayError(Publisher<? extends MaybeSource<? extends T>> publisher) {
        return b.fromPublisher(publisher).concatMapDelayError(MaybeToPublisher.instance());
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> fromFuture(Future<? extends T> future, long j, TimeUnit timeUnit) {
        ObjectHelper.requireNonNull(future, "future is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(Publisher<? extends MaybeSource<? extends T>> publisher, int i) {
        ObjectHelper.requireNonNull(publisher, "source is null");
        ObjectHelper.verifyPositive(i, "maxConcurrency");
        return i42.l(new FlowableFlatMapPublisher(publisher, MaybeToPublisher.instance(), false, i, b.bufferSize()));
    }
    ...
    @CheckReturnValue
    @Experimental
    public static <T> b<T> mergeDelayError(Publisher<? extends MaybeSource<? extends T>> publisher, int i) {
        return b.fromPublisher(publisher).flatMap(MaybeToPublisher.instance(), true, i);
    }
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <R> c<R> flatMap(Function<? super T, ? extends MaybeSource<? extends R>> function, Function<? super Throwable, ? extends MaybeSource<? extends R>> function2, Callable<? extends MaybeSource<? extends R>> callable) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> onErrorResumeNext(Function<? super Throwable, ? extends MaybeSource<? extends T>> function) {
    ...
    @CheckReturnValue
    @Experimental
    public final e<T> switchIfEmpty(SingleSource<? extends T> singleSource) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <U> c<T> takeUntil(Publisher<U> publisher) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeDelayError(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, BiFunction<? super T1, ? super T2, ? extends R> biFunction) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> delaySubscription(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return delaySubscription(b.timer(j, timeUnit, scheduler));
    }

    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> retry(long j, Predicate<? super Throwable> predicate) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler, MaybeSource<? extends T> maybeSource) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <U, V> c<T> delay(Publisher<U> publisher) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final c<T> retry(Predicate<? super Throwable> predicate) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concat(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T> c<T> merge(MaybeSource<? extends MaybeSource<? extends T>> maybeSource) {
    ...
    @SchedulerSupport("custom")
    @CheckReturnValue
    public final c<T> timeout(long j, TimeUnit timeUnit, Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeDelayError(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, Function3<? super T1, ? super T2, ? super T3, ? extends R> function3) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U, R> c<R> flatMap(Function<? super T, ? extends MaybeSource<? extends U>> function, BiFunction<? super T, ? super U, ? extends R> biFunction) {
        ObjectHelper.requireNonNull(function, "mapper is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> c<T> timeout(MaybeSource<U> maybeSource) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public final <U> c<T> timeout(MaybeSource<U> maybeSource, MaybeSource<? extends T> maybeSource2) {
        ObjectHelper.requireNonNull(maybeSource, "timeoutIndicator is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concat(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3, MaybeSource<? extends T> maybeSource4) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> mergeDelayError(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3, MaybeSource<? extends T> maybeSource4) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, Function4<? super T1, ? super T2, ? super T3, ? super T4, ? extends R> function4) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <U> c<T> timeout(Publisher<U> publisher) {
    ...
    @BackpressureSupport(BackpressureKind.UNBOUNDED_IN)
    @CheckReturnValue
    public final <U> c<T> timeout(Publisher<U> publisher, MaybeSource<? extends T> maybeSource) {
        ObjectHelper.requireNonNull(publisher, "timeoutIndicator is null");
        ObjectHelper.requireNonNull(maybeSource, "fallback is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher) {
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> merge(MaybeSource<? extends T> maybeSource, MaybeSource<? extends T> maybeSource2, MaybeSource<? extends T> maybeSource3, MaybeSource<? extends T> maybeSource4) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public static <T> b<T> concat(Publisher<? extends MaybeSource<? extends T>> publisher, int i) {
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, T5, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, MaybeSource<? extends T5> maybeSource5, Function5<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? extends R> function5) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, T5, T6, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, MaybeSource<? extends T5> maybeSource5, MaybeSource<? extends T6> maybeSource6, Function6<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? extends R> function6) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, T5, T6, T7, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, MaybeSource<? extends T5> maybeSource5, MaybeSource<? extends T6> maybeSource6, MaybeSource<? extends T7> maybeSource7, Function7<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? extends R> function7) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, T5, T6, T7, T8, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, MaybeSource<? extends T5> maybeSource5, MaybeSource<? extends T6> maybeSource6, MaybeSource<? extends T7> maybeSource7, MaybeSource<? extends T8> maybeSource8, Function8<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? extends R> function8) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
    ...
    @SchedulerSupport("none")
    @CheckReturnValue
    public static <T1, T2, T3, T4, T5, T6, T7, T8, T9, R> c<R> zip(MaybeSource<? extends T1> maybeSource, MaybeSource<? extends T2> maybeSource2, MaybeSource<? extends T3> maybeSource3, MaybeSource<? extends T4> maybeSource4, MaybeSource<? extends T5> maybeSource5, MaybeSource<? extends T6> maybeSource6, MaybeSource<? extends T7> maybeSource7, MaybeSource<? extends T8> maybeSource8, MaybeSource<? extends T9> maybeSource9, Function9<? super T1, ? super T2, ? super T3, ? super T4, ? super T5, ? super T6, ? super T7, ? super T8, ? super T9, ? extends R> function9) {
        ObjectHelper.requireNonNull(maybeSource, "source1 is null");
        ObjectHelper.requireNonNull(maybeSource2, "source2 is null");
        ObjectHelper.requireNonNull(maybeSource3, "source3 is null");
        ObjectHelper.requireNonNull(maybeSource4, "source4 is null");
