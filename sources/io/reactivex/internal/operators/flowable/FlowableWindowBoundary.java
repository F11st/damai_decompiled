...
public final class FlowableWindowBoundary<T, B> extends AbstractFlowableWithUpstream<T, AbstractC8147b<T>> {
    final int bufferSize;
    final Publisher<B> other;

    /* compiled from: Taobao */
    /* loaded from: classes3.dex */
    static final class WindowBoundaryInnerSubscriber<T, B> extends AbstractC8173b<B> {
        boolean done;
    ...
    static final class WindowBoundaryMainSubscriber<T, B> extends QueueDrainSubscriber<T, Object, AbstractC8147b<T>> implements Subscription {
        ...
        WindowBoundaryMainSubscriber(Subscriber<? super AbstractC8147b<T>> subscriber, Publisher<B> publisher, int i) {
    ...
    public FlowableWindowBoundary(AbstractC8147b<T> abstractC8147b, Publisher<B> publisher, int i) {
