...
public final class ObservableAllSingle<T> extends AbstractC8152e<Boolean> implements FuseToObservable<Boolean> {
    ...
    public AbstractC8149d<Boolean> fuseToObservable() {
        return i42.n(new ObservableAll(this.source, this.predicate));
    }
