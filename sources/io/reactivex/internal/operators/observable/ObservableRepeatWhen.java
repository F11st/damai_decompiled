...
public final class ObservableRepeatWhen<T> extends AbstractObservableWithUpstream<T, T> {
    final Function<? super AbstractC8149d<Object>, ? extends ObservableSource<?>> handler;
    ...
    static final class RepeatWhenObserver<T> extends AtomicInteger implements Observer<T>, Disposable {
        ...
        RepeatWhenObserver(Observer<? super T> observer, pi2<Object> pi2Var, ObservableSource<T> observableSource) {
    ...
    public ObservableRepeatWhen(ObservableSource<T> observableSource, Function<? super AbstractC8149d<Object>, ? extends ObservableSource<?>> function) {
