...
public abstract class b<T> implements Publisher<T> {
    ...
    public final <U> b<U> cast(Class<U> cls) {
        ...
        return (b<U>) map(Functions.castFunction(cls));
    }
    ...
    public final <U> b<T> delay(Function<? super T, ? extends Publisher<U>> function) {
        ...
        return (b<T>) flatMap(FlowableInternalHelper.itemDelay(function));
    }
    ...
    public final <K> b<io.reactivex.flowables.a<K, T>> groupBy(Function<? super T, ? extends K> function) {
        return (b<io.reactivex.flowables.a<K, T>>) groupBy(function, Functions.identity(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.FULL)
    @CheckReturnValue
    public final b<ul1<T>> materialize() {
    ...
    <R> b<R> switchMap0(Function<? super T, ? extends Publisher<? extends R>> function, int i, boolean z) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.verifyPositive(i, "bufferSize");
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timeInterval() {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timestamp() {
    ...
    public final b<List<T>> buffer(int i, int i2) {
        return (b<List<T>>) buffer(i, i2, ArrayListSupplier.asCallable());
    }
    ...
    public final <K> b<io.reactivex.flowables.a<K, T>> groupBy(Function<? super T, ? extends K> function, boolean z) {
        return (b<io.reactivex.flowables.a<K, T>>) groupBy(function, Functions.identity(), z, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timeInterval(Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timestamp(Scheduler scheduler) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timeInterval(TimeUnit timeUnit) {
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timestamp(TimeUnit timeUnit) {
    ...
    public final b<T> skipLast(long j, TimeUnit timeUnit) {
        return skipLast(j, timeUnit, io.reactivex.schedulers.a.a(), false, bufferSize());
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timeInterval(TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<io2<T>> timestamp(TimeUnit timeUnit, Scheduler scheduler) {
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        return (b<io2<T>>) map(Functions.timestampWith(timeUnit, scheduler));
    }
    ...
    public final <U, V> b<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> function, BiFunction<? super T, ? super U, ? extends V> biFunction) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "resultSelector is null");
        return (b<V>) flatMap(FlowableInternalHelper.flatMapIntoIterable(function), biFunction, false, bufferSize(), bufferSize());
    }
    ...
    public final b<T> skipLast(long j, TimeUnit timeUnit, boolean z) {
        return skipLast(j, timeUnit, io.reactivex.schedulers.a.a(), z, bufferSize());
    }
    ...
    public final b<T> takeLast(long j, long j2, TimeUnit timeUnit) {
        return takeLast(j, j2, timeUnit, io.reactivex.schedulers.a.a(), false, bufferSize());
    }
    ...
    public final b<T> timeout(long j, TimeUnit timeUnit, Publisher<? extends T> publisher) {
        ObjectHelper.requireNonNull(publisher, "other is null");
        return timeout0(j, timeUnit, publisher, io.reactivex.schedulers.a.a());
    }
    ...
    @BackpressureSupport(BackpressureKind.PASS_THROUGH)
    @CheckReturnValue
    public final b<T> doOnEach(Consumer<? super ul1<T>> consumer) {
    ...
    public final b<List<T>> buffer(long j, long j2, TimeUnit timeUnit) {
        return (b<List<T>>) buffer(j, j2, timeUnit, io.reactivex.schedulers.a.a(), ArrayListSupplier.asCallable());
    }
    ...
    public final <U, V> b<V> flatMapIterable(Function<? super T, ? extends Iterable<? extends U>> function, BiFunction<? super T, ? super U, ? extends V> biFunction, int i) {
        ObjectHelper.requireNonNull(function, "mapper is null");
        ObjectHelper.requireNonNull(biFunction, "resultSelector is null");
        return (b<V>) flatMap(FlowableInternalHelper.flatMapIntoIterable(function), biFunction, false, bufferSize(), i);
    }
    ...
    public final b<List<T>> buffer(long j, long j2, TimeUnit timeUnit, Scheduler scheduler) {
        return (b<List<T>>) buffer(j, j2, timeUnit, scheduler, ArrayListSupplier.asCallable());
    }
    ...
    public final b<T> takeLast(long j, TimeUnit timeUnit) {
        return takeLast(j, timeUnit, io.reactivex.schedulers.a.a(), false, bufferSize());
    }
    ...
    public final b<T> takeLast(long j, TimeUnit timeUnit, boolean z) {
        return takeLast(j, timeUnit, io.reactivex.schedulers.a.a(), z, bufferSize());
    }
    ...
    public final b<List<T>> buffer(long j, TimeUnit timeUnit, Scheduler scheduler, int i) {
        return (b<List<T>>) buffer(j, timeUnit, scheduler, i, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final b<List<T>> buffer(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return (b<List<T>>) buffer(j, timeUnit, scheduler, Integer.MAX_VALUE, ArrayListSupplier.asCallable(), false);
    }
    ...
    public final <TOpening, TClosing> b<List<T>> buffer(b<? extends TOpening> bVar, Function<? super TOpening, ? extends Publisher<? extends TClosing>> function) {
        return (b<List<T>>) buffer(bVar, function, ArrayListSupplier.asCallable());
    }
    ...
    public final <TOpening, TClosing, U extends Collection<? super T>> b<U> buffer(b<? extends TOpening> bVar, Function<? super TOpening, ? extends Publisher<? extends TClosing>> function, Callable<U> callable) {
        ...
        ObjectHelper.requireNonNull(callable, "bufferSupplier is null");
        return i42.l(new FlowableBufferBoundary(this, bVar, function, callable));
    }
    ...
    public final <B> b<List<T>> buffer(Publisher<B> publisher) {
        return (b<List<T>>) buffer(publisher, ArrayListSupplier.asCallable());
    }
    ...
    public final <B> b<List<T>> buffer(Publisher<B> publisher, int i) {
        ObjectHelper.verifyPositive(i, "initialCapacity");
        return (b<List<T>>) buffer(publisher, Functions.createArrayList(i));
    }
