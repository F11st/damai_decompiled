...
public class KProperty2Impl<D, E, V> extends KPropertyImpl<V> implements KProperty2<D, E, V> {
    private final x02.C9895b<C8260a<D, E, V>> l;
    private final Lazy<Field> m;

    /* compiled from: Taobao */
    /* renamed from: kotlin.reflect.jvm.internal.KProperty2Impl$a */
    /* loaded from: classes3.dex */
    public static final class C8260a<D, E, V> extends KPropertyImpl.Getter<V> implements KProperty2.Getter<D, E, V> {
        @NotNull
        private final KProperty2Impl<D, E, V> h;

        /* JADX WARN: Multi-variable type inference failed */
        public C8260a(@NotNull KProperty2Impl<D, E, ? extends V> kProperty2Impl) {
    ...
    public KProperty2Impl(@NotNull KDeclarationContainerImpl kDeclarationContainerImpl, @NotNull String str, @NotNull String str2) {
        ...
        x02.C9895b<C8260a<D, E, V>> b = x02.b(new Function0<C8260a<D, E, ? extends V>>() { // from class: kotlin.reflect.jvm.internal.KProperty2Impl$_getter$1
            ...
            public final KProperty2Impl.C8260a<D, E, V> invoke() {
                return new KProperty2Impl.C8260a<>(KProperty2Impl.this);
            }
        });
        b41.h(b, "ReflectProperties.lazy { Getter(this) }");
        this.l = b;
        a = C8177b.a(LazyThreadSafetyMode.PUBLICATION, new Function0<Field>() { // from class: kotlin.reflect.jvm.internal.KProperty2Impl$delegateField$1
            /* JADX INFO: Access modifiers changed from: package-private */
            {
                super(0);
            }
    ...
    @NotNull
    /* renamed from: s */
    public C8260a<D, E, V> p() {
        C8260a<D, E, V> invoke = this.l.invoke();
