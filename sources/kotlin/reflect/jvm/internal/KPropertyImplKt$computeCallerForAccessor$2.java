...
final class KPropertyImplKt$computeCallerForAccessor$2 extends Lambda implements Function0<Boolean> {
    ...
    public KPropertyImplKt$computeCallerForAccessor$2(KPropertyImpl.AbstractC8261a abstractC8261a) {
        super(0);
    ...
    public final boolean invoke2() {
        return !fr2.m(this.$this_computeCallerForAccessor.m().i().getType());
    }
}
