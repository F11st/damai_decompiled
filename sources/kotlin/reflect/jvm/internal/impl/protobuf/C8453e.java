...
public class C8453e extends ByteString {
    ...
    /* loaded from: classes3.dex */
    public class C8455b implements ByteString.ByteIterator {
        private int a;
        private final int b;
        ...
        private C8455b() {
            this.a = 0;
            this.b = C8453e.this.size();
        }
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public C8453e(byte[] bArr) {
        this.a = bArr;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if ((obj instanceof ByteString) && size() == ((ByteString) obj).size()) {
            ...
            if (obj instanceof C8453e) {
                return x((C8453e) obj, 0, size());
            }
            if (obj instanceof C8456f) {
    ...
    public boolean k() {
        int y = y();
        return C8470h.f(this.a, y, size() + y);
    }
    ...
    protected int p(int i, int i2, int i3) {
        int y = y() + i2;
        return C8470h.g(i, this.a, y, i3 + y);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public boolean x(C8453e c8453e, int i, int i2) {
        if (i2 <= c8453e.size()) {
            if (i + i2 <= c8453e.size()) {
                byte[] bArr = this.a;
                byte[] bArr2 = c8453e.a;
