...
public final class e extends fd2 {
    @NotNull
    ...
    public e(@NotNull TypeConstructor typeConstructor, @NotNull List<? extends TypeProjection> list, boolean z, @NotNull MemberScope memberScope, @NotNull Function1<? super b81, ? extends fd2> function1) {
        ...
        this.e = memberScope;
        this.f = function1;
        if (getMemberScope() instanceof kf0.d) {
