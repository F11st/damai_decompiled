...
public abstract class b {
    ...
    private final NotNullLazyValue<e> c;
    ...
    public class a implements Function0<Collection<PackageViewDescriptor>> {
        ...
        public Collection<PackageViewDescriptor> invoke() {
            return Arrays.asList(b.this.r().getPackage(kotlin.reflect.jvm.internal.impl.builtins.c.BUILT_INS_PACKAGE_FQ_NAME), b.this.r().getPackage(kotlin.reflect.jvm.internal.impl.builtins.c.COLLECTIONS_PACKAGE_FQ_NAME), b.this.r().getPackage(kotlin.reflect.jvm.internal.impl.builtins.c.RANGES_PACKAGE_FQ_NAME), b.this.r().getPackage(kotlin.reflect.jvm.internal.impl.builtins.c.ANNOTATION_PACKAGE_FQ_NAME));
        }
    }
    ...
    /* loaded from: classes3.dex */
    class C0411b implements Function0<e> {
        C0411b() {
        }
        ...
        public e invoke() {
            ...
            for (PrimitiveType primitiveType : PrimitiveType.values()) {
                fd2 q = b.this.q(primitiveType.getTypeName().b());
                fd2 q2 = b.this.q(primitiveType.getArrayTypeName().b());
    ...
    /* compiled from: Taobao */
    /* loaded from: classes3.dex */
    class c implements Function1<ni1, ClassDescriptor> {
        c() {
        }
        ...
        public ClassDescriptor invoke(ni1 ni1Var) {
            ClassifierDescriptor contributedClassifier = b.this.s().getContributedClassifier(ni1Var, NoLookupLocation.FROM_BUILTINS);
            ...
            throw new AssertionError("Built-in class " + kotlin.reflect.jvm.internal.impl.builtins.c.BUILT_INS_PACKAGE_FQ_NAME.c(ni1Var) + " is not found");
        }
    }
    ...
    class d implements Function0<Void> {
        ...
        public Void invoke() {
            if (b.this.a != null) {
                throw new AssertionError("Built-ins module is already set: " + b.this.a + " (attempting to reset to " + this.a + jn1.BRACKET_END_STR);
            }
            b.this.a = this.a;
            return null;
        }
    ...
    public static class e {
        ...
        private e(@NotNull Map<PrimitiveType, fd2> map, @NotNull Map<z71, fd2> map2, @NotNull Map<fd2, fd2> map3) {
            if (map == null) {
                a(0);
            }
            if (map2 == null) {
    ...
    public b(@NotNull StorageManager storageManager) {
        if (storageManager == null) {
            a(0);
        }
        this.f = storageManager;
        this.d = storageManager.createLazyValue(new a());
        this.c = storageManager.createLazyValue(new C0411b());
        this.e = storageManager.createMemoizedFunction(new c());
    }
    ...
    private static z71 A(@NotNull z71 z71Var, @NotNull ModuleDescriptor moduleDescriptor) {
        ...
        if (!eu2Var.b(declarationDescriptor.getName()) || (h = DescriptorUtilsKt.h(declarationDescriptor)) == null || (a2 = eu2Var.a(h)) == null || (a3 = FindClassInModuleKt.a(moduleDescriptor, a2)) == null) {
            return null;
        }
    ...
    public static PrimitiveType P(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        if (c.a.primitiveArrayTypeShortNames.contains(declarationDescriptor.getName())) {
            return c.a.arrayClassFqNameToPrimitiveType.get(d70.m(declarationDescriptor));
        }
        return null;
    }
    ...
    public static PrimitiveType S(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        if (c.a.primitiveTypeShortNames.contains(declarationDescriptor.getName())) {
            return c.a.fqNameToPrimitiveType.get(d70.m(declarationDescriptor));
        }
        return null;
    }
    ...
    public static boolean d0(@NotNull ClassDescriptor classDescriptor) {
        ...
        return e(classDescriptor, c.a.array) || P(classDescriptor) != null;
    }
    ...
    public static boolean t0(@Nullable z71 z71Var) {
        return z71Var != null && k0(z71Var, c.a.string);
    }
    ...
    public static boolean v0(@NotNull z71 z71Var) {
        ...
        return g0(z71Var, c.a.uByteArrayFqName.j());
    }
    ...
    public static boolean w0(@NotNull z71 z71Var) {
        ...
        return g0(z71Var, c.a.uIntArrayFqName.j());
    }
    ...
    public static boolean x0(@NotNull z71 z71Var) {
        ...
        return g0(z71Var, c.a.uLongArrayFqName.j());
    }
    ...
    public static boolean y0(@NotNull z71 z71Var) {
        ...
        return g0(z71Var, c.a.uShortArrayFqName.j());
    }
    ...
    public static boolean z0(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        while (declarationDescriptor != null) {
            if (declarationDescriptor instanceof PackageFragmentDescriptor) {
                return ((PackageFragmentDescriptor) declarationDescriptor).getFqName().i(kotlin.reflect.jvm.internal.impl.builtins.c.BUILT_INS_PACKAGE_NAME);
            }
    ...
    public ClassDescriptor C(int i) {
        return p(kotlin.reflect.jvm.internal.impl.builtins.c.b(i));
    }
    ...
    public ClassDescriptor X(int i) {
        ClassDescriptor o = o(kotlin.reflect.jvm.internal.impl.builtins.c.COROUTINES_PACKAGE_FQ_NAME_RELEASE.c(ni1.f(kotlin.reflect.jvm.internal.impl.builtins.c.d(i))));
        if (o == null) {
            a(18);
        }
        return o;
    ...
    public ClassDescriptor o(@NotNull hp0 hp0Var) {
        ...
        ClassDescriptor c2 = c70.c(r(), hp0Var, NoLookupLocation.FROM_BUILTINS);
        if (c2 == null) {
            a(13);
        }
        return c2;
    ...
    public MemberScope s() {
        MemberScope memberScope = r().getPackage(kotlin.reflect.jvm.internal.impl.builtins.c.BUILT_INS_PACKAGE_FQ_NAME).getMemberScope();
        if (memberScope == null) {
            a(11);
        }
        return memberScope;
