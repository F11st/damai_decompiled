...
public final class C8277c {
    ...
    @NotNull
    public static final C8277c INSTANCE = new C8277c();
    @JvmField
    @NotNull
    ...
    public static final class C8278a {
        @NotNull
        public static final C8278a INSTANCE;
        @JvmField
        @NotNull
        ...
        static {
            C8278a c8278a = new C8278a();
            INSTANCE = c8278a;
            any = c8278a.d("Any");
            nothing = c8278a.d("Nothing");
            cloneable = c8278a.d("Cloneable");
            suppress = c8278a.c("Suppress");
            unit = c8278a.d("Unit");
            charSequence = c8278a.d("CharSequence");
            string = c8278a.d("String");
            array = c8278a.d("Array");
            _boolean = c8278a.d("Boolean");
            _char = c8278a.d("Char");
            _byte = c8278a.d("Byte");
            _short = c8278a.d("Short");
            _int = c8278a.d("Int");
            _long = c8278a.d("Long");
            _float = c8278a.d("Float");
            _double = c8278a.d("Double");
            number = c8278a.d("Number");
            _enum = c8278a.d("Enum");
            functionSupertype = c8278a.d("Function");
            throwable = c8278a.c("Throwable");
            comparable = c8278a.c("Comparable");
            intRange = c8278a.e("IntRange");
            longRange = c8278a.e("LongRange");
            deprecated = c8278a.c("Deprecated");
            deprecatedSinceKotlin = c8278a.c("DeprecatedSinceKotlin");
            deprecationLevel = c8278a.c("DeprecationLevel");
            replaceWith = c8278a.c("ReplaceWith");
            extensionFunctionType = c8278a.c("ExtensionFunctionType");
            parameterName = c8278a.c("ParameterName");
            annotation = c8278a.c("Annotation");
            target = c8278a.a("Target");
            annotationTarget = c8278a.a("AnnotationTarget");
            annotationRetention = c8278a.a("AnnotationRetention");
            retention = c8278a.a("Retention");
            repeatable = c8278a.a("Repeatable");
            mustBeDocumented = c8278a.a("MustBeDocumented");
            unsafeVariance = c8278a.c("UnsafeVariance");
            publishedApi = c8278a.c("PublishedApi");
            iterator = c8278a.b("Iterator");
            iterable = c8278a.b("Iterable");
            collection = c8278a.b("Collection");
            list = c8278a.b("List");
            listIterator = c8278a.b("ListIterator");
            set = c8278a.b("Set");
            hp0 b = c8278a.b("Map");
            map = b;
            ...
            mapEntry = c;
            mutableIterator = c8278a.b("MutableIterator");
            mutableIterable = c8278a.b("MutableIterable");
            mutableCollection = c8278a.b("MutableCollection");
            mutableList = c8278a.b("MutableList");
            mutableListIterator = c8278a.b("MutableListIterator");
            mutableSet = c8278a.b("MutableSet");
            hp0 b2 = c8278a.b("MutableMap");
            mutableMap = b2;
            ...
            hp0 c3 = c8278a.c("UByte");
            uByteFqName = c3;
            hp0 c4 = c8278a.c("UShort");
            uShortFqName = c4;
            hp0 c5 = c8278a.c("UInt");
            uIntFqName = c5;
            hp0 c6 = c8278a.c("ULong");
            uLongFqName = c6;
            hj m2 = hj.m(c3);
            ...
            uLong = m5;
            uByteArrayFqName = c8278a.c("UByteArray");
            uShortArrayFqName = c8278a.c("UShortArray");
            uIntArrayFqName = c8278a.c("UIntArray");
            uLongArrayFqName = c8278a.c("ULongArray");
        ...
        private final ip0 e(String str) {
            ip0 j = C8277c.RANGES_PACKAGE_FQ_NAME.c(ni1.f(str)).j();
        ...
        public static final ip0 f(@NotNull String str) {
            ...
            ip0 j = C8277c.KOTLIN_REFLECT_FQ_NAME.c(ni1.f(str)).j();
    ...
    static {
        ...
        j = C8214m.j("KProperty", "KMutableProperty", "KFunction", "KSuspendFunction");
        PREFIXES = j;
        ni1 f4 = ni1.f("kotlin");
        ...
        g = C8203e0.g(k, c6, c7, c5, hp0Var2, c9, hp0Var);
    ...
    public static final boolean e(@NotNull ip0 ip0Var) {
        ...
        return C8278a.arrayClassFqNameToPrimitiveType.get(ip0Var) != null;
    }
}
