...
public abstract class AbstractC8316a extends u40 implements FunctionDescriptor {
    ...
    /* loaded from: classes3.dex */
    public class C8317a implements Function0<Collection<FunctionDescriptor>> {
        final /* synthetic */ TypeSubstitutor a;

        C8317a(TypeSubstitutor typeSubstitutor) {
        ...
        public Collection<FunctionDescriptor> invoke() {
            xd2 xd2Var = new xd2();
            for (FunctionDescriptor functionDescriptor : AbstractC8316a.this.getOverriddenDescriptors()) {
    ...
    /* loaded from: classes3.dex */
    public static class C8318b implements Function0<List<VariableDescriptor>> {
    ...
    /* loaded from: classes3.dex */
    public class C8319c implements FunctionDescriptor.CopyBuilder<FunctionDescriptor> {
        @NotNull
        protected br2 a;
        @NotNull
        ...
        public C8319c(@NotNull AbstractC8316a abstractC8316a, @NotNull br2 br2Var, @NotNull DeclarationDescriptor declarationDescriptor, @NotNull Modality modality, @NotNull f70 f70Var, @NotNull CallableMemberDescriptor.Kind kind, @Nullable List<ValueParameterDescriptor> list, @NotNull ReceiverParameterDescriptor receiverParameterDescriptor, @Nullable z71 z71Var, ni1 ni1Var) {
            ...
            this.w = abstractC8316a;
            this.e = null;
            this.i = abstractC8316a.i;
            this.l = true;
            this.m = false;
            this.n = false;
            this.o = false;
            this.p = abstractC8316a.isHiddenToOvercomeSignatureClash();
            this.q = null;
            this.r = null;
            this.s = abstractC8316a.isHiddenForResolutionEverywhereBesideSupercalls();
        ...
        @NotNull
        /* renamed from: A */
        public C8319c setValueParameters(@NotNull List<ValueParameterDescriptor> list) {
            if (list == null) {
                a(18);
            }
            this.g = list;
        ...
        @NotNull
        /* renamed from: B */
        public C8319c setVisibility(@NotNull f70 f70Var) {
            if (f70Var == null) {
                a(11);
            }
            this.d = f70Var;
        ...
        @NotNull
        /* renamed from: h */
        public C8319c setAdditionalAnnotations(@NotNull Annotations annotations) {
            if (annotations == null) {
                a(32);
            }
            this.r = annotations;
        ...
        @NotNull
        /* renamed from: i */
        public C8319c setCopyOverrides(boolean z) {
            this.l = z;
            return this;
        }
        ...
        @NotNull
        /* renamed from: j */
        public C8319c setDispatchReceiverParameter(@Nullable ReceiverParameterDescriptor receiverParameterDescriptor) {
        ...
        @NotNull
        /* renamed from: k */
        public C8319c setDropOriginalInContainingParts() {
            this.o = true;
            return this;
        }
        ...
        @NotNull
        /* renamed from: l */
        public C8319c setExtensionReceiverParameter(@Nullable ReceiverParameterDescriptor receiverParameterDescriptor) {
            this.h = receiverParameterDescriptor;
            return this;
        }

        public C8319c m(boolean z) {
        ...
        @NotNull
        /* renamed from: n */
        public C8319c setHiddenForResolutionEverywhereBesideSupercalls() {
            this.s = true;
            return this;
        }
        ...
        @NotNull
        /* renamed from: o */
        public C8319c setHiddenToOvercomeSignatureClash() {
            this.p = true;
            return this;
        }

        @NotNull
        public C8319c p(boolean z) {
            this.v = z;
            return this;
        }
        ...
        @NotNull
        /* renamed from: q */
        public C8319c setKind(@NotNull CallableMemberDescriptor.Kind kind) {
            if (kind == null) {
                a(13);
            }
            this.f = kind;
        ...
        @NotNull
        /* renamed from: r */
        public C8319c setModality(@NotNull Modality modality) {
            if (modality == null) {
                a(9);
            }
            this.c = modality;
        ...
        @NotNull
        /* renamed from: s */
        public C8319c setName(@NotNull ni1 ni1Var) {
            if (ni1Var == null) {
                a(16);
            }
            this.k = ni1Var;
        ...
        @NotNull
        /* renamed from: t */
        public C8319c setOriginal(@Nullable CallableMemberDescriptor callableMemberDescriptor) {
        ...
        @NotNull
        /* renamed from: u */
        public C8319c setOwner(@NotNull DeclarationDescriptor declarationDescriptor) {
            if (declarationDescriptor == null) {
                a(7);
            }
            this.b = declarationDescriptor;
        ...
        @NotNull
        /* renamed from: v */
        public C8319c setPreserveSourceElement() {
            this.n = true;
            return this;
        }
        ...
        @NotNull
        /* renamed from: w */
        public C8319c setReturnType(@NotNull z71 z71Var) {
            if (z71Var == null) {
                a(22);
            }
            this.j = z71Var;
        ...
        @NotNull
        /* renamed from: x */
        public C8319c setSignatureChange() {
            this.m = true;
            return this;
        }
        ...
        @NotNull
        /* renamed from: y */
        public C8319c setSubstitution(@NotNull br2 br2Var) {
            if (br2Var == null) {
                a(34);
            }
            this.a = br2Var;
        ...
        @NotNull
        /* renamed from: z */
        public C8319c setTypeParameters(@NotNull List<TypeParameterDescriptor> list) {
            if (list == null) {
                a(20);
            }
            this.q = list;
    ...
    public AbstractC8316a(@NotNull DeclarationDescriptor declarationDescriptor, @Nullable FunctionDescriptor functionDescriptor, @NotNull Annotations annotations, @NotNull ni1 ni1Var, @NotNull CallableMemberDescriptor.Kind kind, @NotNull SourceElement sourceElement) {
    ...
    @NotNull
    protected abstract AbstractC8316a f(@NotNull DeclarationDescriptor declarationDescriptor, @Nullable FunctionDescriptor functionDescriptor, @NotNull CallableMemberDescriptor.Kind kind, @Nullable ni1 ni1Var, @NotNull Annotations annotations, @NotNull SourceElement sourceElement);

    /* JADX INFO: Access modifiers changed from: protected */
    @Nullable
    public FunctionDescriptor g(@NotNull C8319c c8319c) {
        iz1 iz1Var;
        ...
        Annotations a = c8319c.r != null ? f6.a(getAnnotations(), c8319c.r) : getAnnotations();
        DeclarationDescriptor declarationDescriptor = c8319c.b;
        FunctionDescriptor functionDescriptor = c8319c.e;
        AbstractC8316a f = f(declarationDescriptor, functionDescriptor, c8319c.f, c8319c.k, a, h(c8319c.n, functionDescriptor));
        List<TypeParameterDescriptor> typeParameters = c8319c.q == null ? getTypeParameters() : c8319c.q;
        zArr[0] = zArr[0] | (!typeParameters.isEmpty());
        ArrayList arrayList = new ArrayList(typeParameters.size());
        TypeSubstitutor c = b70.c(typeParameters, c8319c.a, f, arrayList, zArr);
        if (c == null) {
            return null;
        }
        ReceiverParameterDescriptor receiverParameterDescriptor2 = c8319c.h;
        if (receiverParameterDescriptor2 != null) {
            z71 q2 = c.q(receiverParameterDescriptor2.getType(), Variance.IN_VARIANCE);
            if (q2 == null) {
                return null;
            }
            iz1 iz1Var2 = new iz1(f, new dh0(f, q2, c8319c.h.getValue()), c8319c.h.getAnnotations());
            zArr[0] = (q2 != c8319c.h.getType()) | zArr[0];
            iz1Var = iz1Var2;
        } else {
            iz1Var = null;
        }
        ReceiverParameterDescriptor receiverParameterDescriptor3 = c8319c.i;
        if (receiverParameterDescriptor3 != null) {
            ReceiverParameterDescriptor substitute = receiverParameterDescriptor3.substitute(c);
            if (substitute == null) {
                return null;
            }
            zArr[0] = zArr[0] | (substitute != c8319c.i);
            receiverParameterDescriptor = substitute;
        } else {
            receiverParameterDescriptor = null;
        }
        List<ValueParameterDescriptor> j = j(f, c8319c.g, c, c8319c.o, c8319c.n, zArr);
        if (j == null || (q = c.q(c8319c.j, Variance.OUT_VARIANCE)) == null) {
            return null;
        }
        zArr[0] = zArr[0] | (q != c8319c.j);
        if (zArr[0] || !c8319c.v) {
            f.l(iz1Var, receiverParameterDescriptor, arrayList, j, q, c8319c.c, c8319c.d);
            f.z(this.l);
            f.w(this.m);
            f.r(this.n);
            f.y(this.o);
            ...
            f.v(c8319c.p);
            f.u(c8319c.s);
            f.t(c8319c.u != null ? c8319c.u.booleanValue() : this.w);
            if (!c8319c.t.isEmpty() || this.C != null) {
                Map<CallableDescriptor.UserDataKey<?>, Object> map = c8319c.t;
            ...
            if (c8319c.m || getInitialSignatureDescriptor() != null) {
                f.x((getInitialSignatureDescriptor() != null ? getInitialSignatureDescriptor() : this).substitute(c));
            }
            if (c8319c.l && !getOriginal().getOverriddenDescriptors().isEmpty()) {
                if (c8319c.a.f()) {
                    Function0<Collection<FunctionDescriptor>> function0 = this.y;
                    if (function0 != null) {
                        f.y = function0;
    ...
    @NotNull
    public AbstractC8316a l(@Nullable ReceiverParameterDescriptor receiverParameterDescriptor, @Nullable ReceiverParameterDescriptor receiverParameterDescriptor2, @NotNull List<? extends TypeParameterDescriptor> list, @NotNull List<ValueParameterDescriptor> list2, @Nullable z71 z71Var, @Nullable Modality modality, @NotNull f70 f70Var) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    @NotNull
    public C8319c m(@NotNull TypeSubstitutor typeSubstitutor) {
        if (typeSubstitutor == null) {
            a(22);
        }
        return new C8319c(this, typeSubstitutor.j(), getContainingDeclaration(), getModality(), getVisibility(), getKind(), getValueParameters(), getExtensionReceiverParameter(), getReturnType(), null);
    }

    @Override // kotlin.reflect.jvm.internal.impl.descriptors.FunctionDescriptor
    @NotNull
    public FunctionDescriptor.CopyBuilder<? extends FunctionDescriptor> newCopyBuilder() {
        C8319c m = m(TypeSubstitutor.EMPTY);
        if (m == null) {
            a(21);
        }
        return m;
