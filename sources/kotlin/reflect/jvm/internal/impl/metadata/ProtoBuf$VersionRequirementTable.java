...
public final class ProtoBuf$VersionRequirementTable extends GeneratedMessageLite implements ProtoBuf$VersionRequirementTableOrBuilder {
    public static Parser<ProtoBuf$VersionRequirementTable> PARSER = new C8423a();
    ...
    public static final class Builder extends GeneratedMessageLite.Builder<ProtoBuf$VersionRequirementTable, Builder> implements ProtoBuf$VersionRequirementTableOrBuilder {
        ...
        */
        public kotlin.reflect.jvm.internal.impl.metadata.ProtoBuf$VersionRequirementTable.Builder mergeFrom(kotlin.reflect.jvm.internal.impl.protobuf.CodedInputStream r3, kotlin.reflect.jvm.internal.impl.protobuf.C8447c r4) throws java.io.IOException {
            /*
                r2 = this;
                r0 = 0
    ...
    /* loaded from: classes3.dex */
    static class C8423a extends AbstractC8443a<ProtoBuf$VersionRequirementTable> {
        C8423a() {
        }

        @Override // kotlin.reflect.jvm.internal.impl.protobuf.Parser
        /* renamed from: i */
        public ProtoBuf$VersionRequirementTable parsePartialFrom(CodedInputStream codedInputStream, C8447c c8447c) throws InvalidProtocolBufferException {
            return new ProtoBuf$VersionRequirementTable(codedInputStream, c8447c);
        }
    }
    ...
    private ProtoBuf$VersionRequirementTable(CodedInputStream codedInputStream, C8447c c8447c) throws InvalidProtocolBufferException {
        this.memoizedIsInitialized = (byte) -1;
        this.memoizedSerializedSize = -1;
        initFields();
                ...
                try {
                    ...
                    if (K != 0) {
                        if (K != 10) {
                            ...
                            this.requirement_.add(codedInputStream.u(ProtoBuf$VersionRequirement.PARSER, c8447c));
                        }
                    }
                    z = true;
