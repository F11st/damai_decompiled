...
public abstract class AbstractBinaryClassAnnotationAndConstantLoader<A, C> implements AnnotationAndConstantLoader<A, C> {
    ...
    @NotNull
    private final MemoizedFunctionToNotNull<KotlinJvmBinaryClass, C8366a<A, C>> b;
    ...
    /* loaded from: classes3.dex */
    public static final class C8366a<A, C> {
        @NotNull
        ...
        public C8366a(@NotNull Map<ne1, ? extends List<? extends A>> map, @NotNull Map<ne1, ? extends C> map2) {
    ...
    /* compiled from: Taobao */
    /* renamed from: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$c */
    /* loaded from: classes3.dex */
    public static final class C8368c implements KotlinJvmBinaryClass.MemberVisitor {
        ...
        /* compiled from: Taobao */
        /* renamed from: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$c$a */
        /* loaded from: classes3.dex */
        public final class C8369a extends C8370b implements KotlinJvmBinaryClass.MethodAnnotationVisitor {
            final /* synthetic */ C8368c d;

            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            public C8369a(@NotNull C8368c c8368c, ne1 ne1Var) {
                super(c8368c, ne1Var);
                b41.i(c8368c, "this$0");
        ...
        /* compiled from: Taobao */
        /* renamed from: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$c$b */
        /* loaded from: classes3.dex */
        public class C8370b implements KotlinJvmBinaryClass.AnnotationVisitor {
            @NotNull
            private final ne1 a;
            @NotNull
            private final ArrayList<A> b;
            final /* synthetic */ C8368c c;

            public C8370b(@NotNull C8368c c8368c, ne1 ne1Var) {
                b41.i(c8368c, "this$0");
                b41.i(ne1Var, SocialOperation.GAME_SIGNATURE);
                this.c = c8368c;
                this.a = ne1Var;
        ...
        C8368c(AbstractBinaryClassAnnotationAndConstantLoader<A, C> abstractBinaryClassAnnotationAndConstantLoader, HashMap<ne1, List<A>> hashMap, HashMap<ne1, C> hashMap2) {
        ...
        public KotlinJvmBinaryClass.AnnotationVisitor visitField(@NotNull ni1 ni1Var, @NotNull String str, @Nullable Object obj) {
            ...
            ne1.C9470a c9470a = ne1.Companion;
            String b = ni1Var.b();
            b41.h(b, "name.asString()");
            ne1 a = c9470a.a(b, str);
            if (obj != null && (p = this.a.p(str, obj)) != null) {
                this.c.put(a, p);
            }
            return new C8370b(this, a);
        }
        ...
        public KotlinJvmBinaryClass.MethodAnnotationVisitor visitMethod(@NotNull ni1 ni1Var, @NotNull String str) {
            ...
            String b = ni1Var.b();
            b41.h(b, "name.asString()");
            return new C8369a(this, c9470a.d(b, str));
        }
    }

    /* compiled from: Taobao */
    /* renamed from: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$d */
    /* loaded from: classes3.dex */
    public static final class C8371d implements KotlinJvmBinaryClass.AnnotationVisitor {
        final /* synthetic */ AbstractBinaryClassAnnotationAndConstantLoader<A, C> a;
        final /* synthetic */ ArrayList<A> b;

        C8371d(AbstractBinaryClassAnnotationAndConstantLoader<A, C> abstractBinaryClassAnnotationAndConstantLoader, ArrayList<A> arrayList) {
            this.a = abstractBinaryClassAnnotationAndConstantLoader;
            this.b = arrayList;
        }
    ...
    public AbstractBinaryClassAnnotationAndConstantLoader(@NotNull StorageManager storageManager, @NotNull KotlinClassFinder kotlinClassFinder) {
        ...
        this.b = storageManager.createMemoizedFunction(new Function1<KotlinJvmBinaryClass, C8366a<? extends A, ? extends C>>(this) { // from class: kotlin.reflect.jvm.internal.impl.load.kotlin.AbstractBinaryClassAnnotationAndConstantLoader$storage$1
            ...
            @NotNull
            public final AbstractBinaryClassAnnotationAndConstantLoader.C8366a<A, C> invoke(@NotNull KotlinJvmBinaryClass kotlinJvmBinaryClass) {
                AbstractBinaryClassAnnotationAndConstantLoader.C8366a<A, C> o;
    ...
    private final int c(gx1 gx1Var, MessageLite messageLite) {
        if (messageLite instanceof ProtoBuf$Function) {
            ...
            gx1.C9189a c9189a = (gx1.C9189a) gx1Var;
            if (c9189a.g() == ProtoBuf$Class.Kind.ENUM_CLASS) {
                return 2;
            }
            if (c9189a.i()) {
                return 1;
    ...
    private final KotlinJvmBinaryClass f(gx1 gx1Var, KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        if (gx1Var instanceof gx1.C9189a) {
            return s((gx1.C9189a) gx1Var);
        }
        return null;
    }
    ...
    private final ne1 h(MessageLite messageLite, NameResolver nameResolver, er2 er2Var, AnnotatedCallableKind annotatedCallableKind, boolean z) {
        if (messageLite instanceof ProtoBuf$Constructor) {
            ne1.C9470a c9470a = ne1.Companion;
            w61.C9846b b = b71.INSTANCE.b((ProtoBuf$Constructor) messageLite, nameResolver, er2Var);
            if (b == null) {
                return null;
            }
            return c9470a.b(b);
        } else if (messageLite instanceof ProtoBuf$Function) {
            ne1.C9470a c9470a2 = ne1.Companion;
            w61.C9846b e = b71.INSTANCE.e((ProtoBuf$Function) messageLite, nameResolver, er2Var);
            if (e == null) {
                return null;
            }
            return c9470a2.b(e);
            ...
            JvmProtoBuf.JvmPropertySignature jvmPropertySignature = (JvmProtoBuf.JvmPropertySignature) fx1.a((GeneratedMessageLite.ExtendableMessage) messageLite, c8441c);
            if (jvmPropertySignature == null) {
                return null;
            }
            int i = C8367b.$EnumSwitchMapping$0[annotatedCallableKind.ordinal()];
            if (i == 1) {
                if (jvmPropertySignature.hasGetter()) {
                    ne1.C9470a c9470a3 = ne1.Companion;
                    JvmProtoBuf.JvmMethodSignature getter = jvmPropertySignature.getGetter();
                    b41.h(getter, "signature.getter");
                    return c9470a3.c(nameResolver, getter);
                }
                return null;
            } else if (i != 2) {
                if (i != 3) {
                ...
                ne1.C9470a c9470a4 = ne1.Companion;
                JvmProtoBuf.JvmMethodSignature setter = jvmPropertySignature.getSetter();
                b41.h(setter, "signature.setter");
                return c9470a4.c(nameResolver, setter);
            } else {
                return null;
            }
        } else {
    ...
    private final ne1 j(ProtoBuf$Property protoBuf$Property, NameResolver nameResolver, er2 er2Var, boolean z, boolean z2, boolean z3) {
        ...
        if (z) {
            w61.C9845a c = b71.INSTANCE.c(protoBuf$Property, nameResolver, er2Var, z3);
            if (c == null) {
                return null;
            }
            return ne1.Companion.b(c);
        } else if (z2 && jvmPropertySignature.hasSyntheticMethod()) {
            ne1.C9470a c9470a = ne1.Companion;
            JvmProtoBuf.JvmMethodSignature syntheticMethod = jvmPropertySignature.getSyntheticMethod();
            b41.h(syntheticMethod, "signature.syntheticMethod");
            return c9470a.c(nameResolver, syntheticMethod);
        } else {
            return null;
        }
    }
    ...
    private final KotlinJvmBinaryClass l(gx1 gx1Var, boolean z, boolean z2, Boolean bool, boolean z3) {
        ...
        if (z) {
            if (bool != null) {
                if (gx1Var instanceof gx1.C9189a) {
                    gx1.C9189a c9189a = (gx1.C9189a) gx1Var;
                    if (c9189a.g() == ProtoBuf$Class.Kind.INTERFACE) {
                        KotlinClassFinder kotlinClassFinder = this.a;
                        hj d = c9189a.e().d(ni1.f("DefaultImpls"));
                        b41.h(d, "container.classId.create…EFAULT_IMPLS_CLASS_NAME))");
                        return w71.b(kotlinClassFinder, d);
                    }
                }
                if (bool.booleanValue() && (gx1Var instanceof gx1.C9190b)) {
                    SourceElement c = gx1Var.c();
                    z61 z61Var = c instanceof z61 ? (z61) c : null;
                    t61 b = z61Var == null ? null : z61Var.b();
                    if (b != null) {
                        KotlinClassFinder kotlinClassFinder2 = this.a;
                        String f = b.f();
                        b41.h(f, "facadeClassName.internalName");
                        y = C8604o.y(f, r10.DIR, '.', false, 4, null);
                        hj m = hj.m(new hp0(y));
        ...
        if (z2 && (gx1Var instanceof gx1.C9189a)) {
            gx1.C9189a c9189a2 = (gx1.C9189a) gx1Var;
            if (c9189a2.g() == ProtoBuf$Class.Kind.COMPANION_OBJECT && (h = c9189a2.h()) != null && (h.g() == ProtoBuf$Class.Kind.CLASS || h.g() == ProtoBuf$Class.Kind.ENUM_CLASS || (z3 && (h.g() == ProtoBuf$Class.Kind.INTERFACE || h.g() == ProtoBuf$Class.Kind.ANNOTATION_CLASS)))) {
                return s(h);
            }
        }
        if ((gx1Var instanceof gx1.C9190b) && (gx1Var.c() instanceof z61)) {
            ...
            z61 z61Var2 = (z61) c2;
            KotlinJvmBinaryClass c3 = z61Var2.c();
            return c3 == null ? w71.b(this.a, z61Var2.a()) : c3;
        }
        return null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final C8366a<A, C> o(KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        HashMap hashMap = new HashMap();
        HashMap hashMap2 = new HashMap();
        kotlinJvmBinaryClass.visitMembers(new C8368c(this, hashMap, hashMap2), g(kotlinJvmBinaryClass));
        return new C8366a<>(hashMap, hashMap2);
    }
    ...
    private final List<A> q(gx1 gx1Var, ProtoBuf$Property protoBuf$Property, PropertyRelatedElement propertyRelatedElement) {
        ...
        List<A> g2;
        List<A> g3;
        Boolean d = yj0.IS_CONST.d(protoBuf$Property.getFlags());
        b41.h(d, "IS_CONST.get(proto.flags)");
    ...
    private final KotlinJvmBinaryClass s(gx1.C9189a c9189a) {
        SourceElement c = c9189a.c();
        y71 y71Var = c instanceof y71 ? (y71) c : null;
        if (y71Var == null) {
            return null;
        }
        return y71Var.a();
    ...
    @Override // kotlin.reflect.jvm.internal.impl.serialization.deserialization.AnnotationAndConstantLoader
    @NotNull
    public List<A> loadClassAnnotations(@NotNull gx1.C9189a c9189a) {
        b41.i(c9189a, "container");
        KotlinJvmBinaryClass s = s(c9189a);
        if (s != null) {
            ArrayList arrayList = new ArrayList(1);
            s.loadClassAnnotations(new C8371d(this, arrayList), g(s));
            return arrayList;
        }
        throw new IllegalStateException(b41.r("Class for loading annotations is not found: ", c9189a.a()).toString());
    }
    ...
    public List<A> loadEnumEntryAnnotations(@NotNull gx1 gx1Var, @NotNull ProtoBuf$EnumEntry protoBuf$EnumEntry) {
        ...
        String c = ((gx1.C9189a) gx1Var).e().c();
        b41.h(c, "container as ProtoContai…Class).classId.asString()");
        return e(this, gx1Var, c9470a.a(string, jj.b(c)), false, false, null, false, 60, null);
    }
    ...
    public C loadPropertyConstant(@NotNull gx1 gx1Var, @NotNull ProtoBuf$Property protoBuf$Property, @NotNull z71 z71Var) {
        ...
        if (h == null || (c = this.b.invoke(f).b().get(h)) == null) {
            return null;
        }
        return eu2.d(z71Var) ? t(c) : c;
    }
    ...
    @Nullable
    protected abstract C t(@NotNull C c);
}
