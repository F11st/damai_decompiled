...
public class C8226x extends C8225w {
    @NotNull
    ...
    public static <K, V> V j(@NotNull Map<K, ? extends V> map, K k) {
        b41.i(map, "<this>");
        return (V) C8224v.a(map, k);
    }

    @NotNull
    public static <K, V> HashMap<K, V> k(@NotNull Pair<? extends K, ? extends V>... pairArr) {
        b41.i(pairArr, "pairs");
        HashMap<K, V> hashMap = new HashMap<>(C8223u.e(pairArr.length));
        q(hashMap, pairArr);
        return hashMap;
    }
    ...
    public static <K, V> Map<K, V> l(@NotNull Pair<? extends K, ? extends V>... pairArr) {
        b41.i(pairArr, "pairs");
        return pairArr.length > 0 ? u(pairArr, new LinkedHashMap(C8223u.e(pairArr.length))) : C8223u.i();
    }

    @NotNull
    public static <K, V> Map<K, V> m(@NotNull Pair<? extends K, ? extends V>... pairArr) {
        b41.i(pairArr, "pairs");
        LinkedHashMap linkedHashMap = new LinkedHashMap(C8223u.e(pairArr.length));
    ...
    public static final <K, V> Map<K, V> n(@NotNull Map<K, ? extends V> map) {
        ...
        int size = map.size();
        if (size != 0) {
            return size != 1 ? map : C8225w.g(map);
        }
        return C8223u.i();
    }
    ...
    public static <K, V> Map<K, V> r(@NotNull Iterable<? extends Pair<? extends K, ? extends V>> iterable) {
        ...
        if (iterable instanceof Collection) {
            ...
            if (size != 0) {
                if (size != 1) {
                    return s(iterable, new LinkedHashMap(C8223u.e(collection.size())));
                }
                return C8223u.f(iterable instanceof List ? (Pair<? extends K, ? extends V>) ((List) iterable).get(0) : iterable.iterator().next());
            }
            return C8223u.i();
        }
