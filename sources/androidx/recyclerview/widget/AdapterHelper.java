...
public final class AdapterHelper implements OpReorderer.Callback {
    ...
    public static final class UpdateOp {
        ...
        String cmdToString() {
            int i = this.cmd;
            return i != 1 ? i != 2 ? i != 4 ? i != 8 ? "??" : "mv" : "up" : "rm" : Monitor.POINT_ADD;
        }
        ...
        public String toString() {
            return Integer.toHexString(System.identityHashCode(this)) + jn1.ARRAY_START_STR + cmdToString() + ",s:" + this.positionStart + "c:" + this.itemCount + ",p:" + this.payload + jn1.ARRAY_END_STR;
        }
    }
