...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                String str3 = str2 + jn1.ARRAY_START_STR + i + "] ";
                ...
                sb.append(constraintAnchor != null ? "T" : JSMethod.NOT_SET);
                String sb2 = sb.toString();
                StringBuilder sb3 = new StringBuilder();
                sb3.append(sb2);
                sb3.append(constraintWidget.mBottom.mTarget != null ? "B" : JSMethod.NOT_SET);
                String sb4 = sb3.toString();
                StringBuilder sb5 = new StringBuilder();
                sb5.append(sb4);
                sb5.append(constraintWidget.mLeft.mTarget != null ? "L" : JSMethod.NOT_SET);
                ...
                if (view instanceof TextView) {
                    name = name + jn1.BRACKET_START_STR + ((Object) ((TextView) view).getText()) + jn1.BRACKET_END_STR;
                }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
            ...
            sb.append(i == -1 ? Constants.Name.UNDEFINED : Debug.getState(this, i));
            String sb2 = sb.toString();
    ...
    */
    ...
    private static class MyTracker implements MotionTracker {
        ...
        private static MyTracker f1014me = new MyTracker();
        ...
        public static MyTracker obtain() {
            f1014me.tracker = VelocityTracker.obtain();
            return f1014me;
        }
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (constraintSet.getHeight(i4) == -1) {
                Log.w(TAG, "CHECK: " + name + jn1.BRACKET_START_STR + name2 + ") no LAYOUT_HEIGHT");
            }
