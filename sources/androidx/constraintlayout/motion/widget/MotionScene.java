                    ...
                    switch (c) {
                        ...
                        case 2:
                            if (transition == null) {
                                ...
                                Log.v(TypedValues.MotionScene.NAME, " OnSwipe (" + resourceEntryName + ".xml:" + lineNumber + jn1.BRACKET_END_STR);
                            }
                            if (transition != null) {
    ...
    public ConstraintSet getConstraintSet(Context context, String str) {
        ...
        for (int i = 0; i < this.mConstraintSetMap.size(); i++) {
            ...
            if (this.DEBUG_DESKTOP) {
                ...
                printStream3.println("Id for <" + i + "> is <" + resourceName + "> looking for <" + str + jn1.G);
            }
