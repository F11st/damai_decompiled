...
public class ConstraintSet {
    ...
    class WriteXmlEngine {
        ...
        void writeCircle(int i, float f, int i2) throws IOException {
            ...
            Writer writer = this.writer;
            writer.write(AVFSCacheConstants.COMMA_SEP + f);
            Writer writer2 = this.writer;
            writer2.write(i2 + jn1.ARRAY_END_STR);
        }
        ...
        void writeVariable(String str, int[] iArr) throws IOException {
            ...
            while (i < iArr.length) {
                Writer writer2 = this.writer;
                StringBuilder sb = new StringBuilder();
                sb.append(i == 0 ? jn1.ARRAY_START_STR : AVFSCacheConstants.COMMA_SEP);
        ...
        void writeVariable(String str, String str2) throws IOException {
            ...
            this.writer.write(":");
            Writer writer = this.writer;
            writer.write(AVFSCacheConstants.COMMA_SEP + str2);
    ...
    class WriteJsonEngine {
        ...
        private void writeDimension(String str, int i, int i2, float f, int i3, int i4, boolean z) throws IOException {
            if (i != 0) {
                ...
                if (i2 == 1) {
                    ...
                    writer5.write(SPACE + str + ": '" + f + "%',\n");
                }
            } else if (i2 == 0) {
                Writer writer6 = this.writer;
                writer6.write(SPACE + str + ": {'spread' ," + i3 + AVFSCacheConstants.COMMA_SEP + i4 + "}\n");
            } else if (i2 == 1) {
                Writer writer7 = this.writer;
                writer7.write(SPACE + str + ": {'wrap' ," + i3 + AVFSCacheConstants.COMMA_SEP + i4 + "}\n");
            } else if (i2 != 2) {
            } else {
                Writer writer8 = this.writer;
                writer8.write(SPACE + str + ": {'" + f + "'% ," + i3 + AVFSCacheConstants.COMMA_SEP + i4 + "}\n");
            }
        }
        ...
        void writeVariable(String str, int i) throws IOException {
            ...
            this.writer.write(":");
            Writer writer2 = this.writer;
            writer2.write(AVFSCacheConstants.COMMA_SEP + i);
            this.writer.write(StringUtils.LF);
        }
