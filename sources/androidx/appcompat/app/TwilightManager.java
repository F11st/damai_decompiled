...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        twilightCalculator.calculateTwilight(currentTimeMillis - 86400000, com.alibaba.wireless.security.aopsdk.replace.android.location.Location.getLatitude(location), com.alibaba.wireless.security.aopsdk.replace.android.location.Location.getLongitude(location));
        ...
        boolean z2 = z;
        twilightCalculator.calculateTwilight(86400000 + currentTimeMillis, com.alibaba.wireless.security.aopsdk.replace.android.location.Location.getLatitude(location), com.alibaba.wireless.security.aopsdk.replace.android.location.Location.getLongitude(location));
