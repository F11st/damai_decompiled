...
public final class Palette {
    ...
    public static final class Swatch {
        ...
        public String toString() {
            return Swatch.class.getSimpleName() + " [RGB: #" + Integer.toHexString(getRgb()) + jn1.ARRAY_END + " [HSL: " + Arrays.toString(getHsl()) + jn1.ARRAY_END + " [Population: " + this.mPopulation + jn1.ARRAY_END + " [Title Text: #" + Integer.toHexString(getTitleTextColor()) + jn1.ARRAY_END + " [Body Text: #" + Integer.toHexString(getBodyTextColor()) + jn1.ARRAY_END;
        }
