...
public abstract class SpecialEffectsController {
    ...
    public static class Operation {
        ...
        public String toString() {
            return "Operation " + jn1.BLOCK_START_STR + Integer.toHexString(System.identityHashCode(this)) + "} " + jn1.BLOCK_START_STR + "mFinalState = " + this.mFinalState + "} " + jn1.BLOCK_START_STR + "mLifecycleImpact = " + this.mLifecycleImpact + "} " + jn1.BLOCK_START_STR + "mFragment = " + this.mFragment + "}";
        }
